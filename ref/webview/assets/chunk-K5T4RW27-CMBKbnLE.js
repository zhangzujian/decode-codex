import {
  ...
  xt as m,
  yt as h,
} from "./runtime.worker--jQrUpvm.js";
function g(e, n) {
  return t(p(e, n), 1);
}
function _(e, t) {
  return e && e.length ? c(e, n(t, 2)) : [];
}
function v(e) {
...
function ys(e, t, n) {
  ...
  return (Ts(e, r), Es(e, t, r, n, ...p(n.definition, (n) => ms(e, t, n))));
}
function bs(e, t, n) {
  let r = G(e, t, n, { type: 1 });
...
var Bs = class extends Co {
  ...
  buildLookaheadForOptional(e) {
    let {
      ...
      o = this.logging,
      c = ss(n, r, t),
      d = this.atn.decisionMap[c].decision,
      m = p(ba({ maxLookahead: 1, occurrence: t, prodType: r, rule: n }), (e) =>
        p(e, (e) => e[0]),
      );
    if (Vs(m) && m[0][0] && !i) {
      let e = m[0],
        t = l(e);
      if (t.length === 1 && s(t[0].categoryMatches)) {
        let e = t[0].tokenTypeIdx;
        return function () {
          return this.LA_FAST(1).tokenTypeIdx === e;
        };
...
function Gs(e, t, n, r, i, a) {
  let s = Zs(t.configs, n, i);
  if (s.size === 0) return (tc(e, t, n, Ps), Ps);
  let c = ec(s),
    l = $s(s, i);
  if (l !== void 0)
...
function qs(e) {
  let t = p(e.prefixPath, (e) => Ui(e)).join(`, `),
...
//# sourceMappingURL=chunk-K5T4RW27-CMBKbnLE.js.map
