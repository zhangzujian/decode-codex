...
import {
  n as it,
  t as at,
} from "./use-floating-window-pointer-interactivity-wwcSacOS.js";
import {
  a as ot,
  i as st,
  n as ct,
  ...
  r as ut,
  t as dt,
} from "./worktree-environment-dropdown-CIoKKGRW.js";
import {
  n as ft,
  t as pt,
} from "./use-hotkey-window-dismiss-on-escape-pET0sGWN.js";
function mt(e) {
  let t = (0, ht.c)(52),
    {
      canUseCloud: n,
  ...
  t[0] !== r || t[1] !== s
    ? ((u =
        r === `cloud`
          ? (0, J.jsx)(Je, { className: `icon-2xs` })
          : r === `worktree` && s
            ? (0, J.jsx)(qe, { className: `icon-2xs` })
            : (0, J.jsx)(q, { className: `icon-2xs` })),
      (t[0] = r),
      (t[1] = s),
      (t[2] = u))
    : (u = t[2]);
  ...
  let p;
  t[8] !== u || t[9] !== d
    ? ((p = (0, J.jsxs)(J.Fragment, { children: [u, d, f] })),
      (t[8] = u),
      (t[9] = d),
      (t[10] = p))
    : (p = t[10]);
  ...
  if (o) {
    ...
    return (
      t[13] !== o || t[14] !== e
        ? ((n = (0, J.jsx)(F, { tooltipContent: o, children: e })),
          (t[13] = o),
          (t[14] = e),
          (t[15] = n))
        : (n = t[15]),
...
var ht,
  J,
  gt = e(() => {
    ((ht = l()), C(), T(), Ge(), P(), O(), D(), Xe(), Ye(), Ze(), (J = f()));
  });
function _t({
...
var Ct,
  ...
  At = e(() => {
    ((Et = `_home_reiaa_1`),
      (Dt = `_homeShell_reiaa_20`),
      (Ot = `_shellUnderlay_reiaa_21`),
      (kt = `_composerSurface_reiaa_22`),
      (X = {
        home: Et,
        homeShell: Dt,
        shellUnderlay: Ot,
...
function jt() {
  ...
  let t = ee(),
    ...
    u = ae(),
    { access: d } = je(),
    { isLoading: f, remoteProjects: v, selectedRemoteProject: y } = ye(),
    x = (0, Q.useRef)(null),
    C = (0, Q.useRef)(null),
    w = (0, Q.useRef)(null),
    T = (0, Q.useRef)(null),
    te = o.state,
    E = te?.focusComposerNonce ?? null,
    D = te?.project,
    O = D === void 0 ? void 0 : D?.type === `local` ? D.projectId : null,
    { data: k, isLoading: A } = i(pe),
    M = c(h.hotkeyWindowProjectlessDefaultEnabled),
    P = i(fe),
    F = _t({
      activeWorkspaceRoot: k?.roots[0] ?? null,
      defaultToProjectless: M === !0,
      localProjects: P,
      projectId: O,
    }),
    L =
      D === void 0
        ? y
        : D?.type === `remote`
          ? (v.find((e) => e.id === D.projectId) ?? null)
          : null,
    R = L == null && F === `~`,
    ie = i(Ve),
    z = L?.hostId ?? `local`,
    ...
    H =
      L == null && F == null && (D === void 0 ? A : D?.type === `remote` && f),
    U = ne({ cwd: V, hostId: z, isLoading: H }),
    he = i(se),
    { data: ge, isLoading: xe } = le(
      V == null ? null : { cwd: V, hostConfig: B },
      `hotkey_window_home_page`,
      { retainRepoWatch: he },
    ),
    W = ge?.root ?? null,
    Oe = V != null && W != null && l && !b(V, ce),
    ke = L == null && !A && !xe && W == null,
    Me = R || ke,
    G = {
      fallbackMode: `local`,
      isAvailabilityLoading: !Me && ((L == null && A) || xe || u),
      isCloudAvailable: !Me,
      isLocalAvailable: !0,
      isWorktreeAvailable: Oe,
    },
    Fe = r(we, U),
    Le = i(Te),
    ze = Re(),
    K = Ee({ ...G, composerMode: Fe, cloudAccess: d, isEverydayWorkMode: !1 }),
    { gitRoot: Ue } = De(V, {
      enabled: K === `worktree` && V != null,
      hostId: z,
    ...
    }),
    {
      ...
      updateSelection: Je,
    } = Pe({ hostId: z, workspaceRoot: K === `worktree` ? V : null }),
    [Ye, Xe] = (0, Q.useState)(!1),
    [q, Ze] = (0, Q.useState)(null),
    $e = St({
      activationNonce: E,
      interactiveRegionRef: C,
      onInteractiveChange: (e) => {
        N.hotkeyWindowHotkeys?.homePointerInteractionChanged({
          isInteractive: e,
        });
      },
    });
  g(`hotkey-window-home-composer-position-changed`, (e) => {
    Ze(e.topInsetPx);
  });
  let tt = (e) => {
    let t = x.current,
    ...
    (c?.minimumComposerTopInsetPx === s.minimumComposerTopInsetPx &&
      ...
      ((T.current = s), N.hotkeyWindowHotkeys?.homeLayoutChanged(s));
  };
  (0, Q.useEffect)(() => {
    Ne();
  }, [E]);
  ...
  (0, Q.useLayoutEffect)(() => {
    ...
    return (
      C.current != null && n?.observe(C.current),
  ...
  let it = (0, Q.useCallback)(
    ...
    st = (e) => {
      N.hotkeyWindowHotkeys?.open({ path: p(e) });
    },
    ct = (e) => {
      let t = {
        ...te,
        project: e == null ? null : { type: `local`, projectId: m(e) },
      };
      s(
    ...
    lt = (e) => {
      w.current === e.pointerId &&
        ((w.current = null),
        e.currentTarget.hasPointerCapture?.(e.pointerId) &&
          e.currentTarget.releasePointerCapture?.(e.pointerId),
        N.hotkeyWindowHotkeys?.homeDragEnd());
    },
    pt = (e) => {
      e.button === 0 &&
        (e.preventDefault(),
        ...
        N.hotkeyWindowHotkeys?.homeDragStart({
          pointerWindowX: e.clientX,
          pointerWindowY: e.clientY,
        }));
    },
    ht = (e) => {
      w.current === e.pointerId && N.hotkeyWindowHotkeys?.homeDragMove();
    },
    J =
      Qe(L?.remotePath ?? V, L?.label) ??
      t.formatMessage({
  ...
  return (0, $.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, $.jsxs)(`div`, {
        ...
        style: q == null ? void 0 : { bottom: `auto`, top: q },
        children: [
          (0, $.jsx)(`div`, {
          ...
          (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(He, {
              children: (0, $.jsx)(Be, {
                ...
                placeholderText: gt,
                defaultCwd: F ?? (R || D !== void 0 ? `~` : void 0),
                selectedProject: R ? null : (D ?? ie),
                hotkeyWindowHomeFooterControls: (0, $.jsxs)(_e, {
                  open: Ye,
                  onOpenChange: Xe,
                  children: [
                    (0, $.jsx)(be, {
                      asChild: !0,
                      children: (0, $.jsx)(Ie, { label: xt, size: `composer` }),
                    }),
                    (0, $.jsx)(ve, {
                      align: `center`,
                      side: `top`,
                          ...
                          K === `worktree`
                            ? (0, $.jsx)(Z, {
                                ...
                                control: (0, $.jsx)(dt, {
                                  ...
                                  onOpenSettings: () => {
                                    _.dispatchMessage(`show-settings`, {
...
export { jt as HotkeyWindowHomePage };
//# sourceMappingURL=hotkey-window-home-page-BVArHk5x.js.map
