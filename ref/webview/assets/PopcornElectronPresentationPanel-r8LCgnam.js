...
import { a as te, o as ne } from "./workbook-DEnJtw6Z.js";
import {
  $ as re,
  A as m,
  C as ie,
...
import { n as _e, t as ve } from "./PopcornPageNumberNavigation-DE5ULowX.js";
import { n as ye, t as M } from "./modifiers.esm-Cj5jZNKZ.js";
import {
  $ as be,
  A as xe,
  B as Se,
...
function Kr({
  ...
  let [he, ge] = (0, Q.useState)(() =>
    ...
    P = (0, Q.useRef)(Se),
    qe = (0, Q.useRef)(N),
    Je = ee(c(u, { activationConstraint: { distance: 4 } })),
    F = (0, Q.useMemo)(() => [ye], []),
    Xe = n === `left`,
    Ze = n === `bottom`,
    I = h === `codex`,
      ...
      children: [
        (0, $.jsx)(ae, {
          ...
          centeredContent: dt
            ...
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: i(`flex items-center`, I ? `gap-1` : `gap-2`),
            children: [
              _?.annotation && de
                ? (0, $.jsx)(Te, {
                    active: fe,
    ...
    (f(),
      ...
      (pi = (0, Q.memo)(function ({
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              className: i(`text-token-text-primary`, m, ne),
              style: ae,
              children: t + 1,
            }),
            (0, $.jsxs)(`div`, {
              ...
              children: [
                r
                  ? (0, $.jsx)(`img`, {
                      src: r,
                      alt: ``,
                      className: i(`block`, re),
                      style: ie,
                      draggable: !1,
                    })
                  : (0, $.jsx)(`div`, {
                      className: i(re, `animate-pulse bg-gray-200`),
      ...
      (hi = (0, Q.memo)(function ({
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              "aria-hidden": `true`,
              className: i(`text-token-text-primary invisible`, s, a),
              style: l,
              children: `00`,
            }),
            (0, $.jsx)(`div`, {
              ...
              headerRightContent:
                w.length > 0
                  ? (0, Ci.jsxs)(Ci.Fragment, {
                      children: [(0, Ci.jsx)(yi, { count: w.length }), r],
                    })
                  : r,
              renderHeaderZoomControl: o,
              zoomToFitLabel: a,
...
var Si, Ci;
e(() => {
  (ne(), a(), (Si = t(r())), gi(), Yt(), ie(), R(), nt(), (Ci = n()));
})();
export { _i as PopcornElectronPresentationPanel };
//# sourceMappingURL=PopcornElectronPresentationPanel-r8LCgnam.js.map
