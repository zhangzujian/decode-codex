...
import {
  ...
  r as Mr,
  t as Nr,
} from "./selectable-list-row-CWrT6S5I.js";
import { n as Pr, t as Fr } from "./use-plugin-scheduled-tasks-CHytqlP8.js";
import { n as Ir, t as Lr } from "./play-outline-CiuYrPAI.js";
function Rr(e) {
...
function Ii(e) {
  ...
  let s;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Y.jsx)(kt, { className: `size-4` })), (t[5] = s))
    : (s = t[5]);
  let c;
...
function sa({
  ...
  let l = n(at),
    ...
    { availablePlugins: ke, installedPlugins: Ae, isLoading: je } = mt(V),
...
//# sourceMappingURL=automations-page-CU8NR7JJ.js.map
