...
import { M as s } from "./_baseFor-DBc6wfxY.js";
import {
  A as c,
  B as l,
  C as u,
  ...
  y as C,
  z as re,
} from "./lodash-hNqvBNwd.js";
import { j as w, n as T } from "./merge-DIqo0EGT.js";
import { n as E, r as ie, t as D } from "./graphlib-C3puknBC.js";
function O(e) {
...
function ce(e, n) {
  ...
  var r = ue(e, n || j);
  return i(
    t(le(r.graph, r.buckets, r.zeroIdx), function (t) {
...
function le(e, t, n) {
  for (var r = [], i = t[t.length - 1], a = t[0], o; e.nodeCount();) {
    for (; (o = a.dequeue());) k(e, t, n, o);
    for (; (o = i.dequeue());) k(e, t, n, o);
    if (e.nodeCount()) {
      for (var s = t.length - 2; s > 0; --s)
        if (((o = t[s].dequeue()), o)) {
          r = r.concat(k(e, t, n, o, !0));
          break;
        }
    }
  }
...
function k(e, t, n, r, i) {
  ...
  return (
    o(e.inEdges(r.v), function (r) {
      var o = e.edge(r),
        s = e.node(r.v);
      (i && a.push({ v: r.v, w: r.w }), (s.out -= o), A(t, n, s));
    }),
...
function fe(e) {
  o(e.graph().acyclicer === `greedy` ? ce(e, t(e)) : pe(e), function (t) {
    var n = e.edge(t);
    (e.removeEdge(t),
...
function Ae(e) {
  (o(e.nodes(), function (t) {
    ...
    o(e.edges(), function (t) {
      var n = e.edge(t);
      (o(n.points, R), Object.prototype.hasOwnProperty.call(n, `y`) && R(n));
    }));
}
function R(e) {
  e.y = -e.y;
...
function je(e) {
  (o(e.nodes(), function (t) {
    ...
    o(e.edges(), function (t) {
      var n = e.edge(t);
      (o(n.points, z), Object.prototype.hasOwnProperty.call(n, `x`) && z(n));
    }));
}
function z(e) {
  var t = e.x;
...
function Ve(e) {
  ...
  if ((o(e.sinks(), i), te(t) !== e.nodeCount())) throw new q();
  return r;
}
function q() {}
var He = e(() => {
    (x(), (Ve.CycleException = q), (q.prototype = Error()));
  }),
  Ue = e(() => {
    He();
  });
  ...
  return (
    ...
    g(
      n(t.edges(), function (t) {
        return l === st(e, e.node(t.v), c) && l !== st(e, e.node(t.w), c);
      }),
      function (e) {
        return H(t, e);
      },
...
function Ot(e) {
  ...
  function s(t) {
    d(r, t) || ((r[t] = !0), a[e.node(t).rank].push(t), o(e.successors(t), s));
  }
  return (
    o(
      y(i, function (t) {
...
function Mt(e, t) {
  ...
  return (
    o(e, function (e, t) {
      ...
      u(e.barycenter) || ((n.barycenter = e.barycenter), (n.weight = e.weight));
    }),
    o(t.edges(), function (e) {
      var t = r[e.v],
        n = r[e.w];
      !u(t) && !u(n) && (n.indegree++, t.out.push(r[e.w]));
    }),
    Nt(
      n(r, function (e) {
        return !e.indegree;
...
function Nt(e) {
  ...
  function i(e) {
    return function (t) {
      t.merged ||
        ((u(t.barycenter) || u(e.barycenter) || t.barycenter >= e.barycenter) &&
          Pt(e, t));
    };
  }
  function a(t) {
...
function Lt(e, t, n) {
  for (var r; t.length && (r = f(t)).i <= n;) (t.pop(), e.push(r.vs), n++);
  return n;
}
function Rt(e) {
  return function (t, n) {
...
function Bt(e, t, r, a) {
  ...
  o(f, function (t) {
    if (e.children(t.v).length) {
      var n = Bt(e, t.v, r, a);
      ((d[t.v] = n),
        Object.prototype.hasOwnProperty.call(n, `barycenter`) && Ht(t, n));
    }
  });
  var p = Mt(f, r);
  Vt(p, d);
  ...
  if (l && ((m.vs = i([l, m.vs, u])), e.predecessors(l).length)) {
    var ee = e.node(e.predecessors(l)[0]),
      h = e.node(e.predecessors(u)[0]);
    (Object.prototype.hasOwnProperty.call(m, `barycenter`) ||
      ((m.barycenter = 0), (m.weight = 0)),
      (m.barycenter =
        (m.barycenter * m.weight + ee.order + h.order) / (m.weight + 2)),
      (m.weight += 2));
  }
  return m;
}
...
function Wt(e) {
  var t = ye(e),
    n = Gt(e, b(1, t + 1), `inEdges`),
    r = Gt(e, b(t - 1, -1, -1), `outEdges`),
    i = Ot(e);
  qt(e, i);
        ...
        (u || t === c) &&
          (o(r.slice(a, l + 1), function (t) {
            o(e.predecessors(t), function (r) {
              var a = e.node(r),
                o = a.order;
              (o < i || d < o) && !(a.dummy && e.node(t).dummy) && nn(n, r, t);
            });
          }),
          (a = l + 1),
          (i = d));
      ...
      ((c = t[r]),
        e.node(c).dummy &&
          o(e.predecessors(c), function (t) {
            var r = e.node(t);
            r.dummy && (r.order < a || r.order > s) && nn(n, t, c);
          }));
    });
  }
  function i(t, n) {
...
function tn(e, t) {
  if (e.node(t).dummy)
    return m(e.predecessors(t), function (t) {
    ...
    o(t, function (e) {
      ...
      o(e, function (e) {
        ...
        if (o.length) {
          ...
          for (
            var c = (o.length - 1) / 2, l = Math.floor(c), u = Math.ceil(c);
            l <= u;
            ++l
          ) {
            var d = o[l];
...
function xn(e) {
  var t = new E({ multigraph: !0, compound: !0 }),
    n = Q(e.graph());
  return (
    t.setGraph(T({}, Fn, Z(n, Pn), v(n, In))),
    o(e.nodes(), function (n) {
      var r = Q(e.node(n));
      (t.setNode(n, p(Z(r, Ln), $)), t.setParent(n, e.parent(n)));
    }),
    o(e.edges(), function (n) {
      var r = Q(e.edge(n));
      t.setEdge(n, T({}, zn, Z(r, Rn), v(r, Bn)));
    }),
    t
  );
}
  ...
  (o(e.nodes(), function (t) {
    if (e.children(t).length) {
      var n = e.node(t),
        ...
        a = e.node(f(n.borderLeft)),
        o = e.node(f(n.borderRight));
...
export { Vn as n, vn as r, Hn as t };
//# sourceMappingURL=dagre-ByZQGFv2.js.map
