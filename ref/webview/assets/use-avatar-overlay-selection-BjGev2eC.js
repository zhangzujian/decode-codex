...
import { i as u, r as d } from "./custom-avatars-query-ZfMaMCDW.js";
import { n as f, t as p } from "./use-avatar-options-BMz5jNTJ.js";
function m(e) {
...
function W() {
  let e = (0, G.c)(3),
    ...
    { selectedAvatar: i, selectedAvatarId: s } = o(n),
    c = a(i, s),
    { isFetching: l } = t(u, s ?? i.id),
    d = c && (r || l) ? null : i,
    p;
  return (
    e[0] !== s || e[1] !== d
...
//# sourceMappingURL=use-avatar-overlay-selection-BjGev2eC.js.map
