...
import { u as g } from "./chunk-5PVQY5BW-BbQZwqS7.js";
import { i as _ } from "./chunk-U2HBQHQK-1ea0xDQK.js";
import { r as v } from "./chunk-BSJP7CBP-DFvoyeko.js";
import { r as y } from "./chunk-ZZ45TVLE-BBqrp2id.js";
import { n as b, t as x } from "./chunk-55IACEB6-BV1epJsw.js";
import { n as S, t as C } from "./chunk-EDXVE4YY-CTb4qBXR.js";
import { n as w } from "./chunk-X2U36JSP-B_hQhnS7.js";
import { i as T } from "./chunk-5FUZZQ4R-CyIhitb3.js";
import { n as E } from "./chunk-ENJZ2VHE-BjCyLcei.js";
import { i as D, n as O, t as k } from "./chunk-336JU56O-1JNaXPk5.js";
    ...
    (P = class {
      ...
      getData() {
        let e = this.getMindmap(),
          ...
          n = d().layout !== void 0,
          r = t;
        if ((n || (r.layout = `cose-bilkent`), !e))
          return { nodes: [], edges: [], config: r };
        (s.debug(`getData: mindmapRoot`, e, t), this.assignSections(e));
        let i = [],
          a = [];
        (this.flattenNodes(e, i),
          this.generateEdges(e, a),
          s.debug(
            `getData: processed ${i.length} nodes and ${a.length} edges`,
          ));
        let c = new Map();
        for (let e of i)
          c.set(e.id, {
...
` + e,
    ...
    (I = c((e) => {
      ...
      for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) {
        let n = `` + (a === `neo` ? Math.max(10 - (t - 1) * 2, 2) : 17 - 3 * t);
        o += `
    ...
    [data-look="neo"].mindmap-node.section-${t - 1} rect, [data-look="neo"].mindmap-node.section-${t - 1} path, [data-look="neo"].mindmap-node.section-${t - 1} circle, [data-look="neo"].mindmap-node.section-${t - 1} polygon {
      fill: ${i === `redux` || i === `redux-dark` || i === `neutral` ? e.mainBkg : e[`cScale` + t]};
      stroke: ${i === `redux` || i === `redux-dark` ? e.nodeBorder : e[`cScale` + t]};
      stroke-width: ${e.strokeWidth ?? 2}px;
    }
    [data-look="neo"].section-edge-${t - 1}{
      stroke: ${i?.includes(`redux`) || i === `neo-dark` ? e.nodeBorder : e[`cScale` + t]};
    }
    [data-look="neo"].mindmap-node.section-${t - 1} text {
     fill: ${i === `redux` || i === `redux-dark` ? e.nodeBorder : e[`cScaleLabel` + (i === `neutral` ? 1 : t)]};
    }
    `;
      }
      return o;
...
export { R as diagram };
//# sourceMappingURL=mindmap-definition-QFDTVHPH-DITaHmaW.js.map
