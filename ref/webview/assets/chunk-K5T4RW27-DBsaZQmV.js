import {
  ...
  s as i,
  t as a,
} from "./rolldown-runtime-BG2f4sTM.js";
import {
  A as o,
  D as s,
  O as c,
...
import { n as x, t as te } from "./isEmpty-D-5ng6I7.js";
import {
  a as S,
  c as C,
  i as ne,
...
`,
  ...
  n(`Misc Mapping #2`, () => {
    ((f = r.map(Ja)),
      ...
      (m = r.reduce((e, t) => {
        let n = t.GROUP;
        return (typeof n == `string` && n !== ko.SKIPPED && (e[n] = []), e);
      }, {})),
      (h = a.map((e, t) => ({
        pattern: a[t],
        longerAlt: c[t],
...
function Ra(e) {
  return e
    .filter((e) => {
      ...
      let t = e.GROUP;
      return t !== ko.SKIPPED && t !== ko.NA && typeof t != `string`;
    })
    .map((e) => ({
      message:
        `Token Type: ->` +
...
function to() {
  if (so.length === 0) {
    so = Array(65536);
    for (let e = 0; e < 65536; e++) so[e] = e > 255 ? 255 + ~~(e / 255) : e;
  }
}
var no,
  ro,
...
function mo(e) {
  e.forEach((e) => {
    (vo(e) || ((wo[Co] = e), (e.tokenTypeIdx = Co++)),
      yo(e) && !Array.isArray(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]),
      yo(e) || (e.CATEGORIES = []),
      bo(e) || (e.categoryMatches = []),
      xo(e) || (e.categoryMatchesMap = {}));
  });
}
function ho(e) {
  e.forEach((e) => {
    ((e.categoryMatches = []),
      Object.keys(e.categoryMatchesMap).forEach((t) => {
        e.categoryMatches.push(wo[t].tokenTypeIdx);
      }));
  });
}
function go(e) {
...
a boolean 2nd argument is no longer supported`);
          this.config = Object.assign({}, Oo, t);
            ...
            this.TRACE_INIT(`Lexer Constructor`, () => {
              ...
              (this.TRACE_INIT(`Lexer Config handling`, () => {
                if (
                  ...
                  Oo.lineTerminatorsPattern
                )
                  this.config.lineTerminatorsPattern = oo;
                else if (
                  this.config.lineTerminatorCharacters ===
                  Oo.lineTerminatorCharacters
                )
...
` + e,
      ...
      (ko.SKIPPED = `This marks a skipped Token pattern, this means each token identified by it will be consumed and then thrown into oblivion, this can be used to for example to completely ignore whitespace.`),
      (ko.NA = /NOT_APPLICABLE/));
  });
function jo(e) {
  return Mo(e) ? e.LABEL : e.name;
}
function Mo(e) {
  return typeof e.LABEL == `string` && e.LABEL !== ``;
}
...
function Po(e) {
  let t = e.pattern,
    n = {};
  if (
    ((n.name = e.name), t !== void 0 && (n.PATTERN = t), Object.hasOwn(e, Lo))
  )
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return (
    Object.hasOwn(e, Ro) && (n.CATEGORIES = e[Ro]),
    fo([n]),
    Object.hasOwn(e, zo) && (n.LABEL = e[zo]),
    Object.hasOwn(e, Bo) && (n.GROUP = e[Bo]),
    Object.hasOwn(e, Ho) && (n.POP_MODE = e[Ho]),
    Object.hasOwn(e, Vo) && (n.PUSH_MODE = e[Vo]),
    Object.hasOwn(e, Uo) && (n.LONGER_ALT = e[Uo]),
    Object.hasOwn(e, Wo) && (n.LINE_BREAKS = e[Wo]),
    Object.hasOwn(e, Go) && (n.START_CHARS_HINT = e[Go]),
    n
  );
}
    ...
    (qo(),
      ...
      (Jo = {
        buildMismatchTokenMessage({
          ...
          return `Expecting ${Mo(e) ? `--> ${jo(e)} <--` : `token of type --> ${e.name} <--`} but found --> '${t.image}' <--`;
        },
...
`,
        ...
        buildAlternationPrefixAmbiguityError(e) {
          let t = e.prefixPath.map((e) => jo(e)).join(`, `),
      ...
      ($o = class extends Wi {
        ...
        visitNonTerminal(e) {
          ...
          if (t) e.referencedRule = t;
            ...
            this.errors.push({
              message: t,
              type: bl.UNRESOLVED_SUBRULE_REF,
...
function ns(e, t, n, r) {
  ...
  for (
    ...
    else if (h instanceof Li) d.push(rs(h, f, p, m));
    else throw Error(`non exhaustive match`);
  }
  return u;
}
      ...
      (as = class extends is {
        ...
        walkTerminal(e, t, n) {
          if (
            ...
            let e = new Ri({ definition: t.concat(n) });
            ((this.possibleTokTypes = ta(e)), (this.found = !0));
          }
        }
      }),
      (os = class extends $i {
...
function ps(e) {
  let { occurrence: t, rule: n, prodType: r, maxLookahead: i } = e,
    a = fs(r);
  return a === K.ALTERNATION ? Ss(t, n, i) : Cs(t, n, a, i);
}
function ms(e, t, n, r, i, a) {
  let o = Ss(e, t, n);
  return a(o, r, Es(o) ? uo : lo, i);
}
...
function xs(e, t) {
  let n = e.map((e) => ts([e], 1)),
    r = vs(n.length),
    i = n.map((e) => {
      let t = {};
      return (
        e.forEach((e) => {
          ys(e.partialPath).forEach((e) => {
            t[e] = !0;
          });
        }),
        t
    ...
    for (let o = 0; o < n.length; o++) {
      ...
      for (let n = 0; n < s.length; n++) {
        let c = s[n].partialPath,
          l = s[n].suffixDef,
          u = ys(c);
        if (bs(i, u, o) || l.length === 0 || c.length === t) {
          let e = r[o];
          if (ws(e, c) === !1) {
            e.push(c);
...
function Ss(e, t, n, r) {
  let i = new Os(e, K.ALTERNATION, r);
  return (t.accept(i), xs(i.result, n));
}
function Cs(e, t, n, r) {
  let i = new Os(e, n);
  t.accept(i);
  let a = i.result,
    o = new Ds(t, e, n).startWalking();
  return xs([new Ri({ definition: a }), new Ri({ definition: o })], r);
}
function ws(e, t) {
...
function As(e) {
  return e.lookaheadStrategy
    ...
    .map((e) => Object.assign({ type: bl.CUSTOM_LOOKAHEAD_VALIDATION }, e));
}
function js(e, t, n, r) {
  let i = e.flatMap((e) => Ms(e, n)),
    a = Gs(e, t, n),
    o = e.flatMap((e) => Vs(e, n)),
    s = e.flatMap((t) => Fs(t, e, r, n));
...
function Ns(e) {
  return `${Yi(e)}_#_${e.idx}_#_${Ps(e)}`;
}
function Ps(e) {
  return e instanceof W
    ? e.terminalType.name
...
function Fs(e, t, n, r) {
  ...
  if (t.reduce((t, n) => (n.name === e.name ? t + 1 : t), 0) > 1) {
    ...
    i.push({ message: t, type: bl.DUPLICATE_RULE_NAME, ruleName: e.name });
  }
  return i;
}
function Is(e, t, n) {
  ...
  return (
    t.includes(e) ||
      ...
      r.push({ message: i, type: bl.INVALID_RULE_OVERRIDE, ruleName: e })),
    r
  );
}
function Ls(e, t, n, r = []) {
...
function Rs(e) {
  ...
  if (n instanceof Ii) t.push(n.referencedRule);
    ...
    t = t.concat(Rs(n.definition));
  else if (n instanceof Hi)
    t = n.definition.map((e) => Rs(e.definition)).flat();
  else if (!(n instanceof W)) throw Error(`non exhaustive match`);
  let r = qi(n),
    i = e.length > 1;
  if (r && i) {
    let n = e.slice(1);
    return t.concat(Rs(n));
  } else return t;
}
function zs(e, t) {
  let n = new qs();
      ...
      (e.accept(i),
        i.allProductions.forEach((i) => {
          ...
          if (Cs(s, e, a, o)[0].flat().length === 0) {
            ...
            r.push({
              message: t,
              type: bl.NO_NON_EMPTY_LOOKAHEAD,
              ruleName: e.name,
            });
          }
        }));
  ...
  return (
    e.forEach((e) => {
      ...
      if (i.includes(t)) {
        ...
        r.push({
          message: i,
          type: bl.CONFLICT_TOKENS_RULES_NAMESPACE,
          ruleName: t,
        });
      }
    }),
...
function Xs(e) {
  let t = Object.assign({ errMsgProvider: Yo }, e),
    n = {};
  return (
    e.rules.forEach((e) => {
      n[e.name] = e;
    }),
    Qo(n, t.errMsgProvider)
  );
}
function Zs(e) {
  let t = e.errMsgProvider ?? Xo;
  return js(e.rules, e.tokenTypes, t, e.grammarName);
}
var Qs = t(() => {
  (es(), Ys(), Zo());
});
function $s(e) {
  return ic.includes(e.name);
}
var ec,
  tc,
  nc,
  ...
  lc,
  uc = t(() => {
    ((ec = `MismatchedTokenException`),
      (tc = `NoViableAltException`),
      (nc = `EarlyExitException`),
      (rc = `NotAllInputParsedException`),
      (ic = [ec, tc, nc, rc]),
      Object.freeze(ic),
      ...
      (oc = class extends ac {
        constructor(e, t, n) {
          (super(e, t), (this.previousToken = n), (this.name = ec));
        }
      }),
      (sc = class extends ac {
        constructor(e, t, n) {
...
function dc(e, t, n, r, i, a, o) {
  ...
  let l = c.token,
    u = c.occurrence,
    d = c.isEndOfRule;
  (this.RULE_STACK_IDX === 0 && d && l === void 0 && ((l = Ko), (u = 1)),
    !(l === void 0 || u === void 0) &&
...
var fc,
  ...
  gc = t(() => {
    (qo(),
      ...
      Cl(),
      (fc = {}),
      (pc = `InRuleRecoveryException`),
      (mc = class extends Error {
        constructor(e) {
          (super(e), (this.name = pc));
        }
      }),
      (hc = class {
        initRecoverable(e) {
          ((this.firstAfterRepMap = {}),
            ...
            (this.recoveryEnabled = Object.hasOwn(e, `recoveryEnabled`)
              ? e.recoveryEnabled
              : vl.recoveryEnabled),
            this.recoveryEnabled && (this.attemptInRepetitionRecovery = dc));
        }
        getTokenToInsert(e) {
          let t = Fo(e, ``, NaN, NaN, NaN, NaN, NaN, NaN);
        ...
        getNextPossibleTokenTypes(e) {
          ...
          return new as(n, e).startWalking();
        }
        ...
        findReSyncTokenType() {
          let e = this.flattenFollowSet(),
            ...
            n = 2;
          for (;;) {
            let r = e.find((e) => Io(t, e));
            if (r !== void 0) return r;
            ((t = this.LA(n)), n++);
          }
        }
        getCurrFollowKey() {
          if (this.RULE_STACK_IDX === 0) return fc;
        ...
        addToResyncTokens(e, t) {
          return (this.tokenMatcher(e, Ko) || t.push(e), t);
        }
        reSyncTo(e) {
          let t = [],
            n = this.LA_FAST(1);
...
var vc,
  ...
  Cc = t(() => {
    (Zo(),
      ...
      (Sc = class {
        constructor(e) {
          this.maxLookahead = e?.maxLookahead ?? vl.maxLookahead;
        }
        validate(e) {
        ...
        validateNoLeftRecursion(e) {
          return e.flatMap((e) => Ls(e, e, Xo));
        }
        validateEmptyOrAlternatives(e) {
          return e.flatMap((e) => zs(e, Xo));
        }
        validateAmbiguousAlternationAlternatives(e, t) {
          return e.flatMap((e) => Bs(e, t, Xo));
        }
              ...
              (t.forEach((t) => {
                ...
                this.TRACE_INIT(`${Yi(t)}${n}`, () => {
                  let n = this.lookaheadStrategy.buildLookaheadForAlternation({
                    ...
                    r = _c(this.fullRuleNameToShort[e.name], 256, t.idx);
        ...
        computeLookaheadFunc(e, t, n, r, i, a) {
          this.TRACE_INIT(`${a}${t === 0 ? `` : t}`, () => {
            let a = this.lookaheadStrategy.buildLookaheadForOptional({
              ...
              o = _c(this.fullRuleNameToShort[e.name], n, t);
            this.setLaFuncCache(o, a);
          });
        }
        getKeyForAutomaticLookahead(e, t) {
          return _c(this.currRuleShortName, e, t);
        }
...
function zc(e, t, n) {
  let r = function () {};
  Pc(r, e + `BaseSemanticsWithDefaults`);
      ...
      (Wc = class {
        initTreeBuilder(e) {
          if (
            ...
            this.recoveryEnabled
              ? ((this.setNodeLocationFromToken = kc),
                (this.setNodeLocationFromNode = kc),
                (this.cstPostRule = () => {}),
                (this.setInitialNodeLocation =
        ...
        cstPostTerminal(e, t) {
          ...
          (jc(n, t, e), this.setNodeLocationFromToken(n.location, t));
        }
        cstPostNonTerminal(e, t) {
          let n = this.CST_STACK[this.CST_STACK.length - 1];
          (Mc(n, t, e), this.setNodeLocationFromNode(n.location, e.location));
        }
        getBaseCstVisitorConstructor() {
          if (this.baseCstVisitorConstructor === void 0) {
            let e = Rc(this.className, Object.keys(this.gastProductionsCache));
  ...
  qc = t(() => {
    (Cl(),
      (Kc = class {
        ...
        LA(e) {
          let t = this.currIdx + e;
          return t < 0 || this.tokVectorLength <= t ? _l : this.tokVector[t];
        }
        consumeToken() {
          this.currIdx++;
        }
      ...
      (Jc = class {
        ...
        RULE(e, t, n = yl) {
          if (this.definedRulesNames.includes(e)) {
            let t = {
              message: Xo.buildDuplicateRuleNameError({
                topLevelRule: e,
                grammarName: this.className,
              }),
              type: bl.DUPLICATE_RULE_NAME,
              ruleName: e,
            };
        ...
        OVERRIDE_RULE(e, t, n = yl) {
          let r = Is(e, this.definedRulesNames, this.className);
  ...
  Zc = t(() => {
	...
	For Further details.`);
          ...
          if (Array.isArray(e))
            ...
            Object.hasOwn(e, `modes`) &&
            Object.values(e.modes).flat().every(So)
          ) {
          ...
          this.tokensMap.EOF = Ko;
          let n = (
            Object.hasOwn(e, `modes`)
              ? Object.values(e.modes).flat()
              : Object.values(e)
          ).every((e) => e.categoryMatches?.length == 0);
          ((this.tokenMatcher = n ? uo : lo),
            fo(Object.values(this.tokensMap)));
        }
        defineRule(e, t, n) {
        ...
        isAtEndOfInput() {
          return this.tokenMatcher(this.LA(1), Ko);
        }
        reset() {
        ...
        onAfterParse(e) {
          if (this.isAtEndOfInput() === !1) {
            ...
            this.SAVE_ERROR(new cc(t, e));
          }
          for (; this.tokVector.at(-1) === _l;) this.tokVector.pop();
        }
      }));
  }),
  Qc,
      ...
      (Qc = class {
        ...
        raiseEarlyExitException(e, t, n) {
          let r = this.getCurrRuleFullName(),
            ...
            a = Cs(e, i, t, this.maxLookahead)[0],
            o = [];
        ...
        raiseNoAltException(e, t) {
          ...
          throw this.SAVE_ERROR(new sc(s, this.LA(1), o));
        }
      }));
  });
...
var il,
  ...
  dl = t(() => {
    (Zi(),
      ...
      (al = !0),
      (ol = 2 ** 8 - 1),
      (sl = No({ name: `RECORDING_PHASE_TOKEN`, pattern: ko.NA })),
      fo([sl]),
      (cl = Fo(
        sl,
	...
	https://chevrotain.io/docs/guide/internals.html#grammar-recording`;
        ...
        optionInternalRecord(e, t) {
          return el.call(this, H, e, t);
        }
        atLeastOneInternalRecord(e, t) {
          el.call(this, zi, t, e);
        }
        atLeastOneSepFirstInternalRecord(e, t) {
          el.call(this, Bi, t, e, al);
        }
        manyInternalRecord(e, t) {
          el.call(this, U, t, e);
        }
        manySepFirstInternalRecord(e, t) {
          el.call(this, Vi, t, e, al);
        }
        orInternalRecord(e, t) {
          return tl.call(this, e, t);
        }
        subruleInternalRecord(e, t, n) {
          if ((rl(t), !e || !Object.hasOwn(e, `ruleName`))) {
            let n = Error(
              `<SUBRULE${nl(t)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>\n inside top level rule: <${this.recordingProdStack[0].name}>`,
            );
          ...
          return (r.definition.push(a), this.outputCst ? ll : il);
        }
        consumeInternalRecord(e, t, n) {
          if ((rl(t), !vo(e))) {
            let n = Error(
              `<CONSUME${nl(t)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>\n inside top level rule: <${this.recordingProdStack[0].name}>`,
            );
            throw ((n.KNOWN_RECORDER_ERROR = !0), n);
          }
          let r = this.recordingProdStack.at(-1),
            i = new W({ idx: t, terminalType: e, label: n?.LABEL });
          return (r.definition.push(i), cl);
        }
      }));
  }),
  fl,
        ...
        initPerformanceTracer(e) {
          if (Object.hasOwn(e, `traceInitPerf`)) {
            ...
            ((this.traceInitMaxIdent = 0),
              (this.traceInitPerf = vl.traceInitPerf));
          this.traceInitIndent = -1;
        }
        TRACE_INIT(e, t) {
          if (this.traceInitPerf === !0) {
...
var _l,
  ...
  Cl = t(() => {
    (ki(),
      ...
      hl(),
      Ys(),
      (_l = Fo(Ko, ``, NaN, NaN, NaN, NaN, NaN, NaN)),
      Object.freeze(_l),
      (vl = Object.freeze({
        recoveryEnabled: !1,
        maxLookahead: 3,
          ...
          this.TRACE_INIT(`performSelfAnalysis`, () => {
            ...
            if (
              (this.TRACE_INIT(`Grammar Resolving`, () => {
                ((r = Xs({ rules: Object.values(this.gastProductionsCache) })),
                  (this.definitionErrors = this.definitionErrors.concat(r)));
              }),
              ...
              this.definitionErrors.length === 0 &&
                (this.recoveryEnabled &&
                  this.TRACE_INIT(`computeAllProdsFollows`, () => {
                    let e = ca(Object.values(this.gastProductionsCache));
...
`)}`,
	...
	For further details.`);
      ...
      (xl.DEFER_DEFINITION_ERRORS_HANDLING = !1),
      ml(xl, [hc, Tc, Wc, Kc, Xc, Jc, Qc, ul, fl]),
      (Sl = class extends xl {
        constructor(e, t = vl) {
...
function kl(e, t, n) {
  ...
  return (zl(e, r), Ll(e, t, n, Bl(e, t, r, n, Fl(e, t, n))));
}
function Al(e, t, n) {
  let r = J(e, t, n, { type: 5 });
  return (
    zl(e, r),
    Ll(e, t, n, Bl(e, t, r, n, Fl(e, t, n)), Ul(e, t, n.separator, n))
  );
}
function jl(e, t, n) {
  let r = J(e, t, n, { type: 4 });
  return (zl(e, r), Il(e, t, n, Bl(e, t, r, n, Fl(e, t, n))));
}
function Ml(e, t, n) {
  let r = J(e, t, n, { type: 4 });
  return (
    zl(e, r),
    Il(e, t, n, Bl(e, t, r, n, Fl(e, t, n)), Ul(e, t, n.separator, n))
  );
}
function Nl(e, t, n) {
  let r = J(e, t, n, { type: 1 });
  return (zl(e, r), Bl(e, t, r, n, ...o(n.definition, (n) => Ol(e, t, n))));
}
function Pl(e, t, n) {
  let r = J(e, t, n, { type: 1 });
  return (zl(e, r), Rl(e, t, n, Bl(e, t, r, n, Fl(e, t, n))));
}
function Fl(e, t, n) {
  let r = s(
    o(n.definition, (n) => Ol(e, t, n)),
    (e) => e !== void 0,
  );
  return r.length === 1 ? r[0] : r.length === 0 ? void 0 : Hl(e, r);
}
...
function Ll(e, t, n, r, i) {
  ...
  return (
    ...
    (e.decisionMap[Tl(t, i ? `RepetitionWithSeparator` : `Repetition`, n.idx)] =
      s),
    { left: s, right: c }
  );
}
function Rl(e, t, n, r) {
  let i = r.left,
    a = r.right;
  return (q(i, a), (e.decisionMap[Tl(t, `Option`, n.idx)] = i), r);
}
function zl(e, t) {
  return (
...
function Bl(e, t, n, r, ...i) {
  ...
  return ((e.decisionMap[Tl(t, Vl(r), r.idx)] = n), o);
}
function Vl(e) {
...
function Hl(e, t) {
  ...
  for (let r = 0; r < n - 1; r++) {
    ...
    ((a && o.followState === n.right) || i.target === n.right)
      ? (a ? (o.followState = s) : (i.target = s), ql(e, n.right))
      : q(n.right, s);
  }
  let r = t[0],
    i = t[n - 1];
...
function Ul(e, t, n, r) {
  let i = J(e, t, r, { type: 1 }),
    a = J(e, t, r, { type: 1 });
  return (Kl(i, new Yl(a, n)), { left: i, right: a });
}
function Wl(e, t, n) {
  let r = n.referencedRule,
    ...
    a = J(e, t, n, { type: 1 }),
    o = J(e, t, n, { type: 1 });
  return (Kl(a, new Zl(i, r, o)), { left: a, right: o });
}
function Gl(e, t, n) {
...
function au(e) {
  let t = e.decisionStates.length,
    n = Array(t);
  for (let r = 0; r < t; r++) n[r] = ru(e.decisionStates[r], r);
  return n;
}
function ou(e, t, n, r) {
  let i = e[t](n),
    a = i.start;
  return (
    a === void 0 && ((a = yu(i, _u(bu(i.atnStartState)))), (i.start = a)),
    su.apply(this, [i, a, n, r])
  );
}
function su(e, t, n, r) {
  let i = t,
  ...
  for (;;) {
    let t = pu(i, s);
    if ((t === void 0 && (t = cu.apply(this, [e, i, s, a, n, r])), t === eu))
      return fu(o, i, s);
...
function cu(e, t, n, r, i, a) {
  let o = mu(t.configs, n, i);
  if (o.size === 0) return (vu(e, t, n, eu), eu);
  let s = _u(o),
    c = gu(o, i);
  if (c !== void 0)
...
function lu(e, t, n, r) {
  ...
  let a = e.atnStartState,
    o = a.rule,
    s = a.production;
  r(uu({ topLevelRule: o, ambiguityIndices: n, production: s, prefixPath: i }));
}
function uu(e) {
  let t = o(e.prefixPath, (e) => jo(e)).join(`, `),
    n = e.production.idx === 0 ? `` : e.production.idx,
    r = `Ambiguous Alternatives Detected: <${e.ambiguityIndices.join(`, `)}> in <${du(e.production)}${n}> inside <${e.topLevelRule.name}> Rule,\n<${t}> may appears as a prefix path in all these alternatives.\n`;
  return (
    (r += `See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES
For Further details.`),
    r
...
function mu(e, t, n) {
  ...
  if ((i.length === 0 && r.size === 1 && (a = r), a === void 0)) {
    a = new tu();
    for (let e of r.elements) xu(e, a);
  }
  if (i.length > 0 && !Cu(a)) for (let e of i) a.add(e);
  return a;
}
function hu(e, t) {
  if (e instanceof Yl && Io(t, e.tokenType)) return e.target;
}
function gu(e, t) {
  let n;
...
function vu(e, t, n, r) {
  return ((r = yu(e, r)), (t.edges[n.tokenTypeIdx] = r), r);
}
function yu(e, t) {
  if (t === eu) return t;
  let n = t.configs.key,
...
function bu(e) {
  ...
  for (let r = 0; r < n; r++)
    xu({ state: e.transitions[r].target, alt: r, stack: [] }, t);
  return t;
}
function xu(e, t) {
  let n = e.state;
  if (n.type === 7) {
    if (e.stack.length > 0) {
      let n = [...e.stack];
      xu({ state: n.pop(), alt: e.alt, stack: n }, t);
    } else t.add(e);
    return;
  }
...
function Su(e, t) {
  if (t instanceof Xl) return { state: t.target, alt: e.alt, stack: e.stack };
  if (t instanceof Zl) {
  ...
  Mu = t(() => {
    (wl(),
      ...
      (ju = class extends Sc {
        ...
        initialize(e) {
          ((this.atn = El(e.rules)), (this.dfas = au(this.atn)));
        }
        ...
        buildLookaheadForAlternation(e) {
          ...
          if (iu(u, !1) && !i) {
            ...
            return function (e) {
              ...
              let r = ou.call(this, a, l, t, s);
              return typeof r == `number` ? r : void 0;
            };
          else
            return function () {
              let e = ou.call(this, a, l, Au, s);
        ...
        buildLookaheadForOptional(e) {
          let {
            ...
            l = this.atn.decisionMap[c].decision,
            u = o(
              ps({ maxLookahead: 1, occurrence: t, prodType: r, rule: n }),
              (e) => o(e, (e) => e[0]),
            );
          if (iu(u) && u[0][0] && !i) {
            let e = u[0],
  ...
  Bu = t(() => {
    (re(),
      ...
      (Pu = class {
        ...
        buildLeafNode(e, t) {
          let n = new Iu(e.startOffset, e.image.length, Nn(e), e.tokenType, !t);
          return (
            (n.grammarSource = t),
      ...
      (Lu = class extends Fu {
        constructor() {
          (super(...arguments), (this.content = new Ru(this)));
        }
        get offset() {
  ...
  $u = t(() => {
    (Dn(),
      ...
      (Ku = class extends Gu {
        ...
        computeRuleType(e) {
          return Xe(e) ? ai(e) : e.fragment ? void 0 : ei(e) ? Hu : ai(e);
        }
        parse(e, t = {}) {
        ...
        startImplementation(e, t, n) {
          return (r) => {
            ...
            if (i) {
              let n = { $type: e };
              (this.stack.push(n),
                e === Hu ? (n.value = ``) : t !== void 0 && (n.$infixName = t));
            }
      ...
      (qu = class {
        buildMismatchTokenMessage(e) {
          return Jo.buildMismatchTokenMessage(e);
        }
        buildNotAllInputParsedMessage(e) {
          return Jo.buildNotAllInputParsedMessage(e);
        }
        buildNoViableAltMessage(e) {
          return Jo.buildNoViableAltMessage(e);
        }
        buildEarlyExitMessage(e) {
          return Jo.buildEarlyExitMessage(e);
        }
      }),
      (Ju = class extends qu {
      ...
      (Zu = class extends Sl {
        constructor(e, t) {
          ...
          super(e, {
            ...Xu,
            lookaheadStrategy: n
              ? new Sc({ maxLookahead: t.maxLookahead })
              : new ju({ logging: t.skipValidations ? () => {} : void 0 }),
            ...t,
          });
        }
        get IS_RECORDING() {
...
function ed(e, t, n) {
  return (td({ parser: t, tokens: n, ruleNames: new Map() }, e), t);
}
function td(e, t) {
  let n = Ir(t, !1),
    r = F(t.rules)
  ...
  for (let t of r) {
    ...
    e.parser.rule(t, rd(n, t.definition));
  }
  let i = F(t.rules)
    .filter(Xe)
    .filter((e) => n.has(e));
  for (let t of i) e.parser.rule(t, nd(e, t));
}
function nd(e, t) {
...
function rd(e, t, n = !1) {
  let r;
  if (et(t)) r = pd(e, t);
  else if (Pe(t)) r = id(e, t);
  else if (Re(t)) r = rd(e, t.terminal);
  else if (Ue(t)) r = fd(e, t);
  else if (dt(t)) r = ad(e, t);
  else if (Fe(t)) r = cd(e, t);
  else if (Ct(t)) r = ld(e, t);
  else if (Je(t)) r = ud(e, t);
  else if (Ge(t)) {
    let n = e.consume++;
    r = () => e.parser.consume(n, Ko, t);
  } else throw new er(t.$cstNode, `Unexpected element type: ${t.$type}`);
  return md(e, n ? void 0 : dd(t), r, t.cardinality);
}
function id(e, t) {
  let n = ai(t);
...
function ad(e, t) {
  ...
  if (je(n)) {
    let r = e.subrule++,
      i = st(n) && n.fragment,
      a = t.arguments.length > 0 ? od(n, t.arguments) : () => ({}),
      o;
    return (s) => {
      ((o ??= hd(e, n)), e.parser.subrule(r, o, i, t, a(s)));
    };
  } else if (_t(n)) {
    let r = e.consume++,
      i = _d(e, n.name);
...
function cd(e, t) {
  if (t.elements.length === 1) return rd(e, t.elements[0]);
  {
    let n = [];
    for (let r of t.elements) {
      let t = { ALT: rd(e, r, !0) },
        i = dd(r);
      (i && (t.GATE = sd(i)), n.push(t));
    }
    let r = e.or++;
    return (t) =>
...
function ud(e, t) {
  let n = t.elements.map((t) => rd(e, t));
  return (e) => n.forEach((t) => t(e));
}
function dd(e) {
  if (Je(e)) return e.guardCondition;
}
function fd(e, t, n = t.terminal) {
  if (!n) {
    if (!t.type.ref)
    ...
    let r = n.rule.ref,
      ...
      a;
    return (n) => {
      ((a ??= hd(e, r)), e.parser.subrule(i, a, !1, t, n));
    };
  } else if (dt(n) && _t(n.rule.ref)) {
    let r = e.consume++,
      i = _d(e, n.rule.ref.name);
    return () => e.parser.consume(r, i, t);
  } else if (et(n)) {
    let r = e.consume++,
      i = _d(e, n.value);
...
function yd(e) {
  let t = e.Grammar,
    n = e.parser.Lexer,
    r = new Yu(e);
  return (ed(t, r, n.definition), r.finalize(), r);
}
var bd = t(() => {
  ($u(), vd());
});
...
function Sd(e) {
  let t = e.Grammar,
    n = e.parser.Lexer;
  return ed(t, new Ku(e), n.definition);
}
var Cd = t(() => {
    ($u(), vd());
  }),
      ...
      (wd = class {
        ...
        buildTerminalToken(e) {
          ...
          return (
            ...
            e.hidden && (r.GROUP = Cr(t) ? ko.SKIPPED : `hidden`),
            r
          );
        }
      ...
      (Ed = class {
        ...
        runConverter(e, t, n) {
          switch (e.name.toUpperCase()) {
            case `INT`:
              return Dd.convertInt(t);
            case `STRING`:
              return Dd.convertString(t);
            case `ID`:
              return Dd.convertID(t);
          }
          switch (ci(e)?.toLowerCase()) {
            case `number`:
              return Dd.convertNumber(t);
            case `boolean`:
              return Dd.convertBoolean(t);
            case `bigint`:
              return Dd.convertBigint(t);
            case `date`:
              return Dd.convertDate(t);
            default:
              return t;
          }
        }
...
function jd() {
  return ((Fd = performance.now()), new Y.CancellationTokenSource());
}
function Md(e) {
  Id = e;
}
...
async function Pd(e) {
  ...
  if (
    (t - Fd >= Id && ((Fd = t), await Ad(), (Fd = performance.now())),
...
var Fd,
  ...
  Kd = t(() => {
    (Ud(),
      (function (e) {
        ((e.basename = Hd.basename),
          (e.dirname = Hd.dirname),
          (e.extname = Hd.extname),
          (e.joinPath = Hd.joinPath),
          (e.resolvePath = Hd.resolvePath));
        ...
        e.equals = n;
        function r(e, n) {
          let r = typeof e == `string` ? Vd.parse(e).path : e.path,
            i = typeof n == `string` ? Vd.parse(n).path : n.path,
        ...
        e.relative = r;
        function i(e) {
          return Vd.parse(e.toString()).toString();
        }
        e.normalize = i;
        function a(e, t) {
      ...
      (Gd = class {
        ...
        findNode(e) {
          ...
          if (n)
            return {
              name: n.name,
              uri: Wd.joinPath(Vd.parse(t), n.name).toString(),
              element: n.element,
            };
        }
        findChildren(e) {
          ...
          return n
            ? Array.from(n.children.values()).map((e) => ({
                name: e.name,
                uri: Wd.joinPath(Vd.parse(t), e.name).toString(),
                element: e.element,
              }))
            : [];
        }
        ...
        findAll(e) {
          let t = this.getNode(Wd.normalize(e), !1);
        ...
        async link(e, t = Y.CancellationToken.None) {
          if (this.profiler?.isActive(`linking`)) {
            ...
            for (let n of Ce(e.parseResult.value))
              (await Pd(t), Te(n).forEach((t) => this.doLink(t, e)));
        }
        doLink(e, t) {
          let n = e.reference;
          ...
          let i = this,
            a = {
              ...
              get ref() {
                ...
                } else this._ref === Xd && i.throwCyclicReferenceError(e, t, r);
            ...
            a = {
              ...
              get items() {
                ...
                if (this._items === void 0) {
                  ...
                  this._items === Xd && i.throwCyclicReferenceError(e, t, r);
    ...
    (yi(),
      ...
      (nf = class {
        ...
        findReferences(e, t) {
          ...
          return (
            t.documentUri &&
              (r = r.filter((e) => Wd.equals(e.sourceUri, t.documentUri))),
            n.push(...r),
            F(n)
          );
        }
    ...
    (z(),
      ...
      (cf = class {
        ...
        async collectExportedSymbolsForNode(
          ...
          for (let a of n(e)) (await Pd(r), this.addExportedSymbol(a, i, t));
          return i;
        }
        ...
        async collectLocalSymbols(e, t = Y.CancellationToken.None) {
          let n = e.parseResult.value,
            r = new af();
          for (let i of Se(n)) (await Pd(t), this.addLocalSymbol(i, e, r));
          return r;
        }
      ...
      (xf = class {
        constructor(e) {
          ((this.reflection = e.shared.AstReflection),
            ...
            (this.globalScopeCache = new yf(e.shared)));
        }
        getScope(e) {
          let t = [],
        ...
        getGlobalScope(e, t) {
          return this.globalScopeCache.get(
            e,
            () => new ff(this.indexManager.allElements(e)),
          );
        }
      }));
  });
      ...
      (Tf = class {
        ...
        getRefNode(e, t, n) {
          try {
            ...
            if (r < 0) {
              let e = n ? n(t) : Vd.parse(t),
                r = this.langiumDocuments.getDocument(e);
              return r
                ? r.parseResult.value
                : `Could not find document for URI: ` + t;
            }
            let i = n ? n(t.substring(0, r)) : Vd.parse(t.substring(0, r)),
  ...
  Mf = t(() => {
    (Ch(),
      ...
      (jf = class {
        constructor(e) {
          ((this.entries = new af()),
            (this.knownCategories = new Set(Af.defaults)),
            (this.entriesBefore = []),
            (this.entriesAfter = []),
            (this.reflection = e.shared.AstReflection));
        }
...
function Ff(e) {
  switch (e) {
    case `error`:
      return kf(Rf.LexingError);
    case `warning`:
      return kf(Rf.LexingWarning);
    case `info`:
      return kf(Rf.LexingInfo);
    case `hint`:
      return kf(Rf.LexingHint);
    default:
      throw Error(`Invalid diagnostic severity: ` + e);
  }
}
var If,
  ...
  zf = t(() => {
    (kd(),
      ...
      zd(),
      Mf(),
      (If = Object.freeze({ validateNode: !0, validateChildren: !0 })),
      (Lf = class {
        constructor(e) {
        ...
        async validateAstBefore(e, t, n, r = Y.CancellationToken.None) {
          ...
          for (let a of i) (await Pd(r), await a(e, n, t.categories ?? [], r));
        }
        ...
        createInfoDescriptions(e) {
          ...
          for (let e of n)
            a.push({
              ...
              targetPath: e.path,
              segment: o,
              local: Wd.equals(e.documentUri, r),
            });
          return a;
        }
      }));
  ...
  Jf = t(() => {
    (Kf(),
      ...
      (qf = class {
        constructor(e) {
          ((this._ready = new Rd()),
            (this.onConfigurationSectionUpdateEmitter = new Gf.Emitter()),
            (this.settings = {}),
      ...
      (Lp = class {
        constructor(e) {
          ((this.updateBuildOptions = {
            ...
            (this.buildPhaseListeners = new af()),
            (this.documentPhaseListeners = new af()),
            ...
            ? r.state >= e
              ...
              : n.isCancellationRequested
                ...
                : this.currentState >= e && e > r.state
                  ? Promise.reject(
                      new Ip.ResponseError(
                        Ip.LSPErrorCodes.RequestFailed,
                  ...
                  : new Promise((r, i) => {
                      let a = this.onDocumentPhase(e, (e) => {
                        ...
                        o = n.onCancellationRequested(() => {
                          (a.dispose(), o.dispose(), i(Ld));
                        });
                    })
            : Promise.reject(
                new Ip.ResponseError(
                  Ip.LSPErrorCodes.ServerCancelled,
        ...
        async notifyBuildPhase(e, t, n) {
          ...
          for (let t of r) (await Pd(n), await t(e, n));
        }
        shouldLink(e) {
        ...
        findAllReferences(e, t) {
          ...
          return (
            this.referenceIndex.forEach((e) => {
              e.forEach((e) => {
                Wd.equals(e.targetUri, n) && e.targetPath === t && r.push(e);
              });
            }),
            F(r)
          );
    ...
    (wl(),
      (Kp = class {
        buildUnexpectedCharactersMessage(e, t, n, r, i) {
          return Eo.buildUnexpectedCharactersMessage(e, t, n, r, i);
        }
        buildUnableToPopLexerModeMessage(e) {
      ...
      (Jp = class {
        constructor(e) {
          ...
          let n = Gp(t) ? Object.values(t) : t,
            r = e.LanguageMetaData.mode === `production`;
          this.chevrotainLexer = new ko(n, {
            positionTracking: `full`,
            skipValidations: r,
        ...
        toTokenTypeDictionary(e) {
          if (Gp(e)) return e;
          let t = Wp(e) ? Object.values(e.modes).flat() : e,
            n = {};
...
function Xp(e, t, n) {
  ...
  return rm({
    index: 0,
    tokens: $p({ lines: a, position: i, options: o }),
    position: i,
  });
}
function Zp(e, t) {
...
function $p(e) {
  ...
  for (let i = 0; i < e.lines.length; i++) {
    ...
    if (((s = s.substring(0, nm(s))), tm(s, c) >= s.length)) {
      if (t.length > 0) {
        let e = D.create(n, r);
...
function rm(e) {
  ...
  if (e.tokens.length === 0) return new ym([], C.create(t, t));
  let n = [];
  for (; e.index < e.tokens.length;) {
    let t = im(e, n[n.length - 1]);
    t && n.push(t);
  }
  let r = n[0]?.range.start ?? t,
    i = n[n.length - 1]?.range.end ?? t;
  return new ym(n, C.create(r, i));
}
function im(e, t) {
  let n = e.tokens[e.index];
  if (n.type === `tag`) return cm(e, !1);
  if (n.type === `text` || n.type === `inline-tag`) return om(e);
  (am(n, t), e.index++);
}
function am(e, t) {
  if (t) {
    let n = new Sm(``, e.range);
...
function om(e) {
  ...
  for (; t && t.type !== `break` && t.type !== `tag`;)
    (i.push(sm(e)), (r = t), (t = e.tokens[e.index]));
  return new xm(i, C.create(n.range.start, r.range.end));
}
function sm(e) {
  return e.tokens[e.index].type === `inline-tag` ? cm(e, !0) : lm(e);
}
function cm(e, t) {
  let n = e.tokens[e.index++],
  ...
  if (e.tokens[e.index]?.type === `text`)
    if (t) {
      ...
      let i = om(e);
      return new bm(r, i, t, C.create(n.range.start, i.range.end));
    }
  else {
    let e = n.range;
    return new bm(r, new xm([], e), t, e);
  }
}
function lm(e) {
  let t = e.tokens[e.index++];
  return new Sm(t.content, t.range);
}
function um(e) {
  if (!e) return um({ start: `/**`, end: `*/`, line: `*` });
  let { start: t, end: n, line: r } = e;
  return { start: dm(t, !0), end: dm(n, !1), line: dm(r, !0) };
}
function dm(e, t) {
  ...
  if (e === `linkplain` || e === `linkcode` || e === `link`) {
    ...
    return (
      (e === `linkcode` || (e === `link` && n.link === `code`)) &&
        (i = `\`${i}\``),
      n.renderLink?.(t, i) ?? pm(t, i)
    );
  }
}
function pm(e, t) {
  try {
    return (Vd.parse(e, !0), `[${t}](${e})`);
  } catch {
    return e;
  }
}
...
`));
  ...
  jm = t(() => {
    (zd(),
        ...
        async acquireParserWorker(e) {
          ...
          return (
            e.onCancellationRequested(() => {
              ...
              (e >= 0 && this.queue.splice(e, 1), t.reject(Ld));
            }),
            this.queue.push(t),
            t.promise
          );
      ...
      (Am = class {
        ...
        constructor(e, t, n, r) {
          ((this.onReadyEmitter = new Gf.Emitter()),
            (this.deferred = new Rd()),
            (this._ready = !0),
            (this._parsing = !1),
            (this.sendMessage = e),
            (this._terminate = r),
        ...
        terminate() {
          (this.deferred.reject(Ld), this._terminate());
        }
        lock() {
          this._ready = !1;
        }
              ...
              e.map(
                async ({ action: e, deferred: t, cancellationToken: n }) => {
                  try {
                    ...
                    Nd(e) ? t.resolve(void 0) : t.reject(e);
                  }
                },
              ),
            ),
  ...
  Fm = t(() => {
    (Bu(),
      ...
      (Pm = class {
        constructor(e) {
          ((this.grammarElementIdMap = new of()),
            (this.tokenTypeIdMap = new of()),
...
function Im(e) {
  return {
    documentation: {
      CommentProvider: (e) => new Em(e),
      DocumentationProvider: (e) => new wm(e),
    },
    parser: {
      AsyncParser: (e) => new Om(e),
      GrammarConfig: (e) => bi(e),
      LangiumParser: (e) => xd(e),
      CompletionParser: (e) => yd(e),
      ValueConverter: () => new Ed(),
      TokenBuilder: () => new wd(),
      Lexer: (e) => new Jp(e),
      ParserErrorMessageProvider: () => new Ju(),
      LexerErrorMessageProvider: () => new Kp(),
    },
    workspace: {
      AstNodeLocator: () => new Uf(),
      AstNodeDescriptionProvider: (e) => new Bf(e),
      ReferenceDescriptionProvider: (e) => new Vf(e),
    },
    references: {
      Linker: (e) => new Zd(e),
      NameProvider: () => new ef(),
      ScopeProvider: (e) => new xf(e),
      ScopeComputation: (e) => new cf(e),
      References: (e) => new nf(e),
    },
    serializer: {
      Hydrator: (e) => new Pm(e),
      JsonSerializer: (e) => new Tf(e),
    },
    validation: {
      DocumentValidator: (e) => new Lf(e),
...
function Lm(e) {
  return {
    ServiceRegistry: (e) => new Df(e),
    workspace: {
      LangiumDocuments: (e) => new Jd(e),
      LangiumDocumentFactory: (e) => new qd(e),
      DocumentBuilder: (e) => new Lp(e),
      IndexManager: (e) => new zp(e),
      WorkspaceManager: (e) => new Vp(e),
      FileSystemProvider: (t) => e.fileSystemProvider(t),
      WorkspaceLock: () => new Mm(),
      ConfigurationProvider: (e) => new qf(e),
    },
    profilers: {},
  };
}
...
function zm(e, t, n, r, i, a, o, s, c) {
  return Vm([e, t, n, r, i, a, o, s, c].reduce(Um, {}));
}
function Bm(e) {
  if (e && e[Gm]) for (let t of Object.values(e)) Bm(t);
  return e;
}
function Vm(e, t) {
  let n = new Proxy(
  ...
  if (t) {
    for (let [n, r] of Object.entries(t))
      if (r != null)
        if (typeof r == `object`) {
          let t = e[n];
          typeof t == `object` && t ? (e[n] = Um(t, r)) : (e[n] = Um({}, r));
        } else e[n] = r;
  }
  return e;
}
    ...
    (wl(),
      ...
      (eh = class extends wd {
        ...
        buildTokens(e, t) {
          ...
          if (!Up(n)) throw Error(`Invalid tokens built by default builder`);
          let {
              indentTokenName: r,
              dedentTokenName: i,
          ...
          for (let e of n) {
            for (let [t, n] of o)
              e.name === t
                ? (e.PUSH_MODE = $m.IGNORE_INDENTATION)
          ...
          return o.length > 0
            ? {
                modes: {
                  [$m.REGULAR]: [s, c, ...u, l],
                  [$m.IGNORE_INDENTATION]: [...u, l],
                },
                defaultMode: $m.REGULAR,
              }
            : [s, c, l, ...u];
        }
        flushLexingReport(e) {
...
`.includes(e[t - 1])
        ...
        createIndentationTokenInstance(e, t, n, r) {
          ...
          return Fo(e, n, r, r + n.length, i, i, 1, n.length);
        }
        getLineNumber(e, t) {
      ...
      (th = class extends Jp {
        constructor(e) {
          if ((super(e), e.parser.TokenBuilder instanceof eh))
  ...
  rh = t(() => {}),
  ih = t(() => {
    (jm(), bd(), Bu(), nh(), Cd(), $u(), Yp(), vd(), rh(), Td(), Od());
  }),
  ah = t(() => {
    (Qd(), tf(), rf(), mf(), lf(), Sf());
  }),
...
function dh(e) {
  ...
  return (
    t.shared.workspace.LangiumDocumentFactory.fromModel(
      n,
      Vd.parse(`memory:/${n.name ?? `grammar`}.langium`),
    ),
    n
  );
}
var fh,
  ...
  hh = r({
    ...
    delayNextTick: () => Ad,
    interruptAndCheck: () => Pd,
    isOperationCancelled: () => Nd,
    loadGrammarFromJson: () => dh,
    setInterruptionPeriod: () => Md,
      ...
      (vh = class {
        ...
        createTask(e, t) {
          ...
          return (
            ...
            new yh((t) => this.records.add(e, this.dumpRecord(e, t)), t)
          );
        }
        dumpRecord(e, t) {
          console.info(
  ...
  xh = t(() => {
    (Hf(), Wf(), Jf(), Rp(), Yd(), lh(), Bp(), Nm(), Hp(), bh());
  }),
  Sh = r({
    AbstractAstReflection: () => se,
    AbstractCstNode: () => Fu,
    AbstractLangiumParser: () => Gu,
    AbstractParserErrorMessageProvider: () => qu,
    AbstractThreadedAsyncParser: () => km,
    AstUtils: () => me,
    BiMap: () => of,
    Cancellation: () => Y,
    CompositeCstNodeImpl: () => Lu,
    ContextCache: () => _f,
    CstNodeBuilder: () => Pu,
    CstUtils: () => On,
    DEFAULT_TOKENIZE_OPTIONS: () => qp,
    DONE_RESULT: () => L,
    DatatypeSymbol: () => Hu,
    DefaultAstNodeDescriptionProvider: () => Bf,
    DefaultAstNodeLocator: () => Uf,
    DefaultAsyncParser: () => Om,
    DefaultCommentProvider: () => Em,
    DefaultConfigurationProvider: () => qf,
    DefaultDocumentBuilder: () => Lp,
    DefaultDocumentValidator: () => Lf,
    DefaultHydrator: () => Pm,
    DefaultIndexManager: () => zp,
    DefaultJsonSerializer: () => Tf,
    DefaultLangiumDocumentFactory: () => qd,
    DefaultLangiumDocuments: () => Jd,
    DefaultLangiumProfiler: () => vh,
    DefaultLexer: () => Jp,
    DefaultLexerErrorMessageProvider: () => Kp,
    DefaultLinker: () => Zd,
    DefaultNameProvider: () => ef,
    DefaultReferenceDescriptionProvider: () => Vf,
    DefaultReferences: () => nf,
    DefaultScopeComputation: () => cf,
    DefaultScopeProvider: () => xf,
    DefaultServiceRegistry: () => Df,
    DefaultTokenBuilder: () => wd,
    DefaultValueConverter: () => Ed,
    DefaultWorkspaceLock: () => Mm,
    ...
    DocumentCache: () => vf,
    DocumentState: () => X,
    DocumentValidator: () => Rf,
    EMPTY_SCOPE: () => pf,
    EMPTY_STREAM: () => I,
    EmptyFileSystem: () => ch,
    EmptyFileSystemProvider: () => sh,
    ErrorWithLocation: () => er,
    GrammarAST: () => ke,
    GrammarUtils: () => Nr,
    IndentationAwareLexer: () => th,
    IndentationAwareTokenBuilder: () => eh,
    JSDocDocumentationProvider: () => wm,
    LangiumCompletionParser: () => Yu,
    LangiumParser: () => Ku,
    LangiumParserErrorMessageProvider: () => Ju,
    LeafCstNodeImpl: () => Iu,
    LexingMode: () => $m,
    MapScope: () => df,
    Module: () => Wm,
    ...
    UriTrie: () => Gd,
    UriUtils: () => Wd,
    VALIDATE_EACH_NODE: () => If,
    ValidationCategory: () => Af,
    ValidationRegistry: () => jf,
    ValueConverter: () => Dd,
    WorkspaceCache: () => yf,
    assertCondition: () => $n,
    assertUnreachable: () => Qn,
    createCompletionParser: () => yd,
    createDefaultCoreModule: () => Im,
    createDefaultSharedCoreModule: () => Lm,
    createGrammarConfig: () => bi,
    createLangiumParser: () => xd,
    createParser: () => ed,
    delayNextTick: () => Ad,
    diagnosticData: () => kf,
    eagerLoad: () => Bm,
    getDiagnosticRange: () => Nf,
    indentationBuilderDefaultOptions: () => Qm,
    inject: () => zm,
    interruptAndCheck: () => Pd,
    isAstNode: () => O,
    isAstNodeDescription: () => j,
    isAstNodeWithComment: () => Cf,
    isCompositeCstNode: () => N,
    isIMultiModeLexerDefinition: () => Wp,
    isJSDoc: () => Zp,
    isLeafCstNode: () => oe,
    isLinkingError: () => M,
    isMultiReference: () => A,
    ...
    isRootCstNode: () => P,
    isTokenTypeArray: () => Up,
    isTokenTypeDictionary: () => Gp,
    loadGrammarFromJson: () => dh,
    parseJSDoc: () => Xp,
    prepareLangiumParser: () => Sd,
    setInterruptionPeriod: () => Md,
    startCancelableOperation: () => jd,
    stream: () => F,
    toDiagnosticData: () => Ff,
    toDiagnosticSeverity: () => Pf,
  }),
  Ch = t(() => {
    (Rm(),
      qm(),
...
function wh(e) {
  return Bg.isInstance(e, Xh.$type);
}
function Th(e) {
  return Bg.isInstance(e, Qh.$type);
}
function Eh(e) {
  return Bg.isInstance(e, ng.$type);
}
function Dh(e) {
  return Bg.isInstance(e, pg.$type);
}
function Oh(e) {
  return Bg.isInstance(e, hg.$type);
}
function kh(e) {
  return Bg.isInstance(e, xg.$type);
}
function Ah(e) {
  return Bg.isInstance(e, wg.$type);
}
function jh(e) {
  return Bg.isInstance(e, Tg.$type);
}
function Mh(e) {
  return Bg.isInstance(e, Eg.$type);
}
function Nh(e) {
  return Bg.isInstance(e, Dg.$type);
}
function Ph(e) {
  return Bg.isInstance(e, Fg.$type);
}
function Fh(e) {
  return Bg.isInstance(e, $.$type);
}
var Ih,
  Q,
  Lh,
  ...
  O_ = t(() => {
    (Ch(),
      ...
      (Q = (e, t) => Ih(e, `name`, { value: t, configurable: !0 })),
      ((e) => {
        e.Terminals = {
      ...
      (Kh = { $type: `Accelerator`, name: `name`, x: `x`, y: `y` }),
      (qh = {
        $type: `Anchor`,
        evolution: `evolution`,
        name: `name`,
      ...
      Q(wh, `isArchitecture`),
      (Zh = { $type: `Axis`, label: `label`, name: `name` }),
      (Qh = { $type: `Branch`, name: `name`, order: `order` }),
      Q(Th, `isBranch`),
      ($h = { $type: `Checkout`, branch: `branch` }),
      (eg = {
        $type: `CherryPicking`,
        id: `id`,
        parent: `parent`,
      ...
      (ag = { $type: `Deaccelerator`, name: `name`, x: `x`, y: `y` }),
      (og = { $type: `Decorator`, strategy: `strategy` }),
      (sg = {
        $type: `Direction`,
        accDescr: `accDescr`,
        accTitle: `accTitle`,
      ...
      (lg = { $type: `Entry`, axis: `axis`, value: `value` }),
      (ug = { $type: `Evolution`, stages: `stages` }),
      (dg = {
        $type: `EvolutionStage`,
        boundary: `boundary`,
        name: `name`,
      ...
      (fg = { $type: `Evolve`, component: `component`, target: `target` }),
      (pg = {
        $type: `GitGraph`,
        accDescr: `accDescr`,
        accTitle: `accTitle`,
      ...
      Q(Oh, `isInfo`),
      (gg = { $type: `Item`, classSelector: `classSelector`, name: `name` }),
      (_g = { $type: `Junction`, id: `id`, in: `in` }),
      (vg = {
        $type: `Label`,
        negX: `negX`,
        negY: `negY`,
      ...
      (Cg = { $type: `Option`, name: `name`, value: `value` }),
      (wg = {
        $type: `Packet`,
        accDescr: `accDescr`,
        accTitle: `accTitle`,
      ...
      Q(Mh, `isPie`),
      (Dg = { $type: `PieSection`, label: `label`, value: `value` }),
      Q(Nh, `isPieSection`),
      (Og = { $type: `Pipeline`, components: `components`, parent: `parent` }),
      (kg = {
      ...
      (jg = { $type: `Section`, classSelector: `classSelector`, name: `name` }),
      (Mg = {
        $type: `Service`,
        icon: `icon`,
        iconText: `iconText`,
      ...
      (Ng = { $type: `Size`, height: `height`, width: `width` }),
      (Pg = { $type: `Statement` }),
      (Fg = {
        $type: `Treemap`,
        accDescr: `accDescr`,
      ...
      Q(Ph, `isTreemap`),
      (Ig = { $type: `TreemapRow`, indent: `indent`, item: `item` }),
      (Lg = { $type: `TreeNode`, indent: `indent`, name: `name` }),
      (Rg = {
        $type: `TreeView`,
        accDescr: `accDescr`,
        accTitle: `accTitle`,
          ...
          (super(...arguments),
            (this.types = {
              ...
              Anchor: {
                name: qh.$type,
                properties: {
                  evolution: { name: qh.evolution },
                  name: { name: qh.name },
                  visibility: { name: qh.visibility },
                },
                superTypes: [],
              },
              Annotation: {
              ...
              Annotations: {
                name: Yh.$type,
                properties: { x: { name: Yh.x }, y: { name: Yh.y } },
                superTypes: [],
              },
              Architecture: {
                name: Xh.$type,
                properties: {
                  accDescr: { name: Xh.accDescr },
                  accTitle: { name: Xh.accTitle },
                  edges: { name: Xh.edges, defaultValue: [] },
                  groups: { name: Xh.groups, defaultValue: [] },
                  junctions: { name: Xh.junctions, defaultValue: [] },
                  services: { name: Xh.services, defaultValue: [] },
                  title: { name: Xh.title },
                },
                superTypes: [],
              },
              ...
              Checkout: {
                name: $h.$type,
                properties: { branch: { name: $h.branch } },
                superTypes: [Pg.$type],
              },
              CherryPicking: {
                name: eg.$type,
                properties: {
                  id: { name: eg.id },
                  parent: { name: eg.parent },
                  tags: { name: eg.tags, defaultValue: [] },
                },
                superTypes: [Pg.$type],
              },
              ClassDefStatement: {
                name: tg.$type,
                properties: {
                  className: { name: tg.className },
                  styleText: { name: tg.styleText },
                },
                superTypes: [],
              },
              Commit: {
                ...
                properties: {
                  id: { name: ng.id },
                  message: { name: ng.message },
                  tags: { name: ng.tags, defaultValue: [] },
                  type: { name: ng.type },
                },
                superTypes: [Pg.$type],
              },
              Component: {
                name: rg.$type,
                properties: {
                  decorator: { name: rg.decorator },
                  evolution: { name: rg.evolution },
                  inertia: { name: rg.inertia, defaultValue: !1 },
                  label: { name: rg.label },
                  name: { name: rg.name },
                  visibility: { name: rg.visibility },
                },
                superTypes: [],
              },
              Curve: {
                name: ig.$type,
                properties: {
                  entries: { name: ig.entries, defaultValue: [] },
                  label: { name: ig.label },
                  name: { name: ig.name },
                },
                superTypes: [],
              ...
              Decorator: {
                name: og.$type,
                properties: { strategy: { name: og.strategy } },
                superTypes: [],
              },
              Direction: {
                name: sg.$type,
                properties: {
                  accDescr: { name: sg.accDescr },
                  accTitle: { name: sg.accTitle },
                  dir: { name: sg.dir },
                  statements: { name: sg.statements, defaultValue: [] },
                  title: { name: sg.title },
                },
                superTypes: [pg.$type],
              },
              Edge: {
                name: cg.$type,
                properties: {
                  lhsDir: { name: cg.lhsDir },
                  lhsGroup: { name: cg.lhsGroup, defaultValue: !1 },
                  lhsId: { name: cg.lhsId },
                  lhsInto: { name: cg.lhsInto, defaultValue: !1 },
                  rhsDir: { name: cg.rhsDir },
                  rhsGroup: { name: cg.rhsGroup, defaultValue: !1 },
                  rhsId: { name: cg.rhsId },
                  rhsInto: { name: cg.rhsInto, defaultValue: !1 },
                  title: { name: cg.title },
                },
                superTypes: [],
              },
              Entry: {
                name: lg.$type,
                properties: {
                  axis: { name: lg.axis, referenceType: Zh.$type },
                  value: { name: lg.value },
                },
                superTypes: [],
              },
              Evolution: {
                name: ug.$type,
                properties: { stages: { name: ug.stages, defaultValue: [] } },
                superTypes: [],
              },
              EvolutionStage: {
                name: dg.$type,
                properties: {
                  boundary: { name: dg.boundary },
                  name: { name: dg.name },
                  secondName: { name: dg.secondName },
                },
                superTypes: [],
              },
              Evolve: {
                name: fg.$type,
                properties: {
                  component: { name: fg.component },
                  target: { name: fg.target },
                },
                superTypes: [],
              },
              GitGraph: {
                name: pg.$type,
                properties: {
                  accDescr: { name: pg.accDescr },
                  accTitle: { name: pg.accTitle },
                  statements: { name: pg.statements, defaultValue: [] },
                  title: { name: pg.title },
                },
                superTypes: [],
              },
              ...
              Info: {
                name: hg.$type,
                properties: {
                  accDescr: { name: hg.accDescr },
                  accTitle: { name: hg.accTitle },
                  title: { name: hg.title },
                },
                superTypes: [],
              },
              Item: {
                name: gg.$type,
                properties: {
                  classSelector: { name: gg.classSelector },
                  name: { name: gg.name },
                },
                superTypes: [],
              },
              Junction: {
                name: _g.$type,
                properties: { id: { name: _g.id }, in: { name: _g.in } },
                superTypes: [],
              },
              Label: {
                name: vg.$type,
                properties: {
                  negX: { name: vg.negX, defaultValue: !1 },
                  negY: { name: vg.negY, defaultValue: !1 },
                  offsetX: { name: vg.offsetX },
                  offsetY: { name: vg.offsetY },
                },
                superTypes: [],
              },
              Leaf: {
                name: yg.$type,
                properties: {
                  classSelector: { name: yg.classSelector },
                  name: { name: yg.name },
                  value: { name: yg.value },
                },
                superTypes: [gg.$type],
              ...
              Link: {
                ...
                properties: {
                  arrow: { name: bg.arrow },
                  from: { name: bg.from },
                  fromPort: { name: bg.fromPort },
                  linkLabel: { name: bg.linkLabel },
                  to: { name: bg.to },
                  toPort: { name: bg.toPort },
                },
                superTypes: [],
              },
              Merge: {
                name: xg.$type,
                properties: {
                  branch: { name: xg.branch },
                  id: { name: xg.id },
                  tags: { name: xg.tags, defaultValue: [] },
                  type: { name: xg.type },
                },
                superTypes: [Pg.$type],
              },
              Note: {
                name: Sg.$type,
                properties: {
                  evolution: { name: Sg.evolution },
                  text: { name: Sg.text },
                  visibility: { name: Sg.visibility },
                },
                superTypes: [],
              },
              Option: {
                ...
                properties: {
                  name: { name: Cg.name },
                  value: { name: Cg.value, defaultValue: !1 },
                },
                superTypes: [],
              },
              Packet: {
                name: wg.$type,
                properties: {
                  accDescr: { name: wg.accDescr },
                  accTitle: { name: wg.accTitle },
                  blocks: { name: wg.blocks, defaultValue: [] },
                  title: { name: wg.title },
                },
                superTypes: [],
              },
              ...
              Pie: {
                name: Eg.$type,
                properties: {
                  accDescr: { name: Eg.accDescr },
                  accTitle: { name: Eg.accTitle },
                  sections: { name: Eg.sections, defaultValue: [] },
                  showData: { name: Eg.showData, defaultValue: !1 },
                  title: { name: Eg.title },
                },
                superTypes: [],
              },
              ...
              Pipeline: {
                name: Og.$type,
                properties: {
                  components: { name: Og.components, defaultValue: [] },
                  parent: { name: Og.parent },
                },
                superTypes: [],
              },
              PipelineComponent: {
              ...
              Radar: {
                name: Ag.$type,
                properties: {
                  accDescr: { name: Ag.accDescr },
                  accTitle: { name: Ag.accTitle },
                  axes: { name: Ag.axes, defaultValue: [] },
                  curves: { name: Ag.curves, defaultValue: [] },
                  options: { name: Ag.options, defaultValue: [] },
                  title: { name: Ag.title },
                },
                superTypes: [],
              },
              Section: {
                name: jg.$type,
                properties: {
                  classSelector: { name: jg.classSelector },
                  name: { name: jg.name },
                },
                superTypes: [gg.$type],
              },
              ...
              Size: {
                name: Ng.$type,
                properties: {
                  height: { name: Ng.height },
                  width: { name: Ng.width },
                },
                superTypes: [],
              },
              Statement: { name: Pg.$type, properties: {}, superTypes: [] },
              TreeNode: {
                name: Lg.$type,
                properties: {
              ...
              TreeView: {
                name: Rg.$type,
                properties: {
                  accDescr: { name: Rg.accDescr },
                  accTitle: { name: Rg.accTitle },
                  nodes: { name: Rg.nodes, defaultValue: [] },
                  title: { name: Rg.title },
                },
                superTypes: [],
              },
              Treemap: {
                name: Fg.$type,
                properties: {
                  accDescr: { name: Fg.accDescr },
                  accTitle: { name: Fg.accTitle },
                  title: { name: Fg.title },
                  TreemapRows: { name: Fg.TreemapRows, defaultValue: [] },
                },
                superTypes: [],
              },
              TreemapRow: {
      ...
      (m_ = { AstReflection: Q(() => new zg(), `AstReflection`) }),
      (h_ = {
        Grammar: Q(() => Hg(), `Grammar`),
        LanguageMetaData: Q(() => a_, `LanguageMetaData`),
        parser: {},
      }),
      (g_ = {
        Grammar: Q(() => Wg(), `Grammar`),
        LanguageMetaData: Q(() => o_, `LanguageMetaData`),
        parser: {},
      }),
      (__ = {
        Grammar: Q(() => Kg(), `Grammar`),
        LanguageMetaData: Q(() => s_, `LanguageMetaData`),
        parser: {},
      }),
      (v_ = {
        Grammar: Q(() => Jg(), `Grammar`),
        LanguageMetaData: Q(() => c_, `LanguageMetaData`),
        parser: {},
      }),
      (y_ = {
        Grammar: Q(() => Xg(), `Grammar`),
...
//# sourceMappingURL=chunk-K5T4RW27-DBsaZQmV.js.map
