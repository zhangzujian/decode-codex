...
import { n as R, t as le } from "./home-suggestion-staggered-item-pYQPXGkh.js";
import { r as ue, t as z } from "./artifact-creation-prompts-DjmJtACc.js";
function de(e) {
  let t = (0, fe.c)(8),
    n,
    r;
  ...
  t[3] === n
    ? (i = t[4])
    : ((i = x(`flex size-4 shrink-0 items-center justify-center`, n)),
      (t[3] = n),
      (t[4] = i));
  let a;
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, B.jsx)(`span`, { className: i, ...r })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = a))
      : (a = t[7]),
...
function ge({
  ...
  let i = De[t];
  return (n === `work` ? ke : Ae).map((n) => ({
    id: n.id,
    starterPrompt: e.formatMessage(n.starterPrompt),
    tasks: n.tasks.map((n) =>
      _e({ intl: e, mailProvider: t, plugins: r, providerValues: i, task: n }),
    ),
...
function _e({
  ...
  let a = ve({ pluginMention: i.artifact, plugins: n }),
    o = ve({ pluginMention: i.pluginMention, plugins: n }),
    s = e.formatMessage(
      i.prompt,
      xe({
        artifact: i.artifact,
  ...
  return {
    homeAction: Se({ artifact: i.artifact, plugin: o }),
    id: i.id,
...
function ve({ pluginMention: e, plugins: t }) {
  if (e == null) return;
...
function ye({
  ...
  return {
    ...
    prompt: t.formatMessage(
      a.prompt,
      xe({ artifact: e, pluginLabel: u, pluginMention: d, providerValues: i }),
    ),
    appIds: a.appIds.map((e) => P(e, n)),
    status: `pending`,
    createdAtMs: 0,
    updatedAtMs: 0,
    analyticsType: `new_chat_page_suggestion`,
    homeAction: Se({ artifact: e, plugin: c }),
    pluginIconDarkUrl: c?.logoDarkPath ?? be(f, `dark`),
    pluginIconUrl: c?.logoPath ?? c?.composerIconPath ?? be(f, `light`),
...
function xe({
  ...
  return {
    ...r,
    artifact: e == null ? void 0 : Ce(e),
    plugin: n == null ? t : Ce(n),
  };
}
function Se({ artifact: e, plugin: t }) {
  return e != null || t == null || (t.plugin.installed && t.plugin.enabled)
    ? { type: `fill-composer` }
    : { type: `connect-plugin-onboarding`, plugin: t };
}
function Ce({ label: e, pluginId: t }) {
  return r(`@${e}`, w(t));
}
var U,
  we,
  ...
  je = e(() => {
    (ee(),
      ...
      M(),
      ue(),
      (U = { label: `GitHub`, pluginId: `github@${v}` }),
      (we = {
        box: `box@${f}`,
        figma: `figma@${v}`,
        github: `github@${v}`,
        gmail: `gmail@${v}`,
        "google-calendar": `google-calendar@${v}`,
        "google-drive": `google-drive@${v}`,
        linear: `linear@${v}`,
        notion: `notion@${v}`,
...
function Be(e, t = `icon-xs shrink-0 object-contain`) {
  if (!(e.pluginIconUrl == null && e.pluginIconDarkUrl == null))
    return (0, Y.jsx)(n, {
      ...
      fallback: (0, Y.jsx)(E, { className: t }),
    });
}
function Ve(e, t) {
  for (let r of e.appIds) {
    let e = d(r);
    if (e != null)
      return (0, Y.jsx)(e, { className: `icon-sm object-contain` });
    let i = t?.get(r);
    if (i?.logoUrl != null || i?.logoUrlDark != null)
      return (0, Y.jsx)(n, {
        alt: ``,
        className: `icon-sm object-contain`,
        logoDarkUrl: i.logoUrlDark,
        logoUrl: i.logoUrl,
        fallback: (0, Y.jsx)(E, { className: `icon-sm` }),
      });
  }
  return (0, Y.jsx)(n, {
    alt: ``,
...
var Y,
  He = e(() => {
    (s(), ne(), F(), te(), Me(), N(), A(), Pe(), b(), Ie(), Re(), (Y = m()));
  });
function Ue({
  ...
  let t = (0, et.c)(8),
    {
      ...
      onStartSuggestion: f,
      prioritizedSupplementalItemIds: p,
      renderSurface: m,
      supplementalItems: h,
    } = e,
    ee = o === void 0 ? !1 : o,
    ...
    w =
      S != null &&
      C == null &&
      s?.suggestionLevel === y.CODEX_NEW_CHAT_SUGGESTION_LEVEL_TASK,
    te = w && S != null ? S.sourceSuggestions : [],
    T;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = {}), (t[0] = T))
    : (T = t[0]);
  let [ne, re] = (0, Q.useState)(T),
    [E, ie] = (0, Q.useState)($),
    O = (0, Q.useRef)(!1),
    k = (0, Q.useRef)(new Set()),
    A = (0, Q.useRef)(new Set()),
    j,
    M;
  (t[1] !== i.length || t[2] !== b
    ? ((j = () => {
        i.length === 0 ||
          O.current ||
          ((O.current = !0),
          Z(b, { action: g.CODEX_NEW_CHAT_SUGGESTION_ACTION_DISPLAYED }));
      }),
      (M = [i.length, b]),
      (t[1] = i.length),
      (t[2] = b),
    ...
    (0, Q.useEffect)(() => {
      x != null &&
        (x.tasks.length === 0 ||
          ...
          (k.current.add(x.id),
          D(b, ae, {
            promptIds: x.tasks.map(Ze).join(`,`),
            promptTypes: x.tasks.map(Xe).join(`,`),
            promptCount: x.tasks.length,
          }),
          Z(b, {
            action: g.CODEX_NEW_CHAT_SUGGESTION_ACTION_FOLLOW_UPS_DISPLAYED,
            categoryId: x.id,
            suggestionCount: x.tasks.length,
            suggestionLevel: y.CODEX_NEW_CHAT_SUGGESTION_LEVEL_TASK,
          })));
    }, [b, x]),
    (0, Q.useEffect)(() => {
      x == null ||
        ...
        (A.current.add(S.id),
        D(b, ae, {
          promptIds: S.sourceSuggestions.map(Ye).join(`,`),
          promptTypes: S.sourceSuggestions.map(Je).join(`,`),
        ...
        Z(b, {
          ...
          suggestionLevel: y.CODEX_NEW_CHAT_SUGGESTION_LEVEL_SOURCE,
        }));
    }, [b, x, S, w]));
  let N;
  t[5] !== l || t[6] !== b
    ? ((N = (e) => {
        (Z(b, {
          action: g.CODEX_NEW_CHAT_SUGGESTION_ACTION_CATEGORY_SELECTED,
          categoryId: e.id,
          suggestionLevel: y.CODEX_NEW_CHAT_SUGGESTION_LEVEL_CATEGORY,
        }),
          l(e));
      }),
      (t[5] = l),
  ...
  let oe = N,
    P = Ue({
      ...
      onSelectSourceSuggestion: (e) => {
        ...
        (Z(b, {
          action: g.CODEX_NEW_CHAT_SUGGESTION_ACTION_FOLLOW_UP_SELECTED,
    ...
    ce = F.filter((e) => !_.includes(e.id)),
    I = x == null ? [...se, ...P, ...ce] : P,
    L = I.map(qe).join(`\0`),
    R = ne[L] ?? 0;
  return m({
    items: x == null ? Qe(I, R, E) : I,
    layout: x == null ? `cards` : `list`,
    ...
    onShowNextSuggestions:
      x == null && I.length > E
        ? () => {
            re((e) => ({ ...e, [L]: (R + E) % I.length }));
          }
        : void 0,
    onShowAllSuggestions: x == null ? void 0 : d,
  });
}
function qe(e) {
  return e.id;
...
var et,
  ...
  $,
  tt = e(() => {
    ((et = c()), O(), re(), (Q = t(_(), 1)), o(), i(), Ge(), ($ = 4));
  });
export { me as a, je as i, tt as n, he as o, ge as r, Ke as t };
//# sourceMappingURL=new-chat-page-suggestions-BXwga4qv.js.map
