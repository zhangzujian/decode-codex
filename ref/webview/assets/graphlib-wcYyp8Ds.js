...
var u = `\0`,
  ...
  p = class {
    constructor(e = {}) {
      ((this._isDirected = Object.prototype.hasOwnProperty.call(e, `directed`)
        ...
        (this._isCompound = Object.prototype.hasOwnProperty.call(e, `compound`)
          ...
          : !1),
        (this._label = void 0),
        (this._defaultNodeLabelFn = i(void 0)),
        (this._defaultEdgeLabelFn = i(void 0)),
        (this._nodes = {}),
        this._isCompound &&
          ((this._parent = {}),
          (this._children = {}),
    ...
    setDefaultNodeLabel(t) {
      return (e(t) || (t = i(t)), (this._defaultNodeLabelFn = t), this);
    }
    nodeCount() {
    ...
    sources() {
      var e = this;
      return n(this.nodes(), function (t) {
        return l(e._in[t]);
      });
    }
    sinks() {
    ...
    setDefaultEdgeLabel(t) {
      return (e(t) || (t = i(t)), (this._defaultEdgeLabelFn = t), this);
    }
    edgeCount() {
...
export { p as t };
//# sourceMappingURL=graphlib-wcYyp8Ds.js.map
