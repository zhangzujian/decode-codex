...
function F(e, t = `icon-xs`) {
  let n = (0, I.createElement)(ue, { className: t });
  return e == null
    ? n
    : e.connectorId === L
      ? (0, I.createElement)(P, { "aria-hidden": !0, className: t })
      : (0, I.createElement)(de, {
          alt: ``,
          className: t,
          fallback: n,
...
//# sourceMappingURL=app-initial~app-main~page~pull-request-route~onboarding-page~appgen-library-page~hotkey-win~lehncapg-DxDbaekH.js.map
