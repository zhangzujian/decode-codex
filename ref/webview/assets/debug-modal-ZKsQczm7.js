...
import {
  ...
  st as zt,
  w as Bt,
} from "./app-initial~app-main~settings-command-menu-section-items~settings-page~codex-mobile-page~de~jwxee9zo-B-cFx3D6.js";
import {
  c as Vt,
  y as Ht,
...
import { It as ln } from "./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~settings-command-~ktg7n5fh-Dew28JND.js";
import {
  D as un,
  S as dn,
  T as fn,
...
import {
  ...
  s as _n,
  t as vn,
} from "./new-chat-suggestion-source-debug-state-CjD3vOWk.js";
import {
  A as yn,
  k as bn,
...
import {
  ...
  r as Kr,
  t as qr,
} from "./avatar-overlay-debug-state-CWabl3uX.js";
...
import {
  ...
  t as ri,
  u as ii,
} from "./codex-mobile-setup-dialog-GDt3tlFi.js";
import {
  c as ai,
  l as oi,
  n as si,
  o as ci,
  s as li,
} from "./use-debug-panel-B3vV0G93.js";
import {
  n as ui,
  r as di,
} from "./codex-app-home-beacon-debug-state-BmHqQ6QS.js";
function L(e) {
  let t = (0, pi.c)(40),
    {
      title: n,
...
function Ri(e) {
  let t = (0, xa.c)(15),
    ...
    i = o(rt),
    [a] = ze(`host_config`),
    [s] = ze(`remote_ssh_connections`),
    [c] = ze(`remote_control_connections`),
    l;
  if (
    t[0] !== a ||
    t[1] !== n ||
...
var cl,
  ll,
  ul = e(() => {
    ((cl = h()), _(), Un(), dn(), un(), be(), yn(), l(), R(), (ll = y()));
  });
function dl() {
  let e = (0, fl.c)(15),
    t = n(v),
    [r, i] = (0, pl.useState)(null),
    { data: a, isLoading: o } = ht(k.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED),
    s = a === !0,
  ...
  e[3] === t
    ...
    : ((d = (e) => {
        (i(null),
          ke(t, k.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
...
function Of() {
  ...
  if (e[0] !== n || e[1] !== i || e[2] !== o || e[3] !== t) {
    ...
    (e[24] === t.client
      ...
      : ((O = () => {
          (r(!0),
            Et(t.client, `debug_button`).finally(() => {
              r(!1);
            }));
        }),
        (e[24] = t.client),
...
function Wf(e) {
  ...
  t[5] !== r || t[6] !== s
    ? ((y = async (e) => {
        let { release: t } = e;
        return (await Bt(s), r.runUpdateNow({ release: t }));
      }),
      (t[5] = r),
      (t[6] = s),
      (t[7] = y))
  ...
  t[8] === a
    ? (x = t[9])
    : ((x = (e) => {
        (d(qf(e)), a.invalidateQueries({ queryKey: Ft }));
      }),
      (t[8] = a),
      (t[9] = x));
  let C;
...
function rp() {
  ...
  e[11] === t
    ...
    : ((x = (e) => {
        (i(null),
          ke(t, k.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch(
            (e) => {
              i(
                e instanceof Error
                  ? e.message
...
function dp({
  ...
  let l = pt(),
    ...
    x = v != null && a && M.allowDebugMenu(mt()),
    S = _?.isPackaged === !1,
    C = e ?? null,
    w =
      typeof window < `u`
                ...
                children: [
                  x
                    ? (0, $.jsx)(`button`, {
                        ...
                        children: (0, $.jsx)(_t, { className: `icon-xs` }),
                      })
                    : null,
                  (0, $.jsx)(`button`, {
                    type: `button`,
...
//# sourceMappingURL=debug-modal-ZKsQczm7.js.map
