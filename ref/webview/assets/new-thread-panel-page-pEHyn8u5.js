...
import {
  H as C,
  V as w,
} from "./app-initial~app-main~first-run~new-thread-panel-page~onboarding-page-9GAwL4-7.js";
import { n as T, t as E } from "./home-announcements-BVgdEjD6.js";
function D() {
  let e = (0, k.c)(14),
    r = s(),
    i = t(m);
  {
    ...
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, A.jsx)(u, { to: `/`, replace: !0 })), (e[0] = t))
        : (t = e[0]),
      t
    );
  }
  ...
  e[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = b.isRecording() ? (0, A.jsx)(S, { onPaint: O }) : null), (e[1] = a))
    : (a = e[1]);
  let o;
  e[2] === r
    ? (o = e[3])
...
//# sourceMappingURL=new-thread-panel-page-pEHyn8u5.js.map
