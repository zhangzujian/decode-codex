...
import { i as S, n as C, r as w, t as T } from "./src-CJas8qj0.js";
import { t as E } from "./dist-CcEbW-Bo.js";
import { i as D, n as O, o as k, r as A } from "./chunk-AGHRB4JF-7UqQL8yc.js";
import {
  A as j,
  C as M,
  G as ee,
...
import { g as ce, u as le } from "./chunk-5PVQY5BW-DI2wdaXU.js";
var ue = n((e, t) => {
    (function (n, r) {
    ...
    (Tt = {
      ...
      renderer: {
        ...
        draw: O(function (e, t, n, u) {
          let d = N().gantt;
          u.db.setDiagramId(t);
          let p = N().securityLevel,
            m;
          p === `sandbox` && (m = C(`#i` + t));
          let g = C(
              p === `sandbox` ? m.nodes()[0].contentDocument.body : `body`,
            ),
            v = p === `sandbox` ? m.nodes()[0].contentDocument : document,
            x = v.getElementById(t);
          ...
          function te(e, t, n) {
            let r = d.barHeight,
              ...
              l = s()
                ...
                .range([`#00B9FA`, `#F95002`])
                .interpolate(i);
            (re(a, o, c, t, n, e, u.db.getExcludes(), u.db.getIncludes()),
              se(c, o, t, n),
              ne(e, a, o, c, r, l, t, n),
              ce(a, o, c, r, l),
              le(c, o, t, n));
          ...
          function se(e, t, n, i) {
            let a = u.db.getDateFormat(),
              o = u.db.getAxisFormat(),
              s;
            s = o || (a === `D` ? `%d` : (d.axisFormat ?? `%Y-%m-%d`));
            let p = w(M)
                .tickSize(-i + t + d.gridLineStartPadding)
                .tickFormat(f(s)),
              m =
            ...
            if (m !== null) {
              ...
              if (isNaN(e) || e <= 0)
                ...
                if (s > $)
                  D.warn(
                    `The tick interval "${e}${t}" would generate ${s} ticks, which exceeds the maximum allowed (${$}). This may indicate an invalid date or time range. Skipping custom tick interval.`,
                  );
                else
                  switch (t) {
                    case `millisecond`:
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-DPe1RqF2.js.map
