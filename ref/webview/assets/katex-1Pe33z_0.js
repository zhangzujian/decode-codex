...
function n(e) {
  for (var t = 0; t < Ne.length; t++)
    for (var n = Ne[t], r = 0; r < n.blocks.length; r++) {
      var i = n.blocks[r];
...
function r(e) {
  for (var t = 0; t < Pe.length; t += 2)
    if (e >= Pe[t] && e <= Pe[t + 1]) return !0;
  return !1;
}
function i(e) {
...
function s(e, t, n) {
  if (!dt[t]) throw Error(`Font metrics not found for font: ` + t + `.`);
  var i = e.charCodeAt(0),
    a = dt[t][i];
  if (
    (!a && e[0] in pt && ((i = pt[e[0]].charCodeAt(0)), (a = dt[t][i])),
    !a && n === `text` && r(i) && (a = dt[t][77]),
    a)
  )
...
function c(e) {
  var t = e >= 5 ? 0 : e >= 3 ? 1 : 2;
  if (!mt[t]) {
    var n = (mt[t] = { cssEmPerMu: ft.quad[t] / 18 });
    for (var r in ft) ft.hasOwnProperty(r) && (n[r] = ft[r][t]);
  }
  return mt[t];
}
function l(e, t, n, r, i, a) {
  ((M[e][i] = { font: t, group: n, replace: r }),
    a && r && (M[e][r] = M[e][i]));
}
function u(e) {
  for (
...
function f(e, t) {
  var n = G([`base`], e, t),
    r = G([`strut`]);
  return (
    (r.style.height = j(n.height + n.depth)),
    n.depth && (r.style.verticalAlign = j(-n.depth)),
  ...
  for (var a = [], o = [], s = 0; s < r.length; s++)
    if (
      ...
      r[s].hasClass(`newline`) &&
        (o.pop(), o.length > 0 && (a.push(f(o, t)), (o = [])), a.push(r[s]));
  o.length > 0 && a.push(f(o, t));
  var l;
  n
    ? ((l = f(Y(n, t, !0), t)), (l.classes = [`tag`]), a.push(l))
    : i && a.push(i);
  var u = G([`katex-html`], a);
  if ((u.setAttribute(`aria-hidden`, `true`), l)) {
    var d = l.children[0];
    ((d.style.height = j(u.height + u.depth)),
      u.depth && (d.style.verticalAlign = j(-u.depth)));
  }
  return u;
}
function m(e) {
...
function h(e) {
  ...
  if (e.type === `mi` && e.children.length === 1) {
    ...
    var n = e.children[0];
    return n instanceof Q && n.text === `,`;
  } else return !1;
}
function g(e, t, n, r, i) {
  var a = An(e, n),
    o =
      a.length === 1 && a[0] instanceof Z && En.has(a[0].type)
        ? a[0]
        : new Z(`mrow`, a),
    s = new Z(`annotation`, [new Q(t)]);
  s.setAttribute(`encoding`, `application/x-tex`);
  var c = new Z(`semantics`, [o, s]),
    l = new Z(`math`, [c]);
  return (
    l.setAttribute(`xmlns`, `http://www.w3.org/1998/Math/MathML`),
    r && l.setAttribute(`display`, `block`),
    G([i ? `katex` : `katex-mathml`], [l])
  );
}
function _(e, t) {
  if (!e || e.type !== t)
...
function y(e) {
  return e && (e.type === `atom` || gt.hasOwnProperty(e.type)) ? e : null;
}
function b(e, t) {
  var n = Y(e.body, t, !0);
...
function ee(e) {
  ...
  for (
    ...
    if (n === `&` || n === `\\\\`) e.consume();
      ...
      break;
    } else throw new E(`Expected \\\\ or \\cr or \\end`, e.nextToken);
  }
  for (var r = [], i = [r], a = 0; a < t.length; a++) {
    for (var o = t[a], s = $n(), c = 0; c < o.length; c++)
      if (!er(o[c])) s.body.push(o[c]);
      else {
        (r.push(s), (c += 1));
        var l = v(o[c]).text,
          u = [, ,];
        if (
          ...
          else throw new E(`Expected one of "<>AV=|." after @`, o[c]);
        var m = {
          type: `styling`,
          body: [S(l, u, e)],
          mode: `math`,
...
function C(e, t) {
  var n = y(e);
  if (n && Rr.has(n.text)) return n;
  throw n
    ? new E(`Invalid delimiter '` + n.text + `' after '` + t.funcName + `'`, e)
    : new E(`Invalid delimiter type '` + e.type + `'`, e);
}
function te(e) {
...
function ie(e, t, n) {
  ...
  if (
    ...
    if (p == null) o = 1;
      ...
      throw new E(`Invalid \\arraystretch: ` + p);
  }
  e.gullet.beginGroup();
  var m = [],
    h = [m],
  ...
  function b() {
    v &&
      (e.gullet.macros.get(`\\df@tag`)
        ? (v.push(e.subparse([new Wr(`\\df@tag`)])),
  ...
  for (y(), _.push(ne(e)); ;) {
    ...
    var S = { type: `ordgroup`, mode: e.mode, body: x };
    (n && (S = { type: `styling`, mode: e.mode, style: n, body: [S] }),
      m.push(S));
    var ee = e.fetch().text;
    if (ee === `&`) {
      if (d && m.length === d) {
        if (l || s) throw new E(`Too many tab characters: &`, e.nextToken);
      ...
      (e.gullet.future().text !== ` ` && (C = e.parseSizeGroup(!0)),
        ...
        h.push(m),
        y());
    } else throw new E(`Expected & or \\\\ or \\cr or \\end`, e.nextToken);
  }
  return (
    e.gullet.endGroup(),
    e.gullet.endGroup(),
...
function oe(e, t, n) {
  for (
    var r = Y(e, t, !1), i = t.sizeMultiplier / n.sizeMultiplier, a = 0;
    a < r.length;
    a++
  ) {
...
e(() => {
  for (
    E = class e extends Error {
      ...
      se = /([A-Z])/g,
      ce = (e) => e.replace(se, `-$1`).toLowerCase(),
      le = {
        "&": `&amp;`,
        ">": `&gt;`,
        "<": `&lt;`,
      ...
      ue = /[&><"']/g,
      D = (e) => String(e).replace(ue, (e) => le[e]),
      de = (e) =>
        e.type === `ordgroup` || e.type === `color`
          ...
          : e.type === `font`
            ? de(e.body)
            : e,
      fe = new Set([`mathord`, `textord`, `atom`]),
      pe = (e) => fe.has(de(e).type),
      me = (e) => {
      ...
      ge = class {
        constructor(e) {
          (e === void 0 && (e = {}), (e ||= {}));
          for (var n of Object.keys(he)) {
            var r = he[n],
              i = e[n];
            this[n] = i === void 0 ? t(r) : r.processor ? r.processor(i) : i;
          }
        }
      ...
      _e = class {
        ...
        sup() {
          return Ee[De[this.id]];
        }
        sub() {
          return Ee[Oe[this.id]];
        }
        fracNum() {
          return Ee[ke[this.id]];
        }
        fracDen() {
          return Ee[Ae[this.id]];
        }
        cramp() {
          return Ee[je[this.id]];
        }
        text() {
          return Ee[Me[this.id]];
        }
        isTight() {
          return this.size >= 2;
        }
      ...
      De = [Se, Ce, Se, Ce, we, Te, we, Te],
      Oe = [Ce, Ce, Ce, Ce, Te, Te, Te, Te],
      ke = [be, xe, Se, Ce, we, Te, we, Te],
      Ae = [xe, xe, Ce, Ce, Te, Te, Te, Te],
      je = [ye, ye, xe, xe, Ce, Ce, Te, Te],
      Me = [ve, ye, be, xe, be, xe, be, xe],
      O = {
        DISPLAY: Ee[ve],
        TEXT: Ee[be],
        SCRIPT: Ee[Se],
      ...
      Pe = [],
      Ne.forEach((e) => e.blocks.forEach((e) => Pe.push(...e))),
      k = (e) => e + ` ` + e,
      Fe = 80,
      Ie = function (e, t) {
        return (
...
219 661 l218 661zM702 ` +
      ...
      We = function (e, t) {
        switch (e) {
          case `⎜`:
            return k(`M291 0 H417 V` + t + ` H291z`);
          case `∣`:
            return k(`M145 0 H188 V` + t + ` H145z`);
          case `∥`:
            return (
              k(`M145 0 H188 V` + t + ` H145z`) +
              k(`M367 0 H410 V` + t + ` H367z`)
            );
          case `⎟`:
            return k(`M457 0 H583 V` + t + ` H457z`);
          case `⎢`:
            return k(`M319 0 H403 V` + t + ` H319z`);
          case `⎥`:
            return k(`M263 0 H347 V` + t + ` H263z`);
          case `⎪`:
            return k(`M384 0 H504 V` + t + ` H384z`);
          case `⏐`:
            return k(`M312 0 H355 V` + t + ` H312z`);
          case `‖`:
            return (
              k(`M257 0 H300 V` + t + ` H257z`) +
              k(`M478 0 H521 V` + t + ` H478z`)
            );
          default:
            return ``;
        }
...
-68.7 15.7-86 37-10 12-15 25.3-15 40 0 22.7 9.8 40.7 29.5 54 19.7 13.3 43.5 21
 71.5 23h399859zM103 281v-40h399897v40z`,
        leftlinesegment: k(`M40 281 V428 H0 V94 H40 V241 H400000 v40z`),
        leftbracketunder: k(`M0 0 h120 V290 H399995 v120 H0z`),
        leftbracketover: k(`M0 440 h120 V150 H399995 v-120 H0z`),
        leftmapsto: k(`M40 281 V448H0V74H40V241H400000v40z`),
        leftToFrom: `M0 147h400000v40H0zm0 214c68 40 115.7 95.7 143 167h22c15.3 0 23
-.3 23-1 0-1.3-5.3-13.7-16-37-18-35.3-41.3-69-70-101l-7-8h399905v-40H95l7-8
c28.7-32 52-65.7 70-101 10.7-23.3 16-35.7 16-37 0-.7-7.7-1-23-1h-22C115.7 265.3
 68 321 0 361zm0-174v-40h399900v40zm100 154v40h399900v-40z`,
        longequal: k(`M0 50 h400000 v40H0z m0 194h40000v40H0z`),
...
-13.3 8.7-20 26-20 38 0 71 11.2 99 33.5 0 0 7 5.6 21 16.7 14 11.2 21 33.5 21
 66.8s-14 61.2-42 83.5c-28 22.3-61 33.5-99 33.5L0 241z M0 281v-40h399859v40z`,
        rightlinesegment: k(`M399960 241 V94 h40 V428 h-40 V281 H0 v-40z`),
        rightbracketunder: k(`M399995 0 h-120 V290 H0 v120 H400000z`),
        rightbracketover: k(`M399995 440 h-120 V150 H0 v-120 H399995z`),
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`
      ...
      Xe = function (e) {
        return (
          ...
          (e in Je) || (e in Ye) || e === `ex`
        );
      },
      A = function (e, t) {
        var n;
        if ((e.unit in Je))
          n = Je[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
          ...
          else throw new E(`Invalid unit: '` + e.unit + `'`);
      ...
      tt = function (e) {
        var t = `<` + e;
        this.classes.length && (t += ` class="` + D(Ze(this.classes)) + `"`);
        var n = ``;
        for (var r of Object.keys(this.style))
          n += ce(r) + `:` + this.style[r] + `;`;
        n && (t += ` style="` + D(n) + `"`);
        for (var i of Object.keys(this.attributes)) {
          if (et.test(i)) throw new E(`Invalid attribute name '` + i + `'`);
          t += ` ` + i + `="` + D(this.attributes[i]) + `"`;
        }
        t += `>`;
      ...
      nt = class {
        constructor(e, t, n, r) {
          (Qe.call(this, e, n, r), (this.children = t || []));
        }
        setAttribute(e, t) {
          this.attributes[e] = t;
        }
      ...
      it = class {
        ...
        toMarkup() {
          var e =
              `<img src="` + D(this.src) + `"` + (` alt="` + D(this.alt) + `"`),
            t = ``;
      ...
      ot = class {
        constructor(e, t, r, i, a, o, s, c) {
          ((this.text = e),
            ...
            (this.style = c || {}),
            (this.maxFontSize = 0));
          var l = n(this.text.charCodeAt(0));
          (l && this.classes.push(l + `_fallback`),
            /[îïíì]/.test(this.text) && (this.text = at[this.text]));
        }
        hasClass(e) {
          return this.classes.includes(e);
        }
        toNode() {
          ...
          (this.italic > 0 &&
            ...
            (t.style.marginRight = j(this.italic))),
        ...
        toMarkup() {
          ...
          this.classes.length &&
            ...
            (t += `"`));
          var n = ``;
          this.italic > 0 && (n += `margin-right:` + j(this.italic) + `;`);
          for (var r of Object.keys(this.style))
            n += ce(r) + `:` + this.style[r] + `;`;
          n && ((e = !0), (t += ` style="` + D(n) + `"`));
          var i = D(this.text);
        ...
        toNode() {
          ...
          return (
            this.alternate
              ...
              : e.setAttribute(`d`, Ge[this.pathName]),
            e
          );
        }
        toMarkup() {
          return this.alternate
            ? `<path d="` + D(this.alternate) + `"/>`
            : `<path d="` + D(Ge[this.pathName]) + `"/>`;
        }
      },
      lt = class {
        constructor(e) {
      ...
      ut = (e) => e instanceof nt || e instanceof rt || e instanceof qe,
      dt = {
        "AMS-Regular": {
          32: [0, 0, 0, 0, 0.25],
      ...
      mt = {},
      ht = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
      gt = {
        "accent-token": 1,
        mathord: 1,
        "op-token": 1,
      ...
      l(N, F, V, `⋈`, `\\bowtie`, !0),
      l(N, F, V, `⌣`, `\\smile`, !0),
      l(N, F, V, `⊑`, `\\sqsubseteq`, !0),
      l(N, F, V, `⊒`, `\\sqsupseteq`, !0),
      l(N, F, V, `≐`, `\\doteq`, !0),
      l(N, F, V, `⌢`, `\\frown`, !0),
      l(N, F, V, `∋`, `\\ni`, !0),
      l(N, F, V, `∝`, `\\propto`, !0),
      ...
      l(N, F, H, `‡`, `\\ddag`),
      l(P, F, H, `‡`, `\\ddag`),
      l(P, F, H, `‡`, `\\textdaggerdbl`),
      l(N, F, _t, `⎱`, `\\rmoustache`, !0),
      l(N, F, yt, `⎰`, `\\lmoustache`, !0),
      l(N, F, _t, `⟯`, `\\rgroup`, !0),
      l(N, F, yt, `⟮`, `\\lgroup`, !0),
      l(N, F, R, `∓`, `\\mp`, !0),
      l(N, F, R, `⊖`, `\\ominus`, !0),
      ...
      l(N, F, R, `⨿`, `\\amalg`),
      l(N, F, R, `&`, `\\And`),
      l(N, F, V, `⟵`, `\\longleftarrow`, !0),
      l(N, F, V, `⇐`, `\\Leftarrow`, !0),
      l(N, F, V, `⟸`, `\\Longleftarrow`, !0),
      l(N, F, V, `⟶`, `\\longrightarrow`, !0),
      l(N, F, V, `⇒`, `\\Rightarrow`, !0),
      l(N, F, V, `⟹`, `\\Longrightarrow`, !0),
      l(N, F, V, `↔`, `\\leftrightarrow`, !0),
      l(N, F, V, `⟷`, `\\longleftrightarrow`, !0),
      l(N, F, V, `⇔`, `\\Leftrightarrow`, !0),
      l(N, F, V, `⟺`, `\\Longleftrightarrow`, !0),
      l(N, F, V, `↦`, `\\mapsto`, !0),
      l(N, F, V, `⟼`, `\\longmapsto`, !0),
      l(N, F, V, `↗`, `\\nearrow`, !0),
      l(N, F, V, `↩`, `\\hookleftarrow`, !0),
      l(N, F, V, `↪`, `\\hookrightarrow`, !0),
      l(N, F, V, `↘`, `\\searrow`, !0),
      l(N, F, V, `↼`, `\\leftharpoonup`, !0),
      l(N, F, V, `⇀`, `\\rightharpoonup`, !0),
      l(N, F, V, `↙`, `\\swarrow`, !0),
      l(N, F, V, `↽`, `\\leftharpoondown`, !0),
      l(N, F, V, `⇁`, `\\rightharpoondown`, !0),
      l(N, F, V, `↖`, `\\nwarrow`, !0),
      l(N, F, V, `⇌`, `\\rightleftharpoons`, !0),
      l(N, I, V, `≮`, `\\nless`, !0),
      l(N, I, V, ``, `\\@nleqslant`),
      l(N, I, V, ``, `\\@nleqq`),
      l(N, I, V, `⪇`, `\\lneq`, !0),
      ...
      l(N, I, V, `⋬`, `\\ntrianglelefteq`, !0),
      l(N, I, V, `⊊`, `\\subsetneq`, !0),
      l(N, I, V, ``, `\\@varsubsetneq`),
      l(N, I, V, `⫋`, `\\subsetneqq`, !0),
      l(N, I, V, ``, `\\@varsubsetneqq`),
      l(N, I, V, `≯`, `\\ngtr`, !0),
      l(N, I, V, ``, `\\@ngeqslant`),
      l(N, I, V, ``, `\\@ngeqq`),
      l(N, I, V, `⪈`, `\\gneq`, !0),
      ...
      l(N, I, V, `⋡`, `\\nsucceq`, !0),
      l(N, I, V, `⋩`, `\\succnsim`, !0),
      l(N, I, V, `⪺`, `\\succnapprox`, !0),
      l(N, I, V, `≆`, `\\ncong`, !0),
      l(N, I, V, ``, `\\@nshortparallel`),
      l(N, I, V, `∦`, `\\nparallel`, !0),
      l(N, I, V, `⊯`, `\\nVDash`, !0),
      l(N, I, V, `⋫`, `\\ntriangleright`),
      l(N, I, V, `⋭`, `\\ntrianglerighteq`, !0),
      l(N, I, V, ``, `\\@nsupseteqq`),
      l(N, I, V, `⊋`, `\\supsetneq`, !0),
      l(N, I, V, ``, `\\@varsupsetneq`),
      l(N, I, V, `⫌`, `\\supsetneqq`, !0),
      l(N, I, V, ``, `\\@varsupsetneqq`),
      l(N, I, V, `⊮`, `\\nVdash`, !0),
      l(N, I, V, `⪵`, `\\precneqq`, !0),
      l(N, I, V, `⪶`, `\\succneqq`, !0),
      l(N, I, V, ``, `\\@nsubseteqq`),
      ...
      l(N, I, H, `®`, `\\circledR`),
      l(P, I, H, `®`, `\\circledR`),
      l(N, I, H, `∡`, `\\measuredangle`, !0),
      l(N, I, H, `∄`, `\\nexists`),
      l(N, I, H, `℧`, `\\mho`),
      l(N, I, H, `Ⅎ`, `\\Finv`, !0),
      l(N, I, H, `⅁`, `\\Game`, !0),
      l(N, I, H, `‵`, `\\backprime`),
      l(N, I, H, `▲`, `\\blacktriangle`),
      l(N, I, H, `▼`, `\\blacktriangledown`),
      l(N, I, H, `■`, `\\blacksquare`),
      l(N, I, H, `⧫`, `\\blacklozenge`),
      l(N, I, H, `★`, `\\bigstar`),
      l(N, I, H, `∢`, `\\sphericalangle`, !0),
      l(N, I, H, `∁`, `\\complement`, !0),
      l(N, I, H, `ð`, `\\eth`, !0),
      l(P, F, H, `ð`, `ð`),
      l(N, I, H, `╱`, `\\diagup`),
      l(N, I, H, `╲`, `\\diagdown`),
      ...
      l(N, I, V, `≦`, `\\leqq`, !0),
      l(N, I, V, `⩽`, `\\leqslant`, !0),
      l(N, I, V, `⪕`, `\\eqslantless`, !0),
      l(N, I, V, `≲`, `\\lesssim`, !0),
      l(N, I, V, `⪅`, `\\lessapprox`, !0),
      l(N, I, V, `≊`, `\\approxeq`, !0),
      l(N, I, R, `⋖`, `\\lessdot`),
      l(N, I, V, `⋘`, `\\lll`, !0),
      l(N, I, V, `≶`, `\\lessgtr`, !0),
      l(N, I, V, `⋚`, `\\lesseqgtr`, !0),
      l(N, I, V, `⪋`, `\\lesseqqgtr`, !0),
      l(N, I, V, `≑`, `\\doteqdot`),
      l(N, I, V, `≓`, `\\risingdotseq`, !0),
      l(N, I, V, `≒`, `\\fallingdotseq`, !0),
      l(N, I, V, `∽`, `\\backsim`, !0),
      l(N, I, V, `⋍`, `\\backsimeq`, !0),
      l(N, I, V, `⫅`, `\\subseteqq`, !0),
      l(N, I, V, `⋐`, `\\Subset`, !0),
      l(N, I, V, `⊏`, `\\sqsubset`, !0),
      l(N, I, V, `≼`, `\\preccurlyeq`, !0),
      l(N, I, V, `⋞`, `\\curlyeqprec`, !0),
      l(N, I, V, `≾`, `\\precsim`, !0),
      l(N, I, V, `⪷`, `\\precapprox`, !0),
      l(N, I, V, `⊲`, `\\vartriangleleft`),
      l(N, I, V, `⊴`, `\\trianglelefteq`),
      l(N, I, V, `⊨`, `\\vDash`, !0),
      l(N, I, V, `⊪`, `\\Vvdash`, !0),
      l(N, I, V, `⌣`, `\\smallsmile`),
      l(N, I, V, `⌢`, `\\smallfrown`),
      ...
      l(N, I, V, `⋑`, `\\Supset`, !0),
      l(N, I, V, `⊐`, `\\sqsupset`, !0),
      l(N, I, V, `≽`, `\\succcurlyeq`, !0),
      l(N, I, V, `⋟`, `\\curlyeqsucc`, !0),
      l(N, I, V, `≿`, `\\succsim`, !0),
      l(N, I, V, `⪸`, `\\succapprox`, !0),
      l(N, I, V, `⊳`, `\\vartriangleright`),
      l(N, I, V, `⊵`, `\\trianglerighteq`),
      l(N, I, V, `⊩`, `\\Vdash`, !0),
      l(N, I, V, `∣`, `\\shortmid`),
      l(N, I, V, `∥`, `\\shortparallel`),
      l(N, I, V, `≬`, `\\between`, !0),
      l(N, I, V, `⋔`, `\\pitchfork`, !0),
      l(N, I, V, `∝`, `\\varpropto`),
      l(N, I, V, `◀`, `\\blacktriangleleft`),
      l(N, I, V, `∴`, `\\therefore`, !0),
      l(N, I, V, `∍`, `\\backepsilon`),
      l(N, I, V, `▶`, `\\blacktriangleright`),
      l(N, I, V, `∵`, `\\because`, !0),
      l(N, I, V, `⋘`, `\\llless`),
      l(N, I, V, `⋙`, `\\gggtr`),
      l(N, I, R, `⊲`, `\\lhd`),
      ...
      l(N, I, V, `≑`, `\\Doteq`, !0),
      l(N, I, R, `∔`, `\\dotplus`, !0),
      l(N, I, R, `∖`, `\\smallsetminus`),
      l(N, I, R, `⋒`, `\\Cap`, !0),
      l(N, I, R, `⋓`, `\\Cup`, !0),
      l(N, I, R, `⩞`, `\\doublebarwedge`, !0),
      l(N, I, R, `⊟`, `\\boxminus`, !0),
      l(N, I, R, `⊞`, `\\boxplus`, !0),
      l(N, I, R, `⋇`, `\\divideontimes`, !0),
      l(N, I, R, `⋉`, `\\ltimes`, !0),
      l(N, I, R, `⋊`, `\\rtimes`, !0),
      l(N, I, R, `⋋`, `\\leftthreetimes`, !0),
      l(N, I, R, `⋌`, `\\rightthreetimes`, !0),
      l(N, I, R, `⋏`, `\\curlywedge`, !0),
      l(N, I, R, `⋎`, `\\curlyvee`, !0),
      l(N, I, R, `⊝`, `\\circleddash`, !0),
      l(N, I, R, `⊛`, `\\circledast`, !0),
      l(N, I, R, `⋅`, `\\centerdot`),
      l(N, I, R, `⊺`, `\\intercal`, !0),
      l(N, I, R, `⋒`, `\\doublecap`),
      l(N, I, R, `⋓`, `\\doublecup`),
      l(N, I, R, `⊠`, `\\boxtimes`, !0),
      l(N, I, V, `⇢`, `\\dashrightarrow`, !0),
      l(N, I, V, `⇠`, `\\dashleftarrow`, !0),
      l(N, I, V, `⇇`, `\\leftleftarrows`, !0),
      l(N, I, V, `⇆`, `\\leftrightarrows`, !0),
      l(N, I, V, `⇚`, `\\Lleftarrow`, !0),
      l(N, I, V, `↞`, `\\twoheadleftarrow`, !0),
      l(N, I, V, `↢`, `\\leftarrowtail`, !0),
      l(N, I, V, `↫`, `\\looparrowleft`, !0),
      l(N, I, V, `⇋`, `\\leftrightharpoons`, !0),
      l(N, I, V, `↶`, `\\curvearrowleft`, !0),
      l(N, I, V, `↺`, `\\circlearrowleft`, !0),
      l(N, I, V, `↰`, `\\Lsh`, !0),
      l(N, I, V, `⇈`, `\\upuparrows`, !0),
      l(N, I, V, `↿`, `\\upharpoonleft`, !0),
      l(N, I, V, `⇃`, `\\downharpoonleft`, !0),
      l(N, F, V, `⊶`, `\\origof`, !0),
      l(N, F, V, `⊷`, `\\imageof`, !0),
      l(N, I, V, `⊸`, `\\multimap`, !0),
      l(N, I, V, `↭`, `\\leftrightsquigarrow`, !0),
      l(N, I, V, `⇉`, `\\rightrightarrows`, !0),
      l(N, I, V, `⇄`, `\\rightleftarrows`, !0),
      l(N, I, V, `↠`, `\\twoheadrightarrow`, !0),
      l(N, I, V, `↣`, `\\rightarrowtail`, !0),
      l(N, I, V, `↬`, `\\looparrowright`, !0),
      l(N, I, V, `↷`, `\\curvearrowright`, !0),
      l(N, I, V, `↻`, `\\circlearrowright`, !0),
      l(N, I, V, `↱`, `\\Rsh`, !0),
      l(N, I, V, `⇊`, `\\downdownarrows`, !0),
      l(N, I, V, `↾`, `\\upharpoonright`, !0),
      l(N, I, V, `⇂`, `\\downharpoonright`, !0),
      l(N, I, V, `⇝`, `\\rightsquigarrow`, !0),
      l(N, I, V, `⇝`, `\\leadsto`),
      l(N, I, V, `⇛`, `\\Rrightarrow`, !0),
      l(N, I, V, `↾`, `\\restriction`),
      l(N, F, H, `‘`, "`"),
      l(N, F, H, `$`, `\\$`),
      l(P, F, H, `$`, `\\$`),
      ...
      l(N, F, z, `ψ`, `\\psi`, !0),
      l(N, F, z, `ω`, `\\omega`, !0),
      l(N, F, z, `ε`, `\\varepsilon`, !0),
      l(N, F, z, `ϑ`, `\\vartheta`, !0),
      l(N, F, z, `ϖ`, `\\varpi`, !0),
      l(N, F, z, `ϱ`, `\\varrho`, !0),
      l(N, F, z, `ς`, `\\varsigma`, !0),
      l(N, F, z, `φ`, `\\varphi`, !0),
      l(N, F, R, `∗`, `*`, !0),
      l(N, F, R, `+`, `+`),
      l(N, F, R, `−`, `-`, !0),
      ...
      l(N, F, H, `∂`, `\\partial`, !0),
      l(N, F, R, `⊘`, `\\oslash`, !0),
      l(N, I, R, `⊚`, `\\circledcirc`, !0),
      l(N, I, R, `⊡`, `\\boxdot`, !0),
      l(N, F, R, `△`, `\\bigtriangleup`),
      l(N, F, R, `▽`, `\\bigtriangledown`),
      l(N, F, R, `†`, `\\dagger`),
      l(N, F, R, `⋄`, `\\diamond`),
      l(N, F, R, `⋆`, `\\star`),
      l(N, F, R, `◃`, `\\triangleleft`),
      l(N, F, R, `▹`, `\\triangleright`),
      l(N, F, yt, `{`, `\\{`),
      l(P, F, H, `{`, `\\{`),
      l(P, F, H, `{`, `\\textbraceleft`),
      l(N, F, _t, `}`, `\\}`),
      l(P, F, H, `}`, `\\}`),
      l(P, F, H, `}`, `\\textbraceright`),
      l(N, F, yt, `{`, `\\lbrace`),
      l(N, F, _t, `}`, `\\rbrace`),
      l(N, F, yt, `[`, `\\lbrack`, !0),
      l(P, F, H, `[`, `\\lbrack`, !0),
      ...
      l(N, F, H, `∥`, `\\Vert`),
      l(P, F, H, `∥`, `\\textbardbl`),
      l(P, F, H, `~`, `\\textasciitilde`),
      l(P, F, H, `\\`, `\\textbackslash`),
      l(P, F, H, `^`, `\\textasciicircum`),
      l(N, F, V, `↑`, `\\uparrow`, !0),
      l(N, F, V, `⇑`, `\\Uparrow`, !0),
      l(N, F, V, `↓`, `\\downarrow`, !0),
      l(N, F, V, `⇓`, `\\Downarrow`, !0),
      l(N, F, V, `↕`, `\\updownarrow`, !0),
      l(N, F, V, `⇕`, `\\Updownarrow`, !0),
      l(N, F, B, `∐`, `\\coprod`),
      l(N, F, B, `⋁`, `\\bigvee`),
      l(N, F, B, `⋀`, `\\bigwedge`),
      ...
      l(N, F, B, `⨆`, `\\bigsqcup`),
      l(N, F, B, `∫`, `\\smallint`),
      l(P, F, vt, `…`, `\\textellipsis`),
      l(N, F, vt, `…`, `\\mathellipsis`),
      l(P, F, vt, `…`, `\\ldots`, !0),
      l(N, F, vt, `…`, `\\ldots`, !0),
      l(N, F, vt, `⋯`, `\\@cdots`, !0),
      l(N, F, vt, `⋱`, `\\ddots`, !0),
      ...
      l(P, F, H, `—`, `\\textemdash`),
      l(P, F, H, `‘`, "`", !0),
      l(P, F, H, `‘`, `\\textquoteleft`),
      l(P, F, H, `’`, `'`, !0),
      l(P, F, H, `’`, `\\textquoteright`),
      l(P, F, H, `“`, "``", !0),
      l(P, F, H, `“`, `\\textquotedblleft`),
      l(P, F, H, `”`, `''`, !0),
      l(P, F, H, `”`, `\\textquotedblright`),
      l(N, F, H, `°`, `\\degree`, !0),
      l(P, F, H, `°`, `\\degree`),
      l(P, F, H, `°`, `\\textdegree`, !0),
      l(N, F, H, `£`, `\\pounds`),
      l(N, F, H, `£`, `\\mathsterling`, !0),
      l(P, F, H, `£`, `\\pounds`),
      l(P, F, H, `£`, `\\textsterling`, !0),
      l(N, I, H, `✠`, `\\maltese`),
      l(P, I, H, `✠`, `\\maltese`),
      Ct = `0123456789/@."`,
      wt = 0;
    ...
    ((Tt = Ct.charAt(wt)), l(N, F, H, Tt, Tt));
  for (Et = `0123456789!@*()-=+";:?/.,`, Dt = 0; Dt < Et.length; Dt++)
    ((Ot = Et.charAt(Dt)), l(P, F, H, Ot, Ot));
  for (
    kt = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz`, At = 0;
    At < kt.length;
    At++
  )
    ((jt = kt.charAt(At)), l(N, F, z, jt, jt), l(P, F, H, jt, jt));
  for (
    l(N, I, H, `C`, `ℂ`),
      l(P, I, H, `C`, `ℂ`),
      l(N, I, H, `H`, `ℍ`),
    ...
    ((W = kt.charAt(Mt)),
      (U = String.fromCharCode(55349, 56320 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      (U = String.fromCharCode(55349, 56372 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      (U = String.fromCharCode(55349, 56424 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      (U = String.fromCharCode(55349, 56580 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      (U = String.fromCharCode(55349, 56684 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      (U = String.fromCharCode(55349, 56736 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      (U = String.fromCharCode(55349, 56788 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      (U = String.fromCharCode(55349, 56840 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      (U = String.fromCharCode(55349, 56944 + Mt)),
      l(N, F, z, W, U),
      l(P, F, H, W, U),
      Mt < 26 &&
        ((U = String.fromCharCode(55349, 56632 + Mt)),
        l(N, F, z, W, U),
        l(P, F, H, W, U),
        (U = String.fromCharCode(55349, 56476 + Mt)),
        l(N, F, z, W, U),
        l(P, F, H, W, U)));
  for (
    U = String.fromCharCode(55349, 56668),
      l(N, F, z, `k`, U),
      l(P, F, H, `k`, U),
      Nt = 0;
    Nt < 10;
    ...
    ((Pt = Nt.toString()),
      (U = String.fromCharCode(55349, 57294 + Nt)),
      l(N, F, z, Pt, U),
      l(P, F, H, Pt, U),
      (U = String.fromCharCode(55349, 57314 + Nt)),
      l(N, F, z, Pt, U),
      l(P, F, H, Pt, U),
      (U = String.fromCharCode(55349, 57324 + Nt)),
      l(N, F, z, Pt, U),
      l(P, F, H, Pt, U),
      (U = String.fromCharCode(55349, 57334 + Nt)),
      l(N, F, z, Pt, U),
      l(P, F, H, Pt, U));
  for (Ft = `ÐÞþ`, It = 0; It < Ft.length; It++)
    ((Lt = Ft.charAt(It)), l(N, F, z, Lt, Lt), l(P, F, H, Lt, Lt));
  ((Rt = [
    ...
    (Bt = (e, t) => {
      ...
      if (119808 <= i && i < 120484) {
        ...
        return [Rt[o][2], Rt[o][a]];
      } else if (120782 <= i && i <= 120831) {
        var s = Math.floor((i - 120782) / 10);
        return [zt[s][2], zt[s][a]];
      } else if (i === 120485 || i === 120486) return [Rt[0][2], Rt[0][a]];
      else if (120486 < i && i < 120782) return [``, ``];
      else throw new E(`Unsupported character: ` + e);
    }),
    (Vt = function (e, t, n) {
      if (M[n][e]) {
        var r = M[n][e].replace;
      ...
      return { value: e, metrics: s(e, t, n) };
    }),
    (Ht = function (e, t, n, r, i) {
      ...
      if (o) {
        ...
        ((n === `text` || (r && r.font === `mathit`)) && (c = 0),
          (s = new ot(e, o.height, o.depth, c, o.skew, o.width, i)));
      } else
        (typeof console < `u` &&
          console.warn(
    ...
    (Ut = function (e, t, n, r) {
      return (
        r === void 0 && (r = []),
        n.font === `boldsymbol` && Vt(e, `Main-Bold`, t).metrics
          ? Ht(e, `Main-Bold`, t, n, r.concat([`mathbf`]))
          : e === `\\` || M[t][e].font === `main`
            ? Ht(e, `Main-Regular`, t, n, r)
            : Ht(e, `AMS-Regular`, t, n, r.concat([`amsrm`]))
      );
    }),
    ...
    (Gt = function (e, t, n) {
      var r = e.mode,
        ...
        c = ``,
        l = ``;
      if ((i.charCodeAt(0) === 55349 && ([c, l] = Bt(i, r)), c.length > 0))
        return Ht(i, c, r, t, a.concat(l));
      if (s) {
        var u, d;
        if (s === `boldsymbol`) {
          var f = Wt(i, r, t, a, n);
          ...
          o
            ? ((u = rn[s].fontName), (d = [s]))
            : ((u = nn(s, t.fontWeight, t.fontShape)),
              (d = [s, t.fontWeight, t.fontShape]));
        if (Vt(i, u, r).metrics) return Ht(i, u, r, t, a.concat(d));
        if (St.hasOwnProperty(i) && u.slice(0, 10) === `Typewriter`) {
          for (var p = [], m = 0; m < i.length; m++)
            p.push(Ht(i[m], u, r, t, a.concat(d)));
          return Qt(p);
        }
      }
      if (n === `mathord`)
        return Ht(i, `Math-Italic`, r, t, a.concat([`mathnormal`]));
      if (n === `textord`) {
        var h = M[r][i] && M[r][i].font;
        if (h === `ams`)
          return Ht(
            i,
            nn(`amsrm`, t.fontWeight, t.fontShape),
            r,
            t,
        ...
        if (h === `main` || !h)
          return Ht(
            i,
            nn(`textrm`, t.fontWeight, t.fontShape),
            r,
            t,
            a.concat(t.fontWeight, t.fontShape),
          );
        var g = nn(h, t.fontWeight, t.fontShape);
        return Ht(i, g, r, t, a.concat(g, t.fontWeight, t.fontShape));
      } else throw Error(`unexpected type: ` + n + ` in makeOrd`);
    }),
    (Kt = (e, t) => {
      if (
        Ze(e.classes) !== Ze(t.classes) ||
        e.skew !== t.skew ||
    ...
    (G = function (e, t, n, r) {
      var i = new nt(e, t, n, r);
      return (Jt(i), i);
    }),
    (Yt = (e, t, n, r) => new nt(e, t, n, r)),
    (Xt = function (e, t, n) {
      var r = G([e], [], t);
      return (
        (r.height = Math.max(
    ...
    ($t = function (e, t) {
      return e instanceof qe ? G([], [e], t) : e;
    }),
    (en = function (e) {
    ...
    (K = function (e, t) {
      for (
        var { children: n, depth: r } = en(e), i = 0, a = 0;
        a < n.length;
        a++
      ) {
        var o = n[a];
    ...
    (tn = (e, t) => {
      var n = G([`mspace`], [], t),
        r = A(e, t);
      return ((n.style.marginRight = j(r)), n);
    }),
    (nn = function (e, t, n) {
      var r = ``;
      switch (e) {
    ...
    (cn = { number: 5, unit: `mu` }),
    (ln = {
      mord: { mop: q, mbin: sn, mrel: cn, minner: q },
      mop: { mord: q, mop: q, mrel: cn, minner: q },
      mbin: { mord: sn, mop: sn, mopen: sn, minner: sn },
      mrel: { mord: cn, mop: cn, mopen: cn, minner: cn },
      mopen: {},
      mclose: { mop: q, mbin: sn, mrel: cn, minner: q },
      mpunct: {
        mord: q,
        mop: q,
        mrel: cn,
    ...
    (hn = new Set([`leftmost`, `mbin`, `mopen`, `mrel`, `mop`, `mpunct`])),
    (gn = new Set([`rightmost`, `mrel`, `mclose`, `mpunct`])),
    (_n = {
      display: O.DISPLAY,
      text: O.TEXT,
      script: O.SCRIPT,
    ...
    (Y = function (e, t, n, r) {
      ...
      if (e.length === 1) {
        ...
        l.type === `sizing`
          ...
          : l.type === `styling` && (c = t.havingStyle(_n[l.style]));
      }
      var u = G([r[0] || `leftmost`], [], t),
        d = G([r[1] || `rightmost`], [], t),
        f = n === `root`;
      return (
        yn(
          ...
          (e, t) => {
            ...
            n === `mbin` && gn.has(r)
              ? (t.classes[0] = `mord`)
              : r === `mbin` && hn.has(n) && (e.classes[0] = `mord`);
          },
          { node: u },
          d,
          f,
    ...
    (yn = function (e, t, n, r, i) {
      ...
      for (var a = 0; a < e.length; a++) {
        ...
        (c
          ? (n.node = o)
          : i && o.hasClass(`newline`) && (n.node = G([`leftmost`])),
          (n.insertAfter = ((t) => (n) => {
            (e.splice(t + 1, 0, n), a++);
          })(a)));
      }
    ...
    (bn = function (e) {
      return e instanceof qe ||
        e instanceof rt ||
        (e instanceof nt && e.hasClass(`enclosing`))
        ? e
        : null;
    }),
    (xn = function (e, t) {
      ...
      if (n) {
        var r = n.children;
        if (r.length) {
          if (t === `right`) return xn(r[r.length - 1], `right`);
          if (t === `left`) return xn(r[0], `left`);
        }
      }
      return e;
    }),
    (Sn = function (e, t) {
      return e ? (t && (e = xn(e, t)), vn[e.classes[0]] || null) : null;
    }),
    (Cn = function (e, t) {
    ...
    (X = function (e, t, n) {
      ...
      if (fn[e.type]) {
        ...
        return r;
      } else throw new E(`Got group of unknown type: '` + e.type + `'`);
    }),
    (Z = class {
      constructor(e, t, n) {
        ((this.type = e),
      ...
      toNode() {
        ...
        for (var t in this.attributes)
          Object.prototype.hasOwnProperty.call(this.attributes, t) &&
            e.setAttribute(t, this.attributes[t]);
        this.classes.length > 0 && (e.className = Ze(this.classes));
        for (var n = 0; n < this.children.length; n++)
          if (
            this.children[n] instanceof Q &&
            this.children[n + 1] instanceof Q
          ) {
            for (
      ...
      toMarkup() {
        ...
        for (var t in this.attributes)
          Object.prototype.hasOwnProperty.call(this.attributes, t) &&
            ((e += ` ` + t + `="`), (e += D(this.attributes[t])), (e += `"`));
        (this.classes.length > 0 &&
          (e += ` class ="` + D(Ze(this.classes)) + `"`),
          (e += `>`));
        for (var n = 0; n < this.children.length; n++)
          e += this.children[n].toMarkup();
    ...
    (Tn = new Set([`\\imath`, `\\jmath`])),
    (En = new Set([`mrow`, `mtable`])),
    (Dn = function (e, t, n) {
      return (
        M[t][e] &&
          M[t][e].replace &&
    ...
    (kn = function (e, t) {
      ...
      var i = e.text;
      if (Tn.has(i)) return null;
      if (M[r][i]) {
        var a = M[r][i].replace;
        a && (i = a);
      }
      var o = rn[n].fontName;
      return s(i, o, r) ? rn[n].variant : null;
    }),
    (An = function (e, t, n) {
      if (e.length === 1) {
        var r = $(e[0], t);
      ...
      for (var i = [], a, o = 0; o < e.length; o++) {
        ...
        if (s instanceof Z && a instanceof Z) {
          if (
            ...
            a.children.push(...s.children);
            continue;
          } else if (h(s) && a.type === `mn`) {
            a.children.push(...s.children);
            continue;
          } else if (s.type === `mn` && h(a))
    ...
    ($ = function (e, t) {
      ...
      if (pn[e.type]) return pn[e.type](e, t);
    ...
    (Nn = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488]),
    (Pn = function (e, t) {
    ...
    (Fn = class e {
      constructor(t) {
        ((this.style = t.style),
          ...
          (this.sizeMultiplier = Nn[this.size - 1]),
      ...
      havingStyle(e) {
        return this.style === e
          ? this
          : this.extend({ style: e, size: Pn(this.textSize, e) });
      }
      havingCrampedStyle() {
      ...
      fontMetrics() {
        return ((this._fontMetrics ||= c(this.size)), this._fontMetrics);
      }
      getColor() {
    ...
    (Rn = function (e, t, n) {
      ...
      return n.output === `mathml`
        ? g(e, t, r, n.displayMode, !0)
        : ((i =
            n.output === `html`
              ? G([`katex`], [p(e, r)])
              : G([`katex`], [g(e, t, r, n.displayMode, !1), p(e, r)])),
          Ln(i, n));
    }),
    (zn = function (e, t, n) {
      return Ln(G([`katex`], [p(e, In(n))]), n);
    }),
    (Bn = {
      widehat: `^`,
      widecheck: `ˇ`,
    ...
    (Vn = function (e) {
      var t = new Z(`mo`, [new Q(Bn[e.replace(/^\\/, ``)])]);
    ...
    (Un = new Set([`widehat`, `widecheck`, `widetilde`, `utilde`])),
    (Wn = function (e, t) {
      function n() {
        var n = 4e5,
          r = e.label.slice(1);
        if (Un.has(r)) {
          ...
          for (var x = 0; x < _; x++) {
            var S = new ct(p[x]),
              ...
              C = Yt([v[x]], [ee], t);
            if (_ === 1) return { span: C, minWidth: m, height: g };
            ((C.style.height = j(g)), d.push(C));
          }
          return { span: G([`stretchy`], d, t), minWidth: m, height: g };
        }
      }
    ...
    (Gn = function (e, t, n, r, i) {
      ...
      if (/fbox|color|angl/.test(t)) {
        ...
        (/^[bx]cancel$/.test(t) &&
          ...
          (a = Yt([], [new st(c, { width: `100%`, height: j(o) })], i)));
      }
      return ((a.height = o), (a.style.height = j(o)), a);
    }),
    (Kn = (e) => {
      if (e instanceof ot) return e;
      if (ut(e) && e.children.length === 1) return Kn(e.children[0]);
    }),
    (qn = (e, t) => {
      var n, r, o;
      e && e.type === `supsub`
        ? ((r = _(e.base, `accent`)),
          ...
          (o = a(X(e, t))),
          (e.base = r))
        : ((r = _(e, `accent`)), (n = r.base));
      var s = X(n, t.havingCrampedStyle()),
        c = r.isShifty && pe(n),
        l = 0;
      c && (l = Kn(s)?.skew ?? 0);
      var u = r.label === `\\c`,
      ...
      if (r.isStretchy)
        ...
        h && (f.classes.push(`accent-full`), (d = s.height));
        var g = l;
        (h || (g -= m / 2),
          (f.style.left = j(g)),
          r.label === `\\textcircled` && (f.style.top = `.2em`),
          (f = K({
            positionType: `firstBaseline`,
            children: [
              { type: `elem`, elem: s },
      ...
      var v = G([`mord`, `accent`], [f], t);
      return o
        ? ((o.children[0] = v),
          (o.height = Math.max(v.height, o.height)),
          (o.classes[0] = `mord`),
          o)
        : v;
    }),
    (Jn = (e, t) => {
      var n = e.isStretchy ? Vn(e.label) : new Z(`mo`, [Dn(e.label, e.mode)]),
        r = new Z(`mover`, [$(e.base, t), n]);
    ...
    u({
      ...
      mathmlBuilder(e, t) {
        ...
        if (e.body) {
          ...
          if (e.below) {
            var a = Xn($(e.below, t));
            r = new Z(`munderover`, [n, a, i]);
          } else r = new Z(`mover`, [n, i]);
        } else if (e.below) {
          var o = Xn($(e.below, t));
          r = new Z(`munder`, [n, o]);
        } else ((r = Xn()), (r = new Z(`mover`, [n, r])));
        return r;
      },
    }),
    u({
    ...
    u({
      ...
      handler(e, t) {
        var { parser: n } = e;
        return { type: `pmb`, mode: n.mode, mclass: Zn(t[0]), body: J(t[0]) };
      },
      htmlBuilder(e, t) {
        var n = Y(e.body, t, !0),
          r = G([e.mclass], n, t);
    ...
    u({
      ...
      htmlBuilder(e, t) {
        var n = $t(X(e.fragment, t), t);
        return (n.classes.push(`cd-vert-arrow`), n);
      },
      mathmlBuilder(e, t) {
        return new Z(`mrow`, [$(e.fragment, t)]);
      },
    }),
    u({
      type: `textord`,
      ...
      handler(e, t) {
        for (
          var { parser: n } = e, r = _(t[0], `ordgroup`).body, i = ``, a = 0;
          a < r.length;
          a++
        ) {
          var o = _(r[a], `textord`);
        ...
        var s = parseInt(i),
          c;
        if (isNaN(s)) throw new E(`\\@char has non-numeric argument ` + i);
        if (s < 0 || s >= 1114111)
    ...
    (nr = (e, t) => Qt(Y(e.body, t.withColor(e.color), !1))),
    (rr = (e, t) => {
      var n = An(e.body, t.withColor(e.color)),
        r = new Z(`mstyle`, n);
    ...
    u({
      ...
      handler(e, t) {
        var { parser: n } = e,
          r = _(t[0], `color-token`).color,
          i = t[1];
        return { type: `color`, mode: n.mode, color: r, body: J(i) };
      },
      htmlBuilder: nr,
      mathmlBuilder: rr,
    }),
      ...
      htmlBuilder(e, t) {
        ...
        return (
          e.newLine &&
            ...
            e.size && (n.style.marginTop = j(A(e.size, t)))),
          n
        );
      },
      mathmlBuilder(e, t) {
        ...
        return (
          e.newLine &&
            ...
            e.size && n.setAttribute(`height`, j(A(e.size, t)))),
          n
        );
      },
    }),
    ...
    (ar = (e) => {
      var t = e.text;
      if (/^(?:[\\{}$&#^_]|EOF)$/.test(t))
        throw new E(`Expected a control sequence`, e);
      return t;
    }),
    (or = (e) => {
        ...
        if (ir[r.text])
          return (
            (n === `\\global` || n === `\\\\globallong`) &&
              (r.text = ir[r.text]),
            _(t.parseFunction(), `internal`)
          );
        throw new E(`Invalid token after macro prefix`, r);
      },
    }),
    u({
      type: `internal`,
        ...
        for (var a = 0, o, s = [[]]; t.gullet.future().text !== `{`;)
          if (((r = t.gullet.popToken()), r.text === `#`)) {
            ...
            if (((r = t.gullet.popToken()), !/^[1-9]$/.test(r.text)))
              throw new E(`Invalid argument number "` + r.text + `"`);
            if (parseInt(r.text) !== a + 1)
              throw new E(`Argument number "` + r.text + `" out of order`);
            (a++, s.push([]));
          } else if (r.text === `EOF`)
    ...
    u({
      ...
      handler(e) {
        var { parser: t, funcName: n } = e,
          r = ar(t.gullet.popToken());
        return (
          t.gullet.consumeSpaces(),
          sr(t, r, or(t), n === `\\\\globallet`),
          { type: `internal`, mode: t.mode }
        );
      },
    }),
    ...
    (cr = function (e, t, n) {
      var r = s((M.math[e] && M.math[e].replace) || e, t, n);
      if (!r)
    ...
    (lr = function (e, t, n, r) {
      var i = n.havingBaseStyle(t),
        a = G(r.concat(i.sizingClasses(n)), [e], n),
    ...
    (dr = function (e, t, n, r, i, a) {
      var o = lr(Ht(e, `Main-Regular`, i, r), t, r, a);
      return (n && ur(o, r, t), o);
    }),
    (fr = function (e, t, n, r) {
      return Ht(e, `Size` + t + `-Regular`, n, r);
    }),
    (pr = function (e, t, n, r, i, a) {
      var o = fr(e, t, i, r),
        s = lr(G([`delimsizing`, `size` + t], [o], r), O.TEXT, r, a);
      return (n && ur(s, r, O.TEXT), s);
    }),
    (mr = function (e, t, n) {
      return {
        type: `elem`,
    ...
    (hr = function (e, t, n) {
      var r = dt[`Size4-Regular`][e.charCodeAt(0)]
          ? dt[`Size4-Regular`][e.charCodeAt(0)][4]
          : dt[`Size1-Regular`][e.charCodeAt(0)][4],
        i = new ct(`inner`, We(e, Math.round(1e3 * t))),
        a = Yt(
          [],
          [
            new st([i], {
    ...
    (gr = 0.008),
    (_r = { type: `kern`, size: -1 * gr }),
    (vr = new Set([`|`, `\\lvert`, `\\rvert`, `\\vert`])),
    ...
    (br = function (e, t, n, r, i, a) {
      ...
      var S = m + v + y,
        ee = S + Math.max(0, Math.ceil((t - S) / (b * g))) * b * g,
        C = r.fontMetrics().axisHeight;
      n && (C *= r.sizeMultiplier);
      var te = ee / 2 - C,
        w = [];
      if (u.length > 0) {
        var T = ee - m - v,
          ne = Math.round(ee * 1e3),
          re = Ke(u, Math.round(T * 1e3)),
          ie = new ct(u, re),
          ae = j(d / 1e3),
          oe = j(ne / 1e3),
          E = Yt(
        ...
        if ((w.push(mr(l, f, i)), w.push(_r), s === null)) {
          var se = ee - m - v + 2 * gr;
          w.push(hr(c, se, r));
        } else {
          var ce = (ee - m - v - y) / 2 + 2 * gr;
          (w.push(hr(c, ce, r)),
            w.push(_r),
            w.push(mr(s, f, i)),
            w.push(_r),
        ...
        (w.push(_r), w.push(mr(o, f, i)));
      }
      var le = r.havingBaseStyle(O.TEXT);
      return lr(
        G(
          [`delimsizing`, `mult`],
          [K({ positionType: `bottom`, positionData: te, children: w })],
          le,
        ),
        O.TEXT,
        r,
    ...
    (wr = function (e, t) {
      var n = t.havingBaseSizing(),
        r = Pr(`\\surd`, e * n.sizeMultiplier, Mr, n),
        i = n.sizeMultiplier,
        ...
        r.type === `small`
          ...
          : r.type === `large`
            ? ((l = (1e3 + xr) * Or[r.size]),
              (c = (Or[r.size] + a) / i),
              (s = (Or[r.size] + a + Sr) / i),
              (o = Cr(`sqrtSize` + r.size, s, l, a, t)),
              (o.style.minWidth = `1.02em`),
              (u = 1 / i))
            : ((s = e + a + Sr),
              (c = e + a),
              (l = Math.floor(1e3 * e + a) + xr),
              (o = Cr(`sqrtTall`, s, l, a, t)),
    ...
    (kr = function (e, t, n, r, i) {
      if (
        ...
        return pr(e, t, !1, n, r, i);
      if (Er.has(e)) return br(e, Or[t], !1, n, r, i);
    ...
    (Fr = function (e, t, n, r, i, a) {
      e === `<` || e === `\\lt` || e === `⟨`
        ? (e = `\\langle`)
        : (e === `>` || e === `\\gt` || e === `⟩`) && (e = `\\rangle`);
      var o = Dr.has(e) ? Ar : Tr.has(e) ? Mr : jr,
        s = Pr(e, t, o, r);
      return s.type === `small`
        ? dr(e, s.style, n, r, i, a)
        : s.type === `large`
          ? pr(e, s.size, n, r, i, a)
          : br(e, t, n, r, i, a);
    }),
    (Ir = function (e, t, n, r, i, a) {
      var o = r.fontMetrics().axisHeight * r.sizeMultiplier,
        ...
        l = Math.max(t - o, n + o);
      return Fr(e, Math.max((l / 500) * s, 2 * l - c), !0, r, i, a);
    }),
    (Lr = {
    ...
    u({
      ...
      handler: (e, t) => {
        ...
        return {
          type: `delimsizing`,
          mode: e.parser.mode,
          size: Lr[e.funcName].size,
          mclass: Lr[e.funcName].mclass,
          delim: n.text,
        };
      },
      htmlBuilder: (e, t) =>
        e.delim === `.`
          ? G([e.mclass])
          : kr(e.delim, e.size, t, e.mode, [e.mclass]),
      mathmlBuilder: (e) => {
        var t = [];
        e.delim !== `.` && t.push(Dn(e.delim, e.mode));
        var n = new Z(`mo`, t);
        (e.mclass === `mopen` || e.mclass === `mclose`
    ...
    u({
      ...
      handler: (e, t) => {
        ...
        var a = _(r.parseFunction(), `leftright-right`);
        return {
          type: `leftright`,
          mode: r.mode,
          body: i,
      ...
      htmlBuilder: (e, t) => {
        te(e);
        for (
          var n = Y(e.body, t, !0, [`mopen`, `mclose`]),
            r = 0,
            i = 0,
            a = !1,
            o = 0;
        ...
        var s =
          e.left === `.`
            ? Cn(t, [`mopen`])
            : Ir(e.left, r, i, t, e.mode, [`mopen`]);
        if ((n.unshift(s), a))
          for (var c = 1; c < n.length; c++) {
            var l = n[c].isMiddle;
            l && (n[c] = Ir(l.delim, r, i, l.options, e.mode, []));
          }
        var u;
        if (e.right === `.`) u = Cn(t, [`mclose`]);
        else {
          var d = e.rightColor ? t.withColor(e.rightColor) : t;
          u = Ir(e.right, r, i, d, e.mode, [`mclose`]);
        }
        return (n.push(u), G([`minner`], n, t));
      },
      mathmlBuilder: (e, t) => {
        te(e);
        var n = An(e.body, t);
        if (e.left !== `.`) {
          var r = new Z(`mo`, [Dn(e.left, e.mode)]);
          (r.setAttribute(`fence`, `true`), n.unshift(r));
        }
        if (e.right !== `.`) {
          var i = new Z(`mo`, [Dn(e.right, e.mode)]);
    ...
    u({
      ...
      handler: (e, t) => {
        ...
        if (!e.parser.leftrightDepth)
          throw new E(`\\middle without preceding \\left`, n);
    ...
    (zr = (e, t) => {
      ...
      if (r === `sout`)
        ...
        var c = A({ number: 0.6, unit: `pt` }, t),
          l = A({ number: 0.35, unit: `ex` }, t),
          u = t.havingBaseSizing();
        i /= u.sizeMultiplier;
        var d = n.height + n.depth + c + l;
        n.style.paddingLeft = j(d / 2 + c);
        var f = Math.floor(1e3 * d * i),
          p = Ve(f);
        ((a = Yt(
          [`hide-tail`],
          [
            new st([new ct(`phase`, p)], {
              width: `400em`,
              height: j(f / 1e3),
        ...
        (/box/.test(r)
          ...
          /fbox|boxed|fcolorbox/.test(r)
            ? ((a.style.borderStyle = `solid`), (a.style.borderWidth = j(g)))
            : r === `angl` &&
              g !== 0.049 &&
              ((a.style.borderTopWidth = j(g)),
              (a.style.borderRightWidth = j(g))),
          (o = n.depth + h),
          e.backgroundColor &&
      ...
      return (
        ...
        /cancel/.test(r) && !s
          ? G([`mord`, `cancel-lap`], [_], t)
          : G([`mord`], [_], t)
      );
    }),
    (Br = (e, t) => {
      var n = 0,
        r = new Z(e.label.includes(`colorbox`) ? `mpadded` : `menclose`, [
          $(e.body, t),
        ]);
      switch (e.label) {
        case `\\cancel`:
        ...
        case `\\colorbox`:
          if (
            ...
            r.setAttribute(
              `style`,
              `border: ` + j(i) + ` solid ` + e.borderColor,
            );
          }
          break;
        case `\\xcancel`:
    ...
    (Wr = class e {
      ...
      range(t, n) {
        return new e(n, Ur.range(this, t));
      }
    }),
    (Gr = (e) => {
      if (!e.parser.settings.displayMode)
        throw new E(`{` + e.envName + `} can be used only in display mode.`);
    }),
    (Kr = new Set([`gather`, `gather*`])),
    (qr = function (e, t) {
      var n,
        r,
        i = e.body.length,
      ...
      e.colSeparationType &&
        ...
        (d =
          0.2778 * (t.havingStyle(O.SCRIPT).sizeMultiplier / t.sizeMultiplier));
      var f =
          e.colSeparationType === `CD`
            ? A({ number: 3, unit: `ex` }, t)
            : 12 * u,
        p = 3 * u,
        m = e.arraystretch * f,
        h = 0.7 * m,
      ...
      for (v(a[0]), n = 0; n < e.body.length; ++n) {
        ...
        for (r = 0; r < y.length; ++r) {
          var ee = X(y[r], t);
          (x < ee.depth && (x = ee.depth),
            b < ee.height && (b = ee.height),
            (S[r] = ee));
        }
        var C = e.rowGaps[n],
          te = 0;
        (C &&
          ((te = A(C, t)), te > 0 && ((te += g), x < te && (x = te), (te = 0))),
          e.addJot && n < e.body.length - 1 && (x += p),
          (S.height = b),
          (S.depth = x),
          (_ += b),
          (S.pos = _),
      ...
      if (e.tags && e.tags.some((e) => e))
        for (n = 0; n < i; ++n) {
          ...
          ((le =
            ...
            (le.depth = oe.depth),
            (le.height = oe.height),
            ae.push({ type: `elem`, elem: le, shift: se }));
        }
      for (r = 0, ie = 0; r < o || ie < T.length; ++r, ++ie) {
        for (var ue = T[ie], D = !0; (de = ue)?.type === `separator`;) {
          var de;
          if (
            (D ||
              ((re = G([`arraycolsep`], [])),
              (re.style.width = j(t.fontMetrics().doubleRuleSep)),
              ne.push(re)),
            ue.separator === `|` || ue.separator === `:`)
          ) {
            var fe = ue.separator === `|` ? `solid` : `dashed`,
              pe = G([`vertical-separator`], [], t);
            ((pe.style.height = j(_)),
              (pe.style.borderRightWidth = j(l)),
              (pe.style.borderRightStyle = fe),
              (pe.style.margin = `0 ` + j(-l / 2)));
            var me = _ - w;
            (me && (pe.style.verticalAlign = j(-me)), ne.push(pe));
        ...
        if (!(r >= o)) {
          ...
          for (n = 0; n < i; ++n) {
            ...
            if (ve) {
              ...
              ((ve.depth = _e.depth),
                (ve.height = _e.height),
                ge.push({ type: `elem`, elem: ve, shift: ye }));
            }
          }
          var be = K({ positionType: `individualShift`, children: ge }),
            xe = G([`col-align-` + (ue?.align || `c`)], [be]);
          (ne.push(xe),
      ...
      if (c.length > 0) {
        for (
          var Ce = Xt(`hline`, t, l),
            we = Xt(`hdashline`, t, l),
            Te = [{ type: `elem`, elem: Se, shift: 0 }];
          c.length > 0;
        ) {
          var Ee = c.pop(),
            De = Ee.pos - w;
          Ee.isDashed
            ? Te.push({ type: `elem`, elem: we, shift: De })
            : Te.push({ type: `elem`, elem: Ce, shift: De });
        }
        Se = K({ positionType: `individualShift`, children: Te });
      }
      if (ae.length === 0) return G([`mord`], [Se], t);
      var Oe = G(
        [`tag`],
        [K({ positionType: `individualShift`, children: ae })],
        t,
      );
      return Qt([Se, Oe]);
    }),
    ...
    (Yr = function (e, t) {
      ...
      for (var te = 1; te < C.length - 1; te++)
        ee += C[te].length === 0 ? `none ` : C[te][0] ? `dashed ` : `solid `;
      return (
        /[sd]/.test(ee) && l.setAttribute(`rowlines`, ee.trim()),
        d !== `` &&
          ((l = new Z(`menclose`, [l])), l.setAttribute(`notation`, d.trim())),
        e.arraystretch &&
          e.arraystretch < 1 &&
          ((l = new Z(`mstyle`, [l])), l.setAttribute(`scriptlevel`, `1`)),
        l
      );
    }),
    (Xr = function (e, t) {
      e.envName.includes(`ed`) || Gr(e);
      var n = [],
        r = e.envName.includes(`at`) ? `alignat` : `align`,
        i = e.envName === `split`,
        a = ie(
          e.parser,
          {
      ...
      a.body.forEach(function (e) {
        for (var t = 1; t < e.length; t += 2)
          _(_(e[t], `styling`).body[0], `ordgroup`).body.unshift(c);
    ...
    w({
      ...
      handler(e) {
        ...
        if (e.envName.charAt(e.envName.length - 1) === `*`) {
          ...
          if ((i.consumeSpaces(), i.fetch().text === `[`)) {
            if (
              ...
              throw new E(`Expected l or c or r`, i.nextToken);
            (i.consume(),
              i.consumeSpaces(),
              i.expect(`]`),
              i.consume(),
        ...
        var a = ie(e.parser, r, ae(e.envName)),
    ...
    w({
      ...
      props: { numArgs: 0 },
      handler(e) {
        var t = ie(e.parser, { arraystretch: 0.5 }, `script`);
    ...
    w({
      ...
      handler(e, t) {
        ...
        var r = { cols: n, hskipBeforeAndAfter: !1, arraystretch: 0.5 },
          i = ie(e.parser, r, `script`);
        if (i.body.length > 0 && i.body[0].length > 1)
    ...
    w({
      ...
      props: { numArgs: 0 },
      handler(e) {
        Kr.has(e.envName) && Gr(e);
        var t = {
          cols: [{ type: `align`, align: `c` }],
          addJot: !0,
          colSeparationType: `gather`,
          autoTag: re(e.envName),
          emptySingleRow: !0,
          leqno: e.parser.settings.leqno,
        };
        return ie(e.parser, t, `display`);
      },
      htmlBuilder: qr,
      mathmlBuilder: Yr,
    }),
    ...
    u({
      ...
      handler(e, t) {
        throw new E(e.funcName + ` valid only within array environment`);
      },
    }),
    (Zr = Vr),
    u({
      ...
      handler(e, t) {
        var { parser: n, funcName: r } = e,
          i = t[0];
        if (i.type !== `ordgroup`) throw new E(`Invalid environment name`, i);
        for (var a = ``, o = 0; o < i.body.length; ++o)
          a += _(i.body[o], `textord`).text;
        if (r === `\\begin`) {
          if (!Zr.hasOwnProperty(a))
            throw new E(`No such environment: ` + a, i);
          var s = Zr[a],
          ...
          n.expect(`\\end`, !1);
          var f = n.nextToken,
            p = _(n.parseFunction(), `environment`);
          if (p.name !== a)
            throw new E(
    ...
    (ti = (e, t) => {
      ...
      e.hasBarLine
        ? (e.barSize
            ? ((d = A(e.barSize, t)), (u = Xt(`frac-line`, t, d)))
            : (u = Xt(`frac-line`, t)),
          (d = u.height),
          (f = u.height))
        : ((u = null), (d = 0), (f = t.fontMetrics().defaultRuleThickness));
      var p, m, h;
      n.size === O.DISPLAY.size
      ...
      var b =
          n.size === O.DISPLAY.size
            ...
            : n.size === O.SCRIPTSCRIPT.size
              ? t.havingStyle(O.SCRIPT).fontMetrics().delim2
              : t.fontMetrics().delim2,
        x =
          e.leftDelim == null
            ? Cn(t, [`mopen`])
            : Fr(e.leftDelim, b, !0, t.havingStyle(n), e.mode, [`mopen`]),
        S = e.continued
          ? G([])
          : e.rightDelim == null
            ? Cn(t, [`mclose`])
            : Fr(e.rightDelim, b, !0, t.havingStyle(n), e.mode, [`mclose`]);
      return G(
    ...
    (ni = (e, t) => {
      var n = new Z(`mfrac`, [$(e.numer, t), $(e.denom, t)]);
      ...
      if (e.leftDelim != null || e.rightDelim != null) {
        var i = [];
        if (e.leftDelim != null) {
          var a = new Z(`mo`, [new Q(e.leftDelim.replace(`\\`, ``))]);
          (a.setAttribute(`fence`, `true`), i.push(a));
        }
        if ((i.push(n), e.rightDelim != null)) {
          var o = new Z(`mo`, [new Q(e.rightDelim.replace(`\\`, ``))]);
    ...
    (ii = [`display`, `text`, `script`, `scriptscript`]),
    (ai = function (e) {
      var t = null;
    ...
    u({
      ...
      handler(e, t) {
        var { parser: n } = e,
          ...
          i = t[5],
          a = mn(t[0]),
          o = a.type === `atom` && a.family === `open` ? ai(a.text) : null,
          s = mn(t[1]),
          c = s.type === `atom` && s.family === `close` ? ai(s.text) : null,
          l = _(t[2], `size`),
          u,
          d = null;
        ...
        if (p.type === `ordgroup`) {
          if (p.body.length > 0) {
            var m = _(p.body[0], `textord`);
            f = ii[Number(m.text)];
          }
        } else ((p = _(p, `textord`)), (f = ii[Number(p.text)]));
        return ri(
          {
            type: `genfrac`,
            mode: n.mode,
    ...
    u({
      ...
      handler: (e, t) => {
        var { parser: n, funcName: r } = e,
          ...
          a = _(t[1], `infix`).size;
        if (!a)
          throw Error(`\\\\abovefrac expected size, but got ` + String(a));
        var o = t[2],
          s = a.number > 0;
        return {
          type: `genfrac`,
    ...
    (oi = (e, t) => {
      ...
      e.type === `supsub`
        ? ((r = e.sup
            ? X(e.sup, t.havingStyle(n.sup()), t)
            : X(e.sub, t.havingStyle(n.sub()), t)),
          (i = _(e.base, `horizBrace`)))
        : (i = _(e, `horizBrace`));
      var a = X(i.base, t.havingBaseStyle(O.DISPLAY)),
        o = Wn(i, t),
        s;
      if (
        (i.isOver
    ...
    (si = (e, t) => {
      var n = Vn(e.label);
      return new Z(e.isOver ? `mover` : `munder`, [$(e.base, t), n]);
    }),
    u({
      type: `horizBrace`,
    ...
    u({
      ...
      handler: (e, t) => {
        ...
        return n.settings.isTrusted({ command: `\\href`, url: i })
          ? { type: `href`, mode: n.mode, href: i, body: J(r) }
          : n.formatUnsupportedCmd(`\\href`);
      },
      htmlBuilder: (e, t) => {
        var n = Y(e.body, t, !1);
        return Zt(e.href, [], n, t);
      },
      mathmlBuilder: (e, t) => {
        var n = jn(e.body, t);
        return (
          n instanceof Z || (n = new Z(`mrow`, [n])),
    ...
    u({
      ...
      handler: (e, t) => {
        ...
        return { type: `href`, mode: n.mode, href: r, body: J(s) };
      },
    }),
    u({
      type: `hbox`,
      ...
      handler(e, t) {
        var { parser: n } = e;
        return { type: `hbox`, mode: n.mode, body: J(t[0]) };
      },
      htmlBuilder(e, t) {
        return Qt(Y(e.body, t, !1));
      },
      mathmlBuilder(e, t) {
        return new Z(`mrow`, An(e.body, t));
      },
    }),
    u({
      type: `html`,
      ...
      handler: (e, t) => {
        ...
        switch (r) {
          ...
          case `\\htmlData`:
            for (var l = a.split(`,`), u = 0; u < l.length; u++) {
              ...
              if (f < 0)
                throw new E(
                  `\\htmlData key/value '` + d + `' missing equals sign`,
                );
              var p = d.slice(0, f),
                m = d.slice(f + 1);
              c[`data-` + p.trim()] = m;
        ...
        return n.settings.isTrusted(s)
          ? { type: `html`, mode: n.mode, attributes: c, body: J(o) }
    ...
    u({
      ...
      htmlBuilder: (e, t) => Qt(Y(e.html, t, !1)),
      mathmlBuilder: (e, t) => jn(e.mathml, t),
    }),
    (ci = function (e) {
      if (/^[-+]? *(\d+(\.\d*)?|\.\d+)$/.test(e))
        return { number: +e, unit: `bp` };
      var t = /([-+]?) *(\d+(?:\.\d*)?|\.\d+) *([a-z]{2})/.exec(e);
      if (!t) throw new E(`Invalid size: '` + e + `' in \\includegraphics`);
      var n = { number: +(t[1] + t[2]), unit: t[3] };
      if (!Xe(n))
        throw new E(`Invalid unit: '` + n.unit + `' in \\includegraphics.`);
      return n;
    }),
    u({
      ...
      handler: (e, t, n) => {
        ...
        if (n[0])
          for (
            var c = _(n[0], `raw`).string.split(`,`), l = 0;
            l < c.length;
            l++
          ) {
            var u = c[l].split(`=`);
      ...
      htmlBuilder: (e, t) => {
        var n = A(e.height, t),
          r = 0;
        e.totalheight.number > 0 && (r = A(e.totalheight, t) - n);
        var i = 0;
        e.width.number > 0 && (i = A(e.width, t));
        var a = { height: j(n + r) };
        (i > 0 && (a.width = j(i)), r > 0 && (a.verticalAlign = j(-r)));
        var o = new it(e.src, e.alt, a);
      ...
      mathmlBuilder: (e, t) => {
        ...
        if (
          (e.totalheight.number > 0 &&
            ((i = A(e.totalheight, t) - r), n.setAttribute(`valign`, j(-i))),
          n.setAttribute(`height`, j(r + i)),
          e.width.number > 0)
        ) {
          var a = A(e.width, t);
          n.setAttribute(`width`, j(a));
        }
    ...
    u({
      ...
      htmlBuilder(e, t) {
        return tn(e.dimension, t);
      },
      mathmlBuilder(e, t) {
        var n = A(e.dimension, t);
        return new wn(n);
      },
    }),
    u({
      ...
      htmlBuilder: (e, t) => {
        var n;
        e.alignment === `clap`
          ? ((n = G([], [X(e.body, t)])), (n = G([`inner`], [n], t)))
          : (n = G([`inner`], [X(e.body, t)]));
        var r = G([`fix`], []),
          i = G([e.alignment], [n, r], t),
          a = G([`strut`]);
        return (
          (a.style.height = j(i.height + i.depth)),
          i.depth && (a.style.verticalAlign = j(-i.depth)),
    ...
    u({
      ...
      props: { numArgs: 0, allowedInText: !0, allowedInMath: !1 },
      handler(e, t) {
        throw new E(`Mismatched ` + e.funcName);
      },
    }),
    (li = (e, t) => {
      switch (t.style.size) {
    ...
    u({
      ...
      htmlBuilder: (e, t) => Qt(Y(li(e, t), t, !1)),
      mathmlBuilder: (e, t) => jn(li(e, t), t),
    }),
    (ui = (e, t, n, r, i, a, o) => {
      e = G([], [e]);
      var s = n && pe(n),
        ...
        l;
      if (t) {
        var u = X(t, r.havingStyle(i.sup()), r);
        l = {
          elem: u,
          kern: Math.max(
      ...
      if (n) {
        var d = X(n, r.havingStyle(i.sub()), r);
        c = {
          elem: d,
          kern: Math.max(
      ...
      if (l && c)
        f = K({
          ...
          children: [
            ...
            { type: `elem`, elem: c.elem, marginLeft: j(-a) },
            { type: `kern`, size: c.kern },
            { type: `elem`, elem: e },
            { type: `kern`, size: l.kern },
            { type: `elem`, elem: l.elem, marginLeft: j(a) },
            { type: `kern`, size: r.fontMetrics().bigOpSpacing5 },
          ],
        });
      else if (c)
      ...
      if (c && a !== 0 && !s) {
        var m = G([`mspace`], [], r);
        ((m.style.marginRight = j(a)), p.unshift(m));
      }
    ...
    (fi = (e, t) => {
      var n,
        ...
        a;
      e.type === `supsub`
        ? ((n = e.sup), (r = e.sub), (a = _(e.base, `op`)), (i = !0))
        : (a = _(e, `op`));
      var o = t.style,
        s = !1;
      o.size === O.DISPLAY.size && a.symbol && !di.has(a.name) && (s = !0);
      var c;
      if (a.symbol) {
        ...
        var p = Y(a.body, t, !0);
        p.length === 1 && p[0] instanceof ot
          ? ((c = p[0]), (c.classes[0] = `mop`))
          : (c = G([`mop`], p, t));
      } else {
        for (var m = [], h = 1; h < a.name.length; h++)
          m.push(Ut(a.name[h], a.mode, t));
        c = G([`mop`], m, t);
      }
      var g = 0,
        v = 0;
      return (
        (c instanceof ot || a.name === `\\oiint` || a.name === `\\oiiint`) &&
          !a.suppressBaseShift &&
          ((g = (c.height - c.depth) / 2 - t.fontMetrics().axisHeight),
          (v = c.italic || 0)),
        i
          ? ui(c, n, r, t, o, v, g)
          : (g && ((c.style.position = `relative`), (c.style.top = j(g))), c)
      );
    }),
    (pi = (e, t) => {
      var n;
      if (e.symbol)
        ((n = new Z(`mo`, [Dn(e.name, e.mode)])),
          di.has(e.name) && n.setAttribute(`largeop`, `false`));
      else if (e.body) n = new Z(`mo`, An(e.body, t));
      else {
        n = new Z(`mi`, [new Q(e.name.slice(1))]);
        var r = new Z(`mo`, [Dn(`⁡`, `text`)]);
        n = e.parentIsSupSub ? new Z(`mrow`, [n, r]) : m([n, r]);
      }
      return n;
    }),
    (mi = {
    ...
    (gi = (e, t) => {
      var n,
        ...
        a;
      e.type === `supsub`
        ? ((n = e.sup), (r = e.sub), (a = _(e.base, `operatorname`)), (i = !0))
        : (a = _(e, `operatorname`));
      var o;
      if (a.body.length > 0) {
        for (
      ...
      return i ? ui(o, n, r, t, t.style, 0, 0) : o;
    }),
    (_i = (e, t) => {
      for (
        var n = An(e.body, t.withFont(`mathrm`)), r = !0, i = 0;
        i < n.length;
        i++
      ) {
        var a = n[i];
        if (!(a instanceof wn))
          if (a instanceof Z)
            switch (a.type) {
              ...
              case `mo`:
                var o = a.children[0];
                a.children.length === 1 && o instanceof Q
                  ? (o.text = o.text
                      .replace(/\u2212/, `-`)
                      .replace(/\u2217/, `*`))
                  : (r = !1);
      ...
      var l = new Z(`mo`, [Dn(`⁡`, `text`)]);
      return e.parentIsSupSub ? new Z(`mrow`, [c, l]) : m([c, l]);
    }),
    u({
      type: `operatorname`,
    ...
    d({
      ...
      htmlBuilder(e, t) {
        return e.semisimple
          ? Qt(Y(e.body, t, !1))
          : G([`mord`], Y(e.body, t, !0), t);
      },
      mathmlBuilder(e, t) {
        return jn(e.body, t, !0);
      },
    }),
    u({
      type: `overline`,
      ...
      htmlBuilder(e, t) {
        var n = X(e.body, t.havingCrampedStyle()),
          r = Xt(`overline-line`, t),
      ...
      mathmlBuilder(e, t) {
        var n = new Z(`mo`, [new Q(`‾`)]);
        n.setAttribute(`stretchy`, `true`);
        var r = new Z(`mover`, [$(e.body, t), n]);
        return (r.setAttribute(`accent`, `true`), r);
      },
    }),
    u({
      ...
      handler: (e, t) => {
        var { parser: n } = e,
          r = t[0];
        return { type: `phantom`, mode: n.mode, body: J(r) };
      },
      htmlBuilder: (e, t) => Qt(Y(e.body, t.withPhantom(), !1)),
      mathmlBuilder: (e, t) => {
        var n = An(e.body, t);
        return new Z(`mphantom`, n);
      },
    }),
    ...
    u({
      ...
      htmlBuilder: (e, t) =>
        G(
          [`mord`, `rlap`],
          [G([`inner`], [X(e.body, t.withPhantom())]), G([`fix`], [])],
          t,
        ),
      mathmlBuilder: (e, t) => {
        var n = An(J(e.body), t),
    ...
    u({
      ...
      htmlBuilder(e, t) {
        var n = G([`mord`, `rule`], [], t),
          r = A(e.width, t),
          i = A(e.height, t),
          a = e.shift ? A(e.shift, t) : 0;
        return (
          (n.style.borderRightWidth = j(r)),
      ...
      mathmlBuilder(e, t) {
        ...
        return (
          i >= 0
            ? s.setAttribute(`height`, j(i))
            : (s.setAttribute(`height`, j(i)), s.setAttribute(`depth`, j(-i))),
          s.setAttribute(`voffset`, j(i)),
          s
        );
      },
    }),
    ...
    u({
      ...
      mathmlBuilder: (e, t) => {
        var n = t.havingSize(e.size),
          r = An(e.body, n),
          i = new Z(`mstyle`, r);
        return (i.setAttribute(`mathsize`, j(n.sizeMultiplier)), i);
      },
    }),
    u({
      type: `smash`,
      ...
      handler: (e, t, n) => {
        var { parser: r } = e,
          i = !1,
          a = !1,
          o = n[0] && _(n[0], `ordgroup`);
        if (o)
          for (var s = ``, c = 0; c < o.body.length; ++c) {
            var l = o.body[c];
            if (((s = v(l).text), s === `t`)) i = !0;
            else if (s === `b`) a = !0;
            else {
              ((i = !1), (a = !1));
              break;
    ...
    u({
      ...
      htmlBuilder(e, t) {
        ...
        if (e.index) {
          var f = t.havingStyle(O.SCRIPTSCRIPT),
            p = X(e.index, f, t);
          return G(
            [`mord`, `sqrt`],
            [
    ...
    (xi = function (e, t) {
      ...
      return n
        ? n.type === `op`
          ? n.limits &&
            (t.style.size === O.DISPLAY.size || n.alwaysHandleSupSub)
            ? fi
            : null
          : n.type === `operatorname`
            ? n.alwaysHandleSupSub &&
              (t.style.size === O.DISPLAY.size || n.limits)
              ? gi
              : null
            : n.type === `accent`
              ? pe(n.base)
    ...
    d({
      ...
      htmlBuilder(e, t) {
        ...
        var h =
            t.style === O.DISPLAY ? l.sup1 : t.style.cramped ? l.sup3 : l.sup2,
          g = t.sizeMultiplier,
          _ = j(0.5 / l.ptPerEm / g),
          v = null;
        if (c) {
          ...
          (o instanceof ot || y) && (v = j(-o.italic));
        }
        var b;
        if (s && c) {
          ...
          ((d = Math.max(d, l.sub1, c.height - 0.8 * l.xHeight)),
            (b = K({
              ...
              positionData: d,
              children: [
                { type: `elem`, elem: c, marginLeft: v, marginRight: _ },
              ],
            })));
        else if (s)
          ((u = Math.max(u, h, s.depth + 0.25 * l.xHeight)),
        ...
        return G([Sn(o, `right`) || `mord`], [o, G([`msupsub`], [b])], t);
      },
      mathmlBuilder(e, t) {
        var n = !1,
          r,
        ...
        if (n) o = r ? `mover` : `munder`;
          ...
          o =
            (s &&
              s.type === `op` &&
              s.limits &&
              (t.style === O.DISPLAY || s.alwaysHandleSupSub)) ||
            (s &&
              s.type === `operatorname` &&
              s.alwaysHandleSupSub &&
              (s.limits || t.style === O.DISPLAY))
              ? `mover`
              : `msup`;
        } else if (e.sup) {
          var c = e.base;
          o =
            (c && c.type === `op` && c.limits && t.style === O.DISPLAY) ||
            (c &&
              c.type === `operatorname` &&
              c.alwaysHandleSupSub &&
              (t.style === O.DISPLAY || c.limits))
              ? `munderover`
              : `msubsup`;
        } else {
          var l = e.base;
          o =
            (l &&
              l.type === `op` &&
              l.limits &&
              (t.style === O.DISPLAY || l.alwaysHandleSupSub)) ||
            (l &&
              l.type === `operatorname` &&
              l.alwaysHandleSupSub &&
              (l.limits || t.style === O.DISPLAY))
              ? `munder`
              : `msub`;
        }
        return new Z(o, a);
    ...
    d({
      type: `atom`,
      htmlBuilder(e, t) {
        return Ut(e.text, e.mode, t, [`m` + e.family]);
      },
      mathmlBuilder(e, t) {
        var n = new Z(`mo`, [Dn(e.text, e.mode)]);
        if (e.family === `bin`) {
          var r = kn(e, t);
    ...
    (Si = { mi: `italic`, mn: `normal`, mtext: `normal` }),
    d({
      type: `mathord`,
      htmlBuilder(e, t) {
        return Gt(e, t, `mathord`);
      },
      mathmlBuilder(e, t) {
        var n = new Z(`mi`, [Dn(e.text, e.mode, t)]),
          r = kn(e, t) || `italic`;
        return (r !== Si[n.type] && n.setAttribute(`mathvariant`, r), n);
      },
    }),
    d({
      type: `textord`,
      htmlBuilder(e, t) {
        return Gt(e, t, `textord`);
      },
      mathmlBuilder(e, t) {
        var n = Dn(e.text, e.mode, t),
          r = kn(e, t) || `normal`,
          i =
            e.mode === `text`
              ? new Z(`mtext`, [n])
              : /[0-9]/.test(e.text)
                ...
                : e.text === `\\prime`
                  ? new Z(`mo`, [n])
                  : new Z(`mi`, [n]);
        return (r !== Si[i.type] && i.setAttribute(`mathvariant`, r), i);
      },
    }),
    ...
    d({
      type: `spacing`,
      htmlBuilder(e, t) {
        if (wi.hasOwnProperty(e.text)) {
          var n = wi[e.text].className || ``;
          if (e.mode === `text`) {
            var r = Gt(e, t, `textord`);
            return (r.classes.push(n), r);
          } else return G([`mspace`, n], [Ut(e.text, e.mode, t)], t);
        } else if (Ci.hasOwnProperty(e.text))
          return G([`mspace`, Ci[e.text]], [], t);
        else throw new E(`Unknown type of space "` + e.text + `"`);
      },
      mathmlBuilder(e, t) {
        var n;
        if (wi.hasOwnProperty(e.text)) n = new Z(`mtext`, [new Q(`\xA0`)]);
        else if (Ci.hasOwnProperty(e.text)) return new Z(`mspace`);
        else throw new E(`Unknown type of space "` + e.text + `"`);
        return n;
      },
    }),
    ...
    d({
      ...
      mathmlBuilder(e, t) {
        var n = new Z(`mtable`, [
          new Z(`mtr`, [
            Ti(),
            new Z(`mtd`, [jn(e.body, t)]),
            Ti(),
            new Z(`mtd`, [jn(e.tag, t)]),
          ]),
        ]);
    ...
    (Di = { "\\textbf": `textbf`, "\\textmd": `textmd` }),
    (Oi = { "\\textit": `textit`, "\\textup": `textup` }),
    (ki = (e, t) => {
      var n = e.font;
      return n
        ? Ei[n]
          ? t.withTextFontFamily(Ei[n])
          : Di[n]
            ? t.withTextFontWeight(Di[n])
            : n === `\\emph`
              ? t.fontShape === `textit`
                ? t.withTextFontShape(`textup`)
                : t.withTextFontShape(`textit`)
              : t.withTextFontShape(Oi[n])
        : t;
    }),
    u({
      type: `text`,
      ...
      handler(e, t) {
        var { parser: n, funcName: r } = e,
          i = t[0];
        return { type: `text`, mode: n.mode, body: J(i), font: r };
      },
      htmlBuilder(e, t) {
        var n = ki(e, t);
        return G([`mord`, `text`], Y(e.body, n, !0), n);
      },
      mathmlBuilder(e, t) {
        var n = ki(e, t);
        return jn(e.body, n);
    ...
    u({
      ...
      mathmlBuilder(e, t) {
        var n = new Z(`mpadded`, [$(e.body, t)], [`vcenter`]);
        return new Z(`mrow`, [n]);
      },
    }),
    u({
      ...
      htmlBuilder(e, t) {
        for (
          var n = Ai(e), r = [], i = t.havingStyle(t.style.text()), a = 0;
          a < n.length;
          a++
        ) {
          var o = n[a];
          (o === `~` && (o = `\\textasciitilde`),
            r.push(Ht(o, `Typewriter-Regular`, e.mode, i, [`mord`, `texttt`])));
        }
        return G([`mord`, `text`].concat(i.sizingClasses(t)), qt(r), i);
      },
      mathmlBuilder(e, t) {
        var n = new Q(Ai(e)),
          r = new Z(`mtext`, [n]);
    ...
    (Ai = (e) => e.body.replace(/ /g, e.star ? `␣` : `\xA0`)),
    (ji = dn),
    (Mi = `[ \r
	]`),
    (Ni = `\\\\[a-zA-Z@]+`),
...
?)[ \r	]*`),
    ...
    (Bi = class {
      constructor(e, t) {
        ((this.input = e),
          (this.settings = t),
          (this.tokenRegex = new RegExp(zi, `g`)),
          (this.catcodes = { "%": 14, "~": 13 }));
      }
      setCatcode(e, t) {
        this.catcodes[e] = t;
      ...
      lex() {
        ...
        if (t === e.length) return new Wr(`EOF`, new Ur(this, t, t));
        var n = this.tokenRegex.exec(e);
        if (n === null || n.index !== t)
          throw new E(
            `Unexpected character: '` + e[t] + `'`,
            new Wr(e[t], new Ur(this, t, t + 1)),
          );
        var r = n[6] || n[3] || (n[2] ? `\\ ` : ` `);
...
`,
        ...
        return new Wr(r, new Ur(this, t, this.tokenRegex.lastIndex));
      }
    }),
    (Vi = class {
      constructor(e, t) {
    ...
    T(`\\char`, function (e) {
      ...
      if (t.text === `'`) ((n = 8), (t = e.popToken()));
        ...
        else if (t.text === `EOF`) throw new E("\\char` missing argument");
        else r = t.text.charCodeAt(0);
      else n = 10;
      if (n) {
        if (((r = Ui[t.text]), r == null || r >= n))
          throw new E(`Invalid base-` + n + ` digit ` + t.text);
        for (var i; (i = Ui[e.future().text]) != null && i < n;)
          ((r *= n), (r += i), e.popToken());
      }
      return `\\@char{` + r + `}`;
    }),
    (Wi = (e, t, n, r) => {
      ...
      if (((i = e.consumeArg().tokens), i.length === 1 && i[0].text === `[`)) {
        ...
        if (!c.match(/^\s*[0-9]+\s*$/))
          throw new E(`Invalid number of arguments: ` + c);
        ((s = parseInt(c)), (i = e.consumeArg().tokens));
      }
      return ((o && r) || e.macros.set(a, { tokens: i, numArgs: s }), ``);
    }),
    T(`\\newcommand`, (e) => Wi(e, !1, !0, !1)),
    T(`\\renewcommand`, (e) => Wi(e, !0, !1, !1)),
    T(`\\providecommand`, (e) => Wi(e, !0, !0, !0)),
    T(`\\message`, (e) => {
    ...
    T(`\\show`, (e) => {
      var t = e.popToken(),
        n = t.text;
      return (console.log(t, e.macros.get(n), ji[n], M.math[n], M.text[n]), ``);
    }),
    T(`\\bgroup`, `{`),
    T(`\\egroup`, `}`),
    T(`~`, `\\nobreakspace`),
    ...
    T(`\\dots`, function (e) {
      ...
      return (
        n in Gi
          ? (t = Gi[n])
          : (n.slice(0, 4) === `\\not` ||
              (n in M.math && Ki.has(M.math[n].group))) &&
            (t = `\\dotsb`),
        t
      );
    }),
    ...
    T(`\\dotso`, function (e) {
      return e.future().text in qi ? `\\ldots\\,` : `\\ldots`;
    }),
    T(`\\dotsc`, function (e) {
      var t = e.future().text;
      return t in qi && t !== `,` ? `\\ldots\\,` : `\\ldots`;
    }),
    T(`\\cdots`, function (e) {
      return e.future().text in qi ? `\\@cdots\\,` : `\\@cdots`;
    }),
    T(`\\dotsb`, `\\cdots`),
    T(`\\dotsm`, `\\cdots`),
    T(`\\dotsi`, `\\!\\cdots`),
    ...
    T(`\\tag@literal`, (e) => {
      if (e.macros.get(`\\df@tag`)) throw new E(`Multiple \\tag`);
    ...
    (Ji = j(dt[`Main-Regular`][84][1] - 0.7 * dt[`Main-Regular`][65][1])),
    T(
      `\\LaTeX`,
      `\\textrm{\\html@mathml{` +
        (`L\\kern-.36em\\raisebox{` + Ji + `}{\\scriptstyle A}`) +
        `\\kern-.15em\\TeX}{LaTeX}}`,
    ),
    T(
      `\\KaTeX`,
      `\\textrm{\\html@mathml{` +
        (`K\\kern-.17em\\raisebox{` + Ji + `}{\\scriptstyle A}`) +
        `\\kern-.15em\\TeX}{KaTeX}}`,
    ),
    ...
    (Zi = class {
      constructor(e, t, n) {
        ((this.settings = t),
          ...
          this.feed(e),
          (this.macros = new Vi(Hi, t.macros)),
          (this.mode = n),
          (this.stack = []));
      }
      feed(e) {
        this.lexer = new Bi(e, this.settings);
      }
      switchMode(e) {
        this.mode = e;
      }
      ...
      scanArgument(e) {
        ...
        return (
          this.pushToken(new Wr(`EOF`, n.loc)),
          this.pushTokens(r),
          new Wr(``, Ur.range(t, n))
        );
      }
      ...
      expandOnce(e) {
        ...
        if (r.numArgs) {
          ...
          for (var o = i.length - 1; o >= 0; --o) {
            ...
            if (s.text === `#`) {
              if (o === 0)
                throw new E(`Incomplete placeholder at end of macro body`, s);
              if (((s = i[--o]), s.text === `#`)) i.splice(o + 1, 1);
              else if (/^[1-9]$/.test(s.text)) i.splice(o, 2, ...a[s.text - 1]);
              else throw new E(`Not a valid argument number`, s);
            }
          }
        }
      ...
      expandMacro(e) {
        return this.macros.has(e) ? this.expandTokens([new Wr(e)]) : void 0;
      }
      expandTokens(e) {
        var t = [],
          n = this.stack.length;
      ...
      _getExpansion(e) {
        ...
        if (typeof r == `string`) {
          ...
          for (
            var o = new Bi(r, this.settings), s = [], c = o.lex();
            c.text !== `EOF`;
          )
            (s.push(c), (c = o.lex()));
      ...
      isDefined(e) {
        return (
          this.macros.has(e) ||
          ji.hasOwnProperty(e) ||
          M.math.hasOwnProperty(e) ||
          M.text.hasOwnProperty(e) ||
          Xi.hasOwnProperty(e)
        );
      }
      isExpandable(e) {
        var t = this.macros.get(e);
        return t == null
          ? ji.hasOwnProperty(e) && !ji[e].primitive
          : typeof t == `string` || typeof t == `function` || !t.unexpandable;
      }
    }),
    (Qi = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/),
    ($i = Object.freeze({
      "₊": `+`,
      "₋": `-`,
      "₌": `=`,
    ...
    (na = class e {
      constructor(e, t) {
        ((this.mode = `math`),
          (this.gullet = new Zi(e, t, this.mode)),
          (this.settings = t),
      ...
      parseExpression(t, n) {
        for (var r = []; ;) {
          ...
          var i = this.fetch();
          if (
            e.endOfExpression.has(i.text) ||
            (n && i.text === n) ||
            (t && ji[i.text] && ji[i.text].infix)
          )
            break;
      ...
      handleSupSubscript(e) {
        ...
        if (!r) throw new E(`Expected group after '` + n + `'`, t);
        return r;
      }
      ...
      parseAtom(e) {
        ...
        for (var n, r; ;) {
          ...
          if (i.text === `\\limits` || i.text === `\\nolimits`) {
            ...
            else throw new E(`Limit controls must follow a math operator`, i);
            this.consume();
          } else if (i.text === `^`) {
            if (n) throw new E(`Double superscript`, i);
            n = this.handleSupSubscript(`superscript`);
          } else if (i.text === `_`) {
            if (r) throw new E(`Double subscript`, i);
            ...
            var s = Qi.test(i.text),
              c = [];
            for (c.push(new Wr($i[i.text])), this.consume(); ;) {
              var l = this.fetch().text;
              if (!$i[l] || Qi.test(l) !== s) break;
              (c.unshift(new Wr($i[l])), this.consume());
            }
      ...
      parseFunction(e, t) {
        ...
        if (this.mode === `text` && !i.allowedInText)
          throw new E(`Can't use function '` + r + `' in text mode`, n);
        if (this.mode === `math` && i.allowedInMath === !1)
          throw new E(`Can't use function '` + r + `' in math mode`, n);
      ...
      parseArguments(e, t) {
        ...
        for (var r = [], i = [], a = 0; a < n; a++) {
          ...
          ((`primitive` in t && t.primitive && o == null) ||
      ...
      parseGroupOfType(e, t, n) {
        switch (t) {
          ...
          case `primitive`:
            ...
            if (a == null) throw new E(`Expected group as ` + e, this.fetch());
            return a;
          case `original`:
          case null:
          case void 0:
      ...
      parseRegexGroup(e, t) {
        ...
        if (i === ``) throw new E(`Invalid ` + t + `: '` + n.text + `'`, n);
        return n.range(r, i);
      }
      parseColorGroup(e) {
        ...
        if (!n) throw new E(`Invalid color: '` + t.text + `'`, t);
        var r = n[0];
        return (
      ...
      parseSizeGroup(e) {
        ...
        if (!r) throw new E(`Invalid size: '` + t.text + `'`, t);
        var i = { number: +(r[1] + r[2]), unit: r[3] };
        if (!Xe(i)) throw new E(`Invalid unit: '` + i.unit + `'`, t);
      ...
      parseGroup(e, t) {
        ...
        if (r === `{` || r === `\\begingroup`) {
          ...
          i == null && r[0] === `\\` && !Xi.hasOwnProperty(r))
        ) {
          if (this.settings.throwOnError)
            throw new E(`Undefined control sequence: ` + r, n);
      ...
      parseSymbol() {
        ...
        if (/^\\verb[^a-zA-Z]/.test(t)) {
          ...
          var n = t.slice(5),
            i = n.charAt(0) === `*`;
          if (
            (i && (n = n.slice(1)), n.length < 2 || n.charAt(0) !== n.slice(-1))
          )
            throw new E(`\\verb assertion failed --
                    please report what input caused this bug`);
          return (
            (n = n.slice(1, -1)),
            { type: `verb`, mode: `text`, body: n, star: i }
          );
        }
        ta.hasOwnProperty(t[0]) &&
          !M[this.mode][t[0]] &&
        ...
        if (M[this.mode][t]) {
          ...
          var s = M[this.mode][t].group,
            c = Ur.range(e),
            l;
          if (ht.hasOwnProperty(s)) {
            var u = s;
            l = { type: `atom`, mode: this.mode, family: u, loc: c, text: t };
          } else l = { type: s, mode: this.mode, loc: c, text: t };
          o = l;
          ...
          (this.settings.strict &&
            ...
            (o = { type: `textord`, mode: `text`, loc: Ur.range(e), text: t }));
        else return null;
        if ((this.consume(), a))
          for (var d = 0; d < a[0].length; d++) {
            var f = a[0][d];
            if (!ea[f]) throw new E(`Unknown accent ' ` + f + `'`, e);
            var p = ea[f][this.mode] || ea[f].text;
            if (!p)
              throw new E(
    ...
    (aa = function (e, t) {
      return ca(e, t).toMarkup();
    }),
    (oa = function (e, t) {
      return ra(e, new ge(t));
    }),
    (sa = function (e, t, n) {
      if (n.throwOnError || !(e instanceof E)) throw e;
      var r = G([`katex-error`], [new ot(t)]);
      return (
    ...
    (fa = {
      ...
      SETTINGS_SCHEMA: he,
      __parse: oa,
      __renderToDomTree: ca,
      __renderToHTMLTree: la,
      __setFontMetrics: o,
      __defineSymbol: l,
      __defineFunction: u,
      __defineMacro: T,
...
//# sourceMappingURL=katex-1Pe33z_0.js.map
