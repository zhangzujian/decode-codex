...
function De(e, t) {
  return e === `other` ? (ge(t) ? `microsoft` : `google`) : e;
}
function Oe(e, t) {
...
//# sourceMappingURL=app-initial~app-main~new-thread-panel-page~onboarding-page~select-workspace-page~login-rout~ed992cau-B_KVg5li.js.map
