...
import {
  n as Fn,
  t as In,
} from "./use-searchable-page-title-visibility-wa1HN-nr.js";
import { n as Ln, t as Rn } from "./thread-overflow-menu-CaSSV4dF.js";
function zn(e) {
  let t = (0, Hn.c)(8),
    n,
    r;
  ...
  let i;
  t[3] === n ? (i = t[4]) : ((i = a(X, n)), (t[3] = n), (t[4] = i));
  let o;
  return (
    t[5] !== r || t[6] !== i
      ? ((o = (0, Un.jsx)(x, {
...
function Bn(e) {
  ...
  return (
    t[3] === r
      ? (i = t[4])
      : ((i = (0, Un.jsx)(Be, { dateString: r })), (t[3] = r), (t[4] = i)),
    i
  );
}
function Vn(e) {
...
function Xn(e) {
  let t = (0, Qn.c)(37),
    ...
    [v, y] = (0, $n.useState)(!1),
    [b, x] = (0, $n.useState)(!1),
    S = o.gizmo.current_user_permission?.can_delete,
    C;
  t[0] !== o.gizmo.gizmo_snorlax_type || t[1] !== s || t[2] !== S
    ? ((C = Jt(S, o.gizmo.gizmo_snorlax_type, s)),
      (t[0] = o.gizmo.gizmo_snorlax_type),
      (t[1] = s),
      (t[2] = S),
      (t[3] = C))
    : (C = t[3]);
  let w = C,
    T;
  t[4] !== w || t[5] !== s
    ? ((T = w ? void 0 : vn({ action: `delete`, projectCrudStatus: s })),
      (t[4] = w),
      (t[5] = s),
      (t[6] = T))
    : (T = t[6]);
  let E = T,
    D;
  t[7] !== w || t[8] !== u || t[9] !== o.gizmo.id || t[10] !== f || t[11] !== l
    ? ((D = () => {
        w &&
          (x(!0),
          gt({
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, er.jsx)(zn, {
        children: (0, er.jsx)(Xe, { className: `icon-xs` }),
      })),
      (A = () => _(!0)),
      (t[13] = k),
      (t[14] = A))
  ...
  t[24] !== O || t[25] !== g || t[26] !== b || t[27] !== c
    ...
    : (N = t[28]);
  let P;
  t[29] !== v || t[30] !== o || t[31] !== s
    ? ((P = v
        ? (0, er.jsx)(tn, { project: o, projectCrudStatus: s, onOpenChange: y })
        : null),
      (t[29] = v),
      (t[30] = o),
      (t[31] = s),
...
function or(e, t, n) {
  ...
  return {
    ...
    sourceSearchText: e.projectKind === `local` ? qe(e).join(` `) : e.path,
  };
}
function sr(e, t, n) {
  return n.length === 0
...
function cr(e, t) {
  return t.length === 0 ? [] : e.filter((e) => ht(e.title, t));
}
function lr(e, t, n) {
  switch (n) {
    case `modified`:
...
function gr(e, t) {
  return (0, Z.jsxs)(
    `div`,
    {
      className: a(Wn, qn, `min-h-[70px] items-center py-2`),
      children: [
        (0, Z.jsx)(Mn, {
          className: `max-w-64`,
          lines: 1,
...
function Sr() {
  ...
  e[0] === c
    ? (d = e[1])
    : ((d = { conversationFilter: c }), (e[0] = c), (e[1] = d));
  let f = wt(d),
    {
      fetchNextProjectPage: p,
      hasNextProjectPage: m,
      isFetchingNextProjectPage: g,
    } = f,
    _ = i(Ae),
    b;
  e[2] !== s || e[3] !== _
    ? ((b = { enabled: s, threadKeys: _ }), (e[2] = s), (e[3] = _), (e[4] = b))
    : (b = e[4]);
  let { groups: x, isWorkspaceRootOptionsLoading: S } = r(Ve, b),
    { data: C } = ne(h.LOCAL_PROJECTS),
    w;
  e[5] !== s || e[6] !== C || e[7] !== u || e[8] !== x
    ? ((w = nr({
        groups: x,
        localProjects: C,
        showLocalProjects: s,
        showChatGptProjects: u,
      })),
      (e[5] = s),
      (e[6] = C),
      (e[7] = u),
    ...
    : (w = e[9]);
  let T = w,
    { data: E } = ne(h.THREAD_PROJECT_ASSIGNMENTS),
    D = r(je, _),
    { chatGptProjectIdByThreadKey: O } = Xt({
      localProjects: C,
      projectGroups: x,
      tasks: D,
      threadProjectAssignments: E,
    }),
    k = new Map();
  for (let [e, t] of O) {
    let n = k.get(t) ?? [];
  ...
  let [A, j] = (0, $r.useState)(`modified`),
    [M, N] = (0, $r.useState)(`descending`),
    { scrollContainerRef: P, showTitleInToolbar: F, titleRef: I } = Fn(),
    [L, R] = (0, $r.useState)(Or),
    [z, ee] = (0, $r.useState)(Dr),
    B,
    H;
  (e[10] !== f.isProjectError ||
  e[11] !== p ||
  e[12] !== m ||
  e[13] !== g ||
  e[14] !== u
    ? ((B = () => {
        u && m && !g && !f.isProjectError && p();
      }),
      (H = [p, m, g, f.isProjectError, u]),
      (e[10] = f.isProjectError),
      (e[11] = p),
      (e[12] = m),
      (e[13] = g),
    ...
    : ((B = e[15]), (H = e[16])),
    (0, $r.useEffect)(B, H));
  let U = u ? [...f.pinnedProjects, ...f.projects.map(Er)] : [],
    W;
  e[17] === n
    ? (W = e[18])
    : ((W = n.trim().toLowerCase()), (e[17] = n), (e[18] = W));
  let K = W,
    q = he(K, ni),
    J =
      u &&
      ...
      (!m || f.isProjectError),
    Y;
  e[19] === J ? (Y = e[20]) : ((Y = { enabled: J }), (e[19] = J), (e[20] = Y));
  let {
      hasError: te,
      isFetching: re,
      projectResults: ie,
    } = r(vt, { projectIds: U.map(Tr), query: q }, Y),
    ae = new Map(
      ie.map((e) => {
        let { conversations: t, projectId: n } = e;
        return [n, t.filter((e) => dt(e.conversation_origin, c))];
      }),
    ),
    oe = new Map(U.map(wr)),
    se;
  e[21] === f.pinnedProjects
    ? (se = e[22])
    : ((se = new Set(f.pinnedProjects.map(Cr))),
      (e[21] = f.pinnedProjects),
      (e[22] = se));
  let ce = se,
    le = ar({
      cloudRows: U.map((e) => ({
        ...
        localThreadKeys: s ? (k.get(e.gizmo.id) ?? []) : [],
    ...
    ue = ir({
      chatGptSearchStatus: rr({
        ...
        hasNextProjectListPage: m,
        isConversationSearchFetching: re || q !== K,
        isFetchingNextProjectListPage: g,
        isProjectListLoading: f.isProjectLoading,
        hasProjectListError: f.isProjectError,
        query: n,
        showChatGptProjects: u,
      }),
      isProjectCatalogLoading: S || (u && f.isProjectLoading),
      rowCount: le.length,
    }),
    de = !S && (!u || !f.isProjectLoading) && T.length === 0 && U.length === 0,
    fe;
  e[23] === t
    ? (fe = e[24])
    : ((fe = t.formatMessage({
  ...
  e[25] === F
    ...
    : ((me = F
      ...
      (e[26] = me));
  let ge;
  e[27] !== f.handleCreateProjectOpen ||
  e[28] !== f.projectCrudStatus ||
  e[29] !== u ||
  e[30] !== de
    ? ((ge = de
        ? null
        : (0, $.jsx)(kr, {
            compact: !0,
            chatGptProjectCrudStatus: f.projectCrudStatus,
            onCreateChatGptProject: u ? f.handleCreateProjectOpen : void 0,
            sidebarMode: u ? `chatgpt` : `codex`,
          })),
      (e[27] = f.handleCreateProjectOpen),
      (e[28] = f.projectCrudStatus),
      (e[29] = u),
  ...
  let _e;
  e[32] !== me || e[33] !== ge
    ? ((_e = (0, $.jsx)(Pt, { start: me, trailing: ge })),
      (e[32] = me),
      (e[33] = ge),
      (e[34] = _e))
    : (_e = e[34]);
  ...
  e[35] !== M || e[36] !== A
    ? ((be = (e) => {
        ...
        N(M === `ascending` ? `descending` : `ascending`);
      }),
      (e[35] = M),
      (e[36] = A),
      (e[37] = be))
  ...
  e[40] === ve
    ? (Ee = e[41])
    : ((Ee = (0, $.jsx)(We, { extension: !0, children: ve })),
      (e[40] = ve),
      (e[41] = Ee));
  let De;
  e[42] === ve
    ...
    : ((De = (0, $.jsx)(We, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, $.jsx)(V.Header, { children: ve }),
      })),
      (e[42] = ve),
      (e[43] = De));
  let Oe = kn,
    ke;
  e[44] !== n || e[45] !== pe || e[46] !== de
    ? ((ke = de
        ? void 0
        : {
            id: `projects-index-search`,
            label: pe,
            onSearchQueryChange: o,
            placeholder: pe,
            searchQuery: n,
          }),
      (e[44] = n),
                ...
                le.map((e) => {
                  ...
                  if (e.kind === `cloud`) {
                    ...
                    return n == null
                      ...
                      : (0, $.jsx)(
                          ...
                          {
                            expanded: t || r,
                            isPinned: ce.has(e.projectId),
                            onToggleExpanded: () => Ce(e.id),
                            project: n,
                            projectCrudStatus: f.projectCrudStatus,
                            row: e,
                  ...
                  return (0, $.jsx)(
                    Hr,
                    {
                      ...
                      showAll: z.has(e.projectId),
                      showLocalBadge: u,
                    },
                    e.id,
                  );
                }),
                ue == null ? null : (0, $.jsx)(mr, { status: ue }),
              ],
            }),
          ],
        }),
...
function Ar(e) {
  let t = (0, Q.c)(13),
    { active: n, children: r, className: i, direction: o, onClick: s } = e,
    c = n && `text-token-foreground`,
    l;
  t[0] !== i || t[1] !== c
    ? ((l = a(
  ...
  t[3] === r
    ? (u = t[4])
    : ((u = (0, $.jsx)(`span`, { className: `truncate`, children: r })),
      (t[3] = r),
      (t[4] = u));
  let d;
  t[5] !== n || t[6] !== o
...
function Mr(e) {
  let t = (0, Q.c)(32),
    ...
    p = r !== void 0,
    m = u != null || d != null,
    h = p && !f && `[&:has(>_[data-project-row]:hover)]:border-b-transparent`,
    g;
  t[0] === h ? (g = t[1]) : ((g = a(qn, h)), (t[0] = h), (t[1] = g));
  let _ = m && `group/project-row cursor-interaction`,
    v;
  t[2] === _
    ? (v = t[3])
    : ((v = a(
  ...
  let y;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = a(Jn, `flex min-w-0 items-center gap-3`)), (t[4] = y))
    : (y = t[4]);
  let b;
  t[5] === o
    ? (b = t[6])
  ...
  let C;
  t[12] !== b || t[13] !== S
    ? ((C = (0, $.jsxs)(`div`, { className: y, children: [b, S] })),
      (t[12] = b),
      (t[13] = S),
      (t[14] = C))
    : (C = t[14]);
  let w;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = a(Jn, `text-token-text-secondary max-[680px]:hidden`)), (t[15] = w))
    : (w = t[15]);
  let T;
  t[16] === l
    ? (T = t[17])
    : ((T = (0, $.jsx)(`div`, { className: w, children: l })),
      (t[16] = l),
      (t[17] = T));
  let E;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = a(Jn, `flex min-w-0 justify-end gap-1`)), (t[18] = E))
    : (E = t[18]);
  let D;
  t[19] === n
    ? (D = t[20])
    : ((D = (0, $.jsx)(`div`, { className: E, children: n })),
      (t[19] = n),
      (t[20] = D));
  let O;
  t[21] !== u ||
...
function Nr(e) {
  ...
  t[0] !== l || t[1] !== v || t[2] !== h
    ? ((b = (e) => {
        mt({ scope: h, isPinned: e, project: l, queryClient: v }).catch(Pr);
      }),
      (t[0] = l),
      (t[1] = v),
      (t[2] = h),
  ...
  t[8] !== g || t[9] !== s
    ...
    : (E = t[10]);
  let D = E,
    O = f.matchingThreadKeys.length > 0 || f.matchingConversations.length > 0,
    A;
  if (o) {
    let e;
    (t[11] !== i ||
    t[12] !== O ||
    t[13] !== l.gizmo.id ||
    t[14] !== f.localThreadKeys ||
    t[15] !== f.matchingConversations ||
    t[16] !== f.matchingThreadKeys ||
    t[17] !== f.name
      ? ((e = O
          ? (0, $.jsx)(Fr, {
              conversations: f.matchingConversations,
              projectName: f.name,
              threadKeys: f.matchingThreadKeys,
            })
          : (0, $.jsx)(Lr, {
              conversationFilter: i,
              localThreadKeys: f.localThreadKeys,
  ...
  t[29] === s
    ? (N = t[30])
    : ((N = s
        ? (0, $.jsx)(mn, { className: `icon-xs` })
        : (0, $.jsx)(Ft, { className: `icon-xs` })),
      (t[29] = s),
      (t[30] = N));
  let P;
  t[31] !== D || t[32] !== M || t[33] !== N
    ? ((P = (0, $.jsx)(x, {
        "aria-label": D,
        className: X,
        color: `ghostMuted`,
  ...
  t[35] === g
    ...
    : ((I = g.formatMessage({
      ...
      (t[36] = I));
  let L;
  t[37] !== _ || t[38] !== l.gizmo.id || t[39] !== f.name || t[40] !== h
    ? ((L = () => {
        (Pe(h, null),
          k(h, `chat`),
          _(`/`, {
            state: { chatGptProjectId: l.gizmo.id, chatGptProjectName: f.name },
          }));
      }),
      (t[37] = _),
      (t[38] = l.gizmo.id),
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, $.jsx)(Ut, { className: `icon-xs` })), (t[42] = R))
    : (R = t[42]);
  let z;
  t[43] !== L || t[44] !== I
    ? ((z = (0, $.jsx)(x, {
  ...
  t[49] !== w || t[50] !== g
        ...
        w == null
          ...
          : (0, $.jsx)(We, {
              ...
              children: (0, $.jsx)(x, {
                ...
                size: `icon`,
                onClick: w,
                children: (0, $.jsx)(Ut, { className: `icon-xs` }),
              }),
            })),
      (t[49] = w),
      (t[50] = g),
    ...
    : (B = t[51]);
  let V;
  t[52] !== ee || t[53] !== B || t[54] !== j || t[55] !== P
    ? ((V = (0, $.jsxs)($.Fragment, { children: [j, P, ee, B] })),
      (t[52] = ee),
      (t[53] = B),
      (t[54] = j),
      (t[55] = P),
  ...
  t[57] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, $.jsx)(Bt, { className: `icon-xs` })), (t[57] = H))
    : (H = t[57]);
  let U;
  t[58] !== l.gizmo.display.emoji || t[59] !== l.gizmo.display.theme
    ? ((U = (0, $.jsx)(Se, {
        className: `icon-xs`,
      ...
      (t[58] = l.gizmo.display.emoji),
      (t[59] = l.gizmo.display.theme),
      (t[60] = U))
    : (U = t[60]);
  let W;
  t[61] !== o || t[62] !== g || t[63] !== c || t[64] !== m
    ? ((W = m
        ? null
        : (0, $.jsx)(`button`, {
            type: `button`,
            ...
            children: (0, $.jsx)(T, {
              ...
              className: a(
                ...
                o ? `rotate-0 opacity-100` : `-rotate-90`,
              ),
            }),
          })),
      (t[61] = o),
  ...
  t[66] === f.modifiedAt
    ? (G = t[67])
    : ((G = (0, $.jsx)(Bn, { modifiedAt: f.modifiedAt })),
      (t[66] = f.modifiedAt),
      (t[67] = G));
  let K;
  t[68] !== c || t[69] !== m
    ? ((K = m
        ? void 0
        : (e) => {
            e.defaultPrevented || e.detail > 1 || fr(e.target) || c();
          }),
      (t[68] = c),
      (t[69] = m),
      (t[70] = K))
...
function Lr(e) {
  let t = (0, Q.c)(24),
    ...
    _;
  if (t[0] !== r || t[1] !== l?.pages || t[2] !== p || t[3] !== g) {
    let e = l?.pages.flatMap(zr).filter((e) => dt(e.conversation_origin, r));
    if (g) {
      let e;
    ...
    ((t[0] = r), (t[1] = l?.pages), (t[2] = p), (t[3] = g), (t[4] = _));
  } else _ = t[4];
  let b;
  t[8] !== c || t[9] !== o
    ? ((b = c.formatMessage(
...
function Vr(e) {
  ...
  let l = c,
    u;
  t[2] !== r.create_time || t[3] !== r.update_time
    ? ((u = St({ createTime: r.create_time, updateTime: r.update_time })),
      (t[2] = r.create_time),
      (t[3] = r.update_time),
      (t[4] = u))
    : (u = t[4]);
  ...
  t[9] === m
    ? (g = t[10])
    : ((g = (e) => {
        e.defaultPrevented || fr(e.target) || m();
      }),
      (t[9] = m),
      (t[10] = g));
  let _, b;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = a(Jn, `flex min-w-0 items-center gap-3`)),
      (b = (0, $.jsx)(`span`, { className: `w-4 shrink-0` })),
      (t[11] = _),
      (t[12] = b))
    : ((_ = t[11]), (b = t[12]));
  let S;
  t[13] === l
    ...
    : ((S = (0, $.jsxs)(`div`, {
        ...
        children: [
          b,
          (0, $.jsx)(`span`, { className: `min-w-0 truncate`, children: l }),
        ],
      })),
      (t[13] = l),
      (t[14] = S));
  let C;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = a(Jn, `text-token-text-secondary max-[680px]:hidden`)), (t[15] = C))
    : (C = t[15]);
  let w;
  t[16] === f
    ? (w = t[17])
    : ((w = (0, $.jsx)(`span`, {
        className: C,
        children: (0, $.jsx)(Bn, { modifiedAt: f }),
      })),
      (t[16] = f),
      (t[17] = w));
  let T;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = a(Jn, `flex min-w-0 justify-end gap-1`)), (t[18] = T))
    : (T = t[18]);
  let E;
  t[19] !== r.is_starred || t[20] !== o
    ? ((E = o.formatMessage(r.is_starred === !0 ? Wt : Kt)),
      (t[19] = r.is_starred),
      (t[20] = o),
      (t[21] = E))
    : (E = t[21]);
  ...
  t[23] !== r || t[24] !== i
    ? ((k = () => {
        _t({ scope: i, conversation: r, isPinned: r.is_starred !== !0 });
      }),
      (t[23] = r),
      (t[24] = i),
      (t[25] = k))
  ...
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, $.jsx)(D, { className: `icon-xs` })), (t[35] = P))
    : (P = t[35]);
  let F;
  t[36] !== m || t[37] !== M
    ? ((F = (0, $.jsx)(x, {
  ...
  let I;
  t[39] !== j || t[40] !== F
    ? ((I = (0, $.jsxs)(`span`, { className: T, children: [j, F] })),
      (t[39] = j),
      (t[40] = F),
      (t[41] = I))
    : (I = t[41]);
...
function Hr(e) {
  let t = (0, Q.c)(87),
    ...
    m = gn(),
    g = ee(Te),
    { data: _ } = ne(h.PINNED_PROJECT_IDS),
    b;
  t[0] !== _ || t[1] !== s.group.projectId
    ? ((b = _?.includes(s.group.projectId)),
      (t[0] = _),
  ...
  t[3] === s.group
    ? (C = t[4])
    : ((C = s.group.projectKind === `local` ? qe(s.group) : []),
      (t[3] = s.group),
      (t[4] = C));
  let w = C,
    E;
  t[5] !== g || t[6] !== s.group
    ? ((E = s.group.projectKind === `local` && g && En(s.group)),
      (t[5] = g),
      (t[6] = s.group),
      (t[7] = E))
    : (E = t[7]);
  ...
  t[10] !== s.group || t[11] !== m
    ? ((A = (e) => {
        e.defaultPrevented || fr(e.target) || m(s.group);
      }),
      (t[10] = s.group),
      (t[11] = m),
      (t[12] = A))
  ...
  let M = A,
    N;
  t[13] !== D || t[14] !== w || t[15] !== s
    ? ((N = (0, $.jsx)(Yr, {
        canEditMetadataProject: D,
        initialSources: w,
        row: s,
      })),
      (t[13] = D),
  ...
  t[17] !== p || t[18] !== S
    ...
    : (F = t[19]);
  let I;
  t[20] !== _ || t[21] !== s.group.projectId || t[22] !== f
    ? ((I = () => {
        j(f, h.PINNED_PROJECT_IDS, Zr(_, s.group.projectId));
      }),
      (t[20] = _),
      (t[21] = s.group.projectId),
      (t[22] = f),
      (t[23] = I))
    : (I = t[23]);
  let L;
  ...
  let B;
  t[32] !== s.group || t[33] !== m
    ? ((B = () => m(s.group)), (t[32] = s.group), (t[33] = m), (t[34] = B))
    : (B = t[34]);
  let V;
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, $.jsx)(Ut, { className: `icon-xs` })), (t[35] = V))
    : (V = t[35]);
  let H;
  t[36] !== z || t[37] !== B
    ? ((H = (0, $.jsx)(x, {
    ...
    : (H = t[38]);
  let U;
  t[39] !== R || t[40] !== H || t[41] !== N
    ? ((U = (0, $.jsxs)($.Fragment, { children: [N, R, H] })),
      (t[39] = R),
      (t[40] = H),
      (t[41] = N),
      (t[42] = U))
  ...
  t[44] !== p ||
  t[45] !== i ||
  t[46] !== s.matchingThreadKeys ||
  t[47] !== s.name ||
  t[48] !== s.recentThreadKeys ||
  t[49] !== l
    ? ((W = r
        ? (0, $.jsx)(`div`, {
            className: `pb-3`,
            children: (0, $.jsx)(un, {
              ...
              threadKeys:
                s.matchingThreadKeys.length > 0
                  ? s.matchingThreadKeys
                  : s.recentThreadKeys,
            }),
          })
        : null),
    ...
    : (W = t[50]);
  let G;
  t[51] !== r || t[52] !== s.group.hostId || t[53] !== s.group.projectKind
    ? ((G =
        s.group.projectKind === `remote`
          ? (0, $.jsx)(Lt, {
              className: `icon-xs shrink-0`,
              remoteHostId: s.group.hostId,
              isRemoteProject: !0,
            })
          : r
            ? (0, $.jsx)($t, { className: `icon-xs shrink-0` })
            : (0, $.jsx)(Bt, { className: `icon-xs shrink-0` })),
      (t[51] = r),
      (t[52] = s.group.hostId),
      (t[53] = s.group.projectKind),
      (t[54] = G))
    : (G = t[54]);
  let K;
  t[55] !== s.group.projectId || t[56] !== s.name || t[57] !== G
    ? ((K = (0, $.jsx)(le, {
      ...
      (t[55] = s.group.projectId),
      (t[56] = s.name),
      (t[57] = G),
      (t[58] = K))
    : (K = t[58]);
  let q;
  t[59] !== p || t[60] !== s.group.projectKind || t[61] !== u
    ? ((q =
        u && s.group.projectKind === `local`
          ? (0, $.jsx)(P, {
          ...
          : null),
      (t[59] = p),
      (t[60] = s.group.projectKind),
      (t[61] = u),
      (t[62] = q))
    : (q = t[62]);
  let J;
  t[63] !== s.group.hostId || t[64] !== s.group.projectKind
    ? ((J =
        s.group.projectKind === `remote` && s.group.hostId != null
          ? (0, $.jsx)(Ur, { hostId: s.group.hostId })
          : null),
      (t[63] = s.group.hostId),
      (t[64] = s.group.projectKind),
      (t[65] = J))
    : (J = t[65]);
  let Y;
  t[66] !== r || t[67] !== p || t[68] !== o || t[69] !== c
    ? ((Y = c
        ? null
        : (0, $.jsx)(`button`, {
            type: `button`,
            ...
            children: (0, $.jsx)(T, {
              ...
              className: a(
                `icon-xs shrink-0 text-token-text-secondary opacity-0 transition-transform group-hover/project-row:opacity-100 group-focus-visible/project-toggle:opacity-100`,
                r ? `rotate-0 opacity-100` : `-rotate-90`,
              ),
            }),
          })),
      (t[66] = r),
    ...
    : (Y = t[70]);
  let te;
  t[71] !== q || t[72] !== J || t[73] !== Y
    ? ((te = (0, $.jsxs)($.Fragment, { children: [q, J, Y] })),
      (t[71] = q),
      (t[72] = J),
      (t[73] = Y),
      (t[74] = te))
  ...
  t[75] === s.modifiedAt
    ? (re = t[76])
    : ((re = (0, $.jsx)(Bn, { modifiedAt: s.modifiedAt })),
      (t[75] = s.modifiedAt),
      (t[76] = re));
  let ie = c ? void 0 : k,
    ae;
...
function Ur(e) {
  ...
  return (
    t[0] === n
      ? (i = t[1])
      : ((i = (0, $.jsx)(Ht, { hostId: n })), (t[0] = n), (t[1] = i)),
    i
  );
}
function Wr(e) {
  let t = (0, Q.c)(55),
    { children: i, className: o, threadKey: s } = e,
    c = n(d),
    l = y(),
    u = Y(),
    f = ot(),
  ...
  let M;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = a(Jn, `flex min-w-0 items-center gap-3`)), (t[15] = M))
    : (M = t[15]);
  let N = p ?? null,
    P;
  t[16] !== m || t[17] !== N
    ? ((P = (0, $.jsx)(Gr, { entry: N, localConversationId: m })),
      (t[16] = m),
      (t[17] = N),
      (t[18] = P))
    : (P = t[18]);
  ...
  t[19] === i
    ? (F = t[20])
    : ((F = (0, $.jsx)(`div`, { className: `min-w-0 flex-1`, children: i })),
      (t[19] = i),
      (t[20] = F));
  let I;
  t[21] !== P || t[22] !== F
  ...
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = a(Jn, `text-token-text-secondary max-[680px]:hidden`)), (t[24] = L))
    : (L = t[24]);
  let R;
  t[25] === b
    ? (R = t[26])
    : ((R = b == null ? null : (0, $.jsx)(Bn, { modifiedAt: b })),
      (t[25] = b),
      (t[26] = R));
  let z;
  t[27] === R
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = a(Jn, `flex min-w-0 justify-end gap-1`)), (t[29] = ee))
    : (ee = t[29]);
  let B = p ?? null,
    V;
  t[30] !== C || t[31] !== B
    ? ((V = (0, $.jsx)(Kr, { entry: B, onOpenThread: C })),
      (t[30] = C),
      (t[31] = B),
      (t[32] = V))
    : (V = t[32]);
  let H;
  t[33] !== v || t[34] !== g || t[35] !== A || t[36] !== O
    ? ((H = v
        ? (0, $.jsx)(x, {
            "aria-label": A,
            className: a(
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, $.jsx)(D, { className: `icon-xs` })), (t[41] = K))
    : (K = t[41]);
  let q;
  t[42] !== C || t[43] !== U
    ? ((q = (0, $.jsx)(x, {
    ...
    : (q = t[44]);
  let J;
  t[45] !== V || t[46] !== H || t[47] !== q
    ? ((J = (0, $.jsxs)(`span`, { className: ee, children: [V, H, q] })),
      (t[45] = V),
      (t[46] = H),
      (t[47] = q),
      (t[48] = J))
  ...
  let te;
  return (
    t[49] !== T || t[50] !== I || t[51] !== z || t[52] !== J || t[53] !== j
      ? ((te = (0, $.jsxs)(`div`, {
          className: j,
          onClick: T,
          children: [I, z, J],
...
function Gr(e) {
  let t = (0, Q.c)(12),
    { entry: n, localConversationId: i } = e,
    a = r(xn, i),
    o = n?.kind === `remote` ? n : null,
    s;
  t[0] === o ? (s = t[1]) : ((s = ln(o)), (t[0] = o), (t[1] = s));
  let c = r(Cn, s),
    l = r(Ie, i),
    u = r(Me, i),
    d = r(U, i),
...
function qr(e) {
  ...
  let u;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(Xe, { className: `icon-xs` })), (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== s || t[6] !== l
    ? ((d = (0, $.jsx)(x, {
  ...
  t[11] === f
    ? (m = t[12])
    : ((m = (0, $.jsx)(Et.Item, { LeftIcon: D, onSelect: f, children: p })),
      (t[11] = f),
      (t[12] = m));
  let h;
  return (
    t[13] !== i || t[14] !== d || t[15] !== m
      ? ((h = (0, $.jsx)(Ot, {
          align: `end`,
          contentWidth: `xs`,
          open: i,
...
function Jr(e) {
  let t = (0, Q.c)(6),
    { entry: n } = e,
    i = n.conversationId,
    o = r(Ee, i) ?? n.summary?.title ?? null,
    s = n.cwd,
    c = n.workspaceKind === `projectless`,
    l;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = a(
        X,
...
function Yr(e) {
  let t = (0, Q.c)(51),
    { canEditMetadataProject: i, initialSources: a, row: o } = e,
    s = n(d),
    c = y(),
    l = r(Oe, o.group.threadKeys),
    u;
  t[0] === l ? (u = t[1]) : ((u = ae(l)), (t[0] = l), (t[1] = u));
  let f = u,
    p = (0, $r.useRef)(null),
    [m, h] = (0, $r.useState)(!1),
    [g, _] = (0, $r.useState)(!1),
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, $.jsx)(Xe, { className: `icon-xs` })), (t[9] = E))
    : (E = t[9]);
  let D;
  t[10] === T
    ? (D = t[11])
  ...
  t[31] !== k
    ...
    : (F = t[32]);
  let I;
  t[33] !== g || t[34] !== o.group.threadKeys || t[35] !== o.name
    ? ((I = g
        ? (0, $.jsx)(pe, {
            projectLabel: o.name,
        ...
        : null),
      (t[33] = g),
      (t[34] = o.group.threadKeys),
      (t[35] = o.name),
      (t[36] = I))
    : (I = t[36]);
  let L;
  t[37] !== b || t[38] !== o.group || t[39] !== o.name
    ? ((L =
        b && o.group.projectKind === `local`
          ? (0, $.jsx)(ce, {
              project: o.group,
              projectLabel: o.name,
              onOpenChange: S,
  ...
  let R;
  t[41] !== b ||
  t[42] !== o.group.projectId ||
  t[43] !== o.group.projectKind ||
  t[44] !== o.name
    ? ((R =
        b && o.group.projectKind === `remote`
          ? (0, $.jsx)(fe, {
  ...
  let z;
  return (
    t[46] !== F || t[47] !== I || t[48] !== L || t[49] !== R
      ? ((z = (0, $.jsxs)($.Fragment, { children: [F, I, L, R] })),
        (t[46] = F),
        (t[47] = I),
        (t[48] = L),
        (t[49] = R),
...
function Qr(e) {
  return {
    projectId: e.projectId,
    ...(e.projectKind === `local` ? { rootPaths: qe(e) } : {}),
  };
}
var Q, $r, $, ei, ti, ni;
e(() => {
...
//# sourceMappingURL=projects-index-page-LymLr4qx.js.map
