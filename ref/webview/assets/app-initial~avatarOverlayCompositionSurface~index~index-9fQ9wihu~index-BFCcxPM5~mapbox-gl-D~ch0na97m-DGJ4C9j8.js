    ...
    ((t = `modulepreload`),
      ...
      (i = function (e, i, a) {
        ...
        if (i && i.length > 0) {
          ...
          o = l(
            i.map((i) => {
              if (((i = n(i, a)), (i = u(i)), i in r)) return;
              r[i] = !0;
              let o = i.endsWith(`.css`);
              for (let t = e.length - 1; t >= 0; t--) {
                let n = e[t];
                if (n.href === i && (!o || n.rel === `stylesheet`)) return;
              }
              let s = document.createElement(`link`);
              if (
                ((s.rel = o ? `stylesheet` : t),
                o || (s.as = `script`),
                (s.crossOrigin = ``),
                (s.href = i),
  ...
  let n = typeof e == `string` ? e : e.source,
    r = {
      replace: (e, t) => {
        ...
        return ((i = i.replace(_.caret, `$1`)), (n = n.replace(e, i)), r);
      },
...
function l(e, t) {
  if (t) {
    if (_.escapeTest.test(e)) return e.replace(_.escapeReplace, G);
  } else if (_.escapeTestNoEncode.test(e))
    return e.replace(_.escapeReplaceNoEncode, G);
  return e;
}
function u(e) {
  try {
    e = encodeURI(e).replace(_.percentDecode, `%`);
  } catch {
    return null;
  }
  return e;
...
var h,
  ...
  Pe = e(() => {
    ((h = o()),
      ...
      (N = /[^\s\p{P}\p{S}]/u),
      (he = c(/^((?![*_])punctSpace)/, `u`)
        .replace(/punctSpace/g, M)
        .getRegex()),
      (P = /(?!~)[\p{P}\p{S}]/u),
      (ge = /(?!~)[\s\p{P}\p{S}]/u),
      (_e = /(?:[^\s\p{P}\p{S}]|~)/u),
      (ve = c(/link|code|html/, `g`)
        .replace(
          `link`,
          /\[(?:[^\[\]`]|(?<!`)(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/,
        )
        ...
        .replace(`html`, /<(?! )[^<>]*?>/)
        .getRegex()),
      (F = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/),
      (ye = c(F, `u`).replace(/punct/g, j).getRegex()),
      (be = c(F, `u`).replace(/punct/g, P).getRegex()),
      ...
      (z = c(/^!?\[(ref)\](?:\[\])?/)
        .replace(`ref`, w)
        .getRegex()),
      (ke = c(`reflink|nolink(?!\\()`, `g`)
        .replace(`reflink`, R)
        .replace(`nolink`, z)
        .getRegex()),
      (B = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/),
      (V = {
        _backpedal: g,
        anyPunctuation: we,
        autolink: Te,
      ...
      (H = {
        ...
        emStrongLDelim: be,
        url: c(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/)
          .replace(`protocol`, B)
          .replace(
            `email`,
      ...
      (je = {
        ...H,
        br: c(A).replace(`{2,}`, `*`).getRegex(),
        text: c(H.text)
          .replace(`\\b_`, `\\b_| {2,}\\n`)
          .replace(/\{2,\}/g, `*`)
          .getRegex(),
      }),
      (U = { normal: O, gfm: ue, pedantic: de }),
      (W = { normal: V, gfm: H, breaks: je, pedantic: Ae }),
      (Me = {
        "&": `&amp;`,
        "<": `&lt;`,
        ">": `&gt;`,
...
`
      ...
      (q = class e {
        ...
        constructor(e) {
          ...
          let t = { other: _, block: U.normal, inline: W.normal };
          (this.options.pedantic
            ? ((t.block = U.pedantic), (t.inline = W.pedantic))
            : this.options.gfm &&
              ((t.block = U.gfm),
              this.options.breaks ? (t.inline = W.breaks) : (t.inline = W.gfm)),
            (this.tokenizer.rules = t));
        }
        static get rules() {
          return { block: U, inline: W };
        }
        static lex(t, n) {
...
`,
        ...
        blockTokens(e, t = [], n = !1) {
          for (
            this.options.pedantic &&
            (e = e.replace(_.tabCharGlobal, `    `).replace(_.spaceLine, ``));
            e;
          ) {
            let r;
            if (
...
` + r.text),
      ...
      (J = class {
        ...
        code({ text: e, lang: t, escaped: n }) {
          let r = (t || ``).match(_.notSpaceStart)?.[0],
            i =
              e.replace(_.endingNewline, ``) +
              `
`;
          return r
...
`
        ...
        image({ href: e, title: t, text: n, tokens: r }) {
          ...
          let i = u(e);
          if (i === null) return l(n);
          e = i;
          let a = `<img src="${e}" alt="${n}"`;
          return (t && (a += ` title="${l(t)}"`), (a += `>`), a);
        }
        text(e) {
                ...
                for (let n in e.hooks) {
                  ...
                  Z.passThroughHooks.has(n)
                    ? (t[r] = (e) => {
                        if (
                          this.defaults.async &&
                          Z.passThroughHooksRespectAsync.has(n)
                        )
                          return (async () => {
        ...
        parseMarkdown(e) {
          return (t, n) => {
            ...
            try {
              ...
              let n = (
                i.hooks ? i.hooks.provideLexer() : e ? q.lex : q.lexInline
              )(t, i);
              (i.hooks && (n = i.hooks.processAllTokens(n)),
                i.walkTokens && this.walkTokens(n, i.walkTokens));
              let r = (
                i.hooks ? i.hooks.provideParser() : e ? X.parse : X.parseInline
              )(n, i);
...
Please report this to https://github.com/markedjs/marked.`),
      ...
      (m.options = m.setOptions =
        function (e) {
          return ($.setOptions(e), (m.defaults = $.defaults), s(m.defaults), m);
        }),
      (m.getDefaults = o),
      (m.defaults = h),
      (m.use = function (...e) {
        return ($.use(...e), (m.defaults = $.defaults), s(m.defaults), m);
      }),
      (m.walkTokens = function (e, t) {
        return $.walkTokens(e, t);
      }),
      (m.parseInline = $.parseInline),
      (m.Parser = X),
      (m.parser = X.parse),
      (m.Renderer = J),
      (m.TextRenderer = Y),
...
export { q as a, m as i, Ne as n, i as o, Pe as r, a as s, Q as t };
//# sourceMappingURL=app-initial~avatarOverlayCompositionSurface~index~index-9fQ9wihu~index-BFCcxPM5~mapbox-gl-D~ch0na97m-DGJ4C9j8.js.map
