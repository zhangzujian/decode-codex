...
function Dt(e) {
  ...
  let { availablePlugins: le, installedPlugins: ue } = Ee(de, void 0, se),
    fe;
  t[8] !== le || t[9] !== ue
  ...
  let O = ye,
    we = r(Me),
    { trimmedName: k, trimmedPrompt: De, canSave: A } = Ie(D),
    j = Fe(D),
    M =
      D.id != null && A && j != null && D.status !== `DELETED`
        ? Re({ draft: D, name: k, prompt: De, status: D.status, rrule: j })
        : null,
    N = je(M, 600),
    Ae;
  t[22] !== E || t[23] !== M
  ...
  t[76] !== M
    ? ((G = (e) => {
        if ((e.preventDefault(), !(l.type !== `proposal` || !A || j == null))) {
          ...
          Ve.mutate(Je({ draft: D, name: k, prompt: De, rrule: j }));
        }
      }),
      (t[68] = A),
      (t[69] = Ve),
...
//# sourceMappingURL=app-initial~app-main~new-thread-panel-page~onboarding-page~projects-index-page~appgen-libra~ke3j1rk8-C85LpMzh.js.map
