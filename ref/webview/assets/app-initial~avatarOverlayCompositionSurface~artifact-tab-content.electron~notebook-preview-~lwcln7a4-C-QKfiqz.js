...
function Ge(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, J.jsx)(Ae, { className: `sr-only`, children: m })),
      (b = (0, J.jsx)(ke, { className: `sr-only`, children: g })),
      (t[15] = y),
      (t[16] = b))
    : ((y = t[15]), (b = t[16]));
  let x;
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, J.jsx)(I, {
        children: (0, J.jsx)(je, { title: m, subtitle: g }),
      })),
      (t[17] = x))
    : (x = t[17]);
  let S;
  ...
  t[24] === T
    ? (D = t[25])
    : ((D = (0, J.jsx)(I, { children: (0, J.jsxs)(Pe, { children: [T, E] }) })),
      (t[24] = T),
      (t[25] = D));
  let O;
...
//# sourceMappingURL=app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~lwcln7a4-C-QKfiqz.js.map
