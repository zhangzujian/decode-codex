...
import { Dt as M, Et as oe } from "./workbook-DEnJtw6Z.js";
import {
  $ as se,
  B as ce,
  F as le,
...
function xe(e) {
  ...
  function _e() {
    ...
    if (!((de && !ee(A)) || !l) && (N || me))
      return k.Transition.toString({ ...l, property: je });
  }
}
function Se(e, t) {
...
function ot({
  ...
  return (0, R.jsx)(`div`, {
    "data-testid": s,
    className: x(`pointer-events-none absolute box-border`),
    style: {
      left: e.left,
      top: e.top,
      width: e.width,
      ...
      (gn = (0, H.forwardRef)(function (
        {
          ...
          mode: d = `create`,
          onDelete: m,
          testId: h = `popcorn-annotation-editor`,
        },
        g,
      ) {
        let _ = (0, H.useRef)(null),
          v = (0, H.useRef)(null),
          y = (0, H.useRef)(null),
          b = (0, H.useRef)(null),
          [S, C] = (0, H.useState)(!1),
          ...
          ce = (0, H.useCallback)(
            (e) => {
              if (((_.current = e), j.setFloating(e), typeof g == `function`)) {
                g(e);
                return;
              }
              g && (g.current = e);
        ...
        if (
          ...
          (0, H.useEffect)(() => {
            e && ae?.();
          }, [e?.height, e?.left, e?.top, e?.width, a, S, ae]),
          !e)
        )
          return null;
        let N = (0, U.jsx)(`div`, {
          ...
          style: { position: ie, left: ne ?? 0, top: oe ?? 0, width: Wt },
          onMouseDown: (e) => {
            e.stopPropagation();
          },
          children: (0, U.jsx)(`form`, {
            ...
            style: $t,
            onSubmit: (e) => {
              (e.preventDefault(), D && u(E ? `saved` : `direct`, `button`));
            },
        ...
        return r ? (0, Ut.createPortal)(N, r) : N;
      })));
  });
function vn(e, t, n) {
...
function Wn({ trigger: e, actions: t }) {
  return (0, q.jsxs)(g, {
    children: [
      (0, q.jsx)(C, { asChild: !0, children: e }),
      (0, q.jsx)(w, {
        children: (0, q.jsx)(T, {
...
function sr({ open: e, onOpenChange: t, trigger: n, children: r }) {
  return (0, X.jsxs)(s, {
    ...
    onOpenChange: t,
    children: [
      (0, X.jsx)(u, { asChild: !0, children: n }),
      (0, X.jsx)(a, {
        children: (0, X.jsx)(m, {
          side: `bottom`,
          align: `end`,
...
function fr({
  ...
  let E = n === `resolved` ? [r, ar(i)].filter(Boolean).join(` · `) : null;
  return (0, X.jsxs)(`div`, {
        ...
        children: [
          (0, X.jsxs)(`div`, {
            ...
            children: [
              ...
              E
                ? (0, X.jsx)(`div`, {
                    className: x(`text-token-description-foreground mt-1`, gr),
                    children: E,
                  })
                : null,
            ],
...
//# sourceMappingURL=popcorn-electron-surface-style-BB0OSEGB.js.map
