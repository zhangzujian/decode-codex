...
import { t as m } from "./chunk-426QAEUC-1bgO4oZ-.js";
import { t as h } from "./chunk-4BX2VUAB-CJOAReEH.js";
var g = d.packet,
  _ = class {
    constructor() {
      ((this.packet = []),
  ...
  S = t((e, t, n, r) => {
    let i = r.db,
      ...
      f = i.getDiagramTitle(),
      p = o + s,
      h = p * (d.length + 1) - (f ? 0 : o),
      g = c * l + 2,
      _ = m(t);
    (_.attr(`viewBox`, `0 0 ${g} ${h}`), u(_, h, g, a.useMaxWidth));
...
export { E as diagram };
//# sourceMappingURL=diagram-TYMM5635-CbMAhKlk.js.map
