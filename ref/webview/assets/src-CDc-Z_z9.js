...
function f(e, t, n, i) {
  ...
  function o(e, i, a, o, s, c) {
    if (e !== a || i !== o) {
      ...
      c.push({ i: l - 4, x: r(e, a) }, { i: l - 2, x: r(i, o) });
    } else (a || o) && s.push(`translate(` + a + t + o + n);
  }
  function s(e, t, n, o) {
    e === t
      ? t && n.push(a(n) + `rotate(` + t + i)
      : (e - t > 180 ? (t += 360) : t - e > 180 && (e += 360),
        o.push({ i: n.push(a(n) + `rotate(`, null, i) - 2, x: r(e, t) }));
  }
  function c(e, t, n, o) {
    e === t
      ? t && n.push(a(n) + `skewX(` + t + i)
      : o.push({ i: n.push(a(n) + `skewX(`, null, i) - 2, x: r(e, t) });
  }
  function l(e, t, n, i, o, s) {
    if (e !== n || t !== i) {
      var c = o.push(a(o) + `scale(`, null, `,`, null, `)`);
      s.push({ i: c - 4, x: r(e, n) }, { i: c - 2, x: r(t, i) });
    } else (n !== 1 || i !== 1) && o.push(a(o) + `scale(` + n + `,` + i + `)`);
  }
  return function (t, n) {
    var r = [],
      i = [];
...
//# sourceMappingURL=src-CDc-Z_z9.js.map
