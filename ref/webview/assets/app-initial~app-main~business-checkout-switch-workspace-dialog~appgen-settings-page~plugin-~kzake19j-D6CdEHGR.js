...
import { y as p } from "./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~appgen-settings-p~dl1mfg21-CewNvCnh.js";
function m(e) {
  let t = (0, h.c)(4),
    { onPaint: n } = e,
    r = c(n),
            ...
            document.visibilityState !== `visible` ||
              ...
              (t = window.requestAnimationFrame(() => {
                n = window.requestAnimationFrame(() => {
                  (document.removeEventListener(`visibilitychange`, i), r());
                });
              }));
          };
        return (
  ...
  return (
    t[2] === a
      ? (o = t[3])
      : ((o = (0, g.jsx)(`span`, { ref: a, className: `hidden` })),
        (t[2] = a),
        (t[3] = o)),
    o
  );
...
function b({
  availableAccessModes: e,
  currentAccessMode: t,
  isWorkspaceAccount: n,
}) {
  let r = e ?? (n ? [`workspace_all`, `custom`] : []),
    i = r.map((e) => ({ disabled: !1, value: e }));
  return r.some((e) => e === t) ? i : [...i, { disabled: !0, value: t }];
}
function x({
  accessGroups: e,
  accessMode: t,
...
function S(e) {
  return e == null
    ...
    : {
        ...
        groupCount:
          e.allowed_tenant_group_ids.length +
          e.allowed_workspace_group_ids.length,
        userCount: Math.max(e.allowed_account_user_ids.length - 1, 0),
      };
}
function C({ accessMode: e, groupCount: t, userCount: n }) {
  return (e === `admins_only` || e === `custom`) && t === 0 && n === 0;
}
function w(e) {
  return (0, k.default)(e.flatMap((e) => (e == null ? [] : [e])));
}
function T(e, t) {
  return {
...
function E({
  ...
  return {
    ...
    allowed_user_emails: w(t.allowed_users.map((e) => e.email)),
    ...D({
      accessGroups: e,
      knownAccessGroups: r,
...
function D({
  ...
  return {
    ...(u
      ? {
          allowed_workspace_group_ids: O(
            c.filter((e) => e.source === `workspace`),
          ),
        }
      : {}),
    ...(d
      ? { allowed_tenant_group_ids: O(c.filter((e) => e.source === `tenant`)) }
      : {}),
  };
}
function O(e) {
...
function U(e) {
  ...
  t[0] === e
    ? ((n = t[1]), (r = t[2]))
    : (({ accessPolicy: n, ...r } = e), (t[0] = e), (t[1] = n), (t[2] = r));
  let i;
  if (t[3] !== n || t[4] !== r) {
    ...
    bb0: {
      ...
      switch (e.accessMode) {
        case `admins_only`:
        case `custom`:
          i = C(e) ? (0, G.jsx)(l, { ...r }) : (0, G.jsx)(V, { ...r });
          break bb0;
        case `workspace_all`: {
          let e;
          (t[6] === r
            ? (e = t[7])
            : ((e = (0, G.jsx)(R, { ...r })), (t[6] = r), (t[7] = e)),
            (i = e));
          break bb0;
        }
        case `public`: {
...
function X(e) {
  if (C(e)) return `owner_only`;
  let { accessMode: t, groupCount: n, userCount: r } = e;
  switch (t) {
    case `admins_only`:
    case `custom`:
      return r > 0 && n > 0
    ...
    (o(),
      ...
      (Z = a({
        groups: {
          ...
          defaultMessage: `Visible to {groupCount, plural, one {# group} other {# groups}}`,
        ...
        people: {
          ...
          defaultMessage: `Visible to {userCount, plural, one {# person} other {# people}}`,
      ...
      (Q = a({
        ...
        owner_only: {
          ...
          description: `Concise label for a site whose access is limited to its owner`,
        },
        people: {
      ...
      ($ = a({
        groups: {
          ...
          defaultMessage: `This site is visible to {groupCount, plural, one {# group} other {# groups}}`,
        ...
        people: {
          ...
          defaultMessage: `This site is visible to {userCount, plural, one {# person} other {# people}}`,
...
//# sourceMappingURL=app-initial~app-main~business-checkout-switch-workspace-dialog~appgen-settings-page~plugin-~kzake19j-D6CdEHGR.js.map
