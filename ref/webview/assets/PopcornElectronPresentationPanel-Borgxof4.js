...
import { o, s } from "./workbook-DKSWaiU4.js";
import {
  $ as c,
  A as l,
  C as u,
...
import { n as D, t as O } from "./PopcornPageNumberNavigation-D9qqIDvg.js";
import {
  _ as k,
  a as A,
  d as pe,
...
import { n as be, t as j } from "./modifiers.esm-zIQANv9s.js";
import {
  $ as xe,
  A as Se,
  B as Ce,
  ...
  y as pt,
  yt as mt,
} from "./popcorn-electron-surface-style-CiOMuzDt.js";
function ht() {
  return (
    (gt ??= Promise.all([
      E(),
...
function Lt() {
  return new Worker(
    new URL(
      `` + new URL(`runtime.worker-D7RtzcHO.js`, import.meta.url).href,
      `` + import.meta.url,
    ),
...
var qt,
  ...
  Yt = e(() => {
    (h(),
      ...
      (Jt = class {
        id = qt++;
        #e = b(`presentation-main-controller`);
        #t = Vt();
        #n = new Set();
        #r = new Set();
        #i = [];
        ...
        #C(e) {
          switch (e.kind) {
            ...
            case `inspector`:
              ...
              return;
            case `debug-log`:
              b(e.namespace).debug(e.message, e.details);
              return;
            default:
              return e;
          }
...
function fn(e) {
  let t = on({
    ...
    n = M(e.camera, e.viewportX, e.viewportY);
        ...
        return (0, qn.jsx)(
          Ve,
          {
            ...
            trigger: (0, qn.jsx)(`button`, {
              ...
              children: (0, qn.jsx)(fe, { className: `size-4` }),
            }),
            content: (0, qn.jsx)(pt, {
              targetPrimaryLabel: h,
              targetSecondaryLabel: ee,
              status: e.status,
...
function yr({
  ...
  commentThreadsEnabled: g = !0,
  annotationPortalContainerElement: ne = null,
}) {
  let re = jn(e),
    _ = r ?? re,
    ie = (0, X.useRef)(null),
    ...
    D = ee && m?.annotation != null && m.annotation.enabled !== !1,
    O = te && m?.drawing != null && m.drawing.enabled !== !1,
  ...
  let ge = (0, X.useRef)(null),
    _e = (0, X.useRef)(!1),
    [ve, ye] = (0, X.useState)(!1),
    be = (0, X.useRef)(null),
    [j, Se] = (0, X.useState)(null),
    [we, M] = (0, X.useState)(null),
    Te = (0, X.useRef)(null);
  Te.current = we;
  let [N, De] = (0, X.useState)([]),
    Oe = (0, X.useRef)([]);
  Oe.current = N;
  let P = (0, X.useRef)(null),
    Ae = (0, X.useRef)(null),
    je = (0, X.useRef)(p),
    Ne = (0, X.useCallback)((e) => {
      (me((t) => (t === e ? null : t)),
    ...
    Be = (0, X.useCallback)(
      (e) => {
        (Ne(e), m?.annotation?.onDismiss?.(e));
      },
      [Ne, m?.annotation],
    ),
    Ve = (0, X.useCallback)((e) => {
      M((t) => {
    ...
    Ue = (0, X.useSyncExternalStore)(
      (e) => t.subscribeToLayoutChanges(e),
      () => t.getLayoutSnapshot(),
      () => t.getLayoutSnapshot(),
    ),
    I = Ue.viewportInsets,
    Ke = Tr(Ue.width, Ue.height, F, _.selectedSlideFrame, I) ?? _.slideRect,
    L = Ke === _.slideRect ? _ : { ..._, slideRect: Ke },
    R = _.slideIds[_.selectedSlideIdx] ?? `slide-${_.selectedSlideIdx}`,
    z = _.slideLabels[_.selectedSlideIdx] ?? `Slide ${_.selectedSlideIdx + 1}`,
    B = (0, X.useMemo)(() => Er(L), [L]),
    Ye = (0, X.useMemo)(() => $n({ snapshot: _ }), [_]),
    Xe = (0, X.useMemo)(() => {
      let e = L.slideRect;
      return e
    ...
    tt = Qe ?? et,
    nt = (0, X.useMemo)(
      () => (!D || !j ? null : ur(j.start, j.current)),
      [D, j],
    ),
    V = (0, X.useMemo)(() => {
      if (!nt || !j) return null;
      let e = er({ snapshot: _, frame: nt, anchorPoint: j.current });
      return e ? ir(e, L.slideRect) : null;
    }, [j, nt, _, L.slideRect]),
    at = (0, X.useMemo)(
      () =>
        nt
          ? dr(_.selectedSlideElementTargets, nt).flatMap((e) => {
          ...
          : [],
      [nt, _.selectedSlideElementTargets],
    ),
    ct = (0, X.useMemo)(
      () =>
    ...
    lt = (0, X.useMemo)(
      () =>
        ve && _.hoveredElementId
          ? (_.selectedSlideElementTargets.find(
              (e) => e.id === _.hoveredElementId,
            ) ?? null)
          : null,
      [ve, _.hoveredElementId, _.selectedSlideElementTargets],
    ),
    ut = (0, X.useMemo)(
      () =>
        V ||
        ...
        (!D || !l
          ...
          : lt
            ...
            : null),
      [Qe, D, lt, l, V, R, z, _.selectedSlideIdx, L.slideRect],
    ),
    {
      annotations: dt,
    ...
    } = Ce(m?.annotation?.handleRef, {
      onDismissAnnotation: Be,
      onDismissAllAnnotations: Pe,
    }),
    gt = (0, X.useMemo)(
      () => dt.filter((e) => e.target.slideId === R),
      [R, dt],
    ),
    _t = (0, X.useMemo)(
      () =>
        gt.map((e) => ({ annotation: e, bounds: ir(e.target, L.slideRect) })),
      [gt, L.slideRect],
    ),
    vt = (0, X.useMemo)(
      () =>
        pe == null || k?.mode === `edit`
          ? null
          : (_t.find(({ annotation: e }) => e.annotationId === pe) ?? null),
      [k?.mode, pe, _t],
    ),
    yt = (0, X.useMemo)(() => (V ? at : ct), [ct, at, V]),
    { drawings: bt, addPendingDrawing: H } = Me(m?.drawing?.handleRef),
    xt = (0, X.useMemo)(
      () => bt.filter((e) => e.target.slideId === R),
      [R, bt],
    ),
    U = (0, X.useMemo)(
      () =>
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      ...
      let n =
        v.current && ae.current
          ? e.attachViewport({
              host: v.current,
              canvas: ae.current,
              overlayCanvas: y.current,
            })
          : void 0;
      return (
    ...
    (0, X.useEffect)(() => {
      _.selectedSlideFrame &&
        ...
        e.setViewportCamera(F);
    }, [F, e, t, _.selectedSlideFrame]),
    (0, X.useEffect)(() => {
      let e = v.current;
      !_.selectedSlideFrame ||
        !e ||
    ...
    }, [o, F, _.selectedSlideFrame, _.textEditState, _.textLayoutBlocks, U]),
    (0, X.useEffect)(() => {
  ...
  let W = (0, X.useCallback)(() => {
    ...
    G = (0, X.useCallback)(() => {
      (Ae.current?.(), (Ae.current = null), Ve(null));
    }, [Ve]),
    K = (0, X.useCallback)(() => {
      ((P.current = null), (Oe.current = []), De([]));
    }, []),
    q = (0, X.useCallback)(() => {
      ((_e.current = !1), A(null), Se(null), W());
    }, [W]),
    St = (0, X.useCallback)(() => {
      let e = he.current;
    ...
    Ct = (0, X.useCallback)(
      (e) => {
        e == null ||
          ...
          !O ||
          !d ||
          ((P.current = R), (Oe.current = [...Oe.current, e]), De(Oe.current));
      },
      [R, O, d],
    ),
    wt = (0, X.useCallback)(
      (e) => {
        ...
        let a = { width: r.clientWidth, height: r.clientHeight },
          ...
          l = dr(_.selectedSlideElementTargets, c).flatMap((e) => {
            let t = _.selectedSlideElementTargets.find((t) => t.id === e);
            return t
              ? [
                  {
        ...
        We({
          ...
          viewportSize: a,
          baseCanvas: i,
          overlayCanvases: [y.current, oe.current],
          strokes: e,
          projectPoint: J,
        })
          .then((t) => {
    ...
    Dt = () => {
      k?.mode === `edit` &&
        (ht(k.annotationId), me((e) => (e === k.annotationId ? null : e)), q());
    };
  ((0, X.useEffect)(() => {
    (D || (k?.mode !== `edit` && A(null)),
      (!D || !l) && (Se(null), (be.current = null)));
  }, [D, k?.mode, l]),
    (0, X.useEffect)(() => {
      if (O && d) {
        (A(null),
      ...
      let t = p !== je.current;
      (G(), Oe.current.length > 0 && !t && K());
    }, [G, K, e, p, O, d]),
    (0, X.useEffect)(() => {
      if (p === je.current) return;
      je.current = p;
      let e = Oe.current;
      if (e.length === 0) {
        K();
    ...
    (0, X.useEffect)(() => {
      if (!D || !l) {
        (ye(!1), e.setHoveredElementId(null));
        return;
      }
      (ye(!1), e.setHoveredElementId(null));
    }, [D, l, e]),
    (0, X.useEffect)(() => {
      k &&
        k.target.slideId !== R &&
        (me(null), Se(null), (be.current = null), A(null));
    }, [k, R]),
    (0, X.useEffect)(
      () => () => {
        G();
    ...
    (0, X.useEffect)(() => {
      P.current == null || P.current === R || K();
    }, [K, R]),
    (0, X.useEffect)(() => {
      let e = v.current,
        t = oe.current,
        n = O && d ? `crosshair` : D && l && !k ? $e : ``;
      return (
        e && (e.style.cursor = n),
        t && (t.style.cursor = n),
        () => {
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      (fe(!1), v.current?.focus());
      let n = Cr(t, v.current, F, _, I);
      if ((Ot(n), O && d)) {
        if (!n) return;
        (Dr(t, b),
          (Ae.current = () => {
          ...
          Ve({ color: xe, strokeWidth: 3, points: [n] }),
          t.preventDefault(),
          t.stopPropagation());
        return;
      }
      if (D && !l && he.current && !St()) {
      ...
      if (D && l) {
        ...
        if ((r != null && i === `replace` && A(null), !n)) {
          (r != null && i !== `replace` && St(), (be.current = null), Se(null));
          return;
        }
        let a = sr(_.selectedSlideElementTargets, n, F.k);
      ...
      if (!o) {
        ...
        let i = sr(_.selectedSlideElementTargets, n, F.k);
      ...
      let r = U.isActive(),
        i =
          ...
          _.selectedElementIds.length === 1 &&
          _.primarySelectedElementId &&
          S.current === _.primarySelectedElementId
            ? _.primarySelectedElementId
            : void 0;
      if (
        (r || i) &&
      ...
      let a = _.primarySelectedElementId
        ...
        c = _.selectedElementIds.length === 1 && a ? lr([a], n, F.k) : null,
        u = c ? null : fr(s, n, F.k),
        f = !c && !u && !!a?.canRotate && pr(s, n, F.k),
        p = c
          ? c.endpoint === `from`
            ? `connector-from`
            : `connector-to`
        ...
        m =
          c?.elementId ??
          (p === `move`
            ? sr(_.selectedSlideElementTargets, n, F.k)
            : _.primarySelectedElementId);
      if (!m) {
    ...
    At = (t) => {
      ...
      if (D && l) {
        ...
        if (r != null && n) {
          ...
          (e && he.current && ((_e.current = !1), A(null)),
            Se(e ? { start: r.start, current: n } : null),
            t.preventDefault(),
            t.stopPropagation());
        }
        if (!n) {
        ...
        (e.setHoveredElementId(i),
          (t.currentTarget.style.cursor = he.current ? `` : $e));
        return;
      }
      if (x.current === `text`) {
        n && U.pointerMove(n);
      ...
      if (!o) {
        if (n && cr(_.hyperlinkTargets, n)) {
          (e.setHoveredElementId(null),
            (t.currentTarget.style.cursor = `pointer`));
          return;
        }
        let r = n ? sr(_.selectedSlideElementTargets, n, F.k) : null;
      ...
      let r = _.primarySelectedElementId
        ...
        a = _.selectedElementIds.length === 1 && r ? lr([r], n, F.k) : null;
      if (a) {
      ...
      if (s) {
        (e.setHoveredElementId(_.primarySelectedElementId),
          (t.currentTarget.style.cursor = Ge(s) ?? ``));
        return;
      }
      if (i && r?.canRotate && pr(i, n, F.k)) {
        (e.setHoveredElementId(_.primarySelectedElementId),
          (t.currentTarget.style.cursor = ze()));
        return;
      }
      ...
      let c = sr(_.selectedSlideElementTargets, n, F.k);
    ...
    jt = (t, n) => {
      if (O && d) {
        if (b.current != null && b.current !== t.pointerId) return;
        Ot(Cr(t, v.current, F, _, I));
        let e = Te.current;
        (Or(t, b), (Ae.current = null), Ve(null), n && Ct(e));
        return;
      }
      if (D && l) {
        if (b.current != null && b.current !== t.pointerId) return;
        (Ot(Cr(t, v.current, F, _, I)), Or(t, b));
        let r = be.current;
        if (((be.current = null), Se(null), !n || !r)) return;
        let i = Cr(t, v.current, F, _, I);
        if (!i) return;
        let a = ur(r.start, i),
      ...
      let r = x.current;
      if (!r) return;
      if ((Ot(Cr(t, v.current, F, _, I)), Or(t, b), r === `text`)) {
    ...
    Mt = (t) => {
      ...
      if (!o) return;
      let n = wr(t.clientX, t.clientY, v.current, F, _, I);
      n &&
    ...
    Nt = (e) =>
      !e.metaKey && !e.ctrlKey
        ...
        : e.key === `0`
          ...
          : e.key === `=` || e.key === `+`
            ? (t.zoomTo(nn(_.zoom + 0.1, _.fitScale ?? 1), { settled: !0 }),
              e.preventDefault(),
              !0)
            : e.key === `-`
              ? (t.zoomTo(nn(_.zoom - 0.1, _.fitScale ?? 1), { settled: !0 }),
    ...
    Pt = (t) => {
      if (!(
        ...
        if (
          ...
          U.activateBlockEnd(_.primarySelectedElementId) && t.preventDefault();
          return;
        }
      ...
      children: [
        ...
        (0, Z.jsx)(`canvas`, {
          ...
          onPointerLeave: (t) => {
            b.current ??
              (Ot(null),
              e.setHoveredElementId(null),
              (t.currentTarget.style.cursor = O && d ? `crosshair` : ``));
          },
        ...
        et
          ? (0, Z.jsx)(Fe, {
              ...
              anchorBounds: et,
              containerElement: v.current,
              portalContainerElement: ne,
              mode: k?.mode ?? `create`,
              value: k?.body ?? ``,
              onChange: (e) => {
                ((_e.current = !1), A((t) => t && { ...t, body: e }));
              },
              onCancel: q,
              onDelete: Dt,
              onSubmit: Et,
...
function Kr({
  ...
  onClose: u,
  renderSlideThumbnailOverlay: f,
  className: p,
  enablePageNavigation: m,
  theme: h = `web`,
  isEditing: g = !0,
  hideSpeakerNotes: ne = !1,
  reviewTools: re,
  onHyperlinkClick: _,
  annotationsEnabled: ie = !0,
  drawingAnnotationsEnabled: v = !0,
  commentThreadsEnabled: ae = !0,
}) {
  let y = le(
    e,
    (0, Q.useCallback)(() => Kt(), []),
  ...
  if (!y) return null;
  let b = An(y),
    { panels: x, stageOverlays: S } = (0, Q.useMemo)(() => Zt(t), [t]),
    C = ie && re?.annotation?.enabled !== !1,
    [w, T] = (0, Q.useState)(!1),
    se = v && re?.drawing?.enabled !== !1,
    [E, ce] = (0, Q.useState)(!1),
    [ue, de] = (0, Q.useState)(0),
  ...
  ((0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      !w || !C || (y.clearElementSelection(), y.setHoveredElementId(null));
    }, [C, w, y]),
    (0, Q.useEffect)(() => {
      !E || !se || (y.clearElementSelection(), y.setHoveredElementId(null));
    }, [y, se, E]),
    (0, Q.useEffect)(() => {
      if (!w) return;
      let e = (e) => {
  ...
  let [D, pe] = (0, Q.useState)(() =>
      Object.fromEntries(x.map((e) => [e.id, e.defaultOpen ?? !1])),
    ),
    [ve, ye] = (0, Q.useState)(Zr),
    [j, xe] = (0, Q.useState)(() =>
      Object.fromEntries(b.slideIds.map((e) => [e, null])),
    ),
    [Ce, we] = (0, Q.useState)(() =>
      Object.fromEntries(b.slideIds.map((e) => [e, null])),
    ),
    [M, Te] = (0, Q.useState)(() => b.slideIds),
    [N, Ee] = (0, Q.useState)(null),
    [De, P] = (0, Q.useState)(!1),
    [Ae, je] = (0, Q.useState)(!1),
    [Me, Ne] = (0, Q.useState)(!1),
    ...
    We = (0, Q.useRef)(Ce),
    I = (0, Q.useRef)(M),
    Ge = k(me(A, { activationConstraint: { distance: 4 } })),
    Ke = (0, Q.useMemo)(() => [be], []),
    L = r === `left`,
    qe = r === `bottom`,
    R = h === `codex`,
    ...
    Je = m ?? R,
    Ye = Ae && (L || z || B),
    Xe = !ne && (g || b.notesText.trim().length > 0),
    Ze = Xe && Ie && ve > 0,
    Qe = (0, Q.useMemo)(
      () => ({
        left: Ye ? Qr : 0,
  ...
  ((0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      (Te(b.slideIds),
        xe((e) => {
          let t = {};
          for (let n of b.slideIds) t[n] = e[n] ?? null;
          return t;
        }),
        we((e) => {
          let t = {};
  ...
  let et = (0, Q.useMemo)(
      () =>
        Object.fromEntries(
          b.slideIds.map((e, t) => [e, b.slideLabels[t] ?? `Slide ${t + 1}`]),
        ),
      [b.slideIds, b.slideLabels],
    ),
    nt = (0, Q.useMemo)(
      () => Object.fromEntries(b.slideIds.map((e, t) => [e, t])),
      [b.slideIds],
    ),
    rt = b.slideIds[b.selectedSlideIdx] ?? null,
    V =
      b.fitScale ??
      (b.slideRect && b.zoom > 0 ? b.slideRect.scale / b.zoom : null),
    it = V ? rn(V) : null,
    at = b.slideRect?.scale ?? rn(V ? V * b.zoom : b.zoom),
    ot = it != null && Math.abs(b.zoom - 1) < ti,
    st = z && (!Me || Pe),
    ct = !st,
    lt = Je && !st,
    dt = (e) => {
    ...
    vt = (0, Q.useCallback)((e, t, n) => {
      ((Be.current[e] = t), t && F.current && n && F.current.observe(t));
    }, []),
    yt = (0, Q.useCallback)(() => {}, []),
    bt = (0, Q.useCallback)(() => {
      y.addSlide();
    ...
    H = (0, Q.useCallback)(
      async (e, t) => {
        if (e < 0 || e >= y.getSnapshot().slideCount) return;
        let n = y.getSnapshot().slideIds[e];
        if (!n) return;
        let r = t?.cacheKind === `stacked-page`,
          i = r ? We.current[n] : Ue.current[n],
          a = `${r ? `stacked-page` : `rail`}:${n}`;
        if (!(
          (!t?.force && i != null) ||
          He.current.has(a) ||
          e < 0 ||
          e >= y.getSnapshot().slideCount
        )) {
          He.current.add(a);
          try {
            await ht();
            let t = await y.requestSlideThumbnail(
              e,
              r ? { cssMaxPx: ri } : void 0,
            );
            (r ? we : xe)((e) => (e[n] === t ? e : { ...e, [n]: t }));
          } finally {
            He.current.delete(a);
          }
        }
  ...
  ((0, Q.useEffect)(() => {
    let e = b.slideIds[b.selectedSlideIdx];
    (e &&
      (He.current.delete(`rail:${e}`), He.current.delete(`stacked-page:${e}`)),
      H(b.selectedSlideIdx, { force: !0 }),
      e &&
        We.current[e] != null &&
        H(b.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [H, b.presentationVersion, b.selectedSlideIdx, b.slideIds]),
    (0, Q.useEffect)(() => {
            ...
            (e) => {
              for (let t of e) {
                ...
                (H(n, { cacheKind: r, force: i }),
                  ...
                  F.current?.unobserve(t.target));
              }
            },
            { root: Re.current, rootMargin: `200px`, threshold: 0.05 },
          )));
        for (let e of [...Be.current, ...Ve.current]) e && F.current.observe(e);
        return () => {
          F.current?.disconnect();
        };
      }
    }, [H, b.presentationVersion, b.slideCount]));
  let xt = (0, Q.useCallback)(
      (e) => {
        ...
        let n = b.selectedSlideIdx,
          r = b.slideIds.length - 1,
          i = t < 0 ? Math.max(0, n - 1) : Math.min(r, n + 1);
        if (i === n) return;
        y.setSelectedSlideIdx(i);
      ...
      [y, b.selectedSlideIdx, b.slideIds.length],
    ),
    U = (0, Q.useCallback)((e) => {
      Ee(typeof e.active.id == `string` ? e.active.id : null);
    }, []),
    W = (0, Q.useCallback)(() => {
      (Te(b.slideIds), Ee(null));
    }, [b.slideIds]),
    G = (0, Q.useCallback)(
      (e) => {
        Ee(null);
    ...
    St = (0, Q.useCallback)((e, t, n) => {
      ((Ve.current[e] = n),
        n && F.current && We.current[t] == null && F.current.observe(n));
    }, []),
    J = (0, Q.useCallback)(
      (e, t = `default`, r) => {
        let i = Vr(e, t);
      ...
      [N, bt, _t, M, Ke, W, G, U, yt, g, vt, f, rt, gt, Ge, nt, et, j],
    );
  return (0, $.jsx)(`div`, {
    className: n(
    ...
    children: (0, $.jsxs)(bn, {
      ...
      children: [
        (0, $.jsx)(d, {
          ...
          centeredContent: lt
            ? (0, $.jsx)(O, {
                currentIndex: b.selectedSlideIdx,
                totalCount: b.slideCount,
                itemLabel: `slide`,
                onChangeIndex: (e) => y.setSelectedSlideIdx(e),
                testId: `popcorn-presentation-page-navigation`,
              })
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: n(`flex items-center`, R ? `gap-1` : `gap-2`),
            children: [
              re?.annotation && C
                ? (0, $.jsx)(Oe, {
                    active: w,
                    onClick: () => {
                      let e = !w;
                      (e && (re?.annotation?.onModeEnabled?.(), ce(!1)), T(e));
                    },
          ...
          icon: (0, $.jsx)(oe, {
            kind: `presentation`,
            children: (0, $.jsx)(te, { className: `size-4` }),
          }),
        }),
        (0, $.jsx)(`div`, {
                    ...
                    children: [
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(yr, {
                          ...
                          drawingMode: E,
                          onDrawingModeChange: ce,
                          drawingCommitToken: ue,
                          reviewTools: re,
                          onHyperlinkClick: _,
                          annotationsEnabled: ie,
    ...
    (pe(),
      ...
      (pi = (0, Q.memo)(function ({
        ...
        let h = zr(c, l),
          ...
          te = Hr(l),
          g = Ur(l),
          ne = l === `floating` ? ii : void 0,
          re = { ...(l === `floating` ? ai : {}), ...(a ? { color: si } : {}) };
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              className: n(`text-token-text-primary`, g, ee),
              style: re,
              children: t + 1,
            }),
            (0, $.jsxs)(`div`, {
              ...
              children: [
                i
                  ? (0, $.jsx)(`img`, {
                      src: i,
                      alt: ``,
                      className: n(`block`, te),
                      style: ne,
                      draggable: !1,
                    })
                  : (0, $.jsx)(`div`, {
                      className: n(te, `animate-pulse bg-gray-200`),
      ...
      (mi = (0, Q.memo)(function ({
        ...
        slideButtonTestIdPrefix: m = `popcorn-presentation-slide`,
        onRegisterButtonRef: h,
      }) {
        let {
            attributes: ee,
            listeners: te,
        ...
        return (0, $.jsx)(R, {
          ...
          trigger: (0, $.jsx)(`div`, {
            ref: g,
            style: {
              transform: ve.Translate.toString(ne),
              transition: _ ? void 0 : re,
              opacity: +!_,
              position: `relative`,
              display: `inline-flex`,
            },
          ...
          children: [
            ...
            (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(`div`, {
                ...
                children: (0, $.jsx)(g, { className: `size-4` }),
              }),
            }),
          ],
        });
...
function _i({
  ...
  drawingAnnotationsEnabled: ie = !1,
  enablePageNavigation: v,
  artifactSearchEnabled: ae = !1,
  commentThreadsEnabled: y = !1,
  workerFactory: oe,
}) {
  let b = Be({ initialCrdtState: s, externalCrdtUpdates: t }),
    x = (0, Si.useRef)(c),
    S = (0, Si.useRef)(null),
    C = le(
      void 0,
    ...
    se = (0, Si.useMemo)(() => bi(f), [f]),
    E = (0, Si.useMemo)(() => xi(se), [se]);
  return (
    (0, Si.useEffect)(() => {
      C &&
        x.current !== c &&
    ...
    (0, Si.useEffect)(() => {
      if (!C || g == null) return;
      let e = () => {
        if (g.requestId === S.current) return !0;
        let e = null;
        if (g.slideId != null) {
          let t = C.getSnapshot().slideIds.indexOf(g.slideId);
          t >= 0 && (e = t);
        }
        return (
          e == null && g.slideNumber != null && (e = g.slideNumber - 1),
          e == null
            ? g.slideId == null
            : ((S.current = g.requestId),
              C.setSelectedSlideIdx(e),
              C.setSelectedElementId(g.objectId ?? null),
              !0)
        );
      };
      if (e()) return;
      ...
      ? (0, Ci.jsxs)(`section`, {
          ...
          children: [
            (0, Ci.jsx)(Kr, {
              ...
              headerRightContent:
                se.length > 0
                  ? (0, Ci.jsxs)(Ci.Fragment, {
                      children: [(0, Ci.jsx)(yi, { count: se.length }), i],
                    })
                  : i,
              renderHeaderZoomControl: o,
              zoomToFitLabel: a,
              ...
              drawingAnnotationsEnabled: ie,
              enablePageNavigation: v,
              artifactSearchEnabled: ae,
...
var Si, Ci;
e(() => {
  (s(), i(), (Si = t(r())), gi(), Yt(), u(), L(), Xe(), (Ci = a()));
})();
export { _i as PopcornElectronPresentationPanel };
//# sourceMappingURL=PopcornElectronPresentationPanel-Borgxof4.js.map
