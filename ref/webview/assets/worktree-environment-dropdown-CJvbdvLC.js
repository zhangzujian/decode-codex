...
import { i as j } from "./app-initial~artifact-tab-content.electron~app-main~pull-request-code-review~new-thread-pane~jnqazr7u-ZF6PGYD1.js";
import {
  Bt as M,
  Rt as N,
  Vt as P,
...
import { n as ce, t as le } from "./star-DPtJX0Z4.js";
import {
  c as ue,
  l as de,
  n as fe,
...
import { n as ge, t as _e } from "./use-git-recent-branches-LpNua5GR.js";
function ve(e) {
  let t = (0, ye.c)(11),
...
function xe(e) {
  ...
  let {
    ...
    he;
  t[5] !== U || t[6] !== me
    ? ((he = { enabled: me, retainRepoWatch: U }),
      (t[5] = U),
      (t[6] = me),
      (t[7] = he))
    : (he = t[7]);
  let {
    ...
    be;
  t[8] !== U || t[9] !== Y
    ? ((be = { enabled: Y, retainRepoWatch: U }),
      (t[8] = U),
      (t[9] = Y),
      (t[10] = be))
    : (be = t[10]);
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((dt = (0, X.jsx)(H, { className: `icon-xs` })), (t[34] = dt))
    : (dt = t[34]);
  let ft;
  t[35] === ut
    ? (ft = t[36])
...
function Se(e) {
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, X.jsx)(ve, {
          borderColor: `border-token-side-bar-background`,
          children: (0, X.jsx)(H, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
function Fe(e) {
  ...
  if (
    ...
    t[30] === x
      ? (B = t[31])
      : ((B = x ? (0, $.jsx)(W, { className: `icon-xs` }) : null),
        (t[30] = x),
        (t[31] = B));
  ...
  t[63] === U
    ...
    : ((K = (0, $.jsx)(J.Section, {
        ...
        children: (0, $.jsx)(J.Item, { LeftIcon: k, onClick: U, children: G }),
      })),
      (t[63] = U),
      (t[64] = K));
  let q;
  t[65] !== V || t[66] !== K || t[67] !== R || t[68] !== z
    ? ((q = (0, $.jsxs)(`div`, { className: R, children: [z, V, H, K] })),
      (t[65] = V),
      (t[66] = K),
      (t[67] = R),
      (t[68] = z),
...
//# sourceMappingURL=worktree-environment-dropdown-CJvbdvLC.js.map
