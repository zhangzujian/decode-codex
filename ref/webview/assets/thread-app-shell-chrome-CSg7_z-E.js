...
import { y as Ft } from "./app-initial~app-main~new-thread-panel-page~onboarding-page~appgen-library-page~hotkey-windo~i1qg4eb0-DryawtDu.js";
import {
  A as It,
  B as Lt,
  D as Rt,
...
import { n as gn, t as _n } from "./artifact-file-preview-icon-bjg-CZHK.js";
import { n as vn, t as yn } from "./thread-panel-toggle-button-BSghz--1.js";
import {
  L as bn,
  R as xn,
  a as Sn,
  r as Cn,
} from "./local-conversation-thread-DW9e-ZKK.js";
import { o as wn, s as Tn } from "./thread-overflow-menu-D12MIudr.js";
import { n as En, t as Dn } from "./use-media-query-DvLFnBbU.js";
var On,
  kn,
  An = e(() => {
    (c(),
...
function Fn({ onClose: e, target: t }) {
  ...
  let E = r(De, x),
    ...
    F = x != null && !Fe(),
    I = f && (p || !u.some((e) => Ne(e))),
    L = !m && (h.kind === `git` || !1) && !u.some((e) => e.tabId === He.DIFF),
    R = P && !u.some((e) => e.tabId === He.TIMELINE),
    z = (!m || t !== `right`) && Pt(a),
    B = s.status === `allowed` || s.status === `loading`,
    V = B && h.kind !== `git` ? M : null,
    te = V != null && V.length > 0,
    ne = () => {
      x != null &&
        Tn(a, Cn, {
    ...
    ue = (e, t, n) => {
      if (t == null) {
        qe({ href: e, initiator: `mcp_app_resource`, originHostId: n });
        return;
      }
      We({ event: t, href: e, initiator: `mcp_app_resource`, originHostId: n });
    },
    de = (e, t) => {
      switch (e.type) {
        case `file`:
    ...
    H = B ? fe : fe.filter((e) => e.id === `browser`);
  return {
    actions:
      h.kind === `git`
        ? [...H].sort((e, t) => (Ln[e.id] ?? H.length) - (Ln[t.id] ?? H.length))
        : H,
    hasOutputArtifacts: te,
    onOpenArtifact: de,
    outputArtifacts: V,
  };
}
var q,
  ...
  Rn = e(() => {
    (p(),
      ...
      (q = h()),
      (In = l(m, ({ get: e }) =>
        e(I).filter((e) => e.entrypoint === `thread`),
      )),
  ...
  switch (n.type) {
    ...
    case `appgen-app`: {
      ...
      return (
        t[10] === r
          ? (e = t[11])
          : ((e = (0, J.jsx)(ct, { className: r })), (t[10] = r), (t[11] = e)),
        e
      );
    }
    case `website`: {
      ...
      return (
        t[12] === r
          ? (e = t[13])
          : ((e = (0, J.jsx)(Qe, { className: r })), (t[12] = r), (t[13] = e)),
        e
      );
    }
  }
                  ...
                  children: [
                    ...
                    (0, $.jsx)(W.HeaderAction, {
                      ...
                      children: (0, $.jsx)(yn, {
                        ...
                        onClick: () => cn(a),
                        children: d
                          ? (0, $.jsx)(_e, { className: `icon-xs rotate-180` })
                          : (0, $.jsx)(ce, { className: `icon-xs rotate-180` }),
                      }),
                    }),
                  ],
                })
...
function wr() {
  let e = (0, Q.c)(7),
    t = n(G),
    r;
  e[0] === t ? (r = e[1]) : ((r = Ve(t)), (e[0] = t), (e[1] = r));
  let i = r,
    a;
  e[2] === i
    ? (a = e[3])
  ...
  let t = n(G),
    ...
    h = () => {
      if (l) {
        ...
        we(t, `bottom`, { activateFallbackTab: !0, allowEmpty: !0 }) &&
          t.get(Dt) &&
          jr();
      }
    };
...
function Er(e) {
  ...
  let {
    ...
    u;
  t[2] === n ? (u = t[3]) : ((u = Se(n)), (t[2] = n), (t[3] = u));
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(ae, { className: `icon-xs` })), (t[5] = m))
    : (m = t[5]);
  let h;
  t[6] === r
    ? (h = t[7])
...
function Or(e) {
  let t = (0, Q.c)(16),
    r = n(G),
    a;
  t[0] === r ? (a = t[1]) : ((a = Ve(r)), (t[0] = r), (t[1] = a));
  let o = a,
    s = T(),
    c = i(H) === `ready`,
    l;
...
//# sourceMappingURL=thread-app-shell-chrome-CSg7_z-E.js.map
