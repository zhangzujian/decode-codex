...
import { nn as Le, tn as Re } from "./app-initial~app-main~page-CtX5-cLy.js";
import {
  Sc as ze,
  xc as Be,
...
import {
  h as Qe,
  m as $e,
} from "./app-initial~app-main~onboarding-page~plan-summary-page~hotkey-window-thread-page~thread-app~e8nmies7-fCF8WRo3.js";
import {
  L as et,
  W as tt,
...
import {
  c as it,
  s as at,
} from "./app-initial~app-main~onboarding-page~hotkey-window-thread-page~quick-chat-window-page~chatg~duyd76c5-CMn2Ipvr.js";
import {
  n as ot,
  t as st,
} from "./app-initial~app-main~settings-page~codex-mobile-page~debug-window-page~remote-connections-s~mf1b27wf-CXrE2v-x.js";
import { n as ct, t as lt } from "./use-home-directory-D1Qih2d1.js";
var ut,
  dt = e(() => {
    (f(), (ut = T(`electron:codex-mobile-setup-step-debug-override`, `auto`)));
  }),
  ft,
  pt = e(() => {
    ft =
...
function Vt(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = F(`flex w-full flex-col gap-2 text-center`, s)),
      (t[0] = s),
      (t[1] = c));
  let l =
      o === `dialog`
...
function Yt(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = F(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function Qt() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = { hostId: ne }), (e[0] = a))
    : (a = e[0]);
  let s = ke(a).available,
    d = fe(Oe.keepRemoteControlAwakeWhilePluggedIn),
    f = v(Ye, ne),
    p = u(Ke),
    m;
  e[1] === t.query
    ? (m = e[2])
    : ((m = t.query.snapshot(Ke)), (e[1] = t.query), (e[2] = m));
  let h = m,
    g;
  ...
  let _ = ue(ne, g),
    y;
  e[4] !== r || e[5] !== _.availablePlugins
    ? ((y = en(_.availablePlugins, rn, r)),
      (e[4] = r),
      (e[5] = _.availablePlugins),
      (e[6] = y))
    : (y = e[6]);
  let x = y,
    C = x?.plugin.installed === !0 && x.plugin.enabled,
    w;
  e[7] !== r || e[8] !== _.availablePlugins
    ? ((w = $t(_.availablePlugins, r)),
      (e[7] = r),
      (e[8] = _.availablePlugins),
      (e[9] = w))
    : (w = e[9]);
  let T = w,
    E;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { hostId: ne }), (e[10] = E))
    : (E = e[10]);
  let { pendingPluginId: D, setPluginEnabled: ee } = R(E),
    O;
  e[11] === _.forceReload
    ? (O = e[12])
    : ((O = { forceReloadPlugins: _.forceReload, hostId: ne }),
      (e[11] = _.forceReload),
      (e[12] = O));
  let {
      closePluginInstall: k,
      connectRequiredApp: A,
  ...
  e[13] === h
    ...
    : ((ae = {
      ...
      (e[14] = ae));
  let P = b(ae),
    oe = n === `macOS` && C && f && p.data?.enabled != null,
    se;
  e[15] !== x ||
  e[16] !== p.data?.enabled ||
  e[17] !== N ||
  ...
  e[19] !== P
    ? ((se = (e) => {
        if (x != null) {
          ...
          ee({ enabled: e, pluginDisplayName: o(x), pluginId: x.plugin.id });
        }
      }),
      (e[15] = x),
      (e[16] = p.data?.enabled),
  ...
  e[21] !== T || e[22] !== N || e[23] !== ee
    ? ((ce = (e) => {
        if (T != null) {
          ...
          ee({ enabled: e, pluginDisplayName: o(T), pluginId: T.plugin.id });
        }
      }),
      (e[21] = T),
      (e[22] = N),
    ...
    : (ce = e[24]);
  let le = ce,
    I = T?.plugin.installed === !0 && T.plugin.enabled,
    L = _.isLoading || T == null || re || D === T.plugin.id,
    de = _.isLoading || x == null || re || P.isPending || D === x.plugin.id,
    pe = d ?? !1,
    me = p.data?.enabled ?? !1,
    z = !C || p.isLoading || P.isPending,
    B;
  e[25] === t
    ? (B = e[26])
    : ((B = (e) => {
        ge(t, Oe.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = B));
  let V;
  ...
  return (
    ...
    e[53] !== U
      ? ((W = {
          chromeExtensionEnabled: I,
          chromeExtensionToggleDisabled: L,
          computerUseEnabled: C,
          computerUseToggleDisabled: de,
          keepComputerAwake: pe,
          ...
          onComputerUseEnabledChange: F,
          onKeepComputerAwakeChange: B,
          onLockedComputerUseEnabledChange: V,
          pluginInstallModal: U,
...
function ln(e) {
  ...
  t[0] === i
    ...
    : ((c =
        i === `page`
          ? (0, K.jsx)(at, { className: `size-11 text-token-foreground` })
          : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  ...
  t[4] === d
    ? (f = t[5])
    : ((f = F(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let m;
  ...
  t[11] !== o ||
  t[12] !== i
    ? ((m = s.showKeepComputerAwake
        ? (0, K.jsx)(dn, {
            icon: s.keepComputerAwake
              ? (0, K.jsx)(st, { className: `icon-base` })
  ...
  t[30] !== a ||
  t[31] !== i
    ? ((g = s.showChromeExtensionSetup
        ? (0, K.jsx)(dn, {
            icon: (0, K.jsx)(W, { className: `icon-base` }),
            variant: i,
            title: (0, K.jsx)(p, {
    ...
    : (g = t[32]);
  let _;
  t[33] !== f || t[34] !== m || t[35] !== h || t[36] !== g
    ? ((_ = (0, K.jsxs)(`div`, { className: f, children: [m, h, g] })),
      (t[33] = f),
      (t[34] = m),
      (t[35] = h),
      (t[36] = g),
  ...
  t[38] === v
    ? (y = t[39])
    : ((y = F(`justify-center`, v)), (t[38] = v), (t[39] = y));
  let b;
  ...
  let E;
  return (
    t[55] !== s.pluginInstallModal || t[56] !== T
      ? ((E = (0, K.jsxs)(K.Fragment, { children: [T, s.pluginInstallModal] })),
...
function Nr(e) {
  ...
  t[5] === r
    ? (_ = t[6])
    : ((_ = F(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = _));
  let v = _;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = F(`cursor-interaction overflow-hidden`, r)),
        (t[7] = r),
        (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
  ...
  t[17] === r
    ? (b = t[18])
    : ((b = F(`cursor-interaction overflow-hidden`, r)),
      (t[17] = r),
      (t[18] = b));
  let x;
  t[19] === g
...
function Qr(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = F(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
...
function ei(e) {
  ...
  t[1] === u
    ? (d = t[2])
    : ((d = F(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] === i
  ...
  t[7] === m
    ? (h = t[8])
    : ((h = F(`pointer-events-auto aspect-square`, m)), (t[7] = m), (t[8] = h));
  let g;
  t[9] !== r || t[10] !== h
    ? ((g = (0, Y.jsx)(`div`, {
...
function Ti(e) {
  let t = (0, Li.c)(82),
    ...
    [_, y] = (0, Ri.useState)(!1),
    [b, x] = (0, Ri.useState)(`phone`),
    S = l ? (n ?? b) : `phone`,
    [C] = (0, Ri.useState)(Ei),
    T;
  t[0] !== s || t[1] !== C
    ? ((T = { hostId: s, openId: C }), (t[0] = s), (t[1] = C), (t[2] = T))
    : (T = t[2]);
  let E = v(je, T),
    D = f && !m,
    O = D && E.error == null ? (E.data ?? null) : null,
    k = O?.manualPairingCode ?? null,
    A = D && O == null && (E.error == null || E.isFetching),
    te = !f || O?.pairingCode != null,
    M = S === `phone` && !f && !m,
    re = D && S === `computer` && !A,
    N;
  t[3] !== n || t[4] !== i
  ...
  if (m) {
    ...
    let e = O?.pairingCode,
      n;
    (t[21] !== L || t[22] !== I || t[23] !== h || t[24] !== u || t[25] !== e
      ? ((n = (0, X.jsx)(Jr, {
          ariaLabel: I,
          centerLogoAriaLabel: L,
          pairingCode: e,
          platform: h,
          size: u,
        })),
  ...
  let pe = u === `compact` ? null : `mt-3`,
    z;
  t[34] === pe
    ? (z = t[35])
    : ((z = F(`flex w-full flex-col items-center gap-4`, pe)),
      (t[34] = pe),
      (t[35] = z));
  let B;
  t[36] !== d || t[37] !== m || t[38] !== ie || t[39] !== S || t[40] !== l
    ? ((B =
        l && !m
          ? (0, X.jsx)(`div`, {
      ...
      (t[41] = B))
    : (B = t[41]);
  let he = u === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    V = M ? null : `justify-center`,
    H =
      S === `computer`
        ? u === `compact`
  ...
  t[60] !== se
              ...
              S === `phone` && te
                ? (0, X.jsx)(ee, {
                    ...
                    children: (0, X.jsx)(j, {
                      ...
                      onClick: () => y(!0),
                      size: `icon`,
                      children: (0, X.jsx)($e, { className: `icon-xs` }),
                    }),
                  })
                : null,
              (0, X.jsx)(ee, {
    ...
    : (be = t[61]);
  let xe;
  t[62] !== U || t[63] !== W || t[64] !== ge || t[65] !== be
    ? ((xe = (0, X.jsxs)(`div`, { className: U, children: [W, ge, be] })),
      (t[62] = U),
      (t[63] = W),
      (t[64] = ge),
      (t[65] = be),
  ...
  t[67] === re
    ? (Se = t[68])
    : ((Se = re ? (0, X.jsx)(Fi, {}) : null), (t[67] = re), (t[68] = Se));
  let Ce;
  t[69] !== L ||
  t[70] !== d ||
  t[71] !== _ ||
  ...
  let we;
  return (
    t[76] !== z || t[77] !== B || t[78] !== xe || t[79] !== Se || t[80] !== Ce
      ? ((we = (0, X.jsxs)(`div`, { className: z, children: [B, xe, Se, Ce] })),
        (t[76] = z),
        (t[77] = B),
        (t[78] = xe),
        (t[79] = Se),
...
function Oi(e) {
  let t = (0, Li.c)(3),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, X.jsx)(r, { className: `size-7 text-token-text-secondary` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
  return (
...
function Bi(e) {
  ...
  t[6] === f
    ? (m = t[7])
    : ((m = F(`flex flex-wrap items-center justify-center gap-3`, f)),
      (t[6] = f),
      (t[7] = m));
  let h;
  t[8] !== n || t[9] !== a || t[10] !== o
  ...
  t[12] === g
    ? (_ = t[13])
    : ((_ = F(`justify-center`, g)), (t[12] = g), (t[13] = _));
  let v;
...
function Wi(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = F(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Ki, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(x, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(p, {
...
function sa(e) {
  ...
  t[5] === b
    ? (x = t[6])
    : ((x = (0, ua.jsx)(ve, { className: `sr-only`, children: b })),
      (t[5] = b),
      (t[6] = x));
  let C;
  t[7] !== g || t[8] !== p
    ...
    : (C = t[9]);
  let T;
  t[10] !== a || t[11] !== g || t[12] !== p
    ? ((T = () => {
        (xe(g, P, { action: `finish_setup`, step: p, surface: `dialog` }),
          a(!1));
      }),
      (t[10] = a),
      (t[11] = g),
...
var la,
  ua,
  da = e(() => {
    ((la = m()), we(), H(), _(), Ee(), M(), a(), d(), s(), oa(), (ua = E()));
  });
export {
  oa as a,
  It as c,
...
//# sourceMappingURL=codex-mobile-setup-dialog-BK5tSttf.js.map
