import { i as e, r as t, t as n } from "./src-RYGCTipz.js";
import { h as r, p as i, r as a } from "./chunk-5PVQY5BW-sjMtKSfN.js";
import { t as o } from "./mermaid-parser.core-OZdPSnBm.js";
import {
  B as s,
  C as c,
  V as l,
...
import { t as y } from "./chunk-4BX2VUAB-CJOAReEH.js";
import { t as b } from "./chunk-QZHKN3VN-eRDwYh8-.js";
var x = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 },
  ee = m.gitGraph,
  S = t(() => a({ ...ee, ...v().gitGraph }), `getConfig`),
  C = new b(() => {
    let e = S(),
      t = e.mainBranchName,
      n = e.mainBranchOrder;
...
var te = t(function (e) {
  ...
  ae = t(function (t) {
    let n = t.name,
      r = t.order;
    if (((n = g.sanitizeText(n, S())), C.records.branches.has(n)))
      throw Error(
  ...
  oe = t((t) => {
    let n = t.branch,
      ...
      a = t.tags,
      o = S();
    ((n = g.sanitizeText(n, o)), (r &&= g.sanitizeText(r, o)));
  ...
  E = t(function (e) {
    if (((e = g.sanitizeText(e, S())), C.records.branches.has(e))) {
...
var ce = t(function () {
  ...
  Ce = t((e, t, n) => {
    ...
    (e.forEach((e) => {
      ...
      (n.parents.length ? ((r = Te(n)), (i = Math.max(r, i))) : a.push(n),
        Ee(n, r));
    }),
      (r = i),
      a.forEach((e) => {
  ...
  Te = t((e) => we(e) + M, `calculateCommitPosition`),
  Ee = t((e, t) => {
      ...
      d.forEach((e) => {
        ...
        if (r) {
          let e = je(t),
            ...
            r = B.get(t.branch)?.index ?? 0;
          (Oe(a, t, c, e, r, n), ke(o, t, c, s, i), Ae(o, t, c, s));
        }
        (K === `TB` || K === `BT`
  ...
  Fe = t((e, t, n, r) => {
    ...
    if (c) {
      ((l = `A 10 10, 0, 0, 0,`),
        ...
        (d = 10),
        (f = 10));
      let e = o.y < s.y ? Z(o.y, s.y) : Z(s.y, o.y),
        n = o.x < s.x ? Z(o.x, s.x) : Z(s.x, o.x);
      K === `TB`
        ? o.x < s.x
  ...
  Le = t((e, t, n, r) => {
    let { look: i, theme: a, themeVariables: o } = p(),
...
`,
      ...
      K = s.getDirection();
      let d = n(`[id="${i}"]`),
        { look: f, theme: m, themeVariables: g } = p(),
        {
          useGradient: _,
          gradientStart: v,
          gradientStop: y,
      ...
      (u.forEach((e, t) => {
        ...
        h(void 0, d, c.diagramPadding, c.useMaxWidth));
    }, `draw`),
  },
  Q = 8,
  $ = new Set([`redux`, `redux-dark`, `redux-color`, `redux-dark-color`]),
  Be = new Set([`redux-color`, `redux-dark-color`]),
...
//# sourceMappingURL=gitGraphDiagram-UUTBAWPF-DoKBBLkC.js.map
