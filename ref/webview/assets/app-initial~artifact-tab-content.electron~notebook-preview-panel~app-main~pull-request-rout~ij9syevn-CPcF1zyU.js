...
function T(e) {
  let t = (e?.icons ?? []).flatMap((e) => {
    ...
    n = E(t.filter((e) => e.theme == null)),
    r = E(t.filter((e) => e.theme === `light`)) ?? n,
    i = E(t.filter((e) => e.theme === `dark`)) ?? n,
    a = r ?? i,
    o = i ?? r;
...
async function O(e) {
  return (await L(e)).flatMap(({ name: e, serverInfo: t, tools: n }) =>
    B.parse(Object.values(n))
      .filter(ce)
      .map((n) => ({
...
async function k(e) {
  return (await L(e)).map(({ name: t, serverInfo: n, tools: r }) => ({
    hostId: e,
    icon: T(n),
    server: t,
    tools: B.parse(Object.values(r)),
  }));
}
function A(e) {
  return e.flatMap(({ hostId: e, icon: t, server: n, tools: r }) =>
    r.flatMap((i) => se(e, t, n, i, r)),
  );
}
function j(e) {
  return e.flatMap(({ hostId: e, icon: t, server: n, tools: r }) =>
    r.flatMap((i) => {
      let a = M(i).flatMap((e) => (e.type === `file` ? e.extensions : [])),
        o = F(i);
      return a.length === 0 || o == null || !I(i)
        ? []
        : [
            {
              extensions: a,
...
function se(e, t, n, r, i) {
  let a = F(r);
  if (a == null || !I(r)) return [];
  let o = U.safeParse(r._meta),
    s = n === z && o.success,
    c = s ? o.data?.connector_id : void 0,
    l = s ? (P(r) ?? o.data?.connector_name ?? r.name) : N(r),
    u =
      c == null
        ? t
        : {
...
function M(e) {
  let t = V.safeParse(e._meta?.[`openai/ui`]);
...
var R,
  ...
  ue = e(() => {
    (x(),
      ...
      (R = 100),
      (z = `codex_apps`),
      (B = re.shape.tools.element.omit({ outputSchema: !0 }).loose().array()),
      (V = m({
        entrypoints: d(
          f([
            m({ type: g(`global`) }),
            m({ type: g(`thread`) }),
            m({ extensions: d(h().trim().min(1)), type: g(`file`) }),
          ]),
        ).optional(),
      }).optional()),
      (H = m({ "mentions/search": m({}).optional() }).optional()),
      (U = m({
        connector_id: h().trim().min(1).optional(),
        connector_name: h().trim().min(1).optional(),
      })
        .passthrough()
        .optional()));
  }),
  ...
  de = e(() => {
    (c(),
      ...
      (W = s(l, (e) => ({
        queryFn: () => k(e),
        queryKey: [...w, e, `capability-catalog`],
        staleTime: 0,
      }))),
      (G = a(l, ({ get: e }) =>
        e(S, `3669474837`) ? (e(W, `local`).data ?? []) : [],
      )),
      (K = s(l, (e) => ({
        queryFn: () => O(e),
        queryKey: [...w, e, `capability-mention-servers`],
        staleTime: 0,
      }))),
      (q = o(l, (e, { get: t }) =>
        t(S, `3669474837`) ? (t(K, e).data ?? []) : [],
      )),
      (J = a(l, ({ get: e }) => e(q, b))),
      (Y = o(l, (e, { get: t }) =>
        t(S, `3669474837`) ? j(t(W, e).data ?? []) : [],
      )),
      (X = a(l, ({ get: e }) => e(Y, b))),
      (Z = a(l, ({ get: e }) => A(e(G)))),
      (Q = a(l, ({ get: e }) =>
        e(Z).filter((e) => e.entrypoint === `global`),
      )));
  }),
  fe = n({ default: () => $ }),
  $,
  ...
  he = r((e) => {
    ...
    function s(t) {
      if (!t || typeof t != `string`) return !1;
      var n = r.exec(t),
        i = n && e.extensions[n[1].toLowerCase()];
      ...
      Object.keys(t).forEach(function (i) {
        ...
        if (!(!o || !o.length)) {
          ...
          for (var s = 0; s < o.length; s++) {
            var c = o[s];
            if (n[c]) {
              var l = r.indexOf(t[n[c]].source),
                u = r.indexOf(a.source);
              if (
                n[c] !== `application/octet-stream` &&
                (l > u || (l === u && n[c].substr(0, 12) === `application/`))
              )
                continue;
            }
            n[c] = i;
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~pull-request-rout~ij9syevn-CPcF1zyU.js.map
