...
import { n as Me, t as Ne } from "./use-element-in-view-DsZc1WuZ.js";
import {
  F as Pe,
  G as O,
  H as Fe,
  ...
  ot as Ve,
  rt as j,
} from "./plugin-detail-page-BCEJGadI.js";
import {
  a as He,
  c as Ue,
  i as We,
  ...
  t as qe,
  u as Je,
} from "./plugins-page-Bk6RV8ts.js";
import { n as Ye, t as Xe } from "./settings-host-dropdown-BHYosch6.js";
function Ze() {
  let e = (0, R.c)(5),
    t = de(),
    n = F(),
...
function I(e) {
  ...
  t[46] !== S || t[47] !== W || t[48] !== G
    ...
    : (K = t[49]);
  let q;
  t[50] !== ge || t[51] !== c || t[52] !== ye || t[53] !== D || t[54] !== f
    ? ((q = () => {
        if (!D) return;
        le(c, ue, {});
        let e = Ge({ creatorPath: D, isFirstOpen: !ge, kind: `skill` });
        (ge || ye(!0), f({ prefillPrompt: e, startInSidebar: !0 }));
      }),
      (t[50] = ge),
      (t[51] = c),
      (t[52] = ye),
...
//# sourceMappingURL=skills-page-DlxpTshI.js.map
