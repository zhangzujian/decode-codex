...
import { a as S, i as C, r as w, t as T } from "./src-DAARyDAb.js";
...
import { g as ce, u as le } from "./chunk-5PVQY5BW-BbQZwqS7.js";
var ue = n((e, t) => {
    (function (n, r) {
    ...
    (Tt = {
      ...
      renderer: {
        ...
        draw: O(function (e, t, n, r) {
          ...
          ((Q = g.parentElement.offsetWidth),
            Q === void 0 && (Q = 1200),
            s.useWidth !== void 0 && (Q = s.useWidth));
          let T = r.db.getTasks(),
            E = [];
          ...
          g.setAttribute(`viewBox`, `0 0 ` + Q + ` ` + A);
          let j = d.select(`[id="${t}"]`),
            M = x()
              .domain([
                i(T, function (e) {
              ...
              .rangeRound([0, Q - s.leftPadding - s.rightPadding]);
          function ee(e, t) {
            let n = e.startTime,
              r = t.startTime,
              i = 0;
            ...
            if (
              ...
              d
                ...
                .attr(`x`, function (e) {
                  ...
                  if (
                    (e.milestone &&
                      ((t += 0.5 * (M(e.endTime) - M(e.startTime)) - 0.5 * o),
                      (n = t + o)),
                    e.vert)
                  )
                    return M(e.startTime) + a;
          ...
          function re(e, n, i, a, o, c, l, u) {
            ...
            j.append(`g`)
              ...
              .attr(`x`, (e) => M(e.start.startOf(`day`)) + i)
              .attr(`y`, s.gridLineStartPadding)
              .attr(
                `width`,
                (e) => M(e.end.endOf(`day`)) - M(e.start.startOf(`day`)),
              )
              .attr(`height`, o - n - s.gridLineStartPadding)
              .attr(`transform-origin`, function (t, n) {
                return (
                  (M(t.start) + i + 0.5 * (M(t.end) - M(t.start))).toString() +
                  `px ` +
                  (n * e + 0.5 * o).toString() +
                  `px`
                );
          ...
          function le(e, t, n, i) {
            ...
            if (a === `off`) return;
            let o = j.append(`g`).attr(`class`, `today`),
              c = new Date(),
              l = o.append(`line`);
            (l
              .attr(`x1`, M(c) + e)
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-B8SNKRb2.js.map
