...
import { i as j } from "./app-initial~artifact-tab-content.electron~app-main~pull-request-code-review~new-thread-pane~jnqazr7u-B-F6AOtL.js";
import {
  Bt as M,
  Rt as N,
  Vt as P,
...
import { n as ce, t as le } from "./star-DKJDI1kW.js";
import {
  c as ue,
  l as de,
  n as fe,
  ...
  t as me,
  u as he,
} from "./git-branch-switcher-BLpkSakG.js";
import { n as ge, t as _e } from "./use-git-recent-branches-DlJdiQVr.js";
function ve(e) {
  let t = (0, ye.c)(11),
    { children: n, color: r, borderColor: a, badgeEnabled: o } = e,
    s = r === void 0 ? `bg-token-text-link-active-foreground` : r,
    c = o === void 0 ? !0 : o;
  if (!c) {
    let e;
    return (
      t[0] === n
        ? (e = t[1])
        : ((e = (0, Y.jsx)(Y.Fragment, { children: n })),
          (t[0] = n),
          (t[1] = e)),
      e
    );
  ...
  t[6] === u
    ? (d = t[7])
    : ((d = (0, Y.jsx)(`div`, { className: u })), (t[6] = u), (t[7] = d));
  let f;
  return (
    t[8] !== n || t[9] !== d
      ? ((f = (0, Y.jsxs)(`div`, { className: `relative`, children: [n, d] })),
        (t[8] = n),
        (t[9] = d),
        (t[10] = f))
      : (f = t[10]),
...
function xe(e) {
  ...
  let K = G,
    q = !V && !!L && y && !!W,
    te;
  t[3] === q ? (te = t[4]) : ((te = { enabled: q }), (t[3] = q), (t[4] = te));
  let {
      data: ne,
      isFetching: ie,
      error: se,
  ...
  let {
      ...
      isLoading: _e,
      refetch: ye,
    } = oe(j, s, `async_task_starting_state_dropdown`, he),
    Y = V && x && !!j,
    be;
  t[8] !== H || t[9] !== Y
    ? ((be = { enabled: Y, retainRepoWatch: H }),
      (t[8] = H),
      (t[9] = Y),
      (t[10] = be))
    : (be = t[10]);
  let { data: xe } = ue(j, s, `async_task_starting_state_dropdown`, be),
    {
      branches: Ee,
      defaultBranch: De,
      fetching: Ae,
      ...
      remoteDefaultBranch: F,
      enabled: V && x,
    }),
    Ne = W.trim().toLowerCase(),
    Z = Ne.length > 0,
    Q = V && y && Z,
    Pe;
  t[11] !== W || t[12] !== j || t[13] !== s || t[14] !== z || t[15] !== Q
    ? ((Pe = {
        cwd: j,
        hostConfig: s,
        operationSource: `async_task_starting_state_dropdown`,
        preserveRemoteRefs: z,
        query: W,
        enabled: Q,
      }),
      (t[11] = W),
      ...
      (t[16] = Pe))
    : (Pe = t[16]);
  let { data: Fe, isFetching: Ie, error: Le, refetch: Re } = n(de, Pe),
    ze = Fe?.branches,
    Be = a.type === `branch` ? (a.remoteRef ?? a.branchName) : void 0,
    $ = V ? De : F,
    Ve = V
      ? Z
        ? ze
        : Ee
      : Z
        ? ne?.filter((e) => e.toLowerCase().includes(Ne))
        : void 0,
    He = !Z || $.toLowerCase().includes(Ne),
    Ue = Ve?.filter((e) => e !== $),
    We;
  t[17] !== Z || t[18] !== z || t[19] !== Fe?.remoteBranchRefs
    ? ((We = z && Z ? (Fe?.remoteBranchRefs ?? []) : []),
      (t[17] = Z),
      (t[18] = z),
      (t[19] = Fe?.remoteBranchRefs),
      (t[20] = We))
    : (We = t[20]);
  let Ge = We,
    Ke = z && Ge.length > 0,
    ...
    Xe = !V && ce,
    Ze = ge ?? $,
    Qe = a.type === `branch` ? a.branchName : Ze,
    $e =
      xe?.type === `success`
        ? xe.stagedCount + xe.unstagedCount + (xe.untrackedCount ?? 0) > 0
        : !1,
    et = V && $e,
    tt = a.type === `working-tree` && $e,
    nt =
      a.type === `working-tree`
        ? (0, X.jsx)(u, {
        ...
        : (0, X.jsx)(u, {
            ...
            values: { branch: a.branchName },
          }),
    rt;
  t[21] === nt
    ? (rt = t[22])
    : ((rt = (0, X.jsx)(re, { electron: !0, children: nt })),
      (t[21] = nt),
      (t[22] = rt));
  let it;
  t[23] === Qe
    ? (it = t[24])
    : ((it = (0, X.jsx)(re, { browser: !0, children: Qe })),
      (t[23] = Qe),
      (t[24] = it));
  let at = (0, X.jsxs)(X.Fragment, {
      children: [
        rt,
        (0, X.jsx)(re, {
          extension: !0,
  ...
  t[32] === c
    ? (lt = t[33])
    : ((lt = i(`whitespace-nowrap`, c)), (t[32] = c), (t[33] = lt));
  let ut = a.type === `working-tree` && $e,
    dt;
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((dt = (0, X.jsx)(U, { className: `icon-xs` })), (t[34] = dt))
    : (dt = t[34]);
  let ft;
  t[35] === ut
    ? (ft = t[36])
  ...
  t[40] === K
    ...
    : ((ht = (e) => {
      ...
      (t[41] = ht));
  let gt;
  t[42] !== T || t[43] !== pt || t[44] !== ht
    ? ((gt = (0, X.jsx)(J.SearchInput, {
        autoFocus: !1,
        placeholder: pt,
        value: T,
        onChange: mt,
  ...
  let _t = et
      ? (0, X.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, X.jsx)(J.Item, {
              LeftIcon: Se,
              RightIcon: a.type === `working-tree` ? _ : void 0,
              SubText: $e
                ? (0, X.jsx)(`span`, {
                ...
                : void 0,
              onClick: () => {
                (o({ type: `working-tree` }), K(!1));
              },
              children: _e
                ? null
                : (0, X.jsx)(X.Fragment, { children: ge ?? $ }),
            }),
          ],
        })
      : null,
  ...
  let yt =
      W && qe
        ? (0, X.jsx)(`div`, {
            ...
            children: (0, X.jsx)(g, { className: `icon-xxs` }),
          })
        : W && Je
          ? (0, X.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, X.jsx)(p, {
                  ...
                  children: (0, X.jsx)(w, { className: `icon-xxs` }),
                }),
              ],
            })
          : (0, X.jsxs)(`div`, {
              ...
              children: [
                He &&
                  (0, X.jsx)(J.Item, {
                    LeftIcon: U,
                    RightIcon: Be === $ ? _ : void 0,
                    onClick: () => {
                      (o({ type: `branch`, branchName: $ }), K(!1));
                    },
                    children: $,
                  }),
                Ue?.map((e) =>
                  (0, X.jsx)(
                    J.Item,
                    {
                      ...
                      onClick: () => {
                        (o({ type: `branch`, branchName: e }), K(!1));
                      },
                      children: e,
                    },
                    e,
...
function Se(e) {
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, X.jsx)(ve, {
          borderColor: `border-token-side-bar-background`,
          children: (0, X.jsx)(U, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
function we(e) {
  ...
  let {
      ...
      error: p,
      refetch: m,
    } = K(n, i, `async_task_starting_state_dropdown`, l),
    h;
  t[3] !== s || t[4] !== c
  ...
  let {
      ...
      error: y,
      refetch: b,
    } = ge(n, i, `async_task_starting_state_dropdown`, h),
    x;
  if (t[6] !== a || t[7] !== u || t[8] !== g || t[9] !== o) {
    let e = [
        u,
        a,
        Ee({
  ...
  let ee = T,
    E;
  return (
    t[14] !== x || t[15] !== S || t[16] !== w || t[17] !== C || t[18] !== ee
      ? ((E = {
          branches: x,
          defaultBranch: S,
          fetching: C,
...
function Te(e) {
  ...
  return (
    t[2] !== r || t[3] !== a
      ? ((o = (0, X.jsx)(`div`, { className: a, children: r })),
        (t[2] = r),
        (t[3] = a),
        (t[4] = o))
      : (o = t[4]),
  ...
  return t == null
    ...
    : (0, Q.jsx)(S, {
        ...
        children: (0, Q.jsx)(ee, {
          ...
          collapse: `sm`,
          disabled: n,
          icon: (0, Q.jsx)(U, { className: `icon-xs` }),
...
function Fe(e) {
  ...
  if (
    ...
    (t[25] === f
      ? (c = t[26])
      : ((c = f ? b(f) : null), (t[25] = f), (t[26] = c)),
      (O = c));
    let l = a.find((e) => b(e.configPath) === O) ?? null,
      d = !o && !s;
    D = e && C ? a.filter((t) => b(t.configPath) !== b(e.configPath)) : a;
    let m = Re({ isLoading: o, selectedEnvironment: l });
    ((E = ae), (A = w), (j = T), (M = v), (N = y));
    let h;
    ...
    t[28] === n
      ? (g = t[29])
      : ((g = i(`whitespace-nowrap`, n)), (t[28] = n), (t[29] = g));
    let k = r == null ? `secondary` : `sm`,
      B;
    t[30] === x
      ? (B = t[31])
      : ((B = x ? (0, $.jsx)(H, { className: `icon-xs` }) : null),
        (t[30] = x),
        (t[31] = B));
    let V = o ? `pending` : `collapsible-chevron`,
      U;
    (t[32] === r
      ? (U = t[33])
      : ((U = i(`max-w-40`, r)), (t[32] = r), (t[33] = U)),
      t[34] !== m ||
      t[35] !== g ||
      t[36] !== k ||
      t[37] !== B ||
      ...
      t[39] !== U
        ? ((P = (0, $.jsx)(S, {
          ...
          (t[40] = P))
        : (P = t[40]),
      (R = `flex w-64 flex-col overflow-hidden`),
      t[41] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((z = (0, $.jsx)(J.Title, {
          ...
          (t[41] = z))
        : (z = t[41]),
      (F = `vertical-scroll-fade-mask flex max-h-[220px] flex-col overflow-y-auto`),
      t[42] !== p || t[43] !== f || t[44] !== d
        ? ((I = d
            ? (0, $.jsx)(J.Item, {
                RightIcon: f == null ? _ : void 0,
                onClick: () => {
                  (p(null), T(!1));
                },
                children: (0, $.jsx)(u, {
      ...
      (L =
        C && e
          ? (0, $.jsx)(J.Item, {
              RightIcon: O != null && b(e.configPath) === O ? _ : void 0,
              onClick: () => {
                (p(e.configPath), T(!1));
              },
              children: (0, $.jsxs)(`div`, {
  ...
  t[52] !== f
    ? ((B = o
        ? (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(g, { className: `icon-xxs` }),
          })
        : s
          ? (0, $.jsx)(J.Message, {
              compact: !0,
          ...
          : D.length > 0
            ? (0, $.jsx)(`div`, {
                className: `flex flex-col`,
                children: D.map((e) => {
                  let t = f != null && b(e.configPath) === O;
                  return (0, $.jsx)(
                    J.Item,
                    {
                      RightIcon: t ? _ : void 0,
                      onClick: () => {
                        (p(e.configPath), T(!1));
                      },
                      children: (0, $.jsx)(`span`, {
    ...
    : (B = t[53]);
  let V;
  t[54] !== B || t[55] !== F || t[56] !== I || t[57] !== L
    ? ((V = (0, $.jsxs)(`div`, { className: F, children: [I, L, B] })),
      (t[54] = B),
      (t[55] = F),
      (t[56] = I),
      (t[57] = L),
  ...
  t[63] === W
    ...
    : ((K = (0, $.jsx)(J.Section, {
        ...
        children: (0, $.jsx)(J.Item, { LeftIcon: k, onClick: W, children: G }),
      })),
      (t[63] = W),
      (t[64] = K));
  let q;
  t[65] !== V || t[66] !== K || t[67] !== R || t[68] !== z
    ? ((q = (0, $.jsxs)(`div`, { className: R, children: [z, V, U, K] })),
      (t[65] = V),
      (t[66] = K),
      (t[67] = R),
      (t[68] = z),
...
//# sourceMappingURL=worktree-environment-dropdown-CIoKKGRW.js.map
