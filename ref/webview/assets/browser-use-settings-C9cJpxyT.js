...
import { n as Yn, t as Xn } from "./use-home-directory-BCmhEc_0.js";
import { n as Zn, t as Qn } from "./settings-loading-row-BBNN4NrH.js";
import { n as $n, t as er } from "./settings-row-disclosure-BkrXyeEo.js";
function tr(e) {
  let t = (0, nr.c)(6),
    { service: r } = e,
    i = n(h);
...
function xi(e) {
  ...
  let { pendingPluginId: x, setPluginEnabled: S } = xt(b),
    C;
  t[7] === o ? (C = t[8]) : ((C = { hostId: o }), (t[7] = o), (t[8] = C));
  let { pendingUninstallPluginId: w, uninstallPlugin: T } = _t(C),
...
function Ci(e) {
  ...
  t[0] === n.icon
    ...
    : ((i =
        n.icon ??
        (0, Z.jsx)(kt, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
...
//# sourceMappingURL=browser-use-settings-C9cJpxyT.js.map
