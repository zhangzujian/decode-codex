...
import {
  ...
  r as U,
  t as W,
} from "./connect-plugins-submenu-item-DDVhErV1.js";
import { n as G, t as re } from "./connector-logo-stack-i0Zwh6QS.js";
function ie() {
  let e = (0, K.c)(1),
    t;
  return (
...
function se(e) {
  ...
  t[10] !== r || t[11] !== s || t[12] !== f
    ? ((E = (e, t) => {
        if (t) {
          (r.insertMentionAtSelection(m(e, h(s))), f(e));
          return;
        }
...
//# sourceMappingURL=composer-work-home-plugins-control.electron-DUdd4w3o.js.map
