...
function i(e) {
  let t = c(e),
    n = t ? a(e) : `*${e}`,
    r = o(e),
    i = new N(n, `IGNORE_CASE`, A.join(``)),
    s = t && e !== r ? new N(r, `IGNORE_CASE`, A.join(``)) : null;
  return new M(i, s);
}
function a(e) {
  let t = `*${e}`;
    ...
    ((D = 100),
      ...
      (N = class {
        ...
        matchingDegree(e, t = !1, n = this.match(e)) {
          ...
          return (
            (_ ? 1e3 : 0) + o - n.length + -c * 10 + (h ? 0 : 2) + +!!i + +!!v
          );
        }
        match(e) {
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~app-main~pull-request-code-review~new-thread-pane~b6mb9dk4-gMHmseWC.js.map
