...
function re({ loginHint: e, statsigClient: t, url: n }) {
  if (e == null) return n;
  let r = new URL(n);
  return r.origin !== D.origin ||
    !r.pathname.startsWith(O) ||
    !x(t, k, { disableExposureLog: !1 }).get(`enabled`, !1)
    ? n
...
function ae(e) {
  ...
  t[0] !== i || t[1] !== a
    ...
    : (o = t[2]);
  let s;
  t[3] === i ? (s = t[4]) : ((s = () => De(i)), (t[3] = i), (t[4] = s));
  let l = n && a != null,
    d;
...
function le(e) {
  ...
  let { accountId: o, isLoading: s } = N(a),
    l = n ?? o,
    d = n == null && s,
    f;
...
function fe(e) {
  ...
  let { accountId: i, isLoading: a } = N(r),
    o;
  ...
  t[4] === i
    ? (l = t[5])
    : ((l = async () => (i == null ? null : Te(i))), (t[4] = i), (t[5] = l));
  let d;
  return (
    t[6] !== o || t[7] !== s || t[8] !== l
      ? ((d = {
...
function ye() {
  ...
  e[2] !== i || e[3] !== n || e[4] !== r
    ? ((c = (e) => {
        A(e.immediate_top_up_status) ||
          P({ scope: n, queryClient: i, response: e, userId: r });
      }),
      (e[2] = i),
      (e[3] = n),
      (e[4] = r),
  ...
  let l;
  e[6] !== s || e[7] !== c
    ? ((l = { mutationKey: s, mutationFn: M, onSuccess: c }),
      (e[6] = s),
      (e[7] = c),
      (e[8] = l))
    : (l = e[8]);
  ...
  let m;
  e[15] !== f || e[16] !== p
    ? ((m = { mutationKey: f, mutationFn: xe, onSuccess: p }),
      (e[15] = f),
      (e[16] = p),
      (e[17] = m))
    : (m = e[17]);
  ...
  let v;
  e[24] !== g || e[25] !== _
    ? ((v = { mutationKey: g, mutationFn: be, onSuccess: _ }),
      (e[24] = g),
      (e[25] = _),
      (e[26] = v))
    : (v = e[26]);
...
function Se() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = { mutationKey: Q, mutationFn: Ce }), (e[0] = t))
      : (t = e[0]),
    d(t)
  );
}
...
function N(e) {
  let t = (0, R.c)(8),
    { enabled: n } = e,
    { data: r, isLoading: i, hasEverErrored: a } = E(),
    o = r?.id == null && (!i || a),
    s = n && o,
    c;
  t[0] === s
...
function P({ scope: e, queryClient: t, response: n, userId: r }) {
...
//# sourceMappingURL=app-initial~app-main~new-thread-panel-page~appgen-library-page~hotkey-window-thread-page~ho~crseajay-C22uONlO.js.map
