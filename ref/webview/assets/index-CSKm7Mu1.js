const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./app-initial~app-main~register-app-actions-D9NnGgvQ.js",
      "./app-BhlMTBOP.js",
      "./app-C_Uac7Z9.css",
    ]),
) => i.map((i) => d[i]);
...
var i = e(() => {}),
  a = e(async () => {
    (r(),
      await n(
        () => import(`./rpc-CIiXgyOV.js`),
        __vite__mapDeps([0, 1, 2, 3]),
        import.meta.url,
      ),
      await n(
        () => import(`./app-main-cd2sAUyT.js`),
        __vite__mapDeps([
...
//# sourceMappingURL=index-CSKm7Mu1.js.map
