...
function ae(e, t = ``) {
  let n = k(
    (e?.items ?? []).flatMap((e) =>
      e.type === `agentMessage` ? oe(b(e.text, void 0), e.id) : [],
    ),
    fe,
  );
  return n.key.length > 0 || t.trim().length === 0
    ? n
    : k(oe(b(t, void 0), `home-title`), pe);
}
function O(e) {
  return e ? 20 : 10;
}
...
function Re(e) {
  ...
  let _;
  (t[7] !== p || t[8] !== o
    ? ((_ = [p, o]), (t[7] = p), (t[8] = o), (t[9] = _))
    : (_ = t[9]),
    (0, W.useEffect)(h, _));
  let v;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = { height: 192, opacity: 1 }), (t[10] = v))
    : (v = t[10]);
  let y = f ? 0.12 : Ve,
    b;
  t[11] === y
    ? (b = t[12])
    : ((b = { duration: y, ease: He }), (t[11] = y), (t[12] = b));
  let x;
...
function We(e) {
  ...
  (t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (e) => {
      ...
      (t[3] = u))
    : (u = t[3]),
    p(`codex-micro-joystick-event`, u));
  let d;
...
function tn({ playing: e = !0, reducedMotion: t, level: n, onExit: r }) {
  ...
  (p(`codex-micro-joystick-event`, ({ event: e }) => {
    let t = i.current;
    t != null && Rt(t, e);
  }),
    (0, Q.useEffect)(() => {
...
function on(e) {
  ...
  t[0] === p.value
    ? (m = t[1])
    : ((m = _(p.value)), (t[0] = p.value), (t[1] = m));
  let h = m,
    g = r(ee, o),
    y = i(re),
    { status: b } = i(te),
    x = y?.composerId === h,
    S = !s && !l && (b === `connected` || (x && b !== `not-detected`)),
    C = u && b === `connected`,
    w;
  t[2] === f
    ? (w = t[3])
  ...
  let T = w,
    ...
    D;
  if (
    (t[4] !== S || t[5] !== h || t[6] !== a || t[7] !== f
      ? ((E = () => {
          if (S)
            return ne(h, a, () => {
              f.get(re)?.composerId === h && ie(f);
            });
        }),
        (D = [S, h, a, f]),
        (t[4] = S),
...
//# sourceMappingURL=codex-micro-mini-game-composer-BA8Im2-W.js.map
