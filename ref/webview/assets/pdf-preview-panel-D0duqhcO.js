...
import { n as ze, t as Be } from "./artifact-preview-status-CErP5ltg.js";
function Ve(e) {
  let t = (0, Ge.c)(19),
...
var Ge,
  ...
  Je,
  Ye = e(() => {
    ((Ge = s()), (Ke = t(o(), 1)), (qe = [0, 0.25, 0.5, 0.75, 1]), (Je = 100));
  });
function Xe(e) {
  let t = (0, $e.c)(10),
    { fileDataUrl: n } = e,
...
function Vt({
  ...
  let y = n(u),
    ...
    [ee, M] = (0, Y.useState)(null),
    [N, P] = (0, Y.useState)(null),
    [F, L] = (0, Y.useState)(null),
    [ne, R] = (0, Y.useState)(null),
    [re, z] = (0, Y.useState)(!1),
    [ie, ae] = (0, Y.useState)(!1),
    oe = x.formatMessage({
    ...
    B = (0, Y.useMemo)(
      () => e.filter((e) => e.localPdfContext?.pageNumber === d),
      [e, d],
    ),
    le = ne == null ? null : (B.find((e) => on(e) === ne) ?? null),
    ue = F == null ? null : (B.find((e) => on(e) === F) ?? null),
    V = ue == null ? null : Zt(ue),
    H = E ?? V,
    U = (0, Y.useMemo)(
      () =>
        E == null
          ? V == null || ue == null || F == null
            ? null
            : Jt({
                anchor: V,
                body: Qt(ue),
      ...
      [s, E, O, V, ue, F, d, m, h, v],
    ),
    de = H == null ? null : $t({ anchor: H, layer: w, pageSize: m }),
    W = H != null,
    G = (0, Y.useCallback)(() => {
      (E != null && o?.(d, !1),
        D(null),
    ...
    _e = (0, Y.useCallback)(
      () =>
        U == null
          ? !1
          : U.target.mode === `create` && O.trim().length > 0
            ? re
              ? (G(), !0)
              : (z(!0), pe(), !1)
            : (G(), !0),
    ...
    ve = (0, Y.useEffectEvent)(() => {
      if (H == null) return;
      let e = $t({ anchor: H, layer: w, pageSize: m });
      e != null && be(S.current, e);
    });
  (0, Y.useEffect)(() => {
    if (!W || w == null) return;
  ...
  let ye = (0, Y.useEffectEvent)((e) => {
    let t = e.target;
    (t instanceof Node && S.current?.contains(t)) ||
      (e.preventDefault(),
      e.stopPropagation(),
      _e() &&
  ...
  (0, Y.useEffect)(() => {
    if (t || U?.target.mode !== `create` || w == null) return;
    let e = w.ownerDocument,
      n = (e) => {
        ye(e);
      };
  ...
  let xe = (0, Y.useEffectEvent)(() => {
    ...
    if (e == null) return;
    let n = mt({ pageElement: e, pageSize: m });
    if (n == null) {
      M(null);
      return;
    }
    ((E != null || F != null) && !_e()) ||
      (M(n), D(null), k(``), L(null), R(null), P(null), z(!1));
  });
  (0, Y.useEffect)(() => {
    if (w == null || t) return;
    let e = w.parentElement;
  ...
  let K = (e, n, r) => {
    ...
    Te = (0, Y.useEffectEvent)((e, t) => {
      if (E != null || F != null || !he(e)) return;
      let n =
        mt({ pageElement: t, pageSize: m }) ??
        (ee?.selectionKind === `text` ? null : ee);
      n != null &&
        (e.preventDefault(), e.stopPropagation(), q(n, `ask_codex_shortcut`));
    });
  (0, Y.useEffect)(() => {
    if (w == null || t) return;
    let e = w.parentElement;
  ...
  let Ee = (e) => {
      ((E != null || F != null) && !_e()) || q(e, `annotation_mode_pointer`);
    },
    Oe = (e) => {
    ...
    je = (e) => {
      ...
      (q(i, `annotation_mode_pointer`), j(null));
    },
    Me = async (e, { submitDirectly: n = !1 } = {}) => {
      let i = e.body.trim();
      if (F != null) {
        if (i.length === 0 || ie) return;
        (a((e) =>
          e.map((e) =>
            on(e) === F
      ...
      if (!(E == null || i.length === 0 || ie))
        try {
          ae(!0);
          let o = Yt({ anchor: E, pageSize: m }),
            u = crypto.randomUUID(),
            b;
          try {
            b = await en({
  ...
  return (0, X.jsxs)(`div`, {
    ref: T,
    className: i(`absolute inset-0 z-[3]`, !t && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: t ? { cursor: we } : void 0,
    onPointerDown: Oe,
    onPointerMove: ke,
    onPointerUp: je,
    onPointerCancel: () => {
    ...
    children: [
      ...
      ee != null && E == null
        ? (0, X.jsx)(Ce, {
            anchor: ee.askForEditAnchor,
            label: ce,
            pageSize: m,
            rect: ee.rect,
            testId: `artifact-pdf-ask-for-edit-button`,
            onClick: () => q(ee, `ask_codex_button`),
          })
        : null,
      A == null
        ? null
        : (0, X.jsx)(Kt, { rect: vt(A.start, A.current), pageSize: m }),
      E == null ? null : (0, X.jsx)(Wt, { anchor: E, label: r, pageSize: m }),
      H == null || de == null || U == null
        ? null
        : (0, X.jsx)(`div`, {
            ref: S,
            className: me,
            style: { left: de.x, top: de.y, height: Se, width: 294 },
            ...
            children: (0, X.jsx)(
              Ae,
              {
                ...
                onCancel: G,
                onDelete: (e) => {
                  (a((t) => t.filter((t) => on(t) !== e)), G());
                },
                onDirectSubmit: (e) => {
                  Me(e, { submitDirectly: !0 });
                },
                onEscape: G,
                onBodyChange: U.target.mode === `create` ? fe : void 0,
    ...
    ((Nn = s()),
      ...
      (In = (0, Pn.memo)(function (e) {
        ...
        t[0] !== c || t[1] !== u || t[2] !== k
          ...
          : (A = t[3]);
        let j = A,
          ee = O != null && O.width > 0 ? j.width / O.width : 1,
          M = Math.abs(r - a),
          N = w || M <= 2,
          P = w || M <= 2,
          F = w ? 50 : 50 + M * 40,
        ...
        t[43] !== N ||
        t[44] !== _
          ? ((se = [j.height, j.width, w, p, m, h, D, d, N, _]),
            (t[35] = j.height),
            (t[36] = j.width),
            (t[37] = w),
            (t[38] = p),
            ...
            (t[45] = se))
          : (se = t[45]),
          (0, Pn.useEffect)(oe, se));
        let ce = O == null ? void 0 : ``,
          B = D?.userUnit ?? 1,
          le;
        t[46] !== j.height || t[47] !== j.width || t[48] !== ee || t[49] !== B
          ? ((le = {
              "--scale-factor": ee,
              "--user-unit": B,
              height: j.height,
...
function Rn(e) {
  ...
  t[0] !== n || t[1] !== r
    ...
    : (d = t[2]);
  let [f, p] = (0, Hn.useState)(d),
    [m, h] = (0, Hn.useState)(null),
    g;
  ...
  let T = C,
    D;
  t[8] !== T || t[9] !== a
    ? ((D = { onExternalLink: a, onPageChange: T }),
      (t[8] = T),
      (t[9] = a),
      (t[10] = D))
    : (D = t[10]);
  ...
  let I = te,
    L;
  t[21] !== I || t[22] !== T || t[23] !== F || t[24] !== r || t[25] !== i
    ? ((L = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
        ...
        e.key === `End` && (e.preventDefault(), T(r));
      }),
      (t[21] = I),
      (t[22] = T),
      (t[23] = F),
  ...
  let re = R,
    z;
  t[30] !== o || t[31] !== m
    ? ((z = zn({ pageViewportSize: o, presentationSize: m })),
      (t[30] = o),
      (t[31] = m),
      (t[32] = z))
    : (z = t[32]);
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ie = t[33]);
  let ae;
  t[34] !== N || t[35] !== O || t[36] !== o || t[37] !== s || t[38] !== z
    ? ((ae = (0, Z.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, Z.jsx)(E, { className: `icon-2xs rotate-180` })), (t[40] = se))
    : (se = t[40]);
  let ce;
  t[41] !== F || t[42] !== A || t[43] !== oe
    ? ((ce = (0, Z.jsx)(S, {
        "aria-label": A,
        color: `ghost`,
        disabled: oe,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ue = (0, Z.jsx)(E, { className: `icon-2xs` })), (t[48] = ue))
    : (ue = t[48]);
  let V;
  t[49] !== I || t[50] !== M || t[51] !== le
    ? ((V = (0, Z.jsx)(S, {
        "aria-label": M,
        color: `ghost`,
        disabled: le,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, Z.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })),
      (t[53] = H))
    : (H = t[53]);
  let U, de;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = (0, Z.jsx)(w, { className: `icon-2xs` })),
      (de = (0, Z.jsx)(y, {
...
var Vn,
  ...
  Z,
  Un = e(() => {
    ((Vn = s()), (Hn = t(o(), 1)), x(), T(), D(), C(), M(), Ln(), (Z = d()));
  });
...
function $n(e) {
  ...
  let M = (0, Q.useRef)(k),
    [N, F] = (0, Q.useState)(!1),
    [I, L] = (0, Q.useState)(!1),
    [z, ae] = (0, Q.useState)(null),
    oe;
  t[1] === v.value
    ? (oe = t[2])
    : ((oe = ie(v.value)), (t[1] = v.value), (t[2] = oe));
  let B = oe,
    le;
  t[3] === B
    ? (le = t[4])
    : ((le = B ?? ne({ entrypoint: `home` })), (t[3] = B), (t[4] = le));
  let W = le,
    G = r(ce, W),
    pe;
  t[5] !== W || t[6] !== v
  ...
  if (t[8] !== G || t[9] !== f) {
    ...
    (t[11] === f
      ? (e = t[12])
      : ((e = (e) => m(e) && e.localPdfContext?.path === f),
        (t[11] = f),
        (t[12] = e)),
      (he = G.filter(e)),
      (t[8] = G),
  ...
  t[13] === ge
    ? (_e = t[14])
    : ((_e = Math.max(0, ...ge.map(rr))), (t[13] = ge), (t[14] = _e));
  let ve = _e + 1,
    ye,
    be;
  (t[15] !== f || t[16] !== me
    ? ((ye = () => () => {
        me((e) => {
          let t = e.filter((e) => !(m(e) && e.localPdfContext?.path === f));
  ...
  t[19] === a
    ? (xe = t[20])
    : ((xe = { fileDataUrl: a }), (t[19] = a), (t[20] = xe));
  let {
      loadedFileDataUrl: Se,
      loadState: Ce,
      loadStateFileDataUrl: we,
      numPages: K,
      pageViewportSize: q,
      pdfDocument: Te,
    } = Xe(xe),
  ...
  t[21] === K
    ...
    : ((Ee = {
      ...
      (t[21] = K),
      (t[22] = Ee));
  let { currentPage: De, goToNextPage: Oe, goToPreviousPage: ke } = Ve(Ee),
    Ae;
  ...
  let je = Ae,
    Pe;
  t[24] !== q || t[25] !== z
    ? ((Pe = { onBeforeZoom: je, pageViewportSize: q, pageWidth: z }),
      (t[24] = q),
      (t[25] = z),
      (t[26] = Pe))
    : (Pe = t[26]);
  ...
  t[31] === Fe
    ...
    : ((Je = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = O.current;
        n !== t &&
          (n != null && (je({ kind: `center` }), Fe()), (O.current = t), ae(t));
      }),
      (t[31] = Fe),
      (t[32] = Je));
  let Ye = ee(Je),
  ...
  (t[43] === a
    ? ((tt = t[44]), (nt = t[45]))
    : ((tt = () => {
        D.current !== a && ((D.current = a), je({ kind: `center` }));
      }),
      (nt = [je, a]),
      (t[43] = a),
      (t[44] = tt),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (rt = t[46]);
  let it;
  (t[47] === a ? (it = t[48]) : ((it = [a]), (t[47] = a), (t[48] = it)),
    (0, Q.useEffect)(rt, it));
  let at;
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((at = () => {
        ((w.current = !1), (T.current = !1));
      }),
      (t[49] = at))
    : (at = t[49]);
  let ot;
  (t[50] !== a || t[51] !== p
    ? ((ot = [a, p]), (t[50] = a), (t[51] = p), (t[52] = ot))
    : (ot = t[52]),
    (0, Q.useEffect)(at, ot));
  let st, ct;
  (t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        let e = () => {
          document.fullscreenElement !== x.current && F(!1);
        };
        return (
  ...
  t[55] === Re
    ...
    : ((lt = (e) => {
      ...
      (t[56] = lt));
  let ut = lt,
    J = Ce === `ready` && Te != null && Se === a,
    dt = J,
    ft = J ? Te : null,
    pt;
  t[57] !== K || t[58] !== v
    ? ((pt = () => {
        ((C.current = !0), te(v, P, { pageCount: K }));
      }),
      (t[57] = K),
      (t[58] = v),
      (t[59] = pt))
  ...
  t[72] !== J || t[73] !== vt
    ...
    : (Ct = t[74]);
  let wt;
  (t[75] !== J || t[76] !== p || t[77] !== vt
    ? ((wt = [J, p, vt]), (t[75] = J), (t[76] = p), (t[77] = vt), (t[78] = wt))
    : (wt = t[78]),
    (0, Q.useEffect)(Ct, wt));
  let Tt;
  t[79] !== a || t[80] !== Ce || t[81] !== we || t[82] !== bt
    ? ((Tt = () => {
        Ce !== `error` || we !== a || T.current || bt();
      }),
      (t[79] = a),
      (t[80] = Ce),
      (t[81] = we),
    ...
    : (Tt = t[83]);
  let Et;
  (t[84] !== a || t[85] !== Ce || t[86] !== we || t[87] !== p || t[88] !== bt
    ? ((Et = [a, Ce, we, p, bt]),
      (t[84] = a),
      (t[85] = Ce),
      (t[86] = we),
  ...
  t[90] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Dt = () => {
        (F(!1),
          document.fullscreenElement === x.current &&
  ...
  let Rt = Lt,
    ...
    Vt;
  t[101] !== I || t[102] !== v || t[103] !== g || t[104] !== B
    ? ((Vt = () => {
        (Bt(!1),
          I ||
            Ie(v, {
    ...
    : (Vt = t[105]);
  let Ht;
  t[106] !== It || t[107] !== Rt || t[108] !== I || t[109] !== Vt
    ? ((Ht = (0, $.jsx)(Ne, {
        active: I,
        activeLabel: Rt,
        label: It,
              ...
              : (0, $.jsxs)($.Fragment, {
                  children: [
                    J
                      ? (0, $.jsx)(de, {
                          artifactType: `PDF`,
                          hideMetadata: i === `standalone`,
                          title: ir(_),
                          centerContent: (0, $.jsx)(H, {
                            currentPage: De,
                            onNextPage: Oe,
                            onPreviousPage: ke,
                            totalPages: K,
...
//# sourceMappingURL=pdf-preview-panel-D0duqhcO.js.map
