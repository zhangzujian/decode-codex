...
import { ht as t, wt as n } from "./merge-DluFmTQM.js";
import {
  F as r,
  Lt as i,
  U as a,
...
import { n as d } from "./isEmpty-CN-Tjjtl.js";
function f(e, t) {
  e[t] ? e[t]++ : (e[t] = 1);
}
function p(e, t) {
      ...
      (b = class {
        ...
        setParent(e, t) {
          ...
          if (r(t)) t = v;
            ...
            t += ``;
            for (var n = t; !r(n); n = this.parent(n))
              if (n === e)
                throw Error(
                  `Setting ` +
                    t +
        ...
        filterNodes(e) {
          ...
          var n = this;
          (s(this._nodes, function (n, r) {
            e(r) && t.setNode(r, n);
          }),
            s(this._edgeObjs, function (e) {
        ...
        setEdge() {
          ...
          (typeof o == `object` && o && `v` in o
            ...
            (t = `` + t),
            r(n) || (n = `` + n));
          var s = m(this._isDirected, e, t, n);
          ...
          (this.setNode(e),
            this.setNode(t),
            (this._edgeLabels[s] = a ? i : this._defaultEdgeLabelFn(e, t, n)));
...
//# sourceMappingURL=graphlib-CBRK-rXR.js.map
