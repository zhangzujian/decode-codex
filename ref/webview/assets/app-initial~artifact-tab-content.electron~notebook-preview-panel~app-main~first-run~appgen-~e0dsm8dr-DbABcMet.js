            ...
            (0, h.jsxs)(`defs`, {
              children: [
                (0, h.jsxs)(`linearGradient`, {
                  ...
                  children: [
                    (0, h.jsx)(`stop`, { offset: 0.09, stopColor: `#ffe921` }),
                    (0, h.jsx)(`stop`, { offset: 1, stopColor: `#fec700` }),
                  ],
                }),
                (0, h.jsxs)(`linearGradient`, {
                  ...
                  gradientUnits: `userSpaceOnUse`,
                  children: [
                    (0, h.jsx)(`stop`, { offset: 0.15, stopColor: `#a9a8ff` }),
                    (0, h.jsx)(`stop`, { offset: 0.33, stopColor: `#6d97ff` }),
                    (0, h.jsx)(`stop`, { offset: 0.48, stopColor: `#3186ff` }),
                  ],
                }),
                (0, h.jsxs)(`linearGradient`, {
                  ...
                  gradientUnits: `userSpaceOnUse`,
                  children: [
                    (0, h.jsx)(`stop`, { offset: 0.55, stopColor: `#0ebc5f` }),
                    (0, h.jsx)(`stop`, { offset: 0.85, stopColor: `#78c9ff` }),
                  ],
                }),
              ],
            }),
...
function V({ scope: e, intl: t, repoLabel: n, adminLabel: r }) {
  if (e === `repo`) return n ?? t.formatMessage(G.repo);
  if (e === `admin`) return r ?? t.formatMessage(G.admin);
  let i = G[e];
  return i ? t.formatMessage(i) : z(e, t);
}
function H({ skillPath: e, roots: t, fallbackLabel: n }) {
  let r = t.reduce(
...
function U({
  ...
  return V({
    ...
    repoLabel: H({
      skillPath: e.path,
      roots: t,
      fallbackLabel: r ?? V({ scope: `repo`, intl: n }),
    }),
    adminLabel: i,
  });
}
...
function q(e) {
  let t = (0, ie.c)(60),
    {
      ...
      onHighlight: o,
      onEscape: s,
      autoHighlightFirst: c,
      captureWindowKeydown: l,
      keyboardEventScope: u,
      keyboardEventTarget: d,
      preserveHighlightOnItemsChange: f,
      shouldHandleKeyDown: p,
    } = e,
    m = c === void 0 ? !0 : c,
    h = l === void 0 ? !1 : l,
    g = f === void 0 ? !1 : f,
  ...
  let v = _,
    ...
    b = (0, J.useRef)(null),
    x = n == null ? 0 : n.length,
    [S, C] = (0, J.useState)(m && x > 0 ? 0 : -1),
    w = r && S >= 0 && S < x ? (n?.[S] ?? null) : null,
    T;
  t[1] !== i || t[2] !== w
    ? ((T = w == null ? null : (i?.(w) ?? w)),
      (t[1] = i),
  ...
  t[12] !== g
    ? ((k = () => {
        let e = b.current,
          t =
            e != null &&
            (n == null || e.length !== x || e.some((e, t) => e !== n[t]));
        if (((b.current = n), !r || x === 0)) {
          S !== -1 && C(-1);
          return;
        }
        if (S >= 0 && S < x && (g || !t)) return;
        let i = m ? 0 : -1;
        S !== i && C(i);
      }),
      (A = [m, S, r, n, x, g]),
  ...
  let M;
  (t[19] !== S || t[20] !== E
    ? ((M = [S, E]), (t[19] = S), (t[20] = E), (t[21] = M))
    : (M = t[21]),
    (0, J.useEffect)(j, M));
  let N, P;
  (t[22] !== S || t[23] !== r || t[24] !== x
    ? ((N = () => {
        if (!r || S < 0 || S >= x) return;
        let e = y.current;
        e &&
    ...
    (0, J.useEffect)(N, P));
  let F;
  t[27] !== n || t[28] !== x || t[29] !== a
    ? ((F = (e) => {
        let t = n != null && e >= 0 && e < x ? n[e] : void 0;
        t && (C(e), a(t, e));
      }),
      (t[27] = n),
      (t[28] = x),
  ...
  t[31] === x
    ? (L = t[32])
    : ((L = (e) => {
        C((t) => (x === 0 ? -1 : t < 0 ? (e >= 0 ? 0 : x - 1) : ne(t + e, x)));
      }),
      (t[31] = x),
      (t[32] = L));
  let R = L,
  ...
  t[40] !== p
    ? ((B = (e) => {
        if (!r || p?.(e) === !1) return !1;
        let { key: t } = e;
        if (x === 0) return t === `Escape` && s ? (s(), z(e), !0) : !1;
        if (t === `ArrowDown` || (v && e.ctrlKey && t === `n`))
          return (R(1), z(e), !0);
        if (t === `ArrowUp` || (v && e.ctrlKey && t === `p`))
          return (R(-1), z(e), !0);
        if (t === `Enter`) {
          let t = S >= 0 ? S : m ? 0 : -1;
          return t >= 0 && t < x ? (I(t), z(e), !0) : !1;
        }
        return t === `Escape` && s ? (s(), z(e), !0) : !1;
      }),
      (t[33] = m),
      (t[34] = S),
      (t[35] = r),
  ...
  let V = B,
    H,
    U;
  (t[42] !== h || t[43] !== V || t[44] !== r || t[45] !== u || t[46] !== d
    ? ((H = () => {
        if (!h || !r) return;
        let e = (e) => {
            (u != null &&
              (!(e.target instanceof Node) || !u.contains(e.target))) ||
              V(e);
          },
          t = d ?? window;
        return (
...
function le(e, t) {
  let n = de(t);
  for (let t of fe(e)) if (n.has(t)) return !0;
  return !1;
}
function ue(e, t) {
  let n = de(t),
    { aliasAppsByKey: r, exactAppsByKey: i } = pe(e),
    a = he(i, n);
...
function de(e) {
  let t = _e.get(e);
  if (t != null) return t;
  let n = new Set([e.name, e.interface?.displayName ?? ``].map(Q));
  return (_e.set(e, n), n);
}
function fe(e) {
  let t = ge.get(e);
  if (t != null) return t;
  let n = new Set([e.name, ...e.pluginDisplayNames].map(Q));
  return (ge.set(e, n), n);
}
function pe(e) {
  let t = $.get(e);
  ...
  for (let t of e) {
    me(n, Q(t.name), t);
    for (let e of new Set(t.pluginDisplayNames.map(Q))) me(r, e, t);
  }
...
var $,
  ...
  _e,
  ve = e(() => {
    (($ = new WeakMap()), (ge = new WeakMap()), (_e = new WeakMap()));
  });
export {
  m as A,
  S as C,
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~first-run~appgen-~e0dsm8dr-DbABcMet.js.map
