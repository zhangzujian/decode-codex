const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./stable-worktree-status-dialog-CyNcu1iI.js",
...
function f(e, t, n) {
  switch (n.launchMode) {
    case `create-stable-worktree`:
      c(e, u, { pendingWorktreeId: n.id });
      return;
    case `fork-conversation`:
    case `start-conversation`:
      t(o(n.clientThreadId));
  }
}
var p = e(() => {
  (r(), n(), d());
});
export { d as i, f as n, u as r, p as t };
//# sourceMappingURL=app-initial~app-main~projects-index-page~hotkey-window-thread-page~local-environments-setti~jjjs6eag-Bob5REcz.js.map
