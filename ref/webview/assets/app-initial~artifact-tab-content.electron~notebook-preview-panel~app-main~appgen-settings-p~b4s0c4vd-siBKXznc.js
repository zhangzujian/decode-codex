  ...
  let a = (e) => {
    ...
    if (s(l)) {
      ...
      return e === `http:` || e === `https:`
        ? { url: y(l), isCustomPath: !!r }
        : { url: S(l), isCustomPath: !!r };
    }
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~appgen-settings-p~b4s0c4vd-siBKXznc.js.map
