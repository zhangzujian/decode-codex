...
function N(e, t) {
  e instanceof Map
    ? ((e = [void 0, e]), t === void 0 && (t = ie))
    : t === void 0 && (t = re);
  for (var n = new I(e), r, i = [n], a, o, s, c; (r = i.pop());)
    if ((o = t(r.data)) && (c = (o = Array.from(o)).length))
      for (r.children = o, s = c - 1; s >= 0; --s)
        (i.push((a = o[s] = new I(o[s]))),
          (a.parent = r),
          (a.depth = r.depth + 1));
  return n.eachBefore(F);
}
function P() {
  return N(this).eachBefore(ae);
}
function re(e) {
  return e.children;
}
...
function q() {
  ...
  function a(e, t) {
    return function (r) {
      r.children &&
        G(r, r.x0, (e * (r.depth + 1)) / t, r.x1, (e * (r.depth + 2)) / t);
      var i = r.x0,
        a = r.y0,
        o = r.x1 - n,
        s = r.y1 - n;
...
function se(e, t, n, r, i, a) {
  for (
    ...
    (o.push((c = { value: g, dice: p < m, children: s.slice(u, d) })),
      c.dice
        ? G(c, n, r, i, h ? (r += (m * g) / h) : a)
        : oe(c, n, r, h ? (n += (p * g) / h) : i, a),
      (h -= g),
      (u = d));
  }
  return o;
...
function ce() {
  ...
  return (
    ...
    (u.tile = function (t) {
      return arguments.length ? ((e = R(t)), u) : e;
    }),
    ...
    (u.paddingTop = function (e) {
      return arguments.length
        ? ((o = typeof e == `function` ? e : V(+e)), u)
        : o;
    }),
    (u.paddingRight = function (e) {
      return arguments.length
        ? ((s = typeof e == `function` ? e : V(+e)), u)
        : s;
    }),
    (u.paddingBottom = function (e) {
      return arguments.length
        ? ((c = typeof e == `function` ? e : V(+e)), u)
        : c;
    }),
    (u.paddingLeft = function (e) {
      return arguments.length
        ? ((l = typeof e == `function` ? e : V(+e)), u)
        : l;
    }),
    u
  );
...
//# sourceMappingURL=src-DWyvtO7a.js.map
