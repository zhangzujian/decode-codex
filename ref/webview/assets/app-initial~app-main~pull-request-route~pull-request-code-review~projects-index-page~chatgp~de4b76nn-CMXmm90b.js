    ...
    t[17] !== n.projectKind || t[18] !== o
      ? ((r = (e) => {
          ...
          return {
            ...
            onClick: t
              ? () => {
                  Ce({ path: e.value, cwd: _(e.value), target: `fileManager` });
                }
              : void 0,
            value: r,
          };
...
function qt(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(Oe, { className: `icon-xs` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] !== r || t[4] !== i || t[5] !== a
    ? ((l = () => {
...
//# sourceMappingURL=app-initial~app-main~pull-request-route~pull-request-code-review~projects-index-page~chatgp~de4b76nn-CMXmm90b.js.map
