...
import {
  ...
  r as pe,
  t as me,
} from "./app-initial~app-main~pull-request-route~onboarding-page~projects-index-page~hotkey-window-t~hmgrvcya-Sz4HQHji.js";
import {
  on as he,
  sn as ge,
...
import { n as ye, t as be } from "./play-S7L2a0S4.js";
import { n as xe, t as Se } from "./play-outline-Cv251b6I.js";
import { n as Ce, t as we } from "./flask-C7itGjJA.js";
import { n as Te, t as Ee } from "./star-DlZaLlAP.js";
var De,
  Oe,
  ke = e(() => {
...
function Ae(e) {
  ...
  t[4] === u
    ? (m = t[5])
    : ((m = te(u).toString(16).padStart(6, `0`)), (t[4] = u), (t[5] = m));
  let g = `#${m}`,
    _ = u === `off`,
    v = s?.selected ? `opacity-40` : `opacity-25`,
    y = s?.selected ? `opacity-55` : `opacity-40`;
  (_ && ((v = `opacity-0`), (y = `opacity-0`)),
    n && ((v = `opacity-45`), (y = `opacity-65`)));
  let ee = r == null ? p : void 0,
    x = n && `translate-y-px scale-[0.985]`,
    S;
  t[6] === x
    ? (S = t[7])
    : ((S = b(
  ...
  t[10] === g
    ? (T = t[11])
    : ((T = { backgroundColor: g }), (t[10] = g), (t[11] = T));
  let E;
  t[12] !== w || t[13] !== T
    ? ((E = (0, J.jsx)(`div`, { className: w, style: T })),
      (t[12] = w),
      (t[13] = T),
      (t[14] = E))
    : (E = t[14]);
  ...
  t[17] === g
    ? (O = t[18])
    : ((O = { backgroundColor: g }), (t[17] = g), (t[18] = O));
  let k;
  t[19] !== D || t[20] !== O
    ? ((k = (0, J.jsx)(`div`, { className: D, style: O })),
      (t[19] = D),
      (t[20] = O),
      (t[21] = k))
    : (k = t[21]);
  ...
  t[27] !== k || t[28] !== N
    ...
    : (P = t[29]);
  let F;
  t[30] !== E || t[31] !== P || t[32] !== ee || t[33] !== S || t[34] !== C
    ? ((F = (0, J.jsxs)(`div`, {
        "aria-label": ee,
        className: S,
        role: C,
  ...
  return (
    t[59] !== R || t[60] !== K
      ? ((q = (0, J.jsx)(h, { delayOpen: !0, tooltipContent: K, children: R })),
        (t[59] = R),
        (t[60] = K),
        (t[61] = q))
      : (q = t[61]),
...
function Fe(e) {
  ...
  t[6] === d
    ? (f = t[7])
    : ((f = (0, X.jsx)(`div`, { className: d })), (t[6] = d), (t[7] = f));
  let p =
      i === `clockwise` &&
      `bg-[#7da8ff]/90 opacity-100 shadow-[0_0_9px_rgba(125,168,255,0.92)]`,
    m;
  ...
  t[10] === m
    ? (h = t[11])
    : ((h = (0, X.jsx)(`div`, { className: m })), (t[10] = m), (t[11] = h));
  let g;
...
//# sourceMappingURL=codex-micro-keycap-preview-4KW6XFKf.js.map
