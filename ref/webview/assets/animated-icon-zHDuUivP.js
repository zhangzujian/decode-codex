...
function se({ animation: e, animationData: t, fallback: n }) {
  let r = {
    animationJson: t ? Promise.resolve(t) : null,
    SvgFallback: n || null,
  };
  return (e && ((r.animationJson = S[e]()), (r.SvgFallback = C[e])), r);
}
var S,
  C,
  ce = e(() => {
...
function w(e) {
  let t = (0, me.c)(71),
    {
      ...
      matchTextColor: ne,
      loop: l,
      mainDotLottieRefCallback: u,
      renderer: re,
      segment: d,
      showFallbackWhileLoading: f,
      className: p,
    } = e,
    m = ee === void 0 ? !0 : ee,
    h = te === void 0 ? `md` : te,
    g = ne === void 0 ? !0 : ne,
    _ = l === void 0 ? !0 : l,
    v = re === void 0 ? `worker` : re,
    ie = f === void 0 ? !0 : f,
    y = (0, T.useRef)(null),
    [b, ae] = (0, T.useState)(null),
    x;
  t[0] !== r || t[1] !== a || t[2] !== o
    ? ((x = se({ animation: r, animationData: a, fallback: o })),
      (t[0] = r),
      (t[1] = a),
      (t[2] = o),
      (t[3] = x))
    : (x = t[3]);
  let { SvgFallback: oe, animationJson: S } = x,
    [C, ce] = (0, T.useState)(null),
    [w, D] = (0, T.useState)(null),
    O = i(),
    k = typeof h == `number` ? `` : he[h],
    A;
  t[4] === h
    ? (A = t[5])
    : ((A = typeof h == `number` ? { width: h, height: h } : {}),
      (t[4] = h),
      (t[5] = A));
  let j = A,
    M = typeof h == `number` ? `` : ge[h],
    N;
  t[6] !== h || t[7] !== j
    ? ((N = typeof h == `number` ? j : {}), (t[6] = h), (t[7] = j), (t[8] = N))
    : (N = t[8]);
  let P = N,
    F;
  t[9] !== p || t[10] !== M || t[11] !== c
    ? ((F = n(M, p, c, `flex items-center justify-center`)),
      (t[9] = p),
      (t[10] = M),
      (t[11] = c),
      (t[12] = F))
  ...
  if (!O && !C && !ie) {
    ...
    return (
      t[35] !== I || t[36] !== P
        ? ((e = (0, E.jsx)(`div`, { ref: y, className: I, style: P })),
          (t[35] = I),
          (t[36] = P),
          (t[37] = e))
        : (e = t[37]),
  ...
  t[41] === k
    ? (G = t[42])
    : ((G = n(k, `flex items-center justify-center`)),
      (t[41] = k),
      (t[42] = G));
  let xe = C?.data ?? void 0,
    K;
  t[43] === C
    ? (K = t[44])
    : ((K = (e) => {
        if (!e || !C || typeof OffscreenCanvas > `u`) return;
        let t = _e.current;
        if (!t) {
          ((t = new OffscreenCanvas(C.size.width, C.size.height)),
            (_e.current = t));
  ...
  t[61] !== I || t[62] !== P || t[63] !== X
    ? ((Z = (0, E.jsx)(`div`, { ref: y, className: I, style: P, children: X })),
      (t[61] = I),
      (t[62] = P),
      (t[63] = X),
      (t[64] = Z))
...
var me,
  ...
  P = e(() => {
    ((me = o()),
      ...
      (D = s(
        () =>
          import(`./browser-C2T72S2F.js`).then(
            (e) => (
              e.setWasmUrl(
        ...
        __vite__mapDeps([17, 1, 18, 19, 20, 21]),
        import.meta.url,
      )),
...
//# sourceMappingURL=animated-icon-zHDuUivP.js.map
