import { i as e, o as t, r as n, t as r } from "./src-CDc-Z_z9.js";
import { h as i } from "./chunk-5PVQY5BW-4ekGUAt7.js";
import {
  $ as a,
  G as o,
  K as s,
...
import { t as ne } from "./dist-D7gmYyds.js";
...
function qe(e, t, n, r, i, o) {
  ...
  function l(t, n, r) {
    let i = Math.abs(n - t) / r,
      o = g(([, , e]) => e).right(s, i);
    if (o === s.length) return e.every(a(t / Te, n / Te, r));
    if (o === 0) return P.every(Math.max(a(t, n, r), 1));
    let [c, l] = s[i / s[o - 1][2] < s[o][2] / i ? o - 1 : o];
    return c.every(l);
  }
  return [c, l];
}
...
function Cn(e, t, n, r, i, a, o, c, l, d) {
  var f = s(),
    p = f.invert,
    m = f.domain,
    h = d(`.%L`),
  ...
  return (
    ...
    (f.copy = function () {
      return b(f, Cn(e, t, n, r, i, a, o, c, l, d));
    }),
    f
  );
}
  ...
  pi = {
    ...
    renderer: {
      ...
      draw: n(function (t, i, a, s) {
        let l = k().gantt;
        s.db.setDiagramId(i);
        let u = k().securityLevel,
          d;
        u === `sandbox` && (d = r(`#i` + i));
        let p = r(u === `sandbox` ? d.nodes()[0].contentDocument.body : `body`),
          m = u === `sandbox` ? d.nodes()[0].contentDocument : document,
          h = m.getElementById(i);
        ...
        function C(e, t, n) {
          let r = l.barHeight,
            ...
            u = o()
              ...
              .range([`#00B9FA`, `#F95002`])
              .interpolate(be);
          (T(i, a, c, t, n, e, s.db.getExcludes(), s.db.getIncludes()),
            D(c, a, t, n),
            w(e, i, a, c, r, u, t, n),
            O(i, a, c, r, u),
            te(c, a, t, n));
          ...
          if (
            ...
            f
              ...
              .attr(`x`, function (e) {
                ...
                if (
                  (e.milestone &&
                    ((t += 0.5 * (x(e.endTime) - x(e.startTime)) - 0.5 * o),
                    (n = t + o)),
                  e.vert)
                )
        ...
        function T(t, n, r, a, o, c, u, d) {
          ...
          b.append(`g`)
            ...
            .attr(`height`, o - n - l.gridLineStartPadding)
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-vT2Tn1ge.js.map
