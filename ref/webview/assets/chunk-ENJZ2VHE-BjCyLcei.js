...
import { r as m, t as h } from "./src-DAARyDAb.js";
import { n as g, t as _ } from "./rough.esm-CxIZKu28.js";
import { i as v, n as y, r as b } from "./chunk-AGHRB4JF-COxpu2PX.js";
import { A as x, b as S, w as C, y as w } from "./chunk-ICPOFSXX-DR5eNcWR.js";
import { g as T, l as ee, u as te } from "./chunk-5PVQY5BW-BbQZwqS7.js";
import { i as E, n as D } from "./chunk-U2HBQHQK-1ea0xDQK.js";
import {
  a as ne,
  i as O,
  n as re,
...
import { n as j, r as M } from "./chunk-ZZ45TVLE-BBqrp2id.js";
import { a as N, n as P, r as ie } from "./chunk-X2U36JSP-B_hQhnS7.js";
import { i as ae, r as F } from "./chunk-5FUZZQ4R-CyIhitb3.js";
function I(e, t) {
  C(S()) &&
    e &&
...
var V,
    ...
    (k(),
      ...
      (X = y((e, t) => {
        ...
        let n = t.updatedPath ? t.updatedPath : t.originalPath,
          { subGraphTitleTotalMargin: r } = j(S());
        if (e.label) {
          let i = G.get(e.id),
            a = e.x,
            o = e.y;
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
      ...
      (ue = y(function (e, h, g, y, b, x, C, w = !1) {
        ...
        (v.debug(`UIO intersect check`, h.points, k.x, O.x),
          k.intersect &&
            O.intersect &&
            !w &&
        ...
        if (h.look === `handDrawn`) {
          let t = _.svg(e);
          Object.assign([], M);
          let n = t.path(H, { roughness: 0.3, seed: te });
          ((L += ` transition`),
            (z = m(n)
              .select(`path`)
              .attr(`id`, `${C}-${h.id}`)
        ...
        let Y = Math.floor(E.length / 2),
          X = E[Y];
        T.isLabelCoordinateInPath(X, z.attr(`d`)) || (D = !0);
        let Z = {};
...
//# sourceMappingURL=chunk-ENJZ2VHE-BjCyLcei.js.map
