...
function ct(e) {
  ...
  let w = S,
    ...
    E = T ? b : (w?.label ?? o),
    D = me;
  T ? (D = ye) : w?.isCodexWorktree === !0 && (D = Ne);
  let O;
  t[8] === _
    ? (O = t[9])
    : ((O = _.formatMessage({
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~app-main~appgen-settings-page~pull-request-route~~pdazrfmg-DzasxZnO.js.map
