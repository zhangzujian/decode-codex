...
import {
  ...
  o as V,
  t as H,
} from "./codex-micro-layout-CmEh6w5f.js";
import {
  a as U,
  d as Ae,
  f as W,
  ...
  t as Pe,
  u as Fe,
} from "./codex-micro-slot-signals-DaIrlu3x.js";
import {
  a as Ie,
  i as Le,
  n as Re,
  o as ze,
  r as Be,
} from "./codex-micro-joystick-feedback-BRx_Tk4S.js";
import {
  a as Ve,
  c as He,
  i as Ue,
  ...
  t as Je,
  u as Ye,
} from "./codex-micro-mini-games-CUpPMB_v.js";
import {
  i as Xe,
  n as Ze,
...
function Ot(e) {
  ...
  let g = h,
    ie = Object.values(g.analogStick).some(At),
    _;
  t[4] === ie ? (_ = t[5]) : ((_ = { enabled: ie }), (t[4] = ie), (t[5] = _));
  let { skills: v } = ge(void 0, void 0, _),
    y = (0, Q.useRef)(null),
    b = (0, Q.useRef)(He),
    x;
  ...
  t[26] !== m
    ? ((W = (e) => {
        ...
        if (i?.type === `external-url`) {
          de({ href: i.url, initiator: `open_in_browser_bridge` });
          return;
        }
        ...
        let c = tt(t.slot, s.key, globalThis.performance.now(), se.current);
        ((se.current = c.tap),
          ve(o, s.key),
          ye(o, s.key, f, d),
...
//# sourceMappingURL=codex-micro-bridge-_DS5aeJ9.js.map
