...
import { gi as Ze } from "./app-initial~app-main~onboarding-page-zcfEkMl-.js";
import {
  S as Qe,
  T as $e,
  nt as et,
...
import {
  n as yt,
  t as bt,
} from "./app-initial~app-main~codex-micro-settings-BU0aicEv.js";
import {
  i as xt,
  r as St,
  t as Ct,
...
import { n as Dt, t as Ot } from "./selectable-list-row-VvE_PtY2.js";
import { n as kt, r as At, t as jt } from "./codex-micro-commands-wvR2JZJF.js";
import {
  c as Mt,
  i as Nt,
  n as Pt,
...
import {
  n as Wt,
  t as Gt,
} from "./codex-micro-analog-action-title-CUEFUOLe.js";
import {
  a as Kt,
  c as qt,
  d as Jt,
  ...
  t as rn,
  u as an,
} from "./codex-micro-keycap-preview-4KW6XFKf.js";
function on(e, t, n) {
  let r = t.trim(),
    i = (0, sn.default)(
      e.flatMap((e) => {
        let { description: t, title: i } = Et(e, n);
        return r.length > 0 && ![e.id, i, t].some((e) => y(e, r) > 0)
          ? []
          : [
              {
                command: e,
  ...
  return _t.flatMap((e) => {
    ...
    return t.length === 0
      ? []
      : [{ id: e, label: n.formatMessage(cn[e]), options: t }];
  });
}
var sn,
  cn,
...
function un(e) {
  let t = (0, _n.c)(52),
    ...
    v = m.trim(),
    b = r[a],
    C = b?.type === `command` ? kt(b.commandId)?.id : null,
    T = b == null ? u.formatMessage(Cn.none) : Gt(b, _, u),
    E = _.filter(
      (e) => v.length === 0 || [e.name, f(e), ie(e)].some((e) => y(e, v) > 0),
    ),
    D = on(n, v, u),
    O = E.length > 0 || D.length > 0,
    k;
  t[0] === u
    ? (k = t[1])
    : ((k = u.formatMessage({
        ...
        b == null
          ...
          : (0, X.jsx)(B, {
              ...
              children: (0, X.jsx)(ne, {
                ...
                children: (0, X.jsx)(oe, { "aria-hidden": !0 }),
              }),
            })),
      (t[32] = te),
      (t[33] = s),
          ...
          children: [
            ...
            D.map((e) =>
              (0, X.jsxs)(
                ...
                {
                  children: [
                    (0, X.jsx)(ht.Header, { title: e.label }),
                    (0, X.jsx)(ht.Content, {
              ...
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, X.jsxs)(`div`, {
                    ...
                    role: `group`,
                    children: [
                      (0, X.jsx)(hn, { title: T, unassigned: b == null }),
                      Y,
                    ],
                  }),
                ],
...
function pn(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== s || t[3] !== i || t[4] !== a) {
    u = n == null ? s.formatMessage(Cn.none) : Gt(n, a, s);
    let e = s.formatMessage(Cn[r]);
    ((l = B),
      (p = `trigger-overflows`),
      (m = u),
      (c = Ot),
  ...
  t[12] === h
    ? (g = t[13])
    : ((g = le(`size-4 shrink-0`, h)), (t[12] = h), (t[13] = g));
  let _;
  t[14] === g
    ? (_ = t[15])
    : ((_ = (0, X.jsx)(Ke, { className: g })), (t[14] = g), (t[15] = _));
  let v = n == null,
    y;
  t[16] !== u || t[17] !== v
    ? ((y = (0, X.jsx)(hn, { compact: !0, title: u, unassigned: v })),
      (t[16] = u),
      (t[17] = v),
      (t[18] = y))
    : (y = t[18]);
  ...
  t[19] === r
    ? (b = t[20])
    : ((b = (0, X.jsx)(gn, { direction: r })), (t[19] = r), (t[20] = b));
  let x;
  t[21] !== c ||
  t[22] !== i ||
  t[23] !== o ||
  ...
  let S;
  return (
    t[30] !== l || t[31] !== x || t[32] !== p || t[33] !== m
      ? ((S = (0, X.jsx)(l, { openWhen: p, tooltipContent: m, children: x })),
        (t[30] = l),
        (t[31] = x),
        (t[32] = p),
        (t[33] = m),
...
function hn(e) {
  let t = (0, _n.c)(7),
    ...
    l;
  t[0] !== s || t[1] !== c
    ? ((l = le(`block truncate`, s, c)), (t[0] = s), (t[1] = c), (t[2] = l))
    : (l = t[2]);
  let u;
  return (
    t[3] !== o || t[4] !== l || t[5] !== r
    ...
    case `up`: {
      ...
      return (
        t[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(S, { ...Cn.upLowercase })), (t[2] = e))
          : (e = t[2]),
        e
      );
    }
    case `right`: {
      ...
      return (
        t[3] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(S, { ...Cn.rightLowercase })), (t[3] = e))
          : (e = t[3]),
        e
      );
    }
    case `down`: {
      ...
      return (
        t[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(S, { ...Cn.downLowercase })), (t[4] = e))
          : (e = t[4]),
        e
      );
    }
    case `left`: {
      ...
      return (
        t[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(S, { ...Cn.leftLowercase })), (t[5] = e))
          : (e = t[5]),
        e
      );
    }
                ...
                children: [
                  ...
                  e.map((e, t) =>
                    (0, On.jsxs)(
                      ...
                      {
                        children: [
                          p || t > 0 ? (0, On.jsx)(W.Separator, {}) : null,
                          (0, On.jsx)(W.SectionLabel, { children: e.label }),
                          e.options.map((e) => {
                            let { command: t, description: n, title: r } = e;
                            return (0, On.jsx)(
                              W.Item,
...
var En,
  ...
  On,
  kn = e(() => {
    ((En = C()), (Dn = t(U(), 1)), O(), a(), I(), it(), ln(), (On = R()));
  });
function An(e) {
  let t = (0, jn.c)(22),
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Mn.jsx)(S, {
        ...
        defaultMessage: `This restores the command keys and analog stick to their default assignments without changing your agent key mode or custom task assignments`,
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Mn.jsx)(ke, { className: `sr-only`, children: a })),
      (d = (0, Mn.jsx)(ae, { className: `sr-only`, children: s })),
      (t[7] = u),
      (t[8] = d))
    : ((u = t[7]), (d = t[8]));
  let f;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Mn.jsx)(w, {
        children: (0, Mn.jsx)(je, { title: a, subtitle: s }),
      })),
      (t[9] = f))
    : (f = t[9]);
  let p;
  ...
  t[11] === n
    ? (m = t[12])
    : ((m = (0, Mn.jsx)(ne, { color: `secondary`, onClick: n, children: p })),
      (t[11] = n),
      (t[12] = m));
  let h;
  ...
  t[14] === m
    ? (g = t[15])
    : ((g = (0, Mn.jsx)(w, {
        children: (0, Mn.jsxs)(ee, { children: [m, h] }),
      })),
      (t[14] = m),
      (t[15] = g));
  let _;
...
function Fn(e) {
  let t = (0, Bn.c)(5),
    { data: n, isLoading: r } = Ee(),
    i = n === void 0 ? [] : n,
    { remoteConnections: a } = ge(),
    o = tt(a) ?? [],
    { data: s } = b(D),
    l = b($e),
    u;
  ...
  let d = u,
    f = k(d, Hn),
    p = [q, ...o.map(Rn).sort(Ln)],
    { data: m, isFetching: h } = T({
      ...
      queryFn: async () =>
        (
          await Promise.allSettled(
            p.map(async (e) =>
              (
                await ze(`search-threads-for-host`, {
                  hostId: e,
                  query: f,
                  limit: Vn,
                })
...
function Wn(e) {
  ...
  t[0] === o
    ...
    : ((s = o.formatMessage({
        ...
        defaultMessage: `Search tasks to assign`,
  ...
  let c = s,
    ...
    [u, d] = (0, Kn.useState)(``),
    f;
  t[2] === u ? (f = t[3]) : ((f = u.trim()), (t[2] = u), (t[3] = f));
  let m = f,
    { loading: h, options: g } = Fn(m),
    v = l[r]?.threadKey ?? null,
    y = K.indexOf(r) + 1,
    C;
  t[4] !== r || t[5] !== i || t[6] !== a
    ? ((C = function (e) {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Q.jsx)(ae, {
        children: (0, Q.jsx)(S, {
          ...
          defaultMessage: `Choose an active task, or leave this key unassigned`,
  ...
  t[11] === E
    ? (O = t[12])
    : ((O = (0, Q.jsx)(w, {
        children: (0, Q.jsx)(je, { title: E, subtitle: D }),
      })),
      (t[11] = E),
      (t[12] = O));
  let k;
    ...
    ? ((j = (0, Q.jsx)(Ge.List, {
        ...
        children: h
          ? (0, Q.jsx)(`div`, {
              ...
              children: (0, Q.jsx)(n, { className: `icon-xs` }),
            })
          : g.length === 0
            ? (0, Q.jsx)(Ge.Empty, {
                children: (0, Q.jsx)(S, {
                  id: `settings.codexMicro.customAgent.search.empty`,
                  defaultMessage: `No active tasks found`,
            ...
            : (0, Q.jsx)(Ge.Group, {
                ...
                children: g.map((e) => {
                  let { assignment: t, result: n } = e,
                    { threadKey: i } = t,
                    a = K.find((e) => l[e]?.threadKey === i),
                    s = a == null ? null : K.indexOf(a) + 1,
                    c =
                      n.title ??
                      o.formatMessage({
  ...
  t[31] !== T || t[32] !== v
    ...
    : (P = t[33]);
  let F;
  t[34] === i ? (F = t[35]) : ((F = () => i(!1)), (t[34] = i), (t[35] = F));
  let I;
  ...
  t[37] === F
    ? (L = t[38])
    : ((L = (0, Q.jsx)(ne, { color: `ghost`, onClick: F, children: I })),
      (t[37] = F),
      (t[38] = L));
  let R;
  t[39] !== P || t[40] !== L
    ? ((R = (0, Q.jsx)(w, { children: (0, Q.jsxs)(ee, { children: [P, L] }) })),
      (t[39] = P),
      (t[40] = L),
      (t[41] = R))
    : (R = t[41]);
  let z;
  t[42] !== M || t[43] !== R || t[44] !== O
    ? ((z = (0, Q.jsxs)(x, {
...
function Yn(e) {
  let t = (0, cr.c)(86),
    ...
    d = he(We.layout),
    f = he(We.agentSource),
    p = he(We.lightingAutoOff),
    m;
  t[0] === d ? (m = t[1]) : ((m = Nt(d)), (t[0] = d), (t[1] = m));
  let h = m,
    v = M(l, `quickChat`) > 0,
    y;
  t[2] === v
    ? (y = t[3])
    : ((y = jt.filter((e) => e.id !== `quickChat` || v)),
      (t[2] = v),
      (t[3] = y));
  let x = y,
    { skills: C } = g(),
    [w, ee] = (0, lr.useState)(null),
    [E, D] = (0, lr.useState)(null),
    O = u === `macOS`,
    k;
  t[4] === n
    ? (k = t[5])
    : ((k = () => n.getInputMonitoringPermissionStatus()),
      (t[4] = n),
      (t[5] = k));
  let A;
  t[6] !== O || t[7] !== k
  ...
  let { data: N } = T(A),
    P;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, $.jsx)(St, { slug: `codex-micro` })), (t[9] = P))
    : (P = t[9]);
  let F;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, $.jsx)(S, { ...Z.connection })), (t[10] = F))
    : (F = t[10]);
  let I;
  t[11] === a.status
    ? (I = t[12])
    : ((I = (0, $.jsx)(gt, {
        label: F,
        control: (0, $.jsx)(Zn, { status: a.status }),
      })),
      (t[11] = a.status),
      (t[12] = I));
  let L;
  t[13] !== a.battery || t[14] !== a.status
    ? ((L =
    ...
    : (L = t[15]);
  let R;
  t[16] !== n || t[17] !== N || t[18] !== u
    ? ((R =
        u === `macOS`
          ? (0, $.jsx)(gt, {
              label: (0, $.jsx)(S, { ...Z.inputMonitoring }),
              description: (0, $.jsx)(S, {
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, $.jsx)(S, { ...Z.lightingAutoOff })),
      (B = (0, $.jsx)(S, { ...Z.lightingAutoOffDescription })),
      (t[20] = z),
      (t[21] = B))
    : ((z = t[20]), (B = t[21]));
  let V = dr[p],
  ...
  t[24] === i
    ...
    : ((U = Re.options.map((e) =>
        (0, $.jsx)(
          ...
          {
            onSelect: () => {
              Te(i, We.lightingAutoOff, e);
            },
            children: (0, $.jsx)(S, { ...dr[e] }),
          },
          e,
        ),
      )),
  ...
  t[26] !== H || t[27] !== U
    ...
    : (G = t[28]);
  let K;
  t[29] !== R || t[30] !== G || t[31] !== I || t[32] !== L
    ? ((K = (0, $.jsx)(ht, {
        children: (0, $.jsx)(ht.Content, {
          children: (0, $.jsxs)(mt, { children: [I, L, R, G] }),
        }),
      })),
      (t[29] = R),
      (t[30] = G),
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ie = (0, $.jsx)(S, { ...Z.keyboardLayout })), (t[39] = ie))
    : (ie = t[39]);
  let Y;
  t[40] === J
    ? (Y = t[41])
    : ((Y = (0, $.jsx)(ht.Header, { actions: J, title: ie })),
      (t[40] = J),
      (t[41] = Y));
  let ae, oe;
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, $.jsx)(S, { ...Z.agentKeys })),
      (oe = (0, $.jsx)(S, {
  ...
  t[44] === se.label
    ? (ce = t[45])
    : ((ce = (0, $.jsx)(Ct, { children: (0, $.jsx)(S, { ...se.label }) })),
      (t[44] = se.label),
      (t[45] = ce));
  let le;
  t[46] === i
          ...
          W.Item,
          {
            ...
            children: (0, $.jsxs)(`div`, {
              ...
              children: [
                (0, $.jsx)(`span`, {
                  className: `truncate`,
                  children: (0, $.jsx)(S, { ...t.label }),
                }),
                (0, $.jsx)(`span`, {
                  className: `text-sm text-token-text-secondary`,
                  children: (0, $.jsx)(S, { ...t.description }),
                }),
              ],
            }),
          },
  ...
  t[48] !== ce || t[49] !== le
    ? ((ue = (0, $.jsx)(gt, {
      ...
      (t[50] = ue))
    : (ue = t[50]);
  let de = f === `custom` ? D : void 0,
    fe;
  t[51] !== h || t[52] !== i
    ? ((fe = (e, t) => {
        Te(i, We.layout, Lt(h, e, t));
      }),
      (t[51] = h),
      (t[52] = i),
      (t[53] = fe))
  ...
  t[65] !== me
    ? ((ge = (0, $.jsx)(tr, {
        ...
        onEditSlot: ee,
        onEditAgentKey: de,
        onSetAnalogAction: fe,
        onSelectAnalogDirection: pe,
        onSetAnalogEditorOpen: me,
      })),
      (t[57] = s),
      (t[58] = x),
      (t[59] = h),
  ...
  t[67] !== ue || t[68] !== ge
    ? ((_e = (0, $.jsx)(ht.Content, {
        children: (0, $.jsxs)(mt, { children: [ue, ge] }),
      })),
      (t[67] = ue),
      (t[68] = ge),
      (t[69] = _e))
  ...
  let ve;
  t[70] !== Y || t[71] !== _e
    ? ((ve = (0, $.jsxs)(ht, { children: [Y, _e] })),
      (t[70] = Y),
      (t[71] = _e),
      (t[72] = ve))
    : (ve = t[72]);
  let ye;
  t[73] !== x || t[74] !== w || t[75] !== h || t[76] !== i
    ? ((ye =
        w == null
          ? null
          : (0, $.jsx)(
  ...
  let Se;
  return (
    t[81] !== K || t[82] !== ve || t[83] !== ye || t[84] !== be
      ? ((Se = (0, $.jsxs)(qe, { title: P, children: [K, ve, ye, be] })),
        (t[81] = K),
        (t[82] = ve),
        (t[83] = ye),
        (t[84] = be),
...
function $n(e) {
  ...
  if (t[0] !== i || t[1] !== n || t[2] !== r.commandId) {
    let e = r.commandId == null ? null : kt(r.commandId),
      d = e;
    (d == null && n.action.type === `command` && (d = kt(n.action.command)),
      (o = d == null ? null : Et(d, i).description));
    ...
    l = `flex min-w-32 flex-col gap-0.5`;
    let f;
    (t[13] === n ? (f = t[14]) : ((f = sr(n)), (t[13] = n), (t[14] = f)),
      t[15] === f
        ? (u = t[16])
        : ((u = (0, $.jsx)(`span`, {
          ...
          (t[16] = u)),
      (s = `text-xs`),
      (c = e == null ? (0, $.jsx)(Qn, { keycap: n }) : wt(e, i)),
      (t[0] = i),
      (t[1] = n),
      (t[2] = r.commandId),
      (t[3] = a),
    ...
    ((a = t[3]), (o = t[4]), (s = t[5]), (c = t[6]), (l = t[7]), (u = t[8]));
  let d;
  t[17] !== s || t[18] !== c
    ? ((d = (0, $.jsx)(`span`, { className: s, children: c })),
      (t[17] = s),
      (t[18] = c),
      (t[19] = d))
    : (d = t[19]);
  ...
  let m;
  return (
    t[22] !== l || t[23] !== u || t[24] !== d || t[25] !== p
      ? ((m = (0, $.jsxs)(`div`, { className: l, children: [u, d, p] })),
        (t[22] = l),
        (t[23] = u),
        (t[24] = d),
        (t[25] = p),
...
function er(e) {
  let t = (0, cr.c)(88),
    { commands: n, layout: r, slotId: i, onOpenChange: a, onSave: o } = e,
    s = N(),
    c = r.slots[i],
    [l, u] = (0, lr.useState)(c.keycapId),
    [d, f] = (0, lr.useState)(c.commandId),
    [p, m] = (0, lr.useState)(``),
    [h, g] = (0, lr.useState)(null),
    _,
    v,
    y,
    b,
  ...
  if (
      ...
      (T =
        e.action.type === `custom-shortcut`
          ? s.formatMessage({
              ...
              description: `Dropdown option that clears an empty Codex Micro keycap command`,
            })
          : s.formatMessage({
    ...
    ((C = ve),
      ...
      (L = (t) => {
        (t.preventDefault(),
          o({ keycapId: e.id, ...(E == null ? {} : { commandId: E.id }) }));
      }));
    let g;
    (t[29] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((g = (0, $.jsx)(S, {
    ...
    let H =
      h.length === 0
        ...
        : (0, $.jsx)(`div`, {
            ...
            children: h.map((t) => {
              let n = t.id === e.id,
                i = fr.find((e) => r.slots[e.slotId].keycapId === t.id);
              return (0, $.jsx)(
                B,
                {
                  delayOpen: !0,
                  tooltipContent: (0, $.jsx)($n, {
                    keycap: t,
                    slot: i == null ? { keycapId: t.id } : r.slots[i.slotId],
                  }),
                  children: (0, $.jsxs)(`button`, {
                    ...
                    onClick: () => {
                      n ||
                        (u(t.id),
                        f(i == null ? void 0 : r.slots[i.slotId].commandId));
                    },
                    children: [
                      (0, $.jsx)(Qt, { keycap: t, className: `size-4` }),
                      (0, $.jsx)(`span`, {
        ...
        E == null
          ? e.action.type === `custom-shortcut`
            ...
            : (0, $.jsx)(S, {
                ...
                values: { action: (0, $.jsx)(Qn, { keycap: e }, `action`) },
              })
          : wt(E, s)),
      (t[0] = d),
      (t[1] = s),
  ...
  t[47] !== n || t[48] !== h || t[49] !== T || t[50] !== V
    ...
    : (U = t[51]);
  let W;
  t[52] !== _ || t[53] !== D || t[54] !== U || t[55] !== A
    ? ((W = (0, $.jsx)(_, { label: D, description: A, control: U })),
      (t[52] = _),
      (t[53] = D),
      (t[54] = U),
      (t[55] = A),
  ...
  let G;
  t[57] !== v || t[58] !== W
    ? ((G = (0, $.jsx)(v, { children: W })),
      (t[57] = v),
      (t[58] = W),
      (t[59] = G))
    : (G = t[59]);
  let K;
  t[60] !== y || t[61] !== G || t[62] !== j || t[63] !== M || t[64] !== P
    ? ((K = (0, $.jsxs)(y, { className: j, children: [M, P, G] })),
      (t[60] = y),
      (t[61] = G),
      (t[62] = j),
      (t[63] = M),
  ...
  t[72] === J
    ? (Y = t[73])
    : ((Y = (0, $.jsx)(w, {
        children: (0, $.jsxs)(ee, { children: [J, ie] }),
      })),
      (t[72] = J),
      (t[73] = Y));
  let ae;
  ...
  let oe;
  return (
    t[82] !== C || t[83] !== O || t[84] !== k || t[85] !== te || t[86] !== ae
      ? ((oe = (0, $.jsx)(C, {
          open: O,
          size: k,
          onOpenChange: te,
...
function tr(e) {
  ...
  t[0] === a.knobPulse
    ? (v = t[1])
    : ((v = (0, $.jsx)(nr, { pulse: a.knobPulse })),
      (t[0] = a.knobPulse),
      (t[1] = v));
  let y;
  t[2] !== n || t[3] !== s || t[4] !== a.pressedKeys
    ? ((y = K.slice(0, 2).map((e, t) =>
        (0, $.jsx)(
          Zt,
          {
            position: t + 1,
  ...
  t[10] !== d ||
  t[11] !== a.joystick ||
  t[12] !== a.selectedAnalogDirection ||
  t[13] !== o
    ? ((b = (0, $.jsx)(un, {
        commands: r,
        joystick: a.joystick,
    ...
    : (b = t[14]);
  let x;
  t[15] !== n || t[16] !== s || t[17] !== a.pressedKeys
    ? ((x = K.slice(2).map((e, t) =>
        (0, $.jsx)(
          Zt,
          {
  ...
  t[19] === a.pressedKeys
    ? (w = t[20])
    : ((w = ir(a.pressedKeys, f.keys)), (t[19] = a.pressedKeys), (t[20] = w));
  let ee;
  t[21] !== c || t[22] !== S || t[23] !== w
    ? ((ee = (0, $.jsx)(rr, {
        slot: S,
        slotId: C,
        isPressed: w,
      ...
      (t[24] = ee))
    : (ee = t[24]);
  let T = i.slots[p.slotId],
    E = p.slotId,
    D;
  t[25] === a.pressedKeys
    ? (D = t[26])
    : ((D = ir(a.pressedKeys, p.keys)), (t[25] = a.pressedKeys), (t[26] = D));
  let O;
  t[27] !== c || t[28] !== D || t[29] !== T
    ? ((O = (0, $.jsx)(rr, {
        slot: T,
        slotId: E,
        isPressed: D,
      ...
      (t[30] = O))
    : (O = t[30]);
  let k = i.slots[m.slotId],
    te = m.slotId,
    A;
  t[31] === a.pressedKeys
    ? (A = t[32])
    : ((A = ir(a.pressedKeys, m.keys)), (t[31] = a.pressedKeys), (t[32] = A));
  let j;
  t[33] !== c || t[34] !== k || t[35] !== A
    ? ((j = (0, $.jsx)(rr, {
        slot: k,
        slotId: te,
        isPressed: A,
      ...
      (t[36] = j))
    : (j = t[36]);
  let M = i.slots[h.slotId],
    N = h.slotId,
    P;
  t[37] === a.pressedKeys
    ? (P = t[38])
    : ((P = ir(a.pressedKeys, h.keys)), (t[37] = a.pressedKeys), (t[38] = P));
  let F;
  t[39] !== c || t[40] !== M || t[41] !== P
    ? ((F = (0, $.jsx)(rr, {
        slot: M,
        slotId: N,
        isPressed: P,
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, $.jsx)($t, {})), (t[43] = I))
    : (I = t[43]);
  let L = i.slots[g.slotId],
    R = g.slotId,
    z;
  t[44] === a.pressedKeys
    ? (z = t[45])
    : ((z = ir(a.pressedKeys, g.keys)), (t[44] = a.pressedKeys), (t[45] = z));
  let B;
  t[46] !== c || t[47] !== L || t[48] !== z
    ? ((B = (0, $.jsx)(rr, {
        slot: L,
        slotId: R,
      ...
      (t[49] = B))
    : (B = t[49]);
  let V = i.slots[_.slotId],
    H = _.slotId,
    U;
  t[50] === a.pressedKeys
    ? (U = t[51])
    : ((U = ir(a.pressedKeys, _.keys)), (t[50] = a.pressedKeys), (t[51] = U));
  let W;
  t[52] !== c || t[53] !== V || t[54] !== U
    ? ((W = (0, $.jsx)(rr, {
        slot: V,
        slotId: H,
        isPressed: U,
  ...
  return (
    ...
    t[65] !== ee
      ? ((ne = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(nn, {
            children: [v, y, b, x, ee, O, j, F, I, B, W],
          }),
        })),
        (t[56] = v),
        (t[57] = O),
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(S, {
          ...
          description: `Note explaining which composer control the Codex Micro encoder highlights by default`,
        }),
      })),
      (t[1] = a))
    : (a = t[1]);
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, $.jsx)(`dd`, {
        ...
        children: (0, $.jsx)(S, {
          ...
          description: `Action performed when turning the Codex Micro encoder knob clockwise to navigate composer controls and options`,
        }),
      })),
      (t[3] = s))
    : (s = t[3]);
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(`dd`, {
        ...
        children: (0, $.jsx)(S, {
          ...
          description: `Action performed when turning the Codex Micro encoder knob counterclockwise to navigate composer controls and options`,
        }),
      })),
      (t[5] = l))
    : (l = t[5]);
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(`dd`, {
        ...
        children: (0, $.jsx)(S, {
          ...
          description: `Action performed when clicking the Codex Micro encoder knob once to activate the highlighted composer control or option`,
        }),
      })),
      (t[7] = d))
    : (d = t[7]);
  ...
  return (
    t[12] !== n || t[13] !== m
      ? ((h = (0, $.jsx)(B, {
          ...
          tooltipContent: p,
          children: (0, $.jsx)(Kt, { ariaLabel: m, pulse: n }),
        })),
        (t[12] = n),
        (t[13] = m),
        (t[14] = h))
...
function rr(e) {
  let t = (0, cr.c)(27),
    { slot: n, slotId: r, className: i, isPressed: a, onEditSlot: o } = e,
    s;
  t[0] === n.keycapId
    ? (s = t[1])
    : ((s = It(n.keycapId)), (t[0] = n.keycapId), (t[1] = s));
  let c = s,
    l;
  t[2] !== c || t[3] !== n
    ? ((l = (0, $.jsx)($n, { keycap: c, slot: n })),
      (t[2] = c),
      (t[3] = n),
      (t[4] = l))
    : (l = t[4]);
  let u = a && `translate-y-px scale-[0.985]`,
    d;
  t[5] !== i || t[6] !== u
    ? ((d = le(
  ...
  t[13] === c
    ...
    : ((h = (0, $.jsx)(`span`, {
        className: `sr-only`,
        children: (0, $.jsx)(Qn, { keycap: c }),
      })),
      (g = (0, $.jsx)(Qt, { keycap: c, className: `size-5` })),
      (t[13] = c),
      (t[14] = h),
      (t[15] = g));
  let _;
  t[16] !== m || t[17] !== h || t[18] !== g
    ? ((_ = (0, $.jsxs)(rn, { className: m, children: [h, g] })),
      (t[16] = m),
      (t[17] = h),
      (t[18] = g),
      (t[19] = _))
  ...
  return (
    t[24] !== v || t[25] !== l
      ? ((y = (0, $.jsx)(B, { delayOpen: !0, tooltipContent: l, children: v })),
        (t[24] = v),
        (t[25] = l),
        (t[26] = y))
      : (y = t[26]),
...
function ar(e, t) {
  ...
  return n.length === 0
    ? !0
    : [e.id, ...or(e)].some((e) => e.toLowerCase().includes(n));
}
function or(e) {
...
export { Jn as CodexMicroSettings };
//# sourceMappingURL=codex-micro-settings-B_VKXWEo.js.map
