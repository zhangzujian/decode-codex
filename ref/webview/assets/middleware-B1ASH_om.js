...
import { c as s, d as c, l, t as u } from "./esm-h0fuFZq8.js";
function d(e, t) {
  return (
    (t ||= {}),
      ...
      switch (e.label) {
        case 0:
          ((s = Z(t, { clone: !0, traverse: !1 }).rawEvent()),
            ...
            (e.label = 1));
        case 1:
          return c < l.length ? ((u = l[c]), [4, r(s, u)]) : [3, 4];
        case 2:
...
//# sourceMappingURL=middleware-B1ASH_om.js.map
