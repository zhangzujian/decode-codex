...
import { t as o } from "./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~pull-request-rout~h1wwxhmv-DwcFvK_b.js";
import {
  E as ee,
  T as te,
...
function f(e) {
  var t =
    (!(
      (ae && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey) ||
      (oe && e.shiftKey && e.key && e.key.length == 1) ||
      e.key == `Unidentified`
    ) &&
      e.key) ||
    (e.shiftKey ? m : p)[e.keyCode] ||
    e.key ||
    `Unidentified`;
  return (
    t == `Esc` && (t = `Escape`),
  ...
  g = e(() => {
    for (
      p = {
        ...
        ae = typeof navigator < `u` && /Mac/.test(navigator.platform),
        oe =
          typeof navigator < `u` &&
      ...
      p[48 + h] = p[96 + h] = String(h);
    for (h = 1; h <= 24; h++) p[h + 111] = `F` + h;
    for (h = 65; h <= 90; h++)
      ((p[h] = String.fromCharCode(h + 32)), (m[h] = String.fromCharCode(h)));
    for (var e in p) m.hasOwnProperty(e) || (m[e] = p[e]);
  });
function se(e) {
  let t = e.split(/-(?!$)/),
    n = t[t.length - 1];
  ...
  for (let e = 0; e < t.length - 1; e++) {
    ...
    else if (/^mod$/i.test(n)) de ? (o = !0) : (i = !0);
...
function le(e) {
  return new re({ props: { handleKeyDown: ue(e) } });
}
function ue(e) {
  let t = ce(e);
  return function (e, n) {
...
var de,
  ...
  fe = e(() => {
    (g(),
      ...
      (v = typeof navigator < `u` && /Win/.test(navigator.platform)));
  }),
  y,
  pe,
  me = e(() => {
            ...
            (0, w.jsxs)(`defs`, {
              children: [
                (0, w.jsxs)(`linearGradient`, {
                  ...
                  children: [
                    (0, w.jsx)(`stop`, { stopColor: `#1293F1` }),
                    (0, w.jsx)(`stop`, { offset: 1, stopColor: `#043CCC` }),
                  ],
                }),
                (0, w.jsxs)(`radialGradient`, {
              ...
              children: [
                (0, E.jsxs)(`linearGradient`, {
                  ...
                  children: [
                    ...
                    (0, E.jsx)(`stop`, { offset: 1, stopColor: `#B0212C` }),
                  ],
                }),
              ...
              children: [
                (0, O.jsxs)(`linearGradient`, {
                  ...
                  children: [
                    ...
                    (0, O.jsx)(`stop`, { offset: 1, stopColor: `#13551B` }),
                  ],
                }),
...
function Qe(e, t) {
  ...
  let n = t ?? (e ? tt.lookup(e) : !1);
  if (typeof n == `string`) {
    let e = it.find(({ prefix: e }) => n.startsWith(e));
    if (e) return e.key;
  }
  return `file`;
}
  ...
  at = e(() => {
    ((tt = t(o(), 1)),
      ...
      (rt = Object.fromEntries(
        ...
        ].flatMap(({ key: e, extensions: t }) => t.map((t) => [t, e])),
      )),
      (it = [
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~settings-command-~eurqfy6e-BFg1m7tE.js.map
