...
import { a as ie, i as ae, r as oe, t as se } from "./src-DAARyDAb.js";
import { t as ce } from "./dist-BNkeg5V9.js";
import { g as le, u as ue } from "./chunk-S3R3BYOJ-CtaVEEbR.js";
var de = n((e, t) => {
    (function (n, r) {
...
` +
    ...
    (bt = {
      ...
      renderer: {
        setConf: _t,
        draw: C(function (e, t, n, r) {
          let s = M().gantt,
            l = M().securityLevel,
            u;
          l === `sandbox` && (u = oe(`#i` + t));
          let d = oe(
              l === `sandbox` ? u.nodes()[0].contentDocument.body : `body`,
            ),
            f = l === `sandbox` ? u.nodes()[0].contentDocument : document,
            g = f.getElementById(t);
          (($ = g.parentElement.offsetWidth),
            $ === void 0 && ($ = 1200),
          ...
          if (
            ...
            for (let n of Object.keys(e)) {
              let r = yt(e[n], t) + 1;
              ((t += r), (D += r * (s.barHeight + s.barGap)), (E[n] = r));
            }
          } else {
            D += w.length * (s.barHeight + s.barGap);
            for (let e of T) E[e] = w.filter((t) => t.type === e).length;
          }
          g.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + D);
          let O = d.select(`[id="${t}"]`),
            k = x()
              .domain([
                i(w, function (e) {
          ...
          function j(e, t, n) {
            let i = s.barHeight,
              ...
              u = c()
                ...
                .range([`#00B9FA`, `#F95002`])
                .interpolate(b);
            (re(a, o, l, t, n, e, r.db.getExcludes(), r.db.getIncludes()),
              se(l, o, t, n),
              te(e, a, o, l, i, u, t, n),
              ce(a, o, l, i, u),
              le(l, o, t, n));
            ...
            if (
              (d
                ...
                .attr(`y`, function (e, t) {
                  return (
                    (t = e.order),
                    e.vert ? s.gridLineStartPadding : t * n + i
                  );
                })
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? w.length * (s.barHeight + s.barGap) + s.barHeight * 2
                    : o;
                })
              ...
              d
                ...
                .attr(`x`, function (e) {
                  ...
                  if (
                    (e.milestone &&
                      ((t += 0.5 * (k(e.endTime) - k(e.startTime)) - 0.5 * o),
                      (n = t + o)),
                    e.vert)
                  )
                    return k(e.startTime) + a;
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? s.gridLineStartPadding +
                        w.length * (s.barHeight + s.barGap) +
                        60
                    : ((t = e.order),
                      t * n + s.barHeight / 2 + (s.fontSize / 2 - 2) + i);
                })
                .attr(`text-height`, o)
                .attr(`class`, function (e) {
                  let t = k(e.startTime),
          ...
          function re(e, t, n, i, a, o, c, l) {
            ...
            let f = r.db.getDateFormat(),
              p = [],
              m = null,
              h = (0, P.default)(u);
            for (; h.valueOf() <= d;)
              (r.db.isInvalidDate(h, f, c, l)
                ? m
                  ? (m.end = h)
                  : (m = { start: h, end: h })
                : (m &&= (p.push(m), null)),
            ...
            O.append(`g`)
              ...
              .attr(`height`, a - t - s.gridLineStartPadding)
          ...
          function se(e, t, n, i) {
            let c = r.db.getDateFormat(),
              l = r.db.getAxisFormat(),
              u;
            u = l || (c === `D` ? `%d` : (s.axisFormat ?? `%Y-%m-%d`));
            let d = ae(k)
                .tickSize(-i + t + s.gridLineStartPadding)
                .tickFormat(o(u)),
              f =
          ...
          function le(e, t, n, i) {
            ...
            if (a === `off`) return;
            let o = O.append(`g`).attr(`class`, `today`),
              c = new Date(),
              l = o.append(`line`);
            (l
              .attr(`x1`, k(c) + e)
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-CE6vHFLJ.js.map
