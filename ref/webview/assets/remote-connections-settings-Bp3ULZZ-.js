...
import {
  a as fe,
  o as pe,
} from "./app-initial~avatarOverlayCompositionSurface~app-main~hotkey-window-thread-page~avatar-overl~ivlwwypn-BSncXyQ5.js";
import {
  D as me,
  E as he,
  O as ge,
...
import { I as Jt } from "./app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~first-run~appgen-~f83t1tf1-X8MSIvV3.js";
import {
  E as Yt,
  T as Xt,
...
import {
  x as Xn,
  y as Zn,
} from "./app-initial~app-main~business-checkout-switch-workspace-dialog~settings-page~login-route~co~0rxi42yi-DbNHXhqQ.js";
import {
  _ as Qn,
  v as $n,
...
import {
  ...
  t as Tr,
  u as Er,
} from "./codex-mobile-setup-flow-pKUGb8wW.js";
import { r as Dr, t as Or } from "./esm-DJ7kGaEH.js";
import { n as kr, t as Ar } from "./onboarding-login-content-BvOLaxqz.js";
var jr,
  Mr,
  Nr = e(() => {
    (s(),
...
function Ho() {
  let e = n(m),
    ...
    yt = O(`refresh-remote-control-connections`),
    bt = O(`authorize-remote-control-connections`, {
      onSuccess: () => {
    ...
    xt = O(`save-codex-managed-remote-ssh-connections`, {
      onSuccess: () => {
        e.get(W).success(
          a.formatMessage({
    ...
    Kt = () => {
      (ot(e, Je, { result: `started` }), bt.mutate(void 0));
    },
    qt = async () => {
      let { remoteControlConnections: e } = await yt.mutateAsync(void 0);
  ...
  let Yt = async () => {
    ...
    $t = (e) => {
      Pt || xt.mutate({ remoteConnections: Pe.filter((t) => t.hostId !== e) });
    },
    en = (e) => {
    ...
    rn = (0, Qo.useEffectEvent)(async (e) => {
      await Go({
        ...
        saveCodexManagedConnections: async (e) => {
          await xt.mutateAsync({ remoteConnections: e });
        },
...
//# sourceMappingURL=remote-connections-settings-Bp3ULZZ-.js.map
