...
function p(e) {
  ...
  let {
    ...
    ae = M === `field` && `relative`,
    W;
  n[22] === ae ? (W = n[23]) : ((W = t(ae)), (n[22] = ae), (n[23] = W));
  let oe =
      M === `field`
...
function _(e) {
  let n = (0, v.c)(25),
    ...
    d;
  n[0] !== c || n[1] !== a
    ? ((d = c(a)), (n[0] = c), (n[1] = a), (n[2] = d))
    : (d = n[2]);
  let f = s ?? a === i,
    p = a === i && `bg-token-list-hover-background`,
    m;
  n[3] === p
    ? (m = n[4])
    : ((m = t(
  ...
  n[8] === o.label
    ...
    : ((g = (0, y.jsx)(`span`, {
      ...
      (n[9] = g));
  let _;
  n[10] === o.secondaryLabel
    ? (_ = n[11])
    : ((_ =
        o.secondaryLabel == null
          ? null
          : (0, y.jsx)(`span`, {
              className: `text-sm text-token-description-foreground`,
              children: o.secondaryLabel,
            })),
      (n[10] = o.secondaryLabel),
      (n[11] = _));
  let b;
  ...
  n[15] === s
    ? (x = n[16])
    : ((x = s
        ? (0, y.jsx)(l, { "aria-hidden": !0, className: `icon-sm shrink-0` })
        : null),
      (n[15] = s),
      (n[16] = x));
  let S;
...
//# sourceMappingURL=share-invite-autocomplete-CMahPUZO.js.map
