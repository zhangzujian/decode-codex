...
import { n as Ze, t as Qe } from "./onboarding-login-content-CczQdHRG.js";
function $e() {
  let e = E(m),
    t = P(),
    n = Ae(),
  ...
  ((0, G.useEffect)(() => {
    c && (x.current?.focus(), x.current?.select());
  }, [c]),
    (0, G.useEffect)(() => {
      let e = !1;
      return (
        (async () => {
          try {
            let t = await re(`openai-api-key`);
            if (e) return;
            let n = t?.value ?? null;
            (h(n), _((e) => (e.length > 0 ? e : (n ?? ``))));
          } catch {
            e || h(null);
          }
        })(),
  ...
  let w = async () => {
      ...
      try {
        let { authUrl: r, completion: i } = await He({ signal: e.signal });
        r &&
          se({
            href: Ke({
              authUrl: r,
        ...
        let a = await i;
        a.success ? (t(), n(`/first-run`)) : C(U(a.error ?? `Unknown error`));
      } catch (e) {
    ...
    T = async () => {
      ...
      let e = new AbortController();
      (d(!0), a({ abortController: e, kind: `deviceCode` }));
      try {
        let {
          verificationUrl: r,
          userCode: i,
          completion: o,
        } = await Ue({ signal: e.signal });
        ...
        let s = await o;
        s.success ? (t(), n(`/first-run`)) : C(U(s.error ?? `Unknown error`));
      } catch (e) {
        if (e instanceof Error && e.name === `AbortError`) return;
        C(U(e));
      } finally {
    ...
    { data: O } = he(`show-copilot-login-first`),
    A = async () => {
      try {
    ...
    j = async () => {
      ...
      if (!(!e || y)) {
        b(!0);
        try {
          (await Ce(`login-with-api-key`, { hostId: te, apiKey: e }),
            t(),
            n(`/first-run`));
        } catch (e) {
          C(U(e));
    ...
    M =
      !s || !O
        ...
        : (0, K.jsxs)(K.Fragment, {
            children: [
              !o && (0, K.jsx)(tt, { isPrimary: !0, handleCopilotSignIn: A }),
              (0, K.jsx)(`div`, {
                className: `pt-2`,
                children: (0, K.jsx)(et, {
                  isPrimary: !1,
                    ...
                    children: (0, K.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        !o &&
                          (0, K.jsx)(at, {
                            setApiKeyValue: _,
                            defaultApiKeyFromEnv: f,
                            setIsApiKeySignInVisible: l,
                          }),
                        !o &&
                          S &&
                          (0, K.jsx)(rt, {
...
function ot(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, K.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, K.jsx)(O, { href: ut, className: `icon-2xs` }),
        ],
      })),
      (t[11] = h))
    : (h = t[11]);
  ...
  t[16] === g
    ? (y = t[17])
    : ((y = (0, K.jsx)(R, { color: `ghost`, onClick: g, children: _ })),
      (t[16] = g),
      (t[17] = y));
  let b;
  t[18] !== n || t[19] !== a
...
function st(e) {
  r({ event: e, href: ut, initiator: `open_in_browser_bridge` });
}
function ct(e) {
...
function lt(e) {
  ...
  t[11] === l
    ? (b = t[12])
    : ((b = l
        ? (0, K.jsx)(_e, { className: `icon-sm text-token-foreground` })
        : (0, K.jsx)(u, { className: `icon-sm` })),
      (t[11] = l),
      (t[12] = b));
  let x;
  t[13] !== p || t[14] !== y || t[15] !== b
    ? ((x = (0, K.jsx)(`div`, {
  ...
  t[26] === o
    ? (E = t[27])
    : ((E = (0, K.jsx)(R, { color: `ghost`, onClick: o, children: T })),
      (t[26] = o),
      (t[27] = E));
  let D = n.length === 0,
    O;
  ...
  let A;
  t[29] !== i || t[30] !== D
    ? ((A = (0, K.jsx)(R, { onClick: i, disabled: D, children: O })),
      (t[29] = i),
      (t[30] = D),
      (t[31] = A))
    : (A = t[31]);
...
function jt(e) {
  let t = (0, Mt.c)(50),
    ...
    g = n === ie.ChatGPT;
  if (o && !i) {
    let e = g ? `size-10` : `size-[52px]`,
      r;
    t[0] === e ? (r = t[1]) : ((r = B(`shrink-0`, e)), (t[0] = e), (t[1] = r));
    let i;
    t[2] !== n || t[3] !== r
      ? ((i = (0, Z.jsx)(ze, { appBrand: n, className: r })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = i))
      : (i = t[4]);
  ...
  t[14] === _
    ? (y = t[15])
    : ((y = B(`flex w-full flex-col items-center`, _)),
      (t[14] = _),
      (t[15] = y));
  let b;
  t[16] === h
  ...
  t[18] === x
    ? (S = t[19])
    : ((S = B(`shrink-0`, x)), (t[18] = x), (t[19] = S));
  let C;
  t[20] !== n || t[21] !== S
    ? ((C = (0, Z.jsx)(ze, { appBrand: n, className: S })),
      (t[20] = n),
      (t[21] = S),
      (t[22] = C))
    : (C = t[22]);
  let w;
  t[23] !== f || t[24] !== b || t[25] !== C
    ? ((w = (0, Z.jsx)(`button`, {
  ...
  t[27] !== n || t[28] !== g
    ...
    : (T = t[29]);
  let E;
  t[30] !== y || t[31] !== w || t[32] !== T
    ? ((E = (0, Z.jsxs)(`div`, { className: y, children: [w, T] })),
      (t[30] = y),
      (t[31] = w),
      (t[32] = T),
      (t[33] = E))
    ...
    ? ((D = i
        ? (0, Z.jsx)(`div`, {
            ...
            children: (0, Z.jsx)(Qe, {
              ...
              onChatGptSignIn: u,
              onShowApiKeyEntry: m,
              apiKeySecondaryActionLabel: (0, Z.jsx)(v, {
...
var Mt,
  Z,
  Nt = e(() => {
    ((Mt = b()), ce(), F(), C(), At(), je(), ue(), Ve(), Ze(), (Z = M()));
  });
function Pt() {
  let e = E(m),
    t = P(),
    ...
    p = f(Pe),
    g = f(Ne),
    _ = u == null ? null : { hasPreviouslyCompletedOnboarding: u },
    y = w(),
    b = gt(a(vt).get(`enabled`, !1)),
    x = (t) => {
      e.get(N).warning(
        i.formatMessage(
          {
    ...
    ie = () => {
      _ != null && (H(e, A, { method: `apikey`, ..._ }), j(!0));
    },
    B = () => {
      F(!1);
    },
    ...
    V = async (n = `signin`) => {
      ...
      if (_ == null) return;
      let i = n === `google` || n === `microsoft` ? n : `chatgpt`;
      H(e, A, { method: i, ..._ });
      let a = new AbortController();
      T(a);
      try {
        let { useDesktopAuth: s, useStreamlinedLoginUx: u } = ht(c(y, _t)),
          f = De(y, `2936610421`),
          p = De(y, `3963726525`),
          { authUrl: m, completion: h } = await He({
            signal: a.signal,
            ...(f ? { appBrand: ge } : {}),
        ...
        g.success
          ? (H(e, o, { method: i, ..._ }),
            l.removeQueries({ queryKey: Oe(`account-info`), exact: !0 }),
            ne(),
            d(!0),
            t(),
            r(`/welcome`, { replace: !0 }))
          : (H(e, S, { method: i, errorKind: Ft(g.error), ..._ }),
            x(U(g.error ?? `Unknown error`)));
      } catch (t) {
        if (t instanceof Error && t.name === `AbortError`) {
          H(e, S, { method: i, errorKind: `abort`, ..._ });
          return;
        }
        (H(e, S, { method: i, errorKind: Ft(t), ..._ }), x(U(t)));
      } finally {
        T(null);
      }
    };
  return _ == null
    ? (0, $.jsx)(Re, {
        children: (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(n, { className: `h-4 w-4 text-token-foreground` }),
            (0, $.jsx)(v, {
    ...
    : (0, $.jsx)(Re, {
        ...
        children: M
          ? (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(bt, { onExit: B, audioContextRef: z }),
            })
          : (0, $.jsx)(jt, {
              appBrand: ge,
              apiKeyValue: ee,
              isApiKeyEntryVisible: O,
              isApiKeySignInPending: L,
              isChatGptSignInPending: D,
              showChatGptProviderSignIn: b,
              onApiKeySubmit: async () => {
                let n = ee.trim();
                if (!(!n || L || _ == null)) {
                  R(!0);
                  try {
                    (await Ce(`login-with-api-key`, { hostId: te, apiKey: n }),
                      H(e, o, { method: `apikey`, ..._ }),
                      ne(),
                      d(!0),
                      t(),
                      r(`/welcome`, { replace: !0 }));
                  } catch (t) {
                    (H(e, S, { method: `apikey`, errorKind: Ft(t), ..._ }),
                      x(U(t)));
                  } finally {
                    R(!1);
                  }
              ...
              onApiKeyValueChange: I,
              onChatGptSignIn: V,
              onChatGptSignUp: () => V(`signup`),
              onPlaySnake: oe,
              onResetApiKeyEntry: re,
              onShowApiKeyEntry: ie,
            }),
      });
}
function Ft(e) {
...
var Rt, zt;
e(() => {
  ((Rt = b()), t(L(), 1), T(), mt(), It(), (zt = M()));
})();
export { Lt as LoginRoute };
//# sourceMappingURL=login-route-rqBEbtH9.js.map
