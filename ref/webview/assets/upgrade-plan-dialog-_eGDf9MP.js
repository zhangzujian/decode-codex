...
import { n as L, t as R } from "./color-icon-CBzCfRmh.js";
import {
  c as z,
  d as ee,
  f as te,
...
import {
  ...
  s as q,
  t as J,
} from "./subscription-update-plan-DgipuIMj.js";
...
function Fe() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(F, { className: `icon-sm` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
...
//# sourceMappingURL=upgrade-plan-dialog-_eGDf9MP.js.map
