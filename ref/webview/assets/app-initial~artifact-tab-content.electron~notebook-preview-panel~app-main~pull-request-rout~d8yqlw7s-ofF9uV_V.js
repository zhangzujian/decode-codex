...
var B,
  ...
  H,
  U = e(() => {
    H = `<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function xe(e) {
  ...
  return Se[e] ?? Se[t] ?? Se[t.replace(/-mcp-server$/u, ``)] ?? null;
}
var Se,
  Ce = e(() => {
    (U(),
...
function St(e) {
  ...
  for (let n = 0; n < e.length; n += 1)
    t = (t * 31 + e.charCodeAt(n)) % Ct.length;
  return Ct[t] ?? ``;
}
var Ct,
  wt = e(() => {
  ...
  try {
    let e = { path: r, hostId: t },
      i = await n.fetchQuery({
        ...
        queryKey: b(`read-file-binary`, e),
        retry: !1,
        gcTime: 1 / 0,
        staleTime: p.INFINITE,
      });
    return i.contentsBase64 ? `data:${Dt(r)};base64,${i.contentsBase64}` : null;
  } catch (e) {
    return (
      w.warning(`Failed to inline local image`, {
        safe: {},
...
function Dt(e) {
  return kt[Ot.default.extname(e).toLowerCase()] ?? `application/octet-stream`;
}
var Ot,
  kt,
  At = e(() => {
...
function Mt({ marketplacePath: e, remoteMarketplaceName: t }) {
  if (e != null && t != null)
...
function Pt(e) {
  ...
  return `${Nt(e)}:${e.plugin.id}:${t ?? ``}`;
}
function Ft(e) {
  return e.filter((e) => {
    let t = cn(e).toLowerCase();
    return !Mn.some((e) => t === e || t.startsWith(`${e}-`));
  });
}
function It(e) {
  return e.marketplacePath == null ? Rt(e.plugin) : e.plugin.name;
}
function Lt(e) {
  return e.marketplacePath == null ? Rt(e.plugin) : e.plugin.id;
}
function Rt(e) {
...
function zt(e) {
  return { ...Mt(e), pluginName: It(e) };
}
function Bt({ marketplaceName: e, marketplacePath: t }) {
  return t == null
...
function Vt(e, t, i) {
  ...
  let s = ue(o) && (i?.enabled ?? !0),
    c = i?.additionalMarketplaceKinds ?? Tn,
    l = i?.installSuggestionPluginNames ?? null,
    u = ie(`4218407052`),
    d = ce(e)?.authMethod ?? null,
    f;
  a[2] === d ? (f = a[3]) : ((f = we(d)), (a[2] = d), (a[3] = f));
  let p = f,
  ...
  let te = h,
    ...
    _;
  a[8] !== e || a[9] !== ne
    ? ((_ = ne.includes(e)), (a[8] = e), (a[9] = ne), (a[10] = _))
    : (_ = a[10]);
  let v = _,
    y = t === void 0,
    b;
  a[11] === e ? (b = a[12]) : ((b = { hostId: e }), (a[11] = e), (a[12] = b));
  let x = s && v && y,
    S;
  a[13] === x ? (S = a[14]) : ((S = { enabled: x }), (a[13] = x), (a[14] = S));
  let C = n(oe, b, S),
    w = he(e),
    re = s && v,
    T;
  a[15] !== e || a[16] !== re
    ? ((T = { enabled: re, hostId: e }), (a[15] = e), (a[16] = re), (a[17] = T))
    : (T = a[17]);
  let E = me(T),
    D;
  a[18] === e ? (D = a[19]) : ((D = { hostId: e }), (a[18] = e), (a[19] = D));
  let O = fe(D),
    k;
  a[20] === e ? (k = a[21]) : ((k = { hostId: e }), (a[20] = e), (a[21] = k));
  let A = le(k),
    j = C.data?.roots,
    M;
  a[22] !== w || a[23] !== e || a[24] !== t || a[25] !== j
    ? ((M = hn({
        codexHome: w,
        hostId: e,
        rootsOverrideCwd: t,
  ...
  if (!s || !v) {
    ...
    return (
      a[37] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = {
            availablePlugins: $,
            featuredPluginIds: Cn,
            installedPlugins: $,
            marketplaceLoadErrors: wn,
            marketplaces: Dn,
            errorMessage: null,
            isLoading: !1,
            isFetching: !1,
  ...
  a[42] !== R.data?.plugins
    ? ((z = {
        isComputerUseAvailable: E.available,
        isExternalBrowserUseAvailable: A.available,
        isInAppBrowserUseAvailable: O.available,
      }),
      (B = R.data?.plugins ?? $),
      (V = $t({ plugins: B, ...z })),
      (H = Qt({ featuredPluginIds: R.data?.featuredPluginIds ?? Cn, ...z })),
      (a[38] = E.available),
      (a[39] = A.available),
      (a[40] = O.available),
      (a[41] = R.data?.featuredPluginIds),
  ...
  let W = R.data?.marketplaceLoadErrors ?? wn,
    ge = R.data?.marketplaces ?? Dn,
    G = R.error ? String(R.error.message) : null,
    K =
      (y && C.isLoading) ||
      R.isLoading ||
      O.isLoading ||
      A.isLoading ||
      E.isLoading,
    q = (y && C.isFetching) || R.isFetching || E.isFetching,
    J;
  a[49] !== z || a[50] !== R
    ? ((J = async () => {
        let e = (await R.refetch()).data?.plugins ?? $;
        return {
          availablePlugins: $t({ plugins: e, ...z }),
    ...
    : (J = a[51]);
  let Y;
  a[52] === g ? (Y = a[53]) : ((Y = () => g(Q)), (a[52] = g), (a[53] = Y));
  let X;
  return (
    a[54] !== V ||
    a[55] !== H ||
...
function Gt(e, t, n = Tn, r = null, i = !1, a = !1) {
  return r == null
    ? Jt(
        e,
        t,
    ...
    : Kt([...Q, e, t, `installed`, r, `curated-marketplace`, Yt(i)], a);
}
function Kt(e, t) {
  return t ? [...e, xn] : e;
}
...
function Jt(e, t, n, r, i) {
  ...
  return Kt(
    n == null
      ? [...Q, e, t, `curated-marketplace`, a]
      : [...Q, e, t, `marketplace-kinds`, n, `curated-marketplace`, a],
    i,
  );
}
function Yt(e) {
...
function Qt({ featuredPluginIds: e, ...t }) {
  return e.filter((e) => rn(e, t));
}
function $t({ plugins: e, ...t }) {
  return e.filter((e) => rn(e.plugin.id, t));
}
function en(e) {
...
function tn({
  ...
  (i.setQueriesData({ queryKey: [...Q, t] }, (t) => {
    if (t == null) return t;
    let i = nn({ enabled: e, installed: n, pluginId: r, plugins: t.plugins });
    return i === t.plugins ? void 0 : { ...t, plugins: i };
  }),
    i.setQueriesData({ queryKey: [...Q, `marketplace-kind`, t] }, (t) => {
      if (t == null) return;
      let i = nn({ enabled: e, installed: n, pluginId: r, plugins: t });
      return i === t ? void 0 : i;
    }),
    i.setQueriesData({ queryKey: [...Q, `detail`, t] }, (t) => {
      if (!(
        t == null ||
        t.summary.id !== r ||
...
function nn({ enabled: e, installed: t, pluginId: n, plugins: r }) {
  return r.some(
    (r) =>
...
function ln({ buildFlavor: e, featuredPluginIds: t }) {
  let n = d(e);
  return t.filter((e) => {
    let t = f(e);
    return t == null ? !0 : !y(t) || t === n;
  });
}
function un({ buildFlavor: e, plugins: t }) {
  let n = d(e);
  return t.filter((e) => !y(e.marketplaceName) || e.marketplaceName === n);
}
function dn(e) {
  return e
    .trim()
...
async function mn({ hostId: e, plugins: t, queryClient: n }) {
  let r = [...t];
  async function i(a) {
    let o = t[a];
    if (o == null) return;
    let [s, c, l] = await Promise.all([
      Tt(o.composerIconPath, e, n),
      Tt(o.logoPath, e, n),
      Tt(o.logoDarkPath, e, n),
    ]);
  ...
  return (
    await Promise.all(
      Array.from({ length: Math.min(Sn, t.length) }, (e, t) => i(t)),
    ),
    r
  );
}
function hn({
  ...
  let i = t === `local` && e != null ? E(e, jn) : null;
  return gn(
    [
...
function gn(e, t) {
  return Array.from(
    new Set(e.map((e) => e.trim()).filter((e) => g(e) && _n(e, t))),
  );
}
function _n(e, t) {
  return t == null
  ...
  for (let t of e)
    for (let e of t.plugins) {
      ...
      let i = {
          ...
          plugin: e,
          keywords: e.keywords,
          ...Bt({ marketplaceName: t.name, marketplacePath: t.path }),
        },
        a = n.get(e.id);
      if (a == null) {
        n.set(e.id, i);
...
var bn,
  ...
  In = e(() => {
    ((bn = a()),
      ...
      At(),
      (Q = [`plugins`]),
      (xn = `openai-curated-marketplaces-hidden`),
      (Sn = 4),
      (Cn = []),
      (wn = []),
      (Tn = []),
      ...
      (kn = [u, C]),
      (An = `computer-use`),
      (jn = `.tmp/marketplaces/openai-internal-testing`),
      (Mn = [`datadog`, `statsig`]),
      (Nn = new Set(
        [`codex-official`, m, u, C, `openai-primary-runtime`].map(dn),
      )),
      (Pn = o(
        c,
        (
          ...
          let c = Xt({
            ...
            l = n == null ? Jt(t, a, i, r, o) : Gt(t, a, Tn, n, r, o);
          return {
            queryKey: l,
            queryFn: async () => {
              if (n != null) {
                let e = await T(`send-cli-request-for-host`, {
                    hostId: t,
                  ...
                  r = Zt(e.marketplaces, c),
                  i = vn(r, s.getQueryData(l)?.plugins);
                return {
                  featuredPluginIds: Cn,
                  marketplaceLoadErrors: e.marketplaceLoadErrors,
                  marketplaces: pn(r),
                  plugins: await mn({ hostId: t, plugins: i, queryClient: s }),
                };
              }
              let r = await T(
                  `list-plugins`,
                ...
                o = Zt(r.marketplaces, c),
                u = vn(o, s.getQueryData(l)?.plugins),
                d = e == null ? u : un({ buildFlavor: e, plugins: u }),
                f = Ft(r.featuredPluginIds).filter(
                  (e) => !c.some((t) => e.endsWith(`@${t}`)),
                );
              return {
                featuredPluginIds:
                  e == null ? f : ln({ buildFlavor: e, featuredPluginIds: f }),
                marketplaceLoadErrors: r.marketplaceLoadErrors,
                marketplaces: pn(o),
                plugins: await mn({ hostId: t, plugins: d, queryClient: s }),
              };
            },
            staleTime: p.SIX_HOURS,
            gcTime: 1 / 0,
          };
        },
      )),
      (Fn = o(c, ({ hostId: e, marketplaceKind: t }, { queryClient: n }) => {
        let r = [...Q, `marketplace-kind`, e, t];
        return {
          queryKey: r,
          queryFn: async () =>
            vn(
              (await T(`list-plugins`, { hostId: e, marketplaceKinds: [t] }))
                .marketplaces,
              n.getQueryData(r),
            ),
          staleTime: p.SIX_HOURS,
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~pull-request-rout~d8yqlw7s-ofF9uV_V.js.map
