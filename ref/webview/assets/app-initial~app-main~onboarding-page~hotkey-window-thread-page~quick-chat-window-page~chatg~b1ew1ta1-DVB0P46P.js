...
import {
  ...
  s as v,
  u as y,
} from "./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~cx4spki5-CFLjyq53.js";
import {
  i as b,
  r as x,
...
var A,
  ...
  _e = e(() => {
    ((A = t(n(), 1)),
      ...
      (j = r()),
      (M = [`PageUp`, `PageDown`]),
      (N = [`ArrowUp`, `ArrowDown`, `ArrowLeft`, `ArrowRight`]),
      (P = {
      ...
      (H = A.forwardRef((e, t) => {
        ...
        function D(e, t, { commit: n } = { commit: !1 }) {
          let o = ce(a),
            s = O(le(Math.round((e - r) / a) * a + r, o), [r, i]);
          S((e = []) => {
            let r = te(e, s, t);
            if (se(r, l * a)) {
        ...
        return (0, j.jsx)(B, {
          ...
          orientation: o,
          form: g,
          children: (0, j.jsx)(I.Provider, {
            scope: e.__scopeSlider,
            children: (0, j.jsx)(I.Slot, {
              scope: e.__scopeSlider,
              children: (0, j.jsx)(b, {
                "aria-disabled": s,
                ...
                ..._,
                ref: t,
                onPointerDown: f(_.onPointerDown, () => {
                  s || (C.current = x);
                }),
                min: r,
                max: i,
                ...
                onEndKeyDown: () => !s && D(i, x.length - 1, { commit: !0 }),
                onStepKeyDown: ({ event: e, direction: t }) => {
                  if (!s) {
                    let n =
                        M.includes(e.key) || (e.shiftKey && N.includes(e.key))
                          ? 10
                          : 1,
                      r = y.current,
                      i = x[r];
      ...
      (G = A.forwardRef((e, t) => {
        ...
        return (0, j.jsx)(U, {
          ...
          children: (0, j.jsx)(K, {
            ...
            onStepKeyDown: (e) => {
              let t = P[v ? `from-left` : `from-right`].includes(e.key);
      ...
      (de = A.forwardRef((e, t) => {
        ...
        return (0, j.jsx)(U, {
          ...
          children: (0, j.jsx)(K, {
            ...
            onStepKeyDown: (e) => {
              let t = P[m ? `from-bottom` : `from-top`].includes(e.key);
          ...
          onKeyDown: f(e.onKeyDown, (e) => {
            e.key === `Home`
              ...
              : e.key === `End`
                ...
                : M.concat(N).includes(e.key) && (c(e), e.preventDefault());
          }),
      ...
      (fe = A.forwardRef((e, t) => {
        let { __scopeSlider: n, ...r } = e,
          ...
          o = s(t, A.useRef(null)),
          c = i.values.length,
          l = i.values.map((e) => ne(e, i.min, i.max)),
          d = c > 1 ? Math.min(...l) : 0,
          f = 100 - Math.max(...l);
        return (0, j.jsx)(u.span, {
          "data-orientation": i.orientation,
      ...
      (Z = A.forwardRef((e, t) => {
        ...
        return (0, j.jsx)(pe, { ...e, ref: a, index: o });
      })),
      (pe = A.forwardRef((e, t) => {
        let { __scopeSlider: n, index: r, name: i, ...a } = e,
          ...
          [l, d] = A.useState(null),
          p = s(t, (e) => d(e)),
          h = l ? o.form || !!l.closest(`form`) : !0,
          g = m(l),
          _ = o.values[r],
          v = _ === void 0 ? 0 : ne(_, o.min, o.max),
          y = re(r, o.values.length),
          b = g?.[c.size],
          x = b ? ae(b, v, c.direction) : 0;
        return (
          A.useEffect(() => {
            if (l)
              return (
          ...
          (0, j.jsxs)(`span`, {
            style: {
              ...
              position: `absolute`,
              [c.startEdge]: `calc(${v}% + ${x}px)`,
            },
            children: [
              (0, j.jsx)(I.ItemSlot, {
                scope: e.__scopeSlider,
                children: (0, j.jsx)(u.span, {
                  role: `slider`,
                  ...
                  ...a,
                  ref: p,
                  style: _ === void 0 ? { display: `none` } : e.style,
                  onFocus: f(e.onFocus, () => {
      ...
      (Z.displayName = X),
      (me = `RadioBubbleInput`),
      (Q = A.forwardRef(({ __scopeSlider: e, value: t, ...n }, r) => {
        let i = A.useRef(null),
          a = s(i, r),
          o = b(t);
        return (
...
export { E as a, w as c, _e as i, $ as n, D as o, ge as r, C as s, he as t };
//# sourceMappingURL=app-initial~app-main~onboarding-page~hotkey-window-thread-page~quick-chat-window-page~chatg~b1ew1ta1-DVB0P46P.js.map
