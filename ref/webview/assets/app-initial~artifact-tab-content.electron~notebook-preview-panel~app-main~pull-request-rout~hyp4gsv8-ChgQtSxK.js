...
var Qe,
  $e,
  et = e(() => {
    (u(), me(), (Qe = ue(`environment`, null)), ($e = () => r(Qe)));
  });
function P(e) {
...
function qt(e) {
  return Zt(e, ({ label: e, path: t }) => {
    let n = M(t);
    return le({ href: n, label: j(e) }) !== `text` || !rn.test(n);
  });
}
...
function Yt(
  ...
  for (; g < t.length;) {
    ...
    let C = t.slice(y + 1, b),
      ...
      D = T || r || i ? z(E) : null;
    v(y);
    let O = i ? `text` : le({ href: E, label: w }),
...
function ln(e, t, n) {
  (t == null ? we(e, n) : xe(e, t, n), un(e, n));
}
function un(e, t) {
  (he(e), Sn(e, t));
}
function dn(e, t, n) {
  (t == null ? he(e) : Ee(e, t, n), Sn(e, n));
}
function fn(e, t) {
  (e.set(En, t),
    H(e, (e) => {
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~pull-request-rout~hyp4gsv8-ChgQtSxK.js.map
