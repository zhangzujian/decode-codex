...
function d(e) {
  let t = (0, p.c)(12),
    ...
    c = r === `primary` ? `primary` : `ghost`,
    l;
  t[0] === i
    ? (l = t[1])
    : ((l = i ? (0, m.jsx)(i, { className: `icon-xs` }) : null),
      (t[0] = i),
      (t[1] = l));
  let u;
  return (
...
function f(e) {
  let t = (0, p.c)(31),
    ...
    g = r === void 0 ? `aside` : r,
    _ = l != null || f != null || o != null,
    v,
    y,
    b,
    x;
  if (t[0] !== g || t[1] !== o || t[2] !== _ || t[3] !== l || t[4] !== f) {
    let e = {
      ...
      n = (t) =>
        (0, m.jsxs)(`div`, {
          className: s(`flex items-center gap-2`, e, t),
          children: [
            f ? (0, m.jsx)(d, { action: f, kind: `secondary` }) : null,
            l ? (0, m.jsx)(d, { action: l, kind: `primary` }) : null,
            o ? (0, m.jsx)(d, { action: o, kind: `dismiss` }) : null,
          ],
        });
    ((y = _ && g === `body` ? n() : null),
      (b = _ && g === `bodyOnNarrow` ? n(`hidden max-[400px]:flex`) : null),
      (v = _ && g === `aside` ? n() : null),
      (x = _ && g === `bodyOnNarrow` ? n(`max-[400px]:hidden`) : null),
      (t[0] = g),
      (t[1] = o),
      (t[2] = _),
      (t[3] = l),
...
//# sourceMappingURL=onboarding-banner-C3FEg7Dw.js.map
