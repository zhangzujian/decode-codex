const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./middleware-DYzbevgD.js",
      "./middleware-r396UXdv.js",
      "./query-string-B553K5iB.js",
      "./gracefulDecodeURIComponent-DUAwlHZu.js",
      "./routing-middleware-B8BjNZUQ.js",
      "./ajs-destination-CSXOQOY-.js",
      "./load-script-Cltl04TI.js",
      "./metric-helpers-BM0PZMiP.js",
      "./is-plan-event-enabled-BUDpDO9_.js",
      "./legacy-video-plugins-dla-By1c.js",
      "./schema-filter-KidkG1Qu.js",
      "./remote-middleware-DDcuToML.js",
    ]),
) => i.map((i) => d[i]);
                  ...
                  case 0:
                    return this.options.useQueryString === !1
                      ...
                      : [
                          4,
                          t(
                            () => import(`./query-string-B553K5iB.js`),
            ...
            return (
              ...
              Vn(n) || l.length > 0
                ? [
                    ...
                    t(
                      () =>
                        import(`./ajs-destination-CSXOQOY-.js`).then(
                          function (t) {
            ...
            return (
              ...
              n.legacyVideoPluginsEnabled
                ? [
                    ...
                    t(
                      () =>
                        import(`./legacy-video-plugins-dla-By1c.js`).then(
                          function (e) {
          ...
          case 8:
            return i.plan?.track
              ? [
                  ...
                  t(
                    () =>
                      import(`./schema-filter-KidkG1Qu.js`).then(function (e) {
            ...
            return (
              ...
              Object.entries(n.enabledMiddleware ?? {}).some(function (e) {
                ...
                ? [
                    ...
                    t(
                      () =>
                        import(`./remote-middleware-DDcuToML.js`).then(
                          function (e) {
...
//# sourceMappingURL=pkg-Dxft20i6.js.map
