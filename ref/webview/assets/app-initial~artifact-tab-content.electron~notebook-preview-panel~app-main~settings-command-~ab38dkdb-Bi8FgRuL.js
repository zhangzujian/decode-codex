  ...
  t[0] !== r || t[1] !== s || t[2] !== a || t[3] !== i
    ? ((c = async (e) => {
        let { pluginId: t, enabled: n } = e,
          o = await Ue(a, r),
          c = await A(`batch-write-config-value`, {
            hostId: r,
            edits: B({ pluginId: t, enabled: n }),
  ...
  t[5] !== a || t[6] !== i
    ? ((l = async (e) => {
        ...
        (r != null &&
          I(i, {
            action: n
              ? z.CODEX_PLUGIN_ACTION_TYPE_ENABLE
              : z.CODEX_PLUGIN_ACTION_TYPE_DISABLE,
            result: V.CODEX_PLUGIN_ACTION_RESULT_INITIATED,
            ...r,
          }),
          await Promise.all([
        ...
        (r != null &&
          I(i, {
            action: n
              ? z.CODEX_PLUGIN_ACTION_TYPE_ENABLE
              : z.CODEX_PLUGIN_ACTION_TYPE_DISABLE,
            result: V.CODEX_PLUGIN_ACTION_RESULT_SUCCESS,
            ...r,
          }),
          i.get(M).success(
    ...
    ? ((d = (e, t, n) => {
        ...
        (o != null &&
          I(i, {
            ...
            result: V.CODEX_PLUGIN_ACTION_RESULT_FAILURE,
            ...o,
          }),
          w.error(`Failed to update plugin enabled state`, {
            safe: {},
            sensitive: { error: e },
          }),
          n?.previousUserConfig && a.setQueryData(U, n.previousUserConfig));
        for (let [e, t] of n?.previousPluginLists ?? []) a.setQueryData(e, t);
        i.get(M).danger(s.formatMessage(Q.toggleError));
      }),
      (t[11] = s),
      (t[12] = a),
      (t[13] = i),
...
function Ct(e) {
  let t = (0, Ft.c)(31),
    ...
    s = ce(),
    c;
  t[0] === r ? (c = t[1]) : ((c = st(r)), (t[0] = r), (t[1] = c));
  let l = c,
    u;
  t[2] !== l || t[3] !== r || t[4] !== s || t[5] !== a || t[6] !== i
    ? ((u = async (e) => {
        let {
          ...
          u = Ne(n);
        (u != null && (await L(i, u, !0)),
          await A(`uninstall-plugin`, { hostId: r, pluginId: c ?? n }),
          At(a, r, n));
        let d = Nt({ hostId: r, intl: s, queryClient: a, scope: i });
        (a
          .cancelQueries({ queryKey: l })
          .then(() => Qe({ hostId: r, queryClient: a }))
          .finally(() => ge(l))
          .catch((e) => {
            (a.invalidateQueries({ queryKey: l, refetchType: `none` }),
              w.error(`Failed to refresh apps after plugin uninstall`, {
                safe: {},
                sensitive: { error: e },
              }));
          }),
          await Promise.all([
            d,
            Se({ hostId: r, marketplaceName: t, pluginName: o }),
          ]));
      }),
      (t[2] = l),
      (t[3] = r),
  ...
  t[8] === i
    ...
    : ((d = (e) => {
        ...
        t != null &&
          I(i, {
            action: z.CODEX_PLUGIN_ACTION_TYPE_REMOVE,
            result: V.CODEX_PLUGIN_ACTION_RESULT_INITIATED,
            ...t,
          });
      }),
  ...
  t[15] !== s || t[16] !== i
    ? ((p = (e, t) => {
        ...
        (n != null &&
          ...
          w.error(`manual_plugin_uninstall_failed`, {
            safe: { marketplaceName: r, pluginId: c ?? a, pluginName: o },
            sensitive: { error: e },
          }),
          i.get(M).danger(s.formatMessage(Q.uninstallError)));
      }),
      (t[15] = s),
      (t[16] = i),
      (t[17] = p))
...
function wt(e) {
  w.error(`Failed to refresh plugins after plugin uninstall`, {
    safe: {},
    sensitive: { error: e },
  });
}
async function Tt({
  ...
  try {
    let s = Ne(n);
    (s != null && (await L(o, s, !0)),
      await A(`uninstall-plugin`, { hostId: e, pluginId: a ?? n }));
    let c = st(e);
    (i
      .cancelQueries({ queryKey: c })
      .then(() => Qe({ hostId: e, queryClient: i }))
      .finally(() => ge(c))
      .catch((e) => {
      ...
      await Promise.all([
        F({ hostId: e, queryClient: i }).catch((t) => {
          w.error(`plugin_skill_catalog_reload_failed_after_mutation`, {
            safe: { hostId: e },
            sensitive: { error: t },
          });
        }),
        Se({ hostId: e, marketplaceName: t, pluginName: r }),
      ]));
  } finally {
    Pt((e) => Ve(i, e));
  }
...
function Et(e) {
  ...
  t[0] !== r || t[1] !== s || t[2] !== a || t[3] !== i
    ? ((c = async (e) => {
        ...
        (await A(`remove-marketplace`, { hostId: r, marketplaceName: t }),
  ...
  t[5] !== s || t[6] !== i
    ? ((l = (e, t) => {
      ...
      (u = (e, t) => {
        ...
        (w.error(`manual_plugin_marketplace_remove_failed`, {
...
function Dt(e) {
  ...
  t[0] !== r || t[1] !== s || t[2] !== a || t[3] !== i
    ? ((c = async (e) => {
        let { marketplaceName: t } = e,
          n = await A(`upgrade-marketplaces`, {
            hostId: r,
  ...
  t[5] !== s || t[6] !== i
    ? ((l = (e, t) => {
        ...
        if (e.errors.length > 0) {
          (w.error(`Failed to upgrade marketplaces`, {
        ...
        i.get(M).success(s.formatMessage(Q.marketplacesUpgradeSuccess));
      }),
      (u = (e, t) => {
        let { marketplaceDisplayName: n } = t;
        (w.error(`Failed to upgrade marketplaces`, {
...
async function Nt({ hostId: e, intl: t, queryClient: n, scope: r }) {
  try {
    await F({ hostId: e, queryClient: n });
  } catch (n) {
    (w.error(`plugin_skill_catalog_reload_failed_after_mutation`, {
      safe: { hostId: e },
      sensitive: { error: n },
    }),
      r.get(M).danger(t.formatMessage(Q.skillCatalogReloadError)));
  }
}
async function Pt(e) {
  await Promise.all([e(W), e(k), e(pt), e(Ee), e(U), e(It)]);
}
var Ft,
  It,
  Q,
...
var Bt,
  ...
  Gt = e(() => {
    (m(),
      ...
      (Ht = h(g, !1)),
      (Ut = h(g, !1)),
      (Wt = s(g, ({ get: e }) => Fe({ ctrlKey: e(Vt), metaKey: e(Ht) }))));
  });
function Kt() {
...
function qt(e) {
  let t = (0, Jt.c)(4),
    ...
    u = c(),
    f = r(tn),
    { data: p, isLoading: m } = Ge(x.DESKTOP_FIRST_SEEN_AT_MS),
    h = en.safeParse(a),
    _ =
      i &&
      h.success &&
...
var Jt,
  ...
  nn = e(() => {
    ((Jt = f()),
      ...
      (Qt = `ext`),
      ($t = `external-browser`),
      (en = ae({ cutoff_ms: oe().int().nonnegative() })),
      (tn = O(`desktop-link-default-destination`, null)));
  });
function rn(e) {
  let t = (0, an.c)(9),
    {
    ...
    (t.push(
      (0, $.jsx)(
        `a`,
        {
          ...
          className: `underline`,
          onClick: (e) => {
            Pe({ event: e, href: s, initiator: `open_in_browser_bridge` });
          },
          children: a,
        },
        `${s}-${r.index}`,
...
function Dn(e) {
  ...
  t[2] === S
    ? (T = t[3])
    : ((T = [`mcp-settings`, `app-connect`, S]), (t[2] = S), (t[3] = T));
  let se = ae && r != null,
    D;
  t[4] === r
    ? (D = t[5])
  ...
  t[10] === S
    ? (fe = t[11])
    : ((fe = [`mcp-settings`, `app-connect`, `tos`, S]),
      (t[10] = S),
      (t[11] = fe));
  let me = ae && r != null,
    k;
  ...
  t[18] === O
    ? (ge = t[19])
    : ((ge = O == null ? `UNSUPPORTED` : bn(O)), (t[18] = O), (t[19] = ge));
  let N = ge,
    ve;
  t[20] === O
    ? (ve = t[21])
    : ((ve = O == null ? !1 : yn(O.link_params_schema)),
      (t[20] = O),
      (t[21] = ve));
  let ye = ve,
    P =
      a == null && !j && (de.isError || O == null || ye || N === `UNSUPPORTED`),
    be;
  t[22] !== r?.installUrl || t[23] !== C || t[24] !== x || t[25] !== b
    ? ((be = (e) => {
  ...
  let Ce = Se,
    we;
  t[32] !== r || t[33] !== a || t[34] !== O || t[35] !== u || t[36] !== ie
    ? ((we = async () => {
        if (r == null) throw Error(`Expected app metadata to be present.`);
        return (
          u?.(),
  ...
  t[48] !== te
    ? ((F = (e) => {
        switch (e.kind) {
          ...
          case `failed`:
            (l?.(`connect_failed`),
              te && b.get(M).danger(r?.installUrl?.trim() ? rt(x) : it(x)),
              _ && C(!1));
            return;
        }
      }),
  ...
  t[50] !== r?.id || t[51] !== x || t[52] !== l || t[53] !== b
    ...
    : (I = t[54]);
  let Te;
  t[55] !== we || t[56] !== F || t[57] !== I
    ? ((Te = { mutationFn: we, onSuccess: F, onError: I }),
      (t[55] = we),
      (t[56] = F),
      (t[57] = I),
      (t[58] = Te))
  ...
  t[59] === r.installUrl
    ? (ke = t[60])
    : ((ke = r.installUrl?.trim() || null),
      (t[59] = r.installUrl),
      (t[60] = ke));
  let Ae = ke,
    je;
  t[61] === r ? (je = t[62]) : ((je = $e(r)), (t[61] = r), (t[62] = je));
  let z = je,
    Me = null;
  R ? (Me = z) : P && (Me = Ae);
  let B = O?.name ?? r.name,
    V;
  t[63] === O ? (V = t[64]) : ((V = xn(O)), (t[63] = O), (t[64] = V));
  let Ne = V,
    Fe;
  t[65] === x
    ? (Fe = t[66])
  ...
  let He;
  t[83] !== Ve || t[84] !== H
    ? ((He = { title: Ve, description: H }),
      (t[83] = Ve),
      (t[84] = H),
      (t[85] = He))
    : (He = t[85]);
  let Ue;
  t[86] !== Le || t[87] !== Be || t[88] !== He
    ? ((Ue = [Le, Be, He]),
      (t[86] = Le),
      (t[87] = Be),
      (t[88] = He),
  ...
  t[90] === A.data?.blurbs
    ? (U = t[91])
    : ((U = A.data?.blurbs ?? []), (t[90] = A.data?.blurbs), (t[91] = U));
  let Ge = U,
    Ke = Ge.length > 0 ? Ge : We,
    qe;
  t[92] !== Ee ||
  t[93] !== R ||
  t[94] !== L ||
  ...
  let W = qe,
    ...
    Xe = null;
  if (Me != null) {
    let e = R ? void 0 : `external-browser`,
      n;
    (t[102] !== Me || t[103] !== e
      ? ((n = (0, $.jsx)(sn, {
          className: `icon-xs`,
  ...
  t[121] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ut = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(Je, { className: `size-12` }),
      })),
      (t[121] = ut))
    : (ut = t[121]);
  let dt;
  ...
  t[123] !== r.name || t[124] !== x
    ? ((pt = x.formatMessage(
      ...
      (t[125] = pt))
    : (pt = t[125]);
  let mt = r.logoUrl ?? O?.logo_url ?? null,
    _t = r.logoUrlDark ?? O?.logo_url_dark ?? null,
    yt;
  ...
  t[138] === Oe
    ...
    : ((Y = Oe
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(ft, { className: `icon-sm shrink-0` }),
              (0, $.jsx)(E, {
  ...
  t[140] !== G || t[141] !== J || t[142] !== Y
    ...
    : (X = t[143]);
  let Z;
  t[144] !== A.isPending || t[145] !== j || t[146] !== Ke
    ? ((Z =
        j || A.isPending ? (0, $.jsx)(Cn, {}) : (0, $.jsx)(Tn, { blurbs: Ke })),
      (t[144] = A.isPending),
      (t[145] = j),
      (t[146] = Ke),
      (t[147] = Z))
  ...
  t[153] !== Xe || t[154] !== ot
    ...
    : (wt = t[155]);
  let Tt;
  t[156] !== W || t[157] !== De || t[158] !== Ct || t[159] !== wt
    ? ((Tt = (0, $.jsx)(`div`, {
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~settings-command-~ab38dkdb-Bi8FgRuL.js.map
