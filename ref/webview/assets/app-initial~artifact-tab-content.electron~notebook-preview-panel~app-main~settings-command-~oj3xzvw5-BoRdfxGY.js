...
function M(e) {
  return {
    enabled: e != null,
    queryFn: async () =>
      g.safeGet(`/wham/tasks/{task_id}/turns`, {
        parameters: { path: { task_id: e ?? `` } },
      }),
...
function N(e) {
  ...
  t[3] !== e?.limit || t[4] !== e?.taskFilter
    ? ((s = async () =>
        (
          await g.safeGet(`/wham/tasks/list`, {
            parameters: {
...
function L(e, t, n) {
  ...
  r[3] !== e || r[4] !== t
    ? ((s = async () =>
        g.safeGet(`/wham/tasks/{task_id}/turns/{task_turn_id}`, {
...
function R(e, t, n) {
  ...
  r[3] !== e || r[4] !== t
    ? ((o = async () =>
        g.safeGet(`/wham/tasks/{task_id}/turns/{task_turn_id}/logs`, {
          parameters: { path: { task_id: e ?? ``, task_turn_id: t ?? `` } },
        })),
      (r[3] = e),
      (r[4] = t),
...
async function B() {
  return g.safeGet(`/wham/environments`);
}
function V(e, t) {
  let n = (0, Z.c)(14),
    { enabled: r } = t,
  ...
  n[5] === a
    ? (c = n[6])
    : ((c = async () => {
        let e = await g.safeGet(`/wham/environments`),
...
async function se({
  ...
  return g.safePost(`/wham/worktree_snapshots/upload_url`, {
    requestBody: {
      repo_name: e,
      filename: t,
      content_type: n,
...
async function ce({ fileId: e, etag: t }) {
  return g.safePost(`/wham/worktree_snapshots/finish_upload`, {
...
async function fe(e) {
  return g.safePost(`/wham/tasks/{task_id}/turns/{task_turn_id}/pr`, {
...
function ge() {
  return g.safeGet(`/wham/rate-limit-reset-credits`);
}
function _e() {
  let e = (0, Z.c)(3),
    t = s(),
...
function ve(e) {
  ...
  return g.safePost(`/wham/rate-limit-reset-credits/consume`, {
...
async function xe(e) {
  await g.safePost(`/wham/tasks/{task_id}/cancel`, {
    parameters: { path: { task_id: e } },
  });
}
function Se() {
...
async function we(e, t, n = 20, r = null) {
  return g.safeGet(`/wham/github/branches/{repo_id}/search`, {
    parameters: {
...
function Ae(e) {
  ...
  t[0] === e
    ? (r = t[1])
    : ((r = () =>
        g.safePost(`/wham/tasks/{task_id}/mark_read`, {
          parameters: { path: { task_id: e } },
        })),
      (t[0] = e),
      (t[1] = r));
...
function Y(e) {
  let t = (0, Z.c)(4),
    { accountId: n, authMethod: r } = C(),
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = [`accounts`, `check`]), (t[0] = i))
    : (i = t[0]);
  let a = r === `chatgpt` && n != null,
    o;
  return (
    t[1] !== e || t[2] !== a
      ? ((o = {
...
async function X() {
  return g.safeGet(`/wham/accounts/check`);
}
function je(e) {
  let t = (0, Z.c)(8),
    n;
...
async function Me() {
  return g.safeGet(`/wham/onboarding/context`);
}
function Ne(e) {
  return g.safePost(`/wham/onboarding/desktop/complete`, {
    requestBody: { role: e },
  });
}
function Pe(e) {
  return g.safePost(`/wham/statsig/bootstrap`, { requestBody: e });
}
function Fe(e) {
  let t = (0, Z.c)(8),
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~settings-command-~oj3xzvw5-BoRdfxGY.js.map
