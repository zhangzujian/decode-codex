...
import { i as u, r as d } from "./custom-avatars-query-BaoamboH.js";
import { n as f, t as p } from "./use-avatar-options-DuBu_i67.js";
function m(e) {
...
function W() {
  let e = (0, G.c)(3),
    { avatarOptions: t, isFetching: r } = f(),
    { selectedAvatar: a, selectedAvatarId: s } = i(t),
    c = o(a, s),
    { isFetching: l } = n(u, s ?? a.id),
    d = c && (r || l) ? null : a,
    p;
  return (
    e[0] !== s || e[1] !== d
...
//# sourceMappingURL=use-avatar-overlay-selection-Cw72-v7Z.js.map
