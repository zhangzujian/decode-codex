...
var Bs = class extends Co {
  ...
  buildLookaheadForOptional(t) {
    let {
      ...
      p = f(ba({ maxLookahead: 1, occurrence: n, prodType: a, rule: i }), (e) =>
        f(e, (e) => e[0]),
      );
    if (Vs(p) && p[0][0] && !o) {
      let t = p[0],
        n = r(t);
      if (n.length === 1 && m(n[0].categoryMatches)) {
...
function Gs(e, t, n, r, i, a) {
  ...
  let s = ec(o),
    l = $s(o, i);
  if (l !== void 0)
    ((s.isAcceptState = !0), (s.prediction = l), (s.configs.uniqueAlt = l));
  else if (cc(o)) {
    let t = c(o.alts);
    ((s.isAcceptState = !0),
      (s.prediction = t),
...
//# sourceMappingURL=chunk-K5T4RW27-DQYGNv_l.js.map
