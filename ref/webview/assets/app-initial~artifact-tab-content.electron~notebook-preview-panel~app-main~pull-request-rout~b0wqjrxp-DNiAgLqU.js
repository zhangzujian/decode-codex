...
import { n as T } from "./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~g8980z4e-CwatHxhA.js";
import {
  A as E,
  C as D,
  D as ne,
...
async function Js(e, t) {
  return t === `local` &&
    ...
    ? `copilot`
    : Ys(
        (await e.get(Ne, t)?.getAccount({ priority: `critical` }))?.account ??
          null,
      );
}
function Ys(e) {
...
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~pull-request-rout~b0wqjrxp-DNiAgLqU.js.map
