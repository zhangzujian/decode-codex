...
import { n as H, t as U } from "./codex-avatar-CbU9oRkd.js";
import {
  r as W,
  t as G,
...
import {
  ...
  r as At,
  t as jt,
} from "./app-initial~app-main~onboarding-page~hotkey-window-new-thread-page~hotkey-window-home-page~~or65j7iw-9LoIzfHZ.js";
import {
  d as Mt,
  f as Nt,
...
import {
  ...
  x as an,
  y as on,
} from "./app-initial~app-main~new-thread-panel-page~onboarding-page~hotkey-window-thread-page~quick-~e9bovb3h-BxK93xks.js";
import {
  h as sn,
  p as cn,
} from "./app-initial~app-main~settings-command-menu-section-items~appgen-settings-page~page~pull-req~nb6vzw6f-CUA7JZmW.js";
import { n as ln, r as un } from "./custom-avatars-query-ZfMaMCDW.js";
import { n as dn, t as fn } from "./plus-sm-Du6pHULS.js";
function pn() {
  let e = (0, mn.c)(19),
    t = n(u),
    r = ee(),
    { accountId: i, authMethod: a, userId: o } = Ne(),
    { data: s } = We(),
    c,
    l,
    d;
...
function Cn(e) {
  ...
  if (r == null) {
    ...
    if (t[7] !== n || t[8] !== i || t[9] !== a) {
      ...
      bb0: {
        let t = Xe(i?.split(`@`)[0] ?? (a === `skill` ? n.split(`:`)[0] : n));
        if (t != null) {
...
function Pn(e) {
  ...
  t[86] !== fe || t[87] !== me
    ...
    : (he = t[88]);
  let ge;
  t[89] !== ne || t[90] !== le || t[91] !== ue || t[92] !== he || t[93] !== C
    ? ((ge = (0, Y.jsxs)(it, {
        as: `form`,
        className: `gap-5`,
        onSubmit: C,
        children: [w, T, D, ne, le, ue, he],
      })),
      (t[89] = ne),
      (t[90] = le),
      (t[91] = ue),
...
function Ti(e) {
  ...
  let te;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((te = (0, X.jsx)(A, { "aria-hidden": !0, className: `icon-sm` })),
      (t[14] = te))
    : (te = t[14]);
  let L;
  t[15] !== M || t[16] !== N
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, X.jsx)(`h2`, {
      ...
      (t[18] = R))
    : (R = t[18]);
  let z = s == null ? `mt-[50px]` : `mt-8`,
    re;
  t[19] === z
    ? (re = t[20])
    : ((re = i(`flex flex-col items-center`, z)), (t[19] = z), (t[20] = re));
  let ie;
  ...
  let H;
  t[29] !== B || t[30] !== V
    ? ((H = (0, X.jsx)(ne.div, { className: ie, style: B, children: V })),
      (t[29] = B),
      (t[30] = V),
      (t[31] = H))
    : (H = t[31]);
  ...
  let Ie;
  return (
    t[106] !== f || t[107] !== a || t[108] !== Fe || t[109] !== L
      ? ((Ie = (0, X.jsxs)(st, {
          open: a,
...
function Oi(e) {
  ...
  t[26] === d
    ? (C = t[27])
    : ((C = (0, X.jsx)(Re, { href: d, className: `icon-xs` })),
      (t[26] = d),
      (t[27] = C));
  let w;
  t[28] === l
...
function Hi({
  ...
  let l = n(u),
    ...
    R = (e) => {
      ...
      (x(e),
        C(!0),
        L(t, w, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    z = (e) => {
  ...
  return (0, qi.jsxs)(qi.Fragment, {
    children: [
      (0, qi.jsxs)(O, {
        ...
        size: `toolbar`,
        onClick: () => {
          (P(be.CODEX_PROFILE_SHARE_ACTION_SHARE_BUTTON_CLICKED), ne());
        },
        children: [
...
function ea({ today: e = new Date() }) {
  let t = n(u),
    ...
    d = pe(`1991660486`),
    f = pe(`2056428529`),
    { accountId: p, authMethod: m, planAtLogin: _, userId: v } = Ne(),
    { data: y } = We(),
    ...
    he = g.isInternal(He()) && A.error != null ? Fa(A.error) : null,
    ge = A.data?.hasStatsError === !0,
    _e = L.id.startsWith(`custom:`),
    ...
    Le =
      ge || Fe == null
        ? null
        : {
            cells: Pt({ dailyUsage: Fe, todayIso: C, view: H }),
            dailyValues: It({ dailyUsage: Fe, todayIso: C }),
            weeklyTotals: Ft({ dailyUsage: Fe, todayIso: C }),
            cumulativeTotals: Vt({ dailyUsage: Fe, todayIso: C }),
          },
    Re = o.formatMessage({
                    ...
                    children: [
                      ...
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(`input`, {
                          ...
                          maxLength: 64,
                          onChange: (e) => {
                            (S(e.target.value), M(null), L(null));
                          },
                          onFocus: (e) => {
...
function ba(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = []), (t[0] = a))
    : (a = t[0]);
  let { availablePlugins: o } = Fe(se, a);
  if (r) {
    let e;
    return (
...
//# sourceMappingURL=profile-JJqY3n3G.js.map
