...
import { ho as i } from "./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~ngwudnyz-D_QFwR2V.js";
var a = n({ default: () => o }),
  o,
  s = e(() => {
    o = {
  ...
  l = r((e) => {
    ...
    ((e.charset = o),
      ...
      d(e.extensions, e.types));
    function o(e) {
      if (!e || typeof e != `string`) return !1;
      var n = r.exec(e),
        i = n && t[n[1].toLowerCase()];
      return i && i.charset ? i.charset : n && a.test(n[1]) ? `UTF-8` : !1;
    }
    function s(t) {
...
export { l as t };
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~pull-request-rout~h1wwxhmv-DwcFvK_b.js.map
