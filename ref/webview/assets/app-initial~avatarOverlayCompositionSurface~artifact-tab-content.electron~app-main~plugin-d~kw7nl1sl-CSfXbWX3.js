...
import { n as R } from "./app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~g8980z4e-Bj4tUPiN.js";
import {
  a as z,
  h as B,
  m as V,
...
function ye({ queryClient: e, hostId: t, cwd: n, enabled: r }) {
  return x({
    ...
    queryFn: async () => {
      try {
        return q((await J(e, t, n, !1)).config);
      } catch {
        return null;
      }
    },
  ...
  xe = e(() => {
    (O(),
      ...
      (be = h(_, ({ cwd: e = null, hostId: t }, { get: n, queryClient: r }) =>
        ye({ queryClient: r, hostId: t, cwd: e, enabled: n(G).includes(t) }),
      )));
  }),
  Se,
  Ce = e(() => {
...
async function Ae(e) {
  try {
    return (await le({ cwd: null, hostId: e })).preferredTarget;
  } catch {
    return;
  }
}
...
function Pe(e) {
  ...
  t[2] === o
    ? (l = t[3])
    : ((l = o
        ? (0, Q.jsx)(A, { ...De.openConfigTomlWsl })
        : (0, Q.jsx)(A, { ...De.openConfigToml })),
      (t[2] = o),
      (t[3] = l));
  let u = l,
    d;
...
async function Ge(
  ...
  let a = o(e.get, C.enabledReasoningEfforts),
    s = a;
  (t && !a.includes(i)
    ? (s = [...a, i])
    ...
    s !== a &&
      ...
      await l(e, C.enabledReasoningEfforts, s)));
}
async function Ke(e, t, n, r) {
  ...
  let f = await F(`set-default-model-config-for-host`, {
    hostId: t,
    model: l.model,
    profile: d,
    reasoningEffort: u,
  });
  (await F(`clear-prewarmed-threads-for-host`, { hostId: t }),
    e.set(
      U,
      i,
...
var qe,
  ...
  Ye = e(() => {
    (g(),
      ...
      (Je = c(_, ({ get: e }) => new Set(o(e, C.enabledReasoningEfforts)))));
  });
function Xe(e) {
    ...
    ((ct = p()),
      ...
      (dt = h(
        ...
        (
          ...
          return {
            queryKey: at(r, t, a),
            enabled: s(G).includes(r),
            staleTime: S.FIVE_MINUTES,
            queryFn: () =>
              F(`list-models-for-host`, {
                hostId: r,
                includeHidden: !0,
                cursor: null,
                limit: a,
...
function pt(e) {
  let t = (0, mt.c)(79),
    ...
    C = _ === void 0 ? !1 : _,
    w = v === void 0 ? `normal` : v,
    T = y === void 0 ? `horizontal` : y,
    re = te === void 0 ? !1 : te,
    E = T === `vertical`,
    ie = T === `verticalIcon`,
    D = T === `horizontal` && re,
    O = E ? `w-full justify-end` : `shrink-0`,
    k =
      D &&
      `max-[400px]:w-full max-[400px]:shrink max-[400px]:flex-wrap max-[400px]:justify-center`,
    A;
  t[0] !== O || t[1] !== k
    ? ((A = i(`flex gap-2`, O, k)), (t[0] = O), (t[1] = k), (t[2] = A))
    : (A = t[2]);
  let j = A,
    N;
  t[3] !== j ||
  ...
  t[15] !== f
    ? ((N = a
        ? (0, $.jsx)(`div`, { className: j, children: a })
        : (s || f || p) &&
          (0, $.jsxs)(`div`, {
            className: j,
            children: [
  ...
  if (
    ...
    bb0: {
      let e = {
        ...
        o = i(
          `icon-sm shrink-0`,
          w === `infoAccent` && `text-token-text-link-foreground`,
          w === `warning` && `text-token-editor-warning-foreground`,
          h,
        ),
      ...
      if (ie) {
        ...
        t[48] === n
          ...
          : ((r = n
            ...
            (t[49] = r));
        let a;
        t[50] === F ? (a = t[51]) : ((a = F()), (t[50] = F), (t[51] = a));
        let s;
        (t[52] !== P || t[53] !== r || t[54] !== a
          ? ((s = (0, $.jsxs)(`div`, {
      ...
      ((R = b),
        (z = i(
          u,
          `items-center gap-4`,
          D && `max-[400px]:items-start max-[400px]:gap-2`,
        )),
        (B = x),
        (V = l));
      let p = D && `max-[400px]:items-start`;
      (t[56] === p
        ? (I = t[57])
        : ((I = i(`flex h-full w-full items-center gap-2`, p)),
          (t[56] = p),
          (t[57] = I)),
        (L =
          m && (0, $.jsx)(m, { className: i(o, D && `max-[400px]:hidden`) })));
    }
    ((t[17] = m),
      (t[18] = b),
      (t[19] = r),
  ...
  let U =
      D && `max-[400px]:flex-col max-[400px]:items-stretch max-[400px]:gap-2`,
    W;
  t[58] === U
    ? (W = t[59])
    : ((W = i(
  ...
  t[60] === n
    ...
    : ((G =
      ...
      (t[61] = G));
  let K;
  t[62] === F ? (K = t[63]) : ((K = F()), (t[62] = F), (t[63] = K));
  let q;
  t[64] !== P || t[65] !== W || t[66] !== G || t[67] !== K
    ? ((q = (0, $.jsxs)(`div`, { className: W, children: [G, K, P] })),
      (t[64] = P),
      (t[65] = W),
      (t[66] = G),
      (t[67] = K),
    ...
    : (q = t[68]);
  let J;
  t[69] !== I || t[70] !== L || t[71] !== q
    ? ((J = (0, $.jsxs)(`div`, { className: I, children: [L, q] })),
      (t[69] = I),
      (t[70] = L),
      (t[71] = q),
      (t[72] = J))
  ...
  let Y;
  return (
    t[73] !== R || t[74] !== z || t[75] !== B || t[76] !== V || t[77] !== J
      ? ((Y = (0, $.jsxs)(`aside`, {
          "aria-live": R,
          className: z,
          role: B,
...
//# sourceMappingURL=app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~app-main~plugin-d~kw7nl1sl-CSfXbWX3.js.map
