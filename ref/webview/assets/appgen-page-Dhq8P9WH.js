...
import { n as De, t as Oe } from "./appgen-share-dialog-DJl5keFz.js";
function ke() {
  let e = (0, Q.c)(67),
    t = n(l),
    r = f(),
    ...
    _ = ie(),
    [v, te] = (0, Re.useState)(``),
    { scrollContainerRef: y, showTitleInToolbar: b, titleRef: S } = pe(),
    ne = u || p || c,
    C,
    T;
  e[0] !== i || e[1] !== v
    ? ((C = v.trim().toLowerCase()),
      (T = i?.filter((e) => Te(e, C)) ?? null),
      (e[0] = i),
      (e[1] = v),
      (e[2] = C),
      (e[3] = T))
  ...
  e[8] !== t || e[9] !== g || e[10] !== _
    ? ((M = () => {
        we(t, _, { type: `create`, setSelectedMode: g });
      }),
      (e[8] = t),
      (e[9] = g),
      (e[10] = _),
  ...
  e[12] !== t || e[13] !== _
    ? ((P = (e, n, r) => {
        we(t, _, { type: `edit`, liveUrl: r, projectId: e, projectTitle: n });
      }),
      (e[12] = t),
      (e[13] = _),
      (e[14] = P))
  ...
  e[19] === p
    ? (R = e[20])
    : ((R = p ? null : (0, $.jsx)(x, { className: `icon-xs` })),
      (e[19] = p),
      (e[20] = R));
  let z;
  e[21] !== ae || e[22] !== p || e[23] !== ne || e[24] !== O || e[25] !== R
    ? ((z = (0, $.jsx)(m, {
        "aria-label": O,
        color: `ghost`,
        disabled: ne,
  ...
  let B;
  e[27] !== O || e[28] !== z
    ? ((B = (0, $.jsx)(ee, { tooltipContent: O, children: z })),
      (e[27] = O),
      (e[28] = z),
      (e[29] = B))
    : (B = e[29]);
  ...
  e[31] === N
    ? (V = e[32])
    : ((V = (0, $.jsx)(m, { size: `toolbar`, onClick: N, children: se })),
      (e[31] = N),
      (e[32] = V));
  let H;
  e[33] !== V || e[34] !== B
  ...
  e[39] === W
    ? (G = e[40])
    : ((G = (0, $.jsx)(oe, { extension: !0, children: W })),
      (e[39] = W),
      (e[40] = G));
  let K;
  e[41] === W
    ...
    : ((K = (0, $.jsx)(oe, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, $.jsx)(w.Header, { children: W }),
      })),
      (e[41] = W),
      (e[42] = K));
  let q, J;
...
function Fe(e) {
  let t = (0, Q.c)(63),
    { onEdit: n, project: i } = e,
    a = f(),
    o = i.current_live_url,
    s = i.status === `suspended`,
    c = s ? null : o,
    l;
  t[0] === i.disabled_by
    ? (l = t[1])
    : ((l = (0, $.jsx)(xe, { disabledBy: i.disabled_by })),
      (t[0] = i.disabled_by),
      (t[1] = l));
  let u = l,
    { data: p } = D(i.screenshot_url),
    m = !s && `hover:bg-token-list-hover-background/50`,
    h;
  t[2] === m
    ? (h = t[3])
    : ((h = r(
  ...
  t[10] === i.title
    ...
    : ((v = (0, $.jsx)(`span`, {
      ...
      (t[11] = v));
  let y;
  t[12] !== u || t[13] !== s || t[14] !== i.disabled_by
    ? ((y = s
        ? (0, $.jsx)(ee, {
            interactive: i.disabled_by === `openai`,
            tooltipContent: u,
            children: (0, $.jsx)(te, {
  ...
  t[19] === i.updated_at
    ? (x = t[20])
    : ((x = (0, $.jsx)(R, { dateString: i.updated_at })),
      (t[19] = i.updated_at),
      (t[20] = x));
  let S;
  ...
  let C;
  t[22] !== o || t[23] !== i.slug
    ? ((C = H(o) ?? i.slug), (t[22] = o), (t[23] = i.slug), (t[24] = C))
    : (C = t[24]);
  let w;
  t[25] === C
    ? (w = t[26])
    : ((w = (0, $.jsx)(`span`, { className: `truncate`, children: C })),
      (t[25] = C),
      (t[26] = w));
  let T;
  t[27] !== w || t[28] !== x
  ...
  t[44] !== i.title
    ...
    : (j = t[45]);
  let M;
  t[46] !== c || t[47] !== n || t[48] !== i.id || t[49] !== i.title
    ? ((M = () => n(i.id, i.title, c)),
      (t[46] = c),
      (t[47] = n),
      (t[48] = i.id),
  ...
  let F;
  return (
    t[57] !== A || t[58] !== j || t[59] !== N || t[60] !== h || t[61] !== g
      ? ((F = (0, $.jsxs)(`div`, {
          className: h,
          "data-appgen-row": !0,
          children: [g, A, j, N],
...
function Le(e) {
  let t = (0, Q.c)(17),
    { accessPolicy: r, disabled: i, projectId: a, projectTitle: o } = e,
    s = i === void 0 ? !1 : i,
    c = J(r),
    u = n(l),
    f;
  t[0] !== a || t[1] !== u
    ? ((f = () => T(u, Oe, { projectId: a })),
      (t[0] = a),
      (t[1] = u),
      (t[2] = f))
    : (f = t[2]);
  ...
  let v;
  return (
    t[11] !== s || t[12] !== f || t[13] !== p || t[14] !== g || t[15] !== _
      ? ((v = (0, $.jsxs)(`button`, {
...
//# sourceMappingURL=appgen-page-Dhq8P9WH.js.map
