...
function Wt(e) {
  let t = (0, Xt.c)(9),
    ...
    a;
  t[0] !== n || t[1] !== i
    ? ((a = Gt(i, n)), (t[0] = n), (t[1] = i), (t[2] = a))
    : (a = t[2]);
  let o;
  t[3] === i
    ? (o = t[4])
    : ((o = async () =>
        (await I.ambientSuggestions?.hasAccessibleAndEnabledApp({
          hostId: i,
        })) ?? !1),
      (t[3] = i),
      (t[4] = o));
...
function qt({ debugOverride: e, experimentEligible: t, personalized: n }) {
  return e ?? (t && n ? `generated` : `curated`);
}
function Jt({
...
function Yt({
  ...
  shouldUseCuratedNewChatPageSuggestions: i,
}) {
...
function Qt(e) {
  ...
  let m = u === void 0 ? !1 : u,
    ...
    g = en[h],
    _ = tn[h],
    v = a ? `checked` : `unchecked`,
    y;
  t[12] !== a || t[13] !== m || t[14] !== c
    ? ((y = () => {
        m || c(!a);
      }),
      (t[12] = a),
  ...
  t[16] !== b || t[17] !== l
    ...
    : (x = t[18]);
  let S = x,
    C = m ? `cursor-not-allowed opacity-60` : `cursor-interaction`,
    w;
  t[19] !== o || t[20] !== C
    ? ((w = i(
      ...
      (t[21] = w))
    : (w = t[21]);
  let T = a ? `bg-token-charts-blue` : `bg-token-foreground/10`,
    E;
  t[22] !== T || t[23] !== p || t[24] !== g
    ? ((E = i(
  ...
  let O;
  t[29] !== v || t[30] !== D
    ? ((O = (0, Y.jsx)(`span`, { className: D, "data-state": v })),
      (t[29] = v),
      (t[30] = D),
      (t[31] = O))
    : (O = t[31]);
  let k;
  t[32] !== v || t[33] !== O || t[34] !== E
    ? ((k = (0, Y.jsx)(`span`, { className: E, "data-state": v, children: O })),
      (t[32] = v),
      (t[33] = O),
      (t[34] = E),
      (t[35] = k))
...
function rn({ browserExtensionId: e }) {
  return v({
    queryKey:
      e == null
        ? [`chrome-extension-installed-read`, `missing`]
        : ee(`chrome-extension-installed-read`, { extensionId: e }),
    queryFn: async () =>
      e == null
        ? { installed: !1 }
        : k(`chrome-extension-installed-read`, { params: { extensionId: e } }),
...
function on(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = rn({ browserExtensionId: n })), (t[0] = n), (t[1] = i));
  let a;
  t[2] !== r || t[3] !== i
    ? ((a = {
        enabled: r,
      ...
      (t[4] = a))
    : (a = t[4]);
  let { data: o, isLoading: s } = h(a),
    c;
  t[5] === o ? (c = t[6]) : ((c = an(o)), (t[5] = o), (t[6] = c));
  let l = n != null && s,
    u;
  return (
    t[7] !== c || t[8] !== l
...
async function ln({ codexHome: e, hostId: t, plugin: n, queryClient: r }) {
  try {
    let i = pn(e, n);
    if (i == null) return [];
    ...
    return await r.fetchQuery({
      queryFn: async () => {
        let t = await k(`read-file`, { params: a });
        return [
          hn({
            codexHome: e,
            extensionId: Cn.parse(JSON.parse(t.contents)).extensionId,
            plugin: n,
          }),
        ];
      },
    ...
    return (
      N.warning(`Failed to read plugin browser extension setup`, {
        safe: {},
...
function un(e) {
  ...
  t[8] !== a || t[9] !== o || t[10] !== r || t[11] !== i
    ? ((u = async () => {
        ...
        let e = await k(`read-file`, { params: { hostId: r, path: o } }),
          t = Cn.parse(JSON.parse(e.contents));
        return [hn({ codexHome: a, extensionId: t.extensionId, plugin: i })];
      }),
      (t[8] = a),
      (t[9] = o),
      (t[10] = r),
...
async function dn({
  ...
  if (e !== `ON_INSTALL` || a !== `electron` || mn(r) == null) return [];
  let o = await ln({
    codexHome:
      t ?? (await k(`codex-home`, { params: { hostId: n } })).codexHome,
    hostId: n,
    plugin: await fn({ hostId: n, plugin: r }),
    queryClient: i,
  });
  return (
    await Promise.all(
...
async function fn({ hostId: e, plugin: t }) {
  try {
    return vt((await ce(`read-plugin`, { hostId: e, ..._t(t) })).plugin);
  } catch (e) {
    return (
      N.warning(`Failed to read installed plugin browser extension setup`, {
        safe: {},
...
function pn(e, t) {
  return e == null || t?.plugin.source.type !== `local` || mn(t) == null
    ? null
    : ue(
        S({
          codexHome: e,
...
function mn(e) {
  let t = Sn.safeParse(e.plugin.name);
  return !t.success || !e.plugin.id.startsWith(`${t.data}@`) ? null : t.data;
}
function hn({ codexHome: e, extensionId: t, plugin: n }) {
  return {
    iconUrl:
      gn(
...
var vn,
  ...
  wn = e(() => {
    ((vn = s()),
      ...
      cn(),
      mt(),
      (yn = `assets/google-chrome.png`),
      (bn = `scripts/extension-id.json`),
      (xn = `https://chromewebstore.google.com/detail/codex/`),
      (Sn = g([`chrome`, `chrome-dev`, `chrome-internal`])),
      (Cn = E({ extensionId: D().trim().min(1) })));
  });
function Tn(e) {
  return e === Pn;
}
function En(e) {
  return Tn(e?.availability);
}
function Dn(e) {
  let t = (0, Mn.c)(14),
    {
  ...
  t[0] !== n || t[1] !== c || t[2] !== l || t[3] !== u || t[4] !== d
    ? ((f = {
      ...
      (t[5] = f))
    : (f = t[5]);
  let { isLoading: p, plugin: m } = ye(f),
    h = r ?? m?.apps ?? [],
    g = i ?? m?.summary,
    v = g?.source.type === `remote`,
    y = Array.from(new Set(h.map(jn).filter(An))),
    b = y.length > 0,
    x;
  t[6] !== n || t[7] !== b
    ? ((x = { enabled: b, hostId: n }), (t[6] = n), (t[7] = b), (t[8] = x))
    : (x = t[8]);
  let { data: S, isLoading: C, loadError: w } = Rt(x),
    T = S === void 0 ? [] : S,
    E = _({ queries: y.map(kn) }),
    D;
  t[9] !== E || t[10] !== C || t[11] !== p || t[12] !== c
    ? ((D = (c && p) || C || E.some(On)),
      (t[9] = E),
      (t[10] = C),
      (t[11] = p),
  ...
  return (
    v && En(g)
      ...
      : !v &&
        y.length > 0 &&
        A === y.length &&
        (M = k ? `disabled-by-admin` : `connector-unavailable`),
    {
      blockedReasonsByConnectorId: j,
      isConnectorAvailabilityLoading: O,
      isLoading: !v && O,
      blockedReason: M,
    }
  );
...
var Mn,
  ...
  Fn = e(() => {
    ((Mn = s()),
      ...
      Lt(),
      Pe(),
      (Nn = `DISABLED_BY_ADMIN`),
      (Pn = `DISABLED_BY_ADMIN`));
  });
async function In({ hostId: e, queryClient: t, refreshAppsList: n }) {
  let r = t.getQueryData([`apps`, `list`, e]),
    i = await n();
  return Ln({ previousApps: r, nextApps: i })
    ? (await it(t, Kt(e)),
      await Promise.all(
        zn.map((t) =>
          k(`ambient-suggestions-refresh`, {
            params: {
              domain: t,
              hostId: e,
              projectRoot: M(`~`),
      ...
      await Promise.all([
        t.invalidateQueries({ queryKey: ee(`ambient-suggestions`) }),
        t.invalidateQueries({ queryKey: ee(`ambient-suggestions-refresh`) }),
      ]),
      i)
    : i;
}
function Ln({ previousApps: e, nextApps: t }) {
  return e != null && !e.some(Rn) && t.some(Rn);
}
function Rn(e) {
...
var zn,
  Bn = e(() => {
    (ne(), Zt(), ot(), j(), (zn = [null, `science`]));
  });
async function Vn(e) {
  return q(I.computerUseSettings.removeAppApproval(e));
}
async function Hn(e) {
  return q(I.computerUseSettings.setSoundMode(e));
}
async function Un(e) {
  return q(I.computerUseSettings.setLockedUseEnabled(e));
}
var Wn,
  Gn,
  Kn,
  qn = e(() => {
    (l(),
      ...
      (Wn = d(u, () => ({
        queryFn: ({ signal: e }) =>
          q(I.computerUseSettings.getAppApprovals(), e),
      ...
      (Gn = d(u, () => ({
        queryFn: ({ signal: e }) => q(I.computerUseSettings.getSoundMode(), e),
      ...
      (Kn = d(u, () => ({
        queryFn: ({ signal: e }) =>
          q(I.computerUseSettings.getLockedUseState(), e),
        queryKey: [`locked-computer-use`],
        refetchOnMount: `always`,
        refetchOnWindowFocus: !0,
        staleTime: b.FIVE_SECONDS,
      }))),
      T(u, `chrome-extension-installed-read`, (e) => ({
        enabled: e != null,
...
function Jn(e) {
  let t = (0, Yn.c)(19),
    ...
    a;
  t[0] === i ? (a = t[1]) : ((a = ve(i)), (t[0] = i), (t[1] = a));
  let o = a,
    s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, X.jsx)(Dt, { className: `icon-xs text-token-text-secondary` })),
      (t[2] = s))
    : (s = t[2]);
  let c;
...
var $n = e(() => {});
function er({ forceReloadPlugins: e, hostId: t, onRequiredAppConnected: i }) {
  let a = n(u),
    o = re(),
    s = tt(),
    c = p(),
    l = ft(t),
    d = a.query.snapshot(Kn),
    f = at(),
    [, m] = _e(`composer_prefill`),
    h = xt(),
    g = Ie(`2761268526`),
    { data: _ } = r(ct, t),
    {
    ...
    {
      cancelPluginInstallAppPreparation: S,
      claimPluginInstall: C,
      ...
      openPluginInstall: j,
      openPluginInstallAppConnectBeforeInstall: M,
      openRequiredAppConnect: ee,
      preparePluginInstallAppConnect: ne,
      session: P,
      setPluginInstallProgress: F,
      setPluginInstallNeedsApps: ie,
      startPluginInstallAfterAppPreparation: ae,
      startPluginInstallAfterAppConnect: oe,
    } = Pt(),
    { data: se = [], hardRefetchAppsList: le } = Rt({
      enabled:
        P.kind === `needsApps` ||
        P.kind === `connectApp` ||
    ...
    de =
      I == null ||
      (I.marketplacePath == null && I.plugin.remotePluginId == null)
        ? null
        : _t(I),
    { blockedReasonsByConnectorId: fe } = Dn({ hostId: t, pluginApps: ue }),
    {
      blockedReason: L,
      blockedReasonsByConnectorId: me,
      isLoading: he,
    } = Dn(
      I == null
        ? { hostId: t }
        : de == null
          ? { hostId: t, pluginSummary: I.plugin }
          : { hostId: t, ...de, pluginSummary: I.plugin },
    ),
    ge = Et({ hostId: t }),
    ye = wt({ hostId: t }),
    be = At({ hostId: t }),
    ...
    Ce = ye.available,
    we = be.available,
    [De, je] = (0, Q.useState)(!1),
    B = x({
      mutationFn: async (e) => {
        let n = await ce(`install-plugin`, { hostId: t, ..._t(e) });
        return (
          await Se({
            hostId: t,
    ...
    Pe = De || B.isPending,
    V = Pe || P.kind === `installing` || P.kind === `preparingApp`,
    H = tr({
      apps: se,
      appInstallBlockedReasonsById: fe,
      isAppConnectPending: y,
      session: P,
    }),
    Re =
      H.kind === `needsApps` &&
      H.requiredBrowserExtensions.length === 0 &&
      H.requiredApps.length > 0 &&
      H.requiredApps.every((e) => e.status === `connected`),
    ze = (0, Q.useEffectEvent)((e, t) => {
      if (t != null) {
        h({
    ...
    Be = (e, t) => {
      h({
        activeProject: t,
        prefillPrompt: Me({
          defaultPrompt: ke(e.plugin.interface?.defaultPrompt),
          pluginDisplayName: ve(e),
    ...
    Ve = async (n) => {
      ...
      let s =
        r.status === `rejected`
          ...
          : i.status === `rejected`
            ? i.reason
            : void 0;
      N.error(`Failed to refresh plugins after install`, {
        safe: {},
        sensitive: { error: s },
      });
      let l =
      ...
      return (a.get(R).danger(l), !1);
    },
    Ue = ({ activeProject: e, plugin: t, postInstallComposerPrefill: n }) => {
      n?.trim() ||
        a.get(R).custom({
          content: ({ close: n }) =>
            (0, Q.createElement)(Jn, {
              onClose: n,
              onTryInChat: () => {
                (n(), Be(t, e));
              },
          ...
          duration: rr,
          id: `plugin-added:${t.plugin.id}`,
          level: `success`,
        });
    },
    Ke = (0, Q.useEffectEvent)((t) => {
      D();
      let n = t.postInstallComposerPrefill?.trim();
      (n && ze(n, t.postInstallNewConversation),
        e()
          .then(() => {
            Ue({
              activeProject: t.activeProject,
          ...
          .catch((e) => {
            N.error(`Failed to refresh plugins after plugin app setup`, {
              safe: {},
              sensitive: { error: e },
            });
          }));
    ...
    qe = (e) => {
      (Z({
        action: G.CODEX_NEW_CHAT_SUGGESTION_ACTION_REQUIRED_APP_CONNECTED,
        appId: e.app.id,
        pluginId: e.plugin.plugin.id,
        scope: a,
        telemetry: e.telemetry,
      }),
        v({ appId: e.app.id, resumeTarget: $ }),
        oe({
          appId: e.app.id,
          hostId: e.hostId,
          pluginId: e.plugin.plugin.id,
  ...
  let et = (e) =>
    ...
    rt = async ({
      ...
      je(!0);
      try {
        if (En(r.plugin) || L === `disabled-by-admin`) {
          k(r, n);
          return;
        }
        let s;
        try {
          ((s = await B.mutateAsync(r)),
            pt({
              enabled: !0,
              installed: !0,
              queryClient: c,
            ...
            F(ir),
            Z({
              action: G.CODEX_NEW_CHAT_SUGGESTION_ACTION_PLUGIN_INSTALLED,
              pluginId: r.plugin.id,
              scope: a,
            ...
            n.origin === `setup_codex` &&
              Xe(
                a,
                We.CODEX_ONBOARDING_WIZARD_PHASE_PLUGIN_INSTALL,
                Ze.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED,
              ),
            Qe(a, Ge, {
              outcome: Je.CODEX_PLUGIN_INSTALL_OUTCOME_SUCCEEDED,
              pluginId: r.plugin.id,
            }),
            n.marketplaceAnalytics != null &&
              z(a, {
                action: U.CODEX_PLUGIN_ACTION_TYPE_INSTALL,
                plugin: r.plugin,
                result: K.CODEX_PLUGIN_ACTION_RESULT_SUCCESS,
                ...n.marketplaceAnalytics,
              }));
        } catch (e) {
          (Qe(a, Ge, {
            outcome: Je.CODEX_PLUGIN_INSTALL_OUTCOME_FAILED,
            pluginId: r.plugin.id,
          }),
            n.marketplaceAnalytics != null &&
              z(a, {
                ...
                errorType: w(e),
                plugin: r.plugin,
                result: K.CODEX_PLUGIN_ACTION_RESULT_FAILURE,
                ...n.marketplaceAnalytics,
              }));
          let t =
          ...
          (N.error(`manual_plugin_install_failed`, {
            safe: { ...te(t), errorCategory: w(e) },
            sensitive: { ...A(t), error: e },
          }),
            a.get(R).danger(
              o.formatMessage({
        ...
        if (
          (u != null &&
            (await Fe(a, u, !1),
            await ce(`batch-write-config-value`, {
              hostId: t,
              edits: He({ pluginId: r.plugin.id, enabled: !0 }),
          ...
          try {
            ...
            (N.error(`Failed to enable Locked Computer Use after install`, {
              safe: {},
              sensitive: { error: t },
            }),
              (e = !0));
        ...
        (r.plugin.authPolicy === `ON_INSTALL` &&
          In({ hostId: t, queryClient: c, refreshAppsList: le }).catch((e) => {
            N.error(`Failed to refresh apps after plugin install`, {
              safe: {},
              sensitive: { error: e },
            });
          }),
          Promise.all([f(Ne), f(jt), f(yt)]).catch((e) => {
            N.error(`Failed to refresh plugin skills and hooks after install`, {
              safe: {},
              sensitive: { error: e },
            });
          }),
        ...
        if (
          ...
          (i == null && s.authPolicy === `ON_USE`) ||
            (s.appsNeedingAuth.length === 0 && p.length === 0))
        ) {
          let e = n.postInstallComposerPrefill?.trim();
          (e && ze(e, n.postInstallNewConversation),
            D(),
            i?.(),
            Ue({
              activeProject: n.activeProject,
              plugin: r,
        ...
        n.marketplaceAnalytics != null &&
          z(a, {
            action: U.CODEX_PLUGIN_ACTION_TYPE_OPEN_CONNECTOR_SETUP,
            plugin: r.plugin,
            result: K.CODEX_PLUGIN_ACTION_RESULT_INITIATED,
            ...n.marketplaceAnalytics,
          });
        let m =
        ...
        (ie({
          ...
          n.marketplaceAnalytics != null &&
            (z(a, {
              ...
              surface: W.CODEX_PLUGIN_MARKETPLACE_SURFACE_CONNECTOR_SETUP,
            }),
            m != null &&
              me[m] == null &&
              z(a, {
                action: U.CODEX_PLUGIN_ACTION_TYPE_CONNECT_CONNECTOR,
                connectorId: m,
                plugin: r.plugin,
                result: K.CODEX_PLUGIN_ACTION_RESULT_INITIATED,
                source: n.marketplaceAnalytics.source,
    ...
    it = (0, Q.useEffectEvent)((e) => {
      C({ hostId: t, pluginId: e.plugin.plugin.id }) &&
        rt({
          options: {
            origin: e.origin,
  ...
  (0, Q.useEffect)(() => {
    P.kind !== `installing` || P.installStarted || he || it(P);
  }, [he, P]);
  let ot = async (e, n, r) => {
      try {
        let i = r ?? (await ce(`read-plugin`, { hostId: t, ..._t(e) })).plugin;
        if (i == null) throw Error(`Plugin detail was not found.`);
        let a = i.apps.length === 1 ? i.apps[0] : null;
        if (a == null) {
          ae({ hostId: t, pluginId: e.plugin.id });
          return;
        }
        let { link: o } = await pe.safeGet(
        ...
        M({ app: a, hostId: t, options: n, plugin: e });
      } catch (n) {
        (N.error(`Failed to load canonical plugin app before install`, {
          safe: {},
          sensitive: { error: n },
        }),
          a.get(R).danger(
          ...
          S({ hostId: t, pluginId: e.plugin.id }));
      }
    },
    st = (e, n = {}) => {
      if (V || !et(e)) {
        n.marketplaceAnalytics != null &&
          z(a, {
            action: U.CODEX_PLUGIN_ACTION_TYPE_INSTALL,
            errorType: V ? `install_in_progress` : `unsupported_environment`,
            plugin: e.plugin,
            result: K.CODEX_PLUGIN_ACTION_RESULT_BLOCKED,
            ...n.marketplaceAnalytics,
          });
        return;
      }
      if (
        ...
        e.plugin.authPolicy === `ON_INSTALL` &&
          (En(e.plugin) || L === `disabled-by-admin`))
      ) {
        (n.marketplaceAnalytics != null &&
          z(a, {
            action: U.CODEX_PLUGIN_ACTION_TYPE_INSTALL,
      ...
      if (
        (Z({
          action: G.CODEX_NEW_CHAT_SUGGESTION_ACTION_APP_CONNECT_MODAL_OPENED,
          pluginId: e.plugin.id,
          scope: a,
          telemetry: n.telemetry,
        }),
    ...
    dt = (e, t = {}) => {
      V || !et(e) || (B.reset(), k(e, t));
    },
    mt = () => {
      if (!V) {
        if ((B.reset(), P.kind === `connectAppBeforeInstall`)) {
          (P.status === `waitingForCallback` &&
            v({ appId: P.app.id, resumeTarget: $ }),
            T());
          return;
        }
      ...
      P.kind === `details` &&
        (await rt({
          ...
          options: {
            ...
            origin: P.origin,
            marketplaceAnalytics: P.marketplaceAnalytics,
    ...
    gt = async (e) => {
      if (H.kind !== `needsApps`) return;
      let t = H.requiredApps.find((t) => t.appId === e);
      if (
        t == null ||
        fe[e] != null ||
        t.status === `connected` ||
        ...
        return;
      (Z({
        action: G.CODEX_NEW_CHAT_SUGGESTION_ACTION_REQUIRED_APP_CONNECT_STARTED,
        appId: e,
        pluginId: H.plugin.plugin.id,
        scope: a,
        telemetry: P.kind === `needsApps` ? P.telemetry : void 0,
      }),
        J({ appId: e, result: K.CODEX_PLUGIN_ACTION_RESULT_INITIATED }));
    ...
    J = ({ appId: e, errorType: t, result: n }) => {
      (P.kind !== `connectAppBeforeInstall` &&
        P.kind !== `needsApps` &&
        P.kind !== `connectApp`) ||
        P.marketplaceAnalytics == null ||
        (P.kind === `connectAppBeforeInstall` && P.app.id !== e) ||
        z(a, {
          action: U.CODEX_PLUGIN_ACTION_TYPE_CONNECT_CONNECTOR,
          connectorId: e,
          errorType: t,
          ...
          result: n,
          ...P.marketplaceAnalytics,
          surface:
            P.kind === `connectAppBeforeInstall`
              ? P.marketplaceAnalytics.surface
              : W.CODEX_PLUGIN_MARKETPLACE_SURFACE_CONNECTOR_SETUP,
        });
    };
  return {
    closePluginInstall: mt,
    connectRequiredApp: gt,
    ...
    handleRequiredAppConnected: async (e) => {
      if (P.kind === `connectAppBeforeInstall` && P.app.id === e) {
        (J({ appId: e, result: K.CODEX_PLUGIN_ACTION_RESULT_SUCCESS }),
          P.status === `pending` &&
            Z({
              action:
                G.CODEX_NEW_CHAT_SUGGESTION_ACTION_REQUIRED_APP_CONNECT_STARTED,
              appId: e,
      ...
      ((P.kind === `needsApps` || P.kind === `connectApp`) &&
        ...
        P.kind === `connectApp` &&
          ...
          i?.());
      try {
        await In({ hostId: t, queryClient: c, refreshAppsList: le });
      } catch (e) {
        N.error(`Failed to refresh apps after plugin app connect`, {
          safe: {},
          sensitive: { error: e },
        });
      }
      ...
      (P.kind === `connectAppBeforeInstall` &&
        ...
        b({
          ...
          marketplaceAnalytics:
            (P.kind === `connectAppBeforeInstall` || P.kind === `connectApp`) &&
            P.marketplaceAnalytics != null
              ? {
                  pluginId: P.plugin.plugin.id,
                  remotePluginId: Ee(P.plugin.plugin),
                  ...P.marketplaceAnalytics,
                  surface:
                    P.kind === `connectApp`
                      ? W.CODEX_PLUGIN_MARKETPLACE_SURFACE_CONNECTOR_SETUP
    ...
    installPlugin: q,
    isInstalling: V,
    openPluginInstall: st,
    openPluginInstallDetails: dt,
    session: H,
  };
}
...
function sr({ directoryApps: e, pluginApps: t }) {
  let n = new Map(e.map((e) => [e.id, e]));
  return t
    .map((e) => {
      let t = n.get(e.id);
      if (t == null || t.name === t.id) return null;
      let r = e.category?.trim() || lr(t);
      if (!r) return t;
      let i = t.branding ?? {
        category: null,
        developer: null,
...
function cr({ directoryApps: e, appTemplates: t }) {
...
function ur(e, t, n) {
  return !fr(e, t) || n.type !== `local` ? null : n.path;
}
function dr({
  hasLoadedSharePrincipals: e,
  canSharePlugin: t,
  isInstalled: n,
  isShareDisabled: r,
  pluginShareUrl: i,
    ...
    (a =
      (t || r) && (i == null || e)
        ...
        : i == null
          ? null
          : `copy-link`),
    { standaloneActionKind: a, showShareMenuItem: n && t }
  );
}
function fr(e, t) {
  return e == null || t == null ? !1 : L(t) === L(ue(fe(e), _r));
}
function pr({ installedSkills: e, pluginName: t, pluginSkills: n }) {
  let r = mr(e),
    i = [],
    a = [];
  for (let e of n) {
...
function hr(e, t, n) {
  ...
  if (o != null) return o;
  let s = n.byComparableKey.get(gr(a));
...
var _r,
  vr = e(() => {
    (de(), (_r = `.agents/plugins/marketplace.json`));
  });
export {
  nn as A,
  En as C,
...
//# sourceMappingURL=app-initial~app-main~plugin-detail-page~new-thread-panel-page~onboarding-page~appgen-librar~zbesvgjb-GR_E01Nt.js.map
