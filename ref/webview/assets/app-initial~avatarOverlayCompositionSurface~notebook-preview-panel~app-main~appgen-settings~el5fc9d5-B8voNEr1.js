...
function pt() {
  let e = (0, gt.c)(3),
    [t] = ue(`remote_control_connections_state`),
    n = pe(),
    r;
  return (
    e[0] !== t || e[1] !== n
      ? ((r = mt({ remoteControlConnectionsState: t, slingshotEnabled: n })),
        (e[0] = t),
        (e[1] = n),
        (e[2] = r))
      : (r = e[2]),
...
function mt({ remoteControlConnectionsState: e, slingshotEnabled: t }) {
...
function ht({
  ...
  showTabbedSshPage: a,
  isWslConnectionsLoading: o,
  showWslConnections: s,
}) {
  return e === `wsl` && o
    ? `wsl`
    : r
    ...
    (u(),
      ...
      (vt = s(
        ...
        (e, { get: t }) =>
          t(L, `2296472986`) &&
          mt({
            remoteControlConnectionsState: O(
              t,
              `remote_control_connections_state`,
            ),
            slingshotEnabled: t(L, `1042620455`),
          }) &&
          t(H, { hostId: e }).data?.requirements?.computerUse
            ?.allowLockedComputerUse !== !1,
      )));
  }),
  bt,
  xt,
...
function At(e) {
  let t = (0, Mt.c)(64),
    {
      ...
      descriptionPlacement: c,
      badges: l,
      actions: u,
      actionsPlacement: d,
      onClick: f,
      iconContainer: p,
      iconContainerVariant: m,
      iconPlacement: h,
      isHighlighted: g,
      presentation: ee,
      className: _,
    } = e,
    v = c === void 0 ? `stacked` : c,
    y = d === void 0 ? `top` : d,
    b = p === void 0 ? !0 : p,
    x = m === void 0 ? `filled` : m,
    S = h === void 0 ? `outside` : h,
    C = g === void 0 ? !1 : g,
    w = ee === void 0 ? `card` : ee,
    T;
  t[0] === f
  ...
  let ie = re,
    ae;
  t[4] !== n || t[5] !== b || t[6] !== x || t[7] !== w
    ? ((ae = n
        ? b
          ? (0, J.jsx)(`span`, {
              className: i(
                `flex shrink-0 items-center justify-center rounded-lg`,
                w === `row` ? `size-9` : `size-10`,
                x === `outline`
          ...
          : (0, J.jsx)(`span`, { className: `shrink-0`, children: n })
        : null),
      (t[4] = n),
      (t[5] = b),
      (t[6] = x),
  ...
  let E = ae,
    ...
    oe = w === `row` && f && `hover:bg-token-list-hover-background`,
    se = C && `bg-token-foreground/5`,
    ce = f ? `cursor-interaction` : null,
    O;
  t[9] !== _ || t[10] !== D || t[11] !== oe || t[12] !== se || t[13] !== ce
    ? ((O = i(`flex flex-col gap-2.5`, D, oe, se, ce, _)),
      (t[9] = _),
      (t[10] = D),
      (t[11] = oe),
      (t[12] = se),
  ...
  t[15] === A
    ? (de = t[16])
    : ((de = i(`flex items-center gap-3`, A)), (t[15] = A), (t[16] = de));
  let j = S === `outside` ? E : null,
    M = ne ? `items-center gap-3` : null,
    N;
  t[17] === M
    ? (N = t[18])
    : ((N = i(`flex min-w-0 flex-1`, M)), (t[17] = M), (t[18] = N));
  let P = v === `stacked` ? `flex-col` : `items-center gap-3`,
    F;
  t[19] !== o || t[20] !== P
    ? ((F = i(`flex min-w-0 flex-1 justify-center gap-0.5`, P, o)),
      (t[19] = o),
      (t[20] = P),
      (t[21] = F))
    : (F = t[21]);
  let I = v === `inline` && `w-28 shrink-0 sm:w-48`,
    L = ne || S === `inline` ? null : `justify-between`,
    fe;
  t[22] !== I || t[23] !== L
    ? ((fe = i(`flex min-w-0 items-center gap-2`, I, L)),
      (t[22] = I),
      (t[23] = L),
      (t[24] = fe))
    : (fe = t[24]);
  let R = S === `inline` ? E : null,
    z =
      w === `row`
  ...
  t[25] === z
    ? (B = t[26])
    : ((B = i(`truncate text-token-foreground`, z)), (t[25] = z), (t[26] = B));
  let V;
  t[27] !== B || t[28] !== r
    ? ((V = (0, J.jsx)(`div`, { className: B, children: r })),
      (t[27] = B),
      (t[28] = r),
      (t[29] = V))
    : (V = t[29]);
  ...
  let pe = ne ? null : ie,
    me;
  t[35] !== fe || t[36] !== R || t[37] !== U || t[38] !== pe
    ? ((me = (0, J.jsxs)(`div`, { className: fe, children: [R, U, pe] })),
      (t[35] = fe),
      (t[36] = R),
      (t[37] = U),
      (t[38] = pe),
    ...
    : (me = t[39]);
  let he;
  t[40] !== a || t[41] !== s || t[42] !== v
    ? ((he = a
        ? (0, J.jsx)(`div`, {
            className: i(
              `text-token-text-secondary text-sm leading-relaxed`,
              v === `inline` ? `min-w-0 flex-1 truncate text-left` : null,
              s ?? `line-clamp-3`,
            ),
            children: a,
          })
    ...
    : (he = t[43]);
  let ge;
  t[44] !== F || t[45] !== me || t[46] !== he
    ? ((ge = (0, J.jsxs)(`div`, { className: F, children: [me, he] })),
      (t[44] = F),
      (t[45] = me),
      (t[46] = he),
      (t[47] = ge))
  ...
  let _e = ne ? ie : null,
    ve;
  t[48] !== N || t[49] !== ge || t[50] !== _e
    ? ((ve = (0, J.jsxs)(`div`, { className: N, children: [ge, _e] })),
      (t[48] = N),
      (t[49] = ge),
      (t[50] = _e),
      (t[51] = ve))
    : (ve = t[51]);
  let ye;
  t[52] !== de || t[53] !== j || t[54] !== ve
    ? ((ye = (0, J.jsxs)(`div`, { className: de, children: [j, ve] })),
      (t[52] = de),
      (t[53] = j),
      (t[54] = ve),
      (t[55] = ye))
...
function jt(e, t) {
  return typeof e == `string`
    ...
    : (0, J.jsx)(`span`, { className: `flex items-center`, children: e }, t);
}
var Mt,
  J,
  Nt = e(() => {
...
function Lt(e) {
  let t = (0, Ut.c)(48),
    {
      ...
      cardIconPlacement: s,
      cardDescriptionPlacement: c,
      badges: l,
      blockedStatusLabel: u,
      className: d,
      connectedAccountEmail: f,
      installBlockedReason: p,
      installedStateAction: m,
      installActionDisabled: h,
      installActionLabel: g,
      manageAction: ee,
      presentation: _,
      isConnectingApp: v,
      showInstallAction: x,
    ...
    O = m === void 0 ? `check` : m,
    le = h === void 0 ? !1 : h,
    k = ee === void 0 ? `button` : ee,
    ue = x === void 0 ? !0 : x,
    A = b(),
    de;
  t[0] !== g || t[1] !== A
    ? ((de = g ?? A.formatMessage(X.connectApp)),
      (t[0] = g),
      (t[1] = A),
      (t[2] = de))
    : (de = t[2]);
  let j = de,
    M = n.isEnabled,
    N = ce === `disabled-by-admin` && !n.isAccessible,
    P = C === n.id,
    F;
  t[3] !== se || t[4] !== A
    ? ((F = se == null ? null : A.formatMessage(X.connectedTo, { email: se })),
      (t[3] = se),
      (t[4] = A),
      (t[5] = F))
    : (F = t[5]);
                  ...
                  children: [
                    ...
                    (0, Y.jsx)(oe, {
                      ...
                      children: (0, Y.jsx)(`button`, {
                        ...
                        "aria-label": I,
                        onClick: Ht,
                        children: (0, Y.jsx)(qe, { className: `icon-2xs` }),
                      }),
                    }),
                  ],
                },
  ...
  t[9] === d
    ? (R = t[10])
    : ((R = i(`group justify-center border-none`, d)), (t[9] = d), (t[10] = R));
  let z;
  t[11] !== n || t[12] !== r
    ? ((z =
        r ??
  ...
  t[14] === n.description
    ? (B = t[15])
    : ((B = n.description ?? (0, Y.jsx)(y, { ...X.noDescription })),
      (t[14] = n.description),
      (t[15] = B));
  let V;
  t[16] !== n || t[17] !== te
                ...
                children: [
                  k === `menu`
                    ...
                    : (0, Y.jsx)(`div`, {
                        ...
                        children: (0, Y.jsx)(oe, {
                          tooltipContent: (0, Y.jsx)(y, {
                            ...X.manageOnChatGpt,
                          }),
                          children: (0, Y.jsx)(S, {
                            color: `ghost`,
                            size: `icon`,
                            "aria-label": A.formatMessage(X.manageOnChatGpt),
                            onClick: (e) => {
                              (e.stopPropagation(), ae?.(Pe(n)));
                            },
                            children: (0, Y.jsx)(Re, { className: `icon-sm` }),
                          }),
                        }),
                      }),
                  k === `menu`
                    ...
                    : (0, Y.jsx)(oe, {
                        tooltipContent: M
                          ? (0, Y.jsx)(y, { ...X.disableToggleTooltip })
                          : (0, Y.jsx)(y, { ...X.enableToggleTooltip }),
                        children: (0, Y.jsx)(`div`, {
                          ...
                          children: (0, Y.jsx)(K, {
                            ...
                            disabled: P,
                            onChange: (e) => {
                              E?.({ appId: n.id, enabled: e });
                            },
                            ariaLabel: A.formatMessage(X.enableToggleAria),
                          }),
                        }),
                      }),
                ],
              ...
              ? n.isAccessible
                ? (0, Y.jsx)(Et, {
                    ariaLabel: A.formatMessage(
                      M ? X.enabledStatus : X.disabledStatus,
                    ),
                    icon: M
                      ? (0, Y.jsx)(ie, { className: `icon-sm` })
                      : (0, Y.jsx)(Ft, { className: `icon-sm` }),
                  })
                : (0, Y.jsx)(oe, {
                    disabled: !N && !v,
                    tooltipContent: N
                    ...
                    children: (0, Y.jsx)(`div`, {
                      children: (0, Y.jsx)(S, {
                        ...
                        size: `toolbar`,
                        disabled: N || le,
                        "aria-label": v ? A.formatMessage(X.connectingApp) : j,
                        onClick: (e) => {
                          (e.stopPropagation(), !N && w(n));
                        },
                        children: v
                          ? (0, Y.jsx)(ne, { className: `icon-xxs` })
                          : j,
                      }),
                    }),
                  })
    ...
    (x(),
      (Gt = v({
        codexChromeDescription: {
          ...
          defaultMessage: `Install this extension in Chrome to connect ChatGPT to your browser`,
          description: `Description for the required Chrome browser extension in the plugin finish setup modal`,
        },
      })));
  });
function qt(e) {
  return Yt.get(e) ?? null;
}
function Jt(e, t) {
      ...
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsx)(en, {
            description: (0, Z.jsx)(y, {
              ...
              defaultMessage: `ChatGPT can read the thread, understand the ask, and draft a useful response`,
...
function rn(e) {
  let t = (0, Q.c)(151),
    {
      hostId: i,
      isInstalling: a,
      onConnectRequiredApp: o,
      onInstall: s,
      onOpenChange: c,
      onRequiredAppConnectFailed: l,
      onRequiredAppConnected: u,
      onRequiredAppConnectStarted: f,
      onRequiredAppOAuthStarted: p,
      onTryInChat: g,
      onViewDetails: _,
      session: v,
    } = e,
    b = a === void 0 ? !1 : a,
    x = n(d),
    [C, w] = (0, Gn.useState)(null),
    [T, te] = (0, Gn.useState)(null),
    { platform: ne } = Ce(),
    { authMethod: re, planAtLogin: ie } = ge(),
    { data: ae } = je(),
    E = re === `chatgpt`,
    D;
  t[0] === E
    ? (D = t[1])
    : ((D = { queryConfig: { enabled: E } }), (t[0] = E), (t[1] = D));
  let { data: se } = ee(`account-info`, D),
    ce = ae?.plan_type ?? se?.plan ?? ie,
    O;
  t[2] === ce
    ? (O = t[3])
    : ((O = nt(ce)?.pricePlan ?? null), (t[2] = ce), (t[3] = O));
  let le = O,
    k;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let ue = at(k),
    j = rt(),
    M = r(vt, i),
    N = v.kind === `closed` ? null : v.plugin,
    P;
  t[5] !== v.kind || t[6] !== v.requiredApps
    ? ((P = v.kind === `needsApps` ? v.requiredApps.map(un) : void 0),
      (t[5] = v.kind),
      (t[6] = v.requiredApps),
      (t[7] = P))
    : (P = t[7]);
  let F = P,
    I;
  t[8] !== i || t[9] !== F || t[10] !== v.kind || t[11] !== v.plugin
    ? ((I =
        v.kind === `details`
          ? { hostId: i, ...ye(v.plugin), pluginSummary: v.plugin.plugin }
          : { hostId: i, pluginApps: F }),
      (t[8] = i),
      (t[9] = F),
      (t[10] = v.kind),
      (t[11] = v.plugin),
    ...
    : (I = t[12]);
  let {
      blockedReasonsByConnectorId: L,
      blockedReason: fe,
      isConnectorAvailabilityLoading: R,
      isLoading: z,
    } = Ke(I),
    B = N != null && Ue(N.plugin),
    V = v.kind === `details` ? fe : null,
    H = v.kind === `details` && z,
    U = B ? `disabled-by-admin` : V,
    pe = U != null,
    me = U === `disabled-by-admin`,
    he = N?.marketplacePath ?? null,
    _e;
  t[13] === N
    ? (_e = t[14])
    : ((_e = N == null ? null : be(N)), (t[13] = N), (t[14] = _e));
  let xe = N?.remoteMarketplaceName ?? null,
    Se = N != null,
    we;
  t[15] !== i || t[16] !== xe || t[17] !== Se || t[18] !== he || t[19] !== _e
    ? ((we = {
        hostId: i,
        marketplacePath: he,
        pluginName: _e,
        remoteMarketplaceName: xe,
        enabled: Se,
      }),
      (t[15] = i),
      (t[16] = xe),
  ...
  let { plugin: Te } = de(we),
    ...
    Fe,
    Ie;
  t[21] !== L || t[22] !== De || t[23] !== v.kind || t[24] !== v.plugin
    ? ((Oe = De?.filter((e) => L[e.id] !== `disabled-by-admin`)),
      (W = v.kind === `details` && v.plugin.plugin.authPolicy === `ON_INSTALL`),
      (ke = Oe != null && Oe.length > 0),
      (Ie = m),
      (Me = `plugins`),
      (Ne = `install-modal`),
      (Pe = `disclosure`),
    ...
    : ((Oe = t[25]),
      ...
      (Ie = t[32]));
  let Le;
  t[33] !== Me || t[34] !== Ne || t[35] !== Pe || t[36] !== Fe
    ? ((Le = [Me, Ne, Pe, Fe]),
      (t[33] = Me),
      (t[34] = Ne),
      (t[35] = Pe),
  ...
  t[38] === Oe
    ? (ze = t[39])
    : ((ze = async () => {
        if (Oe == null) throw Error(`plugin detail apps are required`);
        let e = await Promise.all(Oe.map(cn));
        return {
          blurbs: Vn(e.flatMap(sn)),
          personalizationToggles: e.flatMap(on),
        };
      }),
      (t[38] = Oe),
      (t[39] = ze));
  let Be;
  t[40] !== Le || t[41] !== Re || t[42] !== ze
    ? ((Be = {
        queryKey: Le,
        enabled: Re,
      ...
      (t[43] = Be))
    : (Be = t[43]);
  let { data: Ve, isLoading: He } = Ie(Be),
    We;
  t[44] !== b || t[45] !== c
    ? ((We = (e) => {
        (!e && b) || (e || (w(null), te(null)), c(e));
      }),
      (t[44] = b),
      (t[45] = c),
      (t[46] = We))
  ...
  if (v.kind === `connectApp`) {
    let e;
    t[47] === v.app
      ? (e = t[48])
      : ((e = In(v.app)), (t[47] = v.app), (t[48] = e));
    let n = !v.closeOnOAuthStarted && v.app.status === `waitingForCallback`,
      r;
    t[49] !== l || t[50] !== v.app.appId
      ? ((r = (e) => {
          l?.(v.app.appId, e);
        }),
        (t[49] = l),
      ...
      : (r = t[51]);
    let i;
    t[52] !== f || t[53] !== v.app.appId || t[54] !== v.closeOnOAuthStarted
      ? ((i = v.closeOnOAuthStarted
          ? void 0
          : () => {
              f?.(v.app.appId);
            }),
        (t[52] = f),
        (t[53] = v.app.appId),
        (t[54] = v.closeOnOAuthStarted),
        (t[55] = i))
      : (i = t[55]);
    let a;
    t[56] !== u || t[57] !== v.app.appId
      ? ((a = async () => {
          await u(v.app.appId);
        }),
        (t[56] = u),
    ...
    return (
      ...
      t[66] !== a
        ? ((o = (0, $.jsx)(Ae, {
            app: e,
            closeOnOAuthStarted: v.closeOnOAuthStarted,
  ...
  if (v.kind === `installing`) return null;
  let G = v.kind === `needsApps` ? `needsApps` : `details`,
    K = v.plugin,
    qe,
    Je,
    Ye,
  ...
  if (
    t[68] !== M ||
    t[69] !== Ve?.personalizationToggles ||
    t[70] !== T ||
    t[71] !== C ||
    t[72] !== G ||
    t[73] !== ne ||
    ...
    qe = C?.pluginId === K.plugin.id ? C.modes : {};
    let e;
    (t[80] !== M || t[81] !== G || t[82] !== ne || t[83] !== K.plugin.id
      ? ((e = G === `details` && ne === `macOS` && M && ve(K.plugin.id)),
        (t[80] = M),
        (t[81] = G),
        (t[82] = ne),
        (t[83] = K.plugin.id),
      ...
      : (e = t[84]),
      (Ye = e),
      (Je = T?.pluginId === K.plugin.id ? T.enabled : !0),
      (Xe = Hn({
        draftModes: qe,
        personalizationToggles: W ? Ve?.personalizationToggles : void 0,
      })),
      (t[68] = M),
      (t[69] = Ve?.personalizationToggles),
      (t[70] = T),
      ...
      (t[78] = Ye),
      (t[79] = Xe));
  } else ((qe = t[76]), (Je = t[77]), (Ye = t[78]), (Xe = t[79]));
  let Qe = Xe,
    et = W && (R || (ke && He)),
    tt;
  t[85] !== U || t[86] !== K.plugin.name
    ? ((tt = Jt(K.plugin.name, U)),
      (t[85] = U),
      (t[86] = K.plugin.name),
      (t[87] = tt))
    : (tt = t[87]);
  let q = tt,
    it;
  t[88] !== K.plugin.name || t[89] !== q
    ? ((it = q ? qt(K.plugin.name) : null),
      (t[88] = K.plugin.name),
      (t[89] = q),
      (t[90] = it))
    : (it = t[90]);
  ...
  t[91] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ct = {
        ...
        style: { maxHeight: Xn, width: Yn },
      }),
      (t[91] = ct))
    : (ct = t[91]);
  let lt =
      G === `needsApps` ? `top-5 right-5 text-token-text-secondary` : void 0,
    ut =
      G === `needsApps`
  ...
  t[92] === G
    ? (dt = t[93])
    : ((dt =
        G === `needsApps` ? { maxHeight: Xn, padding: 0 } : { maxHeight: Xn }),
      (t[92] = G),
      (t[93] = dt));
  let ft;
  t[94] !== G || t[95] !== K || t[96] !== q
    ? ((ft =
        G === `details`
          ? (0, $.jsx)(dn, { plugin: K, showUpgradeBadge: q })
          : null),
      (t[94] = G),
      (t[95] = K),
      (t[96] = q),
  ...
  t[114] !== ot ||
  t[115] !== v.kind ||
  t[116] !== v.requiredApps ||
  t[117] !== v.requiredBrowserExtensions ||
  t[118] !== W ||
  t[119] !== Ye
    ? ((pt =
        G === `needsApps`
          ? (0, $.jsx)(pn, {
              ...
              onViewDetails: _,
              plugin: K,
              requiredApps: v.kind === `needsApps` ? v.requiredApps : [],
              requiredBrowserExtensions:
                v.kind === `needsApps` ? v.requiredBrowserExtensions : [],
            })
          : G === `details`
            ? (0, $.jsx)(Ee, {
                ...
                children:
                  ot == null
                    ? (0, $.jsx)(gn, {
                        appPersonalizationModes: Qe,
                        disclosureData: W ? Ve : void 0,
                        hostId: i,
                        installLockedComputerUse: Je,
                        isLoadingDisclosureData: et,
                        onAppPersonalizationModeChange: (e) => {
                          let { appId: t, mode: n } = e;
                          w({
                            modes: { ...qe, [t]: n },
                            pluginId: K.plugin.id,
                          });
                        },
                        onInstallLockedComputerUseChange: (e) => {
                          te({ enabled: e, pluginId: K.plugin.id });
                        },
                        plugin: K,
                        pluginDetail: Te,
                        shouldShowInstallDisclosure: W,
                        showLockedComputerUseInstall: Ye,
                      })
                    : (0, $.jsx)(Zt, { upsellId: ot }),
              })
            : null),
      (t[98] = L),
      (t[99] = qe),
          ...
          ? (0, $.jsx)(oe, {
              tooltipContent:
                U === `connector-unavailable` && !q
                  ...
                  : null,
              disabled: U !== `connector-unavailable` || q,
              children: (0, $.jsx)(`div`, {
...
async function cn(e) {
  return {
    app: e,
    connectorTos: await se.safeGet(`/aip/connectors/{connector_id}/tos`, {
      parameters: { path: { connector_id: e.id } },
      additionalHeaders: { [Kn]: qn },
    }),
  };
}
function ln(e) {
...
function dn(e) {
  ...
  t[2] === n
    ? (o = t[3])
    : ((o = (0, $.jsx)(fn, { plugin: n })), (t[2] = n), (t[3] = o));
  let s;
  t[4] === n ? (s = t[5]) : ((s = A(n)), (t[4] = n), (t[5] = s));
  let c;
  t[6] === s
    ? (c = t[7])
    : ((c = (0, $.jsx)(Xe, {
  ...
  t[10] === r
    ? (u = t[11])
    : ((u = r ? (0, $.jsx)(Qt, {}) : null), (t[10] = r), (t[11] = u));
  let d;
...
function fn(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(xe, { className: `size-12` }),
      })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (i = t[1]);
  let a;
  t[2] === n ? (a = t[3]) : ((a = A(n)), (t[2] = n), (t[3] = a));
  let o;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(Ne, { className: `icon-md text-token-text-secondary` })),
      (t[4] = o))
    : (o = t[4]);
  let s;
  return (
...
function pn(e) {
  ...
  t[0] === l
    ? (f = t[1])
    : ((f = (0, $.jsx)(mn, { plugin: l })), (t[0] = l), (t[1] = f));
  let p;
  ...
  t[8] === d
    ? (m = t[9])
    : ((m = (0, $.jsx)(kn, { requiredBrowserExtensions: d })),
      (t[8] = d),
      (t[9] = m));
  let h;
  t[10] !== p || t[11] !== m
...
function mn(e) {
  ...
  t[5] !== n.logoDarkPath || t[6] !== n.logoPath || t[7] !== a
    ...
    : (s = t[8]);
  let c;
  t[9] === n ? (c = t[10]) : ((c = A(n)), (t[9] = n), (t[10] = c));
  let l;
  t[11] === c
    ? (l = t[12])
    : ((l = (0, $.jsx)(Xe, {
    ...
    ? ((u =
        r == null
          ...
          : (0, $.jsxs)(S, {
              ...
              children: [
                (0, $.jsx)(Ve, { className: `icon-sm` }),
                (0, $.jsx)(y, {
                  id: `plugins.installModal.needsApps.tryInChat`,
                  defaultMessage: `Try {pluginName} now`,
                  description: `Button label to close the plugin onboarding modal and try the plugin in task`,
                  values: { pluginName: A(a) },
                }),
              ],
            })),
      (t[6] = c),
...
function gn(e) {
  let t = (0, Q.c)(37),
    ...
    p;
  t[0] === l ? (p = t[1]) : ((p = Un(l)), (t[0] = l), (t[1] = p));
  let m = p,
    h;
  ...
  let g = h,
    ee =
      r != null && (r.blurbs.length > 0 || r.personalizationToggles.length > 0),
    _ = !d || !ee,
    v;
  t[4] !== l || t[5] !== _
    ? ((v = _ ? (0, $.jsx)(Ln, { plugin: l }) : null),
      (t[4] = l),
      (t[5] = _),
      (t[6] = v))
    : (v = t[6]);
  ...
  t[7] !== m || t[8] !== _
    ...
    : (b = t[9]);
  let x;
  t[10] !== i || t[11] !== l || t[12] !== u || t[13] !== _
    ? ((x =
        _ && u != null
          ? (0, $.jsx)(vn, { hostId: i, plugin: l, pluginDetail: u })
          : null),
      (t[10] = i),
      (t[11] = l),
      (t[12] = u),
    ...
    : (x = t[14]);
  let S;
  t[15] !== a || t[16] !== c || t[17] !== u || t[18] !== _ || t[19] !== f
    ? ((S =
        _ && u != null && f
          ? (0, $.jsx)(wn, { enabled: a, onChange: c })
          : null),
      (t[15] = a),
      (t[16] = c),
      (t[17] = u),
    ...
    t[4] !== n || t[5] !== r || t[6] !== s
      ? ((c = (0, $.jsx)(zn, {
          children: (0, $.jsxs)(`div`, {
            ...
            children: [
              o,
              (0, $.jsx)(K, { checked: n, ariaLabel: s, onChange: r }),
            ],
          }),
        })),
        (t[4] = n),
...
function En(e) {
  ...
  if (i) {
    ...
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(zn, { children: (0, $.jsx)(Mn, {}) })), (t[0] = e))
        : (e = t[0]),
      e
    );
  }
...
function Dn(e) {
  let t = (0, Q.c)(23),
    ...
    s = b(),
    c;
  t[0] === r ? (c = t[1]) : ((c = new Map(r?.map(On))), (t[0] = r), (t[1] = c));
  let l = c,
    u,
    d,
    f;
  if (
    ...
    bb0: {
      ...
      t[11] === n
        ? (e = t[12])
        : ((e = (e) => n[e.appId] !== `disabled-by-admin`),
          (t[11] = n),
          (t[12] = e));
      let r = o.filter(e),
        c;
      if (
        (t[13] === l
          ? (c = t[14])
          : ((c = (e, t) =>
              (l.get(e.appId) ?? 2 ** 53 - 1) -
              (l.get(t.appId) ?? 2 ** 53 - 1)),
            (t[13] = l),
            (t[14] = c)),
        r.sort(c),
        r.length === 0)
        ...
        ? ((p = (e) => {
            ...
            return (0, $.jsx)(
              Lt,
              {
                ...
                installActionLabel: Fn(e.status, s),
                isConnectingApp:
                  e.status === `launching` || e.status === `waitingForCallback`,
                updatingAppId: null,
...
function kn(e) {
  ...
  let r;
  t[0] === n ? (r = t[1]) : ((r = n.map(An)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
            ...
            (0, $.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, $.jsx)(`div`, {
                  ...
                  children: (0, $.jsx)(y, { ...Gt.codexChromeDescription }),
                }),
              ],
            }),
          ],
...
function jn(e) {
  ...
  t[4] === a
    ? (o = t[5])
    : ((o = (e) => {
        B({ event: e, href: a, initiator: `open_in_browser_bridge` });
      }),
      (t[4] = a),
      (t[5] = o));
  let s;
...
function Mn() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(`div`, {
          children: Array.from({ length: 3 }).map(Nn),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
              ...
              children: [
                (0, $.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, $.jsx)(`div`, { children: Bn(e.blurb.description) }),
                  ],
                }),
                (0, $.jsx)(K, {
          ...
          (0, $.jsxs)(
            `div`,
            {
              ...
              children: [
                ...
                (0, $.jsx)(`div`, { children: Bn(e.description) }),
              ],
            },
            `${e.title}-${t}`,
          )),
...
function Ln(e) {
  ...
  t[9] === n
    ? (s = t[10])
    : ((s = (0, $.jsx)(Rn, { plugin: n })), (t[9] = n), (t[10] = s));
  let c;
  return (
    t[11] !== o || t[12] !== s
      ? ((c = (0, $.jsxs)(zn, { children: [o, s] })),
        (t[11] = o),
        (t[12] = s),
        (t[13] = c))
      : (c = t[13]),
...
function Bn(e) {
  ...
  for (; (r = Jn.exec(e)) != null;) {
    ...
    (t.push((0, $.jsx)(jn, { url: s, children: a }, `${s}-${r.index}`)),
      (n = r.index + i.length));
  }
  return (
...
function Hn({ draftModes: e, personalizationToggles: t }) {
  let n = { ...e };
  if (t == null) return n;
...
function Wn(e) {
  return (
    e.interface?.displayName?.trim() || R(e.name.split(`:`).pop() || e.name)
  );
}
var Q,
  Gn,
...
//# sourceMappingURL=app-initial~avatarOverlayCompositionSurface~notebook-preview-panel~app-main~appgen-settings~el5fc9d5-B8voNEr1.js.map
