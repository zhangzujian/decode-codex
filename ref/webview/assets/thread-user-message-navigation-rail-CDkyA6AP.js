...
import { b as d } from "./app-initial~avatarOverlayCompositionSurface~index-9fQ9wihu~index-BFCcxPM5~mapbox-gl-DVWlwqb~elr7dp2m-DG_7tMKE.js";
import {
  d as f,
  g as ee,
  o as te,
...
import {
  n as L,
  t as R,
} from "./app-initial~app-main~onboarding-page~hotkey-window-thread-page~quick-chat-window-page~chatg~f5p8e1kp-B5dFi3Nu.js";
import {
  Un as Ce,
  Wn as we,
  i as z,
...
import {
  n as q,
  r as De,
} from "./thread-scroll-controller-context-value-DlqasaXA.js";
var J,
  Y,
  Oe = e(() => {
    (i(),
...
function Be(e) {
  switch (e.type) {
    ...
    case `google-drive`:
      return (0, Z.jsx)(A, { className: `icon-sm shrink-0` });
    case `image`:
...
//# sourceMappingURL=thread-user-message-navigation-rail-CDkyA6AP.js.map
