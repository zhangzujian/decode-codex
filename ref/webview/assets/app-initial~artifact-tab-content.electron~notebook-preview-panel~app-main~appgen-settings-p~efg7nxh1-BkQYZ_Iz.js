...
function r(e, r, i) {
  if (i.validHosts !== null) {
    let e = i.validHosts;
    for (let n of e) if (t(r, n)) return n;
  }
  let a = 0;
  if (r.startsWith(`.`)) for (; a < r.length && r[a] === `.`;) a += 1;
  return e.length === r.length - a ? null : n(r, e);
}
var i = e(() => {});
function a(e, t) {
...
function m(e) {
  if (
    e.length > 255 ||
    e.length === 0 ||
    (!p(e.charCodeAt(0)) && e.charCodeAt(0) !== 46 && e.charCodeAt(0) !== 95)
  )
    return !1;
  let t = -1,
    n = -1,
  ...
  for (let i = 0; i < r; i += 1) {
    ...
    if (r === 46) {
      ...
      t = i;
    } else if (!(p(r) || r === 45 || r === 95)) return !1;
    n = r;
  }
  ...
  return typeof e != `string` ||
    (c.extractHostname
      ? c.mixedInputs
        ...
        : (o.hostname = s(e, !1))
      : (o.hostname = e),
    c.detectIp && o.hostname !== null && ((o.isIp = d(o.hostname)), o.isIp))
    ? o
    : c.validateHostname &&
        c.extractHostname &&
        o.hostname !== null &&
      ...
      : (t === 0 ||
          o.hostname === null ||
          (n(o.hostname, c, o), t === 2 || o.publicSuffix === null) ||
          ((o.domain = r(o.publicSuffix, o.hostname, c)),
          t === 3 || o.domain === null) ||
          ((o.subdomain = b(o.hostname, o.domain)), t === 4) ||
          (o.domainWithoutSuffix = a(o.domain, o.publicSuffix)),
        o);
}
var T = e(() => {
  (i(), o(), c(), f(), h(), y(), x());
    ...
    ((k = (function () {
      ...
      (A = (function () {
        let e = [1, {}],
          ...
          C = [0, { lb: t, s3: t, website: t }],
          w = [2, { nodes: t }],
          T = [0, { my: t }],
          E = [0, { s3: t, "s3-accesspoint": t, "s3-website": t }],
          D = [0, { s3: t, "s3-accesspoint": t }],
          O = [0, { direct: t }],
          k = [0, { "webview-assets": t }],
          A = [0, { vfs: t, "webview-assets": t }],
          j = [
            0,
            {
              "execute-api": t,
          ...
          re = [0, { dyn: t }],
          ie = [2, { web: t }],
          ae = [1, { co: e, com: e, edu: e, gov: e, net: e, org: e }],
          oe = [0, { p: t }],
          se = [0, { user: t }],
          ce = [1, { ms: t }],
          K = [0, { cdn: t }],
          le = [2, { raw: i }],
          q = [0, { cust: t, reservd: t }],
          ue = [0, { cust: t }],
          J = [0, { s3: t }],
          de = [1, { biz: e, com: e, edu: e, gov: e, info: e, net: e, org: e }],
          Y = [0, { ipfs: t }],
          X = [1, { framer: t }],
          fe = [0, { forgot: t }],
          pe = [0, { core: [0, { blob: t, file: t, web: t }], servicebus: t }],
          Z = [1, { gs: e }],
          me = [0, { nes: e }],
          ...
          0,
          {
            ...
            eu: [
              1,
              {
                amazonwebservices: [
                  0,
                  { on: [0, { "eusc-de-east-1": [0, { "cognito-idp": z }] }] },
                ],
                cloudns: t,
                prvw: t,
                deuxfleurs: t,
            ...
            io: [
              1,
              {
                ...
                edugit: t,
                telebit: t,
                thingdust: [0, { dev: q, disrec: q, prod: ue, testing: q }],
                tickets: t,
                webflow: t,
                webflowtest: t,
                "drive-platform": t,
            ...
            jp: [
              1,
              {
                ...
                rgr: t,
                rulez: t,
                sakurastorage: [0, { isk01: J, isk02: J }],
                saloon: t,
                sblo: t,
                skr: t,
                tank: t,
            ...
            name: [1, { her: fe, his: fe, ispmanager: t, keenetic: t }],
            nc: [1, { asso: e, nom: e }],
            ne: e,
            net: [
              1,
            ...
            cloud: [
              1,
              {
                ...
                k2: [
                  0,
                  { elastic: t, "ru-msk": C, "ru-spb": C, s3: t, website: t },
                ],
                kuleuven: t,
                laravel: t,
                linkyard: t,
            ...
            email: [
              1,
              { crisp: [0, { on: t }], intouch: t, tawk: oe, tawkto: oe },
            ],
            emerck: e,
            energy: e,
            engineer: e,
...
function I(e, t = {}) {
  return (C(L), w(e, 2, N, t, L).publicSuffix);
}
var L,
  R = e(() => {
    (O(), P(), (L = S()));
  });
export { R as n, F as r, I as t };
//# sourceMappingURL=app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~appgen-settings-p~efg7nxh1-BkQYZ_Iz.js.map
