...
var u = n.a(`build-flavor`),
  d = [t.uc.Nightly, t.uc.InternalAlpha, t.uc.PublicBeta, t.uc.Prod],
  f = {
    [t.uc.Nightly]: { kind: `msix` },
    [t.uc.InternalAlpha]: { kind: `msix` },
    [t.uc.PublicBeta]: {
      kind: `store`,
...
//# sourceMappingURL=file-based-logger-Cp6DKjAv.js.map
