const e = require("./src-DU0S2Fqi.js"),
  t = require("./crash-reporter-env-CdLO-lmi.js"),
  n = require("./file-based-logger-Cp6DKjAv.js");
...
var u = { marketplaceKinds: [`local`] },
  ...
  y = 1024 * 1024,
  b = 100,
  x = e.Ll({ path: e.Bl().trim().min(1) }),
  S = e.Ll({ entries: e.kl(e.Ul()) }),
  C = e.Ll({
    nativeHostNames: e.kl(e.Bl().trim().min(1)),
    paths: e.Ll({
      browserClientPath: e.Bl().trim().min(1).optional(),
      extensionHostPath: e.Bl().trim().min(1),
    }),
  });
async function w(t) {
  let n = e.pi(),
    r = P(t),
    i = r == null ? null : e.bn(r),
...
function P(t) {
  return g(t) ? p : _(t) ? e.Bs : v(t) ? f : null;
}
...
//# sourceMappingURL=feedback-desktop-log-archive-mt7iwBkJ.js.map
