...
var $r = o(() => {
  ...
  ei = o(() => {
    (rt(), hr(), ar(), br(), Or(), jr(), Lr(), Br(), Wr(), Yr(), $r());
  });
function ti(e, t, n) {
  if ((n === void 0 && (n = Error), !e)) throw new n(t);
}
    ...
    (0, W.useEffect)(() => {
      let n = () => {
        ...
        r = (t, r) => {
          ...
          (Zc(r, { preventDefault: !1 }), ne.current ?? _s(t.document, Qi));
          let i = Aa(t, { x: r.clientX, y: r.clientY });
          if (((ne.current = i), fe.current)) {
            a(null);
            return;
          }
          let o = Cs(ne.current, e);
          if (!o) {
            n();
            return;
          }
