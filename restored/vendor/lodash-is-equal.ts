...
// Readable compatibility layer for the lodash deep-equality helpers bundled by Codex.
...
type SeenPairs = WeakMap<object, WeakMap<object, boolean>>;
type EqualityCustomizer = (
  leftValue: unknown,
  rightValue: unknown,
...
function rememberPair(stack: SeenPairs, leftObject: object, rightObject: object) {
...
function createIsEqualFunction(): IsEqualFunction {
  let isEqual = ((leftValue: unknown, rightValue: unknown) =>
    isEqualN(leftValue, rightValue)) as IsEqualFunction;
  Object.defineProperty(isEqual, "default", { value: isEqual, enumerable: true });
  return isEqual;
}
