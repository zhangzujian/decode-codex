...
import {
  worktreeNewThreadOrchestratorCompatSlotUpperOLowerT as _appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKg2pu5rsOt,
  worktreeNewThreadOrchestratorCompatSlotLowerALowerA,
  worktreeNewThreadOrchestratorCompatSlotLowerBLowerT,
  worktreeNewThreadOrchestratorCompatSlotLowerELowerM,
  worktreeNewThreadOrchestratorCompatSlotUpperFLowerR,
  worktreeNewThreadOrchestratorCompatSlotLowerFLowerS,
  worktreeNewThreadOrchestratorCompatSlotUpperILowerR,
  worktreeNewThreadOrchestratorCompatSlotUpperK,
  worktreeNewThreadOrchestratorCompatSlotLowerKLowerT,
  ...
  worktreeNewThreadOrchestratorCompatSlotUpperPLowerT,
  ...
  worktreeNewThreadOrchestratorCompatSlotLowerXLowerT,
...
import {
  ...
  worktreeNewThreadQueryCompatSlotLowerDLowerO,
  worktreeNewThreadQueryCompatSlotLowerDLowerS,
  worktreeNewThreadQueryCompatSlotLowerELowerL,
  ...
  worktreeNewThreadQueryCompatSlotUpperJLowerC,
  worktreeNewThreadQueryCompatSlotLowerLLowerO,
  ...
  worktreeNewThreadQueryCompatSlotUpperRLowerA,
  ...
  worktreeNewThreadQueryCompatSlotLowerULowerO,
  worktreeNewThreadQueryCompatSlotLowerULowerS,
  worktreeNewThreadQueryCompatSlotUpperVLowerA,
  worktreeNewThreadQueryCompatSlotUpperXLowerC,
  ...
  worktreeNewThreadQueryCompatSlotLowerZLowerA,
...
import {
  ...
  appgenLibraryHotDjo67r4nCompatSlotUpperMLowerN,
  appgenLibraryHotDjo67r4nCompatSlotLowerMLowerT,
  appgenLibraryHotDjo67r4nCompatSlotUpperNLowerN,
  appgenLibraryHotDjo67r4nCompatSlotLowerO,
  appgenLibraryHotDjo67r4nCompatSlotUpperU,
  appgenLibraryHotDjo67r4nCompatSlotUpperW,
  appgenLibraryHotDjo67r4nCompatSlotLowerZ,
...
import {
  ...
  projectsIndexCurrentCompatSlotLowerNLowerN,
  projectsIndexCurrentCompatSlotLowerRLowerN,
  projectsIndexCurrentCompatSlotLowerTLowerN,
...
import {
  defaultSettingsSection as _appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageKeyboardShortcutsN7jwlpf0C,
...
import {
  ...
  initAppshotAvailabilityChunk,
} from "../features/appshot";
import {
  initUsageGaugeIconChunk,
  UsageGaugeIcon,
...
import { initFilterIconChunk, FilterIcon } from "../icons/filter-icon";
import { initDockIconChunk, DockIcon } from "../icons/dock-icon";
import {
  isExperimentalFeatureVisible,
  initExperimentalFeatureVisibilityChunk,
...
function settingsPageHelper1({ intl, query, targets, visibleSectionSlugs }) {
  ...
  for (let [
    settingsPageValue203,
    settingsPageValue204,
  ] of visibleSectionSlugs.entries())
    settingsPageValue179.has(settingsPageValue204) ||
      settingsPageValue179.set(settingsPageValue204, settingsPageValue203);
  return targets
    .flatMap((item) => {
...
function settingsPageHelper2(
  ...
  for (let settingsPageValue196 of messageTexts) {
    ...
    settingsPageValue197 > 0 &&
      (settingsPageValue182 == null ||
        settingsPageValue197 > settingsPageValue182.score) &&
      (settingsPageValue182 = {
        score: settingsPageValue197,
        text: settingsPageValue196,
      });
  }
  return {
    label:
      settingsPageValue182 == null || /[<{]/u.test(settingsPageValue182.text)
        ? panelLabel
        : settingsPageValue182.text,
    matchPriority: 1,
    panelLabel,
    score: settingsPageValue181,
    sectionSlug,
  };
}
function settingsPageHelper3(settingsPageParam26, settingsPageParam27) {
  ...
  return settingsPageValue195.length === 0 ||
    settingsPageValue195.some((item) => item === 0)
    ? 0
    : settingsPageValue195.reduce(
...
var settingsPageValue9,
  settingsPageValue10 = once(() => {
    pullRequestNewThreadCompatSlotLowerL();
    appgenLibraryHotDjo67r4nCompatSlotUpperW();
...
function settingsPageHelper5(settingsPageParam1) {
  let {
    ...
    settingsPageValue37 =
      currentAppInitialSharedMember0781(settingsPageValue19),
    [settingsPageValue38, settingsPageValue39] =
      settingsPageValue12.useState(false),
    [settingsPageValue40, settingsPageValue41] =
      settingsPageValue12.useState(""),
    settingsPageValue42 = canCollapse && settingsPageValue38,
    settingsPageValue43 =
      settingsPageValue37 && groupSettingsSections && !settingsPageValue42,
    settingsPageValue44 =
      settingsPageValue43 && settingsPageValue40.trim().length > 0;
  ...
  let settingsPageValue53 = () => {
    settingsPageValue41("");
  };
  let settingsPageValue54 = {
    items: settingsPageValue50,
    isActive: settingsPageValue51,
    autoHighlightFirst: false,
    onSelect: settingsPageValue52,
    onEscape: settingsPageValue53,
  };
  let settingsPageValue55 =
      worktreeNewThreadOrchestratorCompatSlotLowerPLowerS(settingsPageValue54),
    settingsPageValue56 = settingsPageValue13.jsx(
      currentAppInitialSharedMember0924,
      {
        id: "settings.nav.notImplemented",
        defaultMessage: "[alpha] Not available in Alpha",
        description:
          "Tooltip shown for settings sections that are not available in the alpha build",
      },
    );
  let settingsPageValue57 = settingsPageValue56,
    settingsPageValue58 = settingsPageValue13.jsx(
      currentAppInitialSharedMember0924,
      {
        id: "settings.nav.externalTooltip",
        defaultMessage: "[alpha] Opens in browser",
        description:
          "Tooltip for settings items that open externally during alpha",
      },
    );
  let settingsPageValue59 = settingsPageValue58,
    settingsPageValue60 = settingsPageValue42
      ? settingsPageValue21.collapsed
      : settingsPageValue21.expanded,
    settingsPageValue61 = settingsPageValue36.formatMessage(
      settingsPageValue60.message,
    );
  let settingsPageValue62 = settingsPageValue61,
    settingsPageValue63 = settingsPageValue60.icon,
    settingsPageValue64,
    settingsPageValue65,
    settingsPageValue66,
    settingsPageValue67,
    ...
    settingsPageValue72;
  {
    ...
    settingsPageValue72 = settingsPageValue36.formatMessage({
      id: "settings.nav.ariaLabel",
      defaultMessage: "Settings",
      description: "Aria label for settings navigation",
    });
    settingsPageValue66 = "flex min-h-0 flex-1 flex-col";
    settingsPageValue67 = canCollapse ? (
      <div className="mb-2 shrink-0">
        {settingsPageValue13.jsx(worktreeNewThreadQueryCompatSlotLowerYLowerP, {
          tooltipContent: settingsPageValue13.jsx(
            currentAppInitialSharedMember0924,
            {
              ...settingsPageValue60.message,
            },
          ),
          children: settingsPageValue13.jsx(
            projectsIndexCurrentCompatSlotLowerTLowerN,
            {
              "aria-label": settingsPageValue62,
              fullWidth: false,
              icon: settingsPageValue63,
              iconClassName: "icon-xs",
              hideLabel: true,
              label: settingsPageValue13.jsx(
                currentAppInitialSharedMember0924,
                {
                  ...settingsPageValue60.message,
                },
    ...
    settingsPageValue68 = onBack ? (
      ...
      >
        {settingsPageValue13.jsx(worktreeNewThreadQueryCompatSlotLowerYLowerS, {
          className: "icon-xs",
        })}
        {settingsPageValue42 ? (
          <span className="sr-only">
            {settingsPageValue13.jsx(currentAppInitialSharedMember0924, {
    ...
    settingsPageValue69 =
      sidebarHostSelector != null && !settingsPageValue42 ? (
    ...
    settingsPageValue70 = settingsPageValue43
      ...
      : null;
    let settingsPageValue121 = settingsPageValue42
      ? "flex flex-col gap-2"
      : "flex flex-col gap-4";
    settingsPageValue64 = worktreeNewThreadQueryCompatSlotLowerMLowerH(
    ...
    settingsPageValue65 = settingsPageValue45
      ? settingsPageValue13.jsx(settingsPageHelper13, {
          ...
          onSelect,
          searchResults: settingsPageValue46,
        })
      : settingsPageValue119.map((item) =>
          settingsPageValue13.jsx(
            projectsIndexCurrentCompatSlotLowerNLowerN,
            {
              className: "gap-0",
              title:
                settingsPageValue42 || item.heading == null
                  ? null
                  : settingsPageValue13.jsx(currentAppInitialSharedMember0924, {
                      ...item.heading,
                    }),
              children: item.sections.map((_item) => {
                let settingsPageValue151 = _item.slug === activeSection,
                  settingsPageValue152 = !!_item.externalUrl,
                  settingsPageValue153 = !!_item.disabled,
                  settingsPageValue154 =
                    settingsPageValue151 && _item.slug === "pets"
                      ? settingsPageValue4
                      : settingsPageValue14[_item.slug],
                ...
                return settingsPageValue13.jsx(
                  worktreeNewThreadQueryCompatSlotLowerYLowerP,
                  {
                    tooltipContent: settingsPageValue42
                      ? settingsPageValue13.jsx(
                          appgenLibraryHotDjo67r4nCompatSlotLowerZ,
                          {
                            slug: _item.slug,
                    ...
                    disabled:
                      !settingsPageValue42 &&
                      !settingsPageValue153 &&
                      !settingsPageValue152,
                    children: settingsPageValue13.jsx(
                      projectsIndexCurrentCompatSlotLowerTLowerN,
                      {
                        "aria-label": settingsPageValue155,
                        icon: settingsPageValue154,
                        iconClassName: "icon-sm inline-block align-middle",
                        isActive: settingsPageValue151,
                        disabled: settingsPageValue153,
                        "data-settings-panel-slug":
                          ...
                          !settingsPageValue152
                            ? _item.slug
                            : undefined,
                        hideLabel: canCollapse
                          ? settingsPageValue42
                          : undefined,
                        onClick: settingsPageValue156,
                        onKeyDown:
                          groupSettingsSections &&
                          !settingsPageValue153 &&
                          !settingsPageValue152
                            ? (event) => {
                                ...
                                let settingsPageValue177 =
                                  settingsPageValue120[
                                    settingsPageValue120.findIndex(
                                      (__item) => __item.slug === _item.slug,
                                    ) + (event.key === "ArrowDown" ? 1 : -1)
                                  ];
                                settingsPageValue177 != null &&
                                  (event.currentTarget
                                    .closest("nav")
                                    ?.querySelector(
                                      `[data-settings-panel-slug="${settingsPageValue177.slug}"]`,
                                    )
                                    ?.focus(),
                                  onSelect(settingsPageValue177.slug));
                              }
                            : undefined,
                        ...
                        trailing:
                          !settingsPageValue42 && _item.externalUrl != null
                            ? settingsPageValue13.jsx(
                                worktreeNewThreadQueryCompatSlotUpperNLowerN,
                                {
                                  className:
  ...
  let settingsPageValue73 = settingsPageValue45
    ? null
    : settingsPageValue13.jsx(worktreeNewThreadQueryCompatSlotLowerYLowerP, {
        tooltipContent: settingsPageValue42
          ? settingsPageValue13.jsx(currentAppInitialSharedMember0924, {
        ...
        children: settingsPageValue13.jsx(
          projectsIndexCurrentCompatSlotLowerTLowerN,
          {
            "aria-label": settingsPageValue36.formatMessage(
              settingsPageValue15.chatSettings,
            ),
            icon: worktreeNewThreadOrchestratorCompatSlotUpperFLowerR,
            iconClassName: "icon-sm inline-block align-middle",
            hideLabel: canCollapse ? settingsPageValue42 : undefined,
      ...
      <div className="shrink-0 px-row-x pb-2 text-sm text-token-text-secondary">
        ...
        >
          {settingsPageValue13.jsx(currentAppInitialSharedMember0924, {
            ...
            description:
              "Button to show all settings by clearing the selected remote host",
          })}
        </button>
        {settingsPageValue13.jsx(currentAppInitialSharedMember0924, {
          ...
          description:
            "Text explaining that clearing the selected remote host shows all settings",
        })}
      </div>
    );
  let settingsPageValue75 = (
    <div className={settingsPageValue64}>
      {settingsPageValue65}
      {settingsPageValue73}
      {settingsPageValue74}
    </div>
  );
  let settingsPageValue76 = (
    <div className={settingsPageValue66}>
      {settingsPageValue67}
      {settingsPageValue68}
      {settingsPageValue69}
      {settingsPageValue70}
  ...
  return (
    <nav className={settingsPageValue71} aria-label={settingsPageValue72}>
      {settingsPageValue76}
    </nav>
  );
}
...
function settingsPageHelper12(settingsPageParam2) {
  ...
  settingsPageValue125 = {
    ...
    onKeyDown: (event) => {
      event.preventDefault();
      settingsPageValue124.current?.focus();
      settingsPageValue124.current?.select();
    },
  };
  ThreadRowMeta(settingsPageValue125);
  let settingsPageValue126 = settingsPageValue13.jsx(
    worktreeNewThreadQueryCompatSlotLowerLLowerO,
    {
      className:
  ...
  let settingsPageValue127 = settingsPageValue123.formatMessage({
    id: "settings.search.label",
    defaultMessage: "Search settings",
    description: "Accessible label for the settings search input",
  });
  let settingsPageValue128 = (event) => {
    onQueryChange(event.target.value);
  };
  let settingsPageValue129 = settingsPageValue123.formatMessage({
    id: "settings.search.placeholder",
    defaultMessage: "Search settings…",
    description: "Placeholder text for the settings search input",
  });
  let settingsPageValue130 = (
    <input
      ref={settingsPageValue124}
      aria-label={settingsPageValue127}
      ...
      onChange={settingsPageValue128}
      onKeyDown={onKeyDown}
      placeholder={settingsPageValue129}
      role="searchbox"
      type="text"
      value={searchQuery}
    />
  );
  let settingsPageValue131 =
    searchQuery.length > 0 ? (
      <button
        aria-label={settingsPageValue123.formatMessage({
        ...
        type="button"
      >
        {settingsPageValue13.jsx(worktreeNewThreadQueryCompatSlotLowerOLowerP, {
          className: "icon-2xs",
        })}
      </button>
    ) : null;
  return (
    <div className="mb-4 flex h-token-button-composer w-full shrink-0 items-center rounded-lg border border-token-border-heavy bg-token-input-background/50 text-base leading-[18px] shadow-sm backdrop-blur-sm [.electron-dark_&]:border-token-border [.electron-dark_&]:bg-token-bg-fog [.electron-dark_&]:shadow-none [.electron-dark_&]:backdrop-blur-none">
      {settingsPageValue126}
      {settingsPageValue130}
      {settingsPageValue131}
    </div>
  );
}
function settingsPageHelper13(settingsPageParam6) {
    ...
    return (
      <div className="px-row-x pt-2 text-sm text-token-text-secondary">
        {settingsPageValue13.jsx(currentAppInitialSharedMember0924, {
          ...
          description:
            "Empty state shown when settings search has no matching destinations",
        })}
      </div>
    );
  }
  let settingsPageValue158;
  {
    ...
    settingsPageValue158 = searchResults.map(settingsPageValue160);
  }
  return (
    <div ref={listRef} className="flex flex-col gap-3 pt-1">
      {settingsPageValue158}
    </div>
  );
}
  ...
  let settingsPageValue188 = new Map(
    ...
    settingsPageValue189 = settingsPageParam20.map((item) => ({
      ...
      sections: item.slugs.flatMap((_item) => {
        ...
        return settingsPageValue200 == null
          ? []
          : (settingsPageValue188.delete(_item), [settingsPageValue200]);
      }),
    })),
    settingsPageValue190 = Array.from(settingsPageValue188.values());
  return (
    settingsPageValue190.length > 0 &&
      settingsPageValue189[settingsPageValue189.length - 1]?.sections.push(
        ...settingsPageValue190,
      ),
  ...
  return [
    ...settingsPageParam25.flatMap((item) => {
      ...
      return settingsPageValue201 == null
        ? []
        : (settingsPageValue194.delete(item), [settingsPageValue201]);
    }),
    ...settingsPageValue194.values(),
  ];
}
var settingsPageValue11,
  settingsPageValue12,
  settingsPageValue13,
  settingsPageValue14,
  settingsPageValue15,
  ...
  settingsPageValue20,
  settingsPageValue21,
  settingsPageValue22 = once(() => {
    settingsPageValue11 = currentAppInitialSharedCompatSlotLowerGLowerC();
    worktreeNewThreadQueryCompatSlotLowerHLowerH();
    settingsPageValue12 = toEsModule(
      currentAppInitialSharedCompatSlotUnderscoreLowerC(),
      1,
    );
    intlFormatDateTimeRuntime();
    ...
    settingsPageValue10();
    appgenLibraryHotDjo67r4nCompatSlotUpperH();
    settingsPageValue13 = currentAppInitialSharedCompatSlotLowerLLowerC();
    settingsPageValue14 = {
      "general-settings": worktreeNewThreadQueryCompatSlotUpperBLowerA,
      import: worktreeNewThreadQueryCompatSlotLowerDLowerS,
      profile: appMainCurrentCompatSlotLowerELowerN,
      "keyboard-shortcuts": settingsPageValue7,
      "codex-micro": CloudTerminalIcon,
      appshots: appgenLibraryHotDjo67r4nCompatSlotLowerA,
      appearance: SunIcon,
      pets: settingsPageValue2,
      agent: sharedHighlightThemeRegistry,
      "git-settings": worktreeNewThreadQueryCompatSlotUpperQLowerS,
      "data-controls": projectsIndexCurrentCompatSlotDollar,
      "code-review": sharedHighlightThemeRegistry,
      "cloud-settings": appMainCurrentCompatSlotUpperXLowerT,
      "cloud-environments": appMainCurrentCompatSlotUpperXLowerT,
      personalization: UsageGaugeIcon,
      usage: appgenLibraryHotDjo67r4nCompatSlotUpperMLowerN,
      "browser-use": BrowserWindowIcon,
      "computer-use": appMainCurrentCompatSlotUpperDLowerI,
      "local-environments": DockIcon,
      worktrees: worktreeNewThreadOrchestratorCompatSlotUpperK,
      environments: DockIcon,
      "mcp-settings": AppgenPublicationTermsFallbackIcon,
      "hooks-settings": appMainCurrentCompatSlotUpperCLowerI,
      connections: worktreeNewThreadQueryCompatSlotLowerDLowerO,
      "plugins-settings": AppgenPlugIcon,
      "skills-settings": worktreeNewThreadQueryCompatSlotUpperRLowerA,
    };
    settingsPageValue15 = createScopedSignalAtom({
      collapseSidebar: {
    ...
    settingsPageValue17 = [
      {
        key: "personal",
        heading: currentAppInitialSharedMember0273({
          id: "settings.nav.heading.personal",
          defaultMessage: "Personal",
          description:
            "Heading for personal settings in the settings navigation",
        }),
        slugs: [
          "general-settings",
          "import",
      ...
      },
      {
        ...
        heading: currentAppInitialSharedMember0273({
          ...
          description:
            "Heading for archived settings in the settings navigation",
        }),
        slugs: ["data-controls"],
      },
    ];
    settingsPageValue18 = [];
    settingsPageValue19 = "1785186884";
    settingsPageValue20 = "https://chatgpt.com/#settings";
    settingsPageValue21 = {
      collapsed: {
        icon: worktreeNewThreadOrchestratorCompatSlotLowerVLowerT,
        message: settingsPageValue15.expandSidebar,
      },
      expanded: {
        icon: worktreeNewThreadOrchestratorCompatSlotLowerBLowerT,
        message: settingsPageValue15.collapseSidebar,
      },
    };
  }),
  settingsPageValue23,
  settingsPageValue24 = once(() => {
    settingsPageValue23 = {
      agent: [
        {
      ...
      "browser-use": [
        ...
        {
          defaultMessage:
            "View and manage files downloaded from Codex's browser",
      ...
      "cloud-environments": [
        ...
        {
          defaultMessage:
            "Unable to update cloud environment. Reload and try again",
      ...
      "computer-use": [
        ...
        {
          defaultMessage:
            "Manage how Codex uses other applications on your computer",
      ...
      connections: [
        ...
        {
          defaultMessage:
            "This changes the color for {host} everywhere it appears",
      ...
      usage: [
        ...
        {
          defaultMessage:
            "For 2+ seats, billed annually. <link>Learn more</link>",
        ...
        {
          defaultMessage:
            "View more details for Business ChatGPT and Codex plan",
...
function $n(settingsPageParam12) {
  ...
  let settingsPageValue173 = settingsPageValue172,
    settingsPageValue174 = [
      ...
      return [
        appMainCurrentCompatSlotLowerWLowerF(locale, locale),
        appMainCurrentCompatSlotLowerWLowerF(
          language,
          settingsPageValue167.locale,
        ),
      ];
    });
  let settingsPageValue175 = settingsPageValue174;
  return settingsPageValue26.map((item) =>
    item.sectionSlug === "appearance" && !settingsPageValue168
      ...
      : item.sectionSlug === "agent"
        ? {
            ...item,
            terms: settingsPageValue173,
          }
        : item.sectionSlug === "general-settings"
          ? {
              ...item,
              messages: item.messages,
              terms: settingsPageValue175,
            }
          : item,
  );
}
...
var settingsPageValue25,
  ...
  settingsPageValue27,
  or = once(() => {
    settingsPageValue25 = currentAppInitialSharedCompatSlotLowerGLowerC();
    currentAppInitialSharedCompatSlotUpperVLowerO();
    intlFormatDateTimeRuntime();
    settingsPageValue24();
    initSettingsSectionMetadataChunk();
    ...
    worktreeNewThreadQueryCompatSlotLowerCLowerL();
    initExperimentalFeatureVisibilityChunk();
    settingsPageValue26 = settingsSectionIds.map((item) => ({
      messages: settingsPageValue23[item] ?? [],
      sectionSlug: item,
    }));
    settingsPageValue27 = [
...
function settingsPageHelper19(
  ...
  let settingsPageValue137 = currentAppInitialSharedMember0781(
    ...
    settingsPageValue138 = currentAppInitialSharedCompatSlotLowerQLowerO(
      selectedHostAppshotAvailability,
    ),
    settingsPageValue139 = currentAppInitialSharedMember0799(),
    { isProfileVisible, isProfileVisibilityLoading } =
      _appInitialAppMainRemoteConversationPageHotkeyWindowThreadPageKeyboardShortcutsN7jwlpf0C(),
    ...
    settingsPageValue145 = settingsNavigationSections.filter((item) => {
      ...
      switch (item.slug) {
        case "appshots":
          return settingsPageValue138;
        case "plugins-settings":
          return false;
        case "skills-settings":
          return false;
        case "connections":
          return settingsPageValue134 && !settingsPageValue133;
        case "usage":
          return isUsageSettingsVisible;
        case "profile":
          return isProfileVisible;
        case "computer-use":
          return settingsPageValue143;
        case "browser-use":
          return settingsPageValue144;
        case "appearance":
          return true;
        case "pets":
        case "git-settings":
        ...
        case "environments":
          return true;
        case "import":
          return !settingsPageValue139 && settingsPageValue137;
        case "data-controls":
          return true;
        case "code-review":
        case "cloud-settings":
  ...
  if (
    ...
    switch (settingsPageValue147.slug) {
      case "appshots":
        settingsPageValue150 = settingsPageValue139;
        break;
      case "usage":
        settingsPageValue150 = isUsageSettingsAccessLoading;
        break;
      case "profile":
        settingsPageValue150 = isProfileVisibilityLoading;
        break;
      case "appearance":
      case "pets":
      case "general-settings":
      ...
      case "codex-micro":
        ...
        break;
      case "computer-use":
        settingsPageValue150 =
          settingsPageValue140.isLoading || settingsPageValue136.isLoading;
        break;
      case "browser-use":
        settingsPageValue150 =
          settingsPageValue135.isLoading ||
          settingsPageValue136.isLoading ||
          settingsPageValue139;
        break;
      case "local-environments":
      case "worktrees":
      case "environments":
  ...
  return {
    activeSettingsSection: settingsPageValue146?.slug ?? settingsPageValue149,
...
var settingsPageValue28,
  ...
  settingsPageValue30 = once(() => {
    ...
    settingsPageValue29 = "agent";
  });
export function SettingsPageIcon() {
  let settingsPageValue79 = currentAppInitialSharedCompatSlotUpperKLowerO(
      currentAppInitialSharedCompatSlotUpperE,
    ),
    settingsPageValue80 = currentAppInitialSharedFunction0375(),
    settingsPageValue81 = parseWorkspaceRootPathList(),
    settingsPageValue82 = useReactRouterLocationInvariant(),
    settingsPageValue83 =
      currentAppInitialSharedMember0262("/settings/:section/*")?.params
        .section ?? null,
    {
    ...
    settingsPageValue84 =
      currentAppInitialSharedMember0011(selectedHostId).kind === "local",
    {
    ...
    settingsPageValue85 = worktreeNewThreadOrchestratorCompatSlotUpperOLowerT(),
    settingsPageValue86 = currentAppInitialSharedCompatSlotLowerQLowerO(
      settingsReturnRouteSignal,
    ),
    settingsPageValue87 = currentAppInitialSharedCompatSlotLowerQLowerO(
      worktreeNewThreadOrchestratorCompatSlotLowerELowerM,
    ),
    settingsPageValue88 = () =>
  ...
  let settingsPageValue91 = $n(settingsPageValue90),
    settingsPageValue92 =
      ...
      remoteConnectionHostIds != null
        ...
        : null;
  let settingsPageValue93 = settingsPageValue92,
    settingsPageValue94 = settingsPageValue84
      ? undefined
      : () => {
          setSelectedHostId(currentAppInitialSharedMember0542);
        };
  let settingsPageValue95 = settingsPageValue94,
    settingsPageValue96 = $.jsx(worktreeNewThreadQueryCompatSlotLowerLLowerS, {
      electron: true,
      children: (
        <div className="[container-type:inline-size] flex h-token-nav-row shrink-0 items-center justify-end px-row-x empty:hidden">
          {$.jsx(AppHeaderUpdateButton, {})}
        </div>
      ),
    });
  let settingsPageValue97 = settingsPageValue96,
    settingsPageValue98 = shouldRenderRouteContent
      ? $.jsx(_r.Suspense, {
          fallback: $.jsx(SettingsContentLayout, {}),
          children: $.jsx(
            currentAppInitialSharedMember0068,
            {},
            selectedHostId,
  ...
  let settingsPageValue105 = settingsPageValue104;
  useRegisterToggleSidebarCommand();
  let settingsPageValue106 = () => {
    settingsPageValue79.query
  ...
  _r.useEffect(settingsPageValue106, settingsPageValue107);
  let settingsPageValue108, settingsPageValue109;
  if (
    ((settingsPageValue108 = () => {
      let settingsPageValue183 = (event) => {
        event.key === "Escape" &&
      ...
      return (
        ...
        () => {
          window.removeEventListener("keydown", settingsPageValue183);
        }
      );
    }),
    (settingsPageValue109 = [settingsPageValue86, settingsPageValue81]),
    _r.useEffect(settingsPageValue108, settingsPageValue109),
    shouldRedirectToVisibleSettingsSection)
  ) {
    let settingsPageValue191 = `/settings/${activeSettingsSection}`,
      settingsPageValue192;
    return $.jsx(currentAppInitialSharedMember0084, {
      to: settingsPageValue191,
      replace: true,
    });
  }
  if (settingsPageValue85) {
    let settingsPageValue162 =
      settingsPageValue87 &&
      $.jsx(
        _appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKg2pu5rsOt.LeftPanel,
        {
          children: (
            <div className="flex h-full min-h-0 flex-col overflow-hidden">
              {$.jsx(settingsPageHelper5, {
                ...
                onClearHostFilter: settingsPageValue95,
                searchTargets: settingsPageValue91,
                sidebarHostSelector: settingsPageValue93,
                onSelect: settingsPageValue101,
                onBack: settingsPageValue89,
    ...
    let settingsPageValue163 = settingsPageValue82.hash.slice(1) || null;
    let settingsPageValue164 = (
      <div className="h-full min-w-0 overflow-visible">
        {$.jsx(SettingsContentNavigationTargetProvider, {
          navigationKey: settingsPageValue82.key,
          targetId: settingsPageValue163,
          children: settingsPageValue99,
        })}
      </div>
    );
    let settingsPageValue165;
    return $.jsxs(
      _appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKg2pu5rsOt.Root,
      {
        children: [settingsPageValue162, settingsPageValue164],
      },
    );
  }
  let settingsPageValue110 = {
    width: "calc(100vw / var(--codex-window-zoom))",
    height: "calc(100vh / var(--codex-window-zoom))",
    zoom: "var(--codex-window-zoom)",
  };
  let settingsPageValue111, settingsPageValue112;
  settingsPageValue111 = worktreeNewThreadQueryCompatSlotLowerMLowerH(
  ...
  let settingsPageValue113 = settingsPageValue89,
    settingsPageValue114 = (
      <div className={settingsPageValue111}>
        ...
        {$.jsx(settingsPageHelper5, {
          ...
          sidebarHostSelector: settingsPageValue93,
          onSelect: settingsPageValue101,
          onBack: settingsPageValue113,
          groupSettingsSections: true,
        })}
        {settingsPageValue97}
      </div>
    );
  let settingsPageValue115 = settingsPageValue82.hash.slice(1) || null;
  let settingsPageValue116 = $.jsx(SettingsContentNavigationTargetProvider, {
    navigationKey: settingsPageValue82.key,
    targetId: settingsPageValue115,
    children: settingsPageValue99,
  });
  let settingsPageValue117 = (
    <div
      ref={settingsPageValue105}
      className="relative isolate min-w-0 flex-1 overflow-visible"
    >
      {settingsPageValue116}
    </div>
  );
  return (
    <div className="flex h-full min-h-0" style={settingsPageValue110}>
      {settingsPageValue114}
      {settingsPageValue117}
    </div>
  );
}
...
var settingsPageValue31, _r, $;
once(() => {
  settingsPageValue31 = currentAppInitialSharedCompatSlotLowerGLowerC();
  remoteControlRefreshSourceEnum();
  worktreeNewThreadQueryCompatSlotLowerHLowerH();
  currentAppInitialSharedCompatSlotUpperVLowerO();
  _r = toEsModule(currentAppInitialSharedCompatSlotUnderscoreLowerC(), 1);
  intlFormatDateTimeRuntime();
  openAiNativeAppDefinition();
  worktreeNewThreadOrchestratorCompatSlotLowerSLowerT();
  worktreeNewThreadOrchestratorCompatSlotLowerRLowerM();
