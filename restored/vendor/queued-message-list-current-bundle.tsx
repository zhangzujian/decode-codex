...
// Current QueuedMessageList backing bundle rewritten from the current ref chunk.
...
const initQueuedMessageListCurrentBundle = runOnce(() => {
  initDndRuntime();
...
initQueuedMessageListCurrentBundle();
