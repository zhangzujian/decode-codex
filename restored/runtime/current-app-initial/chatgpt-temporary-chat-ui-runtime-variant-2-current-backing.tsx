// Restored from ref/webview/assets/chatgpt-temporary-chat-ui-Diuwj6iw.js
// Flat boundary vendored current-build implementation used by the semantic positional adapter.
// ChatgptTemporaryChatUi chunk restored from the Codex webview bundle.
import {
...
import {
  pullRequestCodeReviewNewThreadPaneRuntimeVariant6Member0053 as appInitialArtifactTabContentElectronAppMainPullRequestCodeReviewNewThreadPaneEmmhcg7rN,
  pullRequestCodeReviewNewThreadPaneRuntimeVariant6Member0064 as appInitialArtifactTabContentElectronAppMainPullRequestCodeReviewNewThreadPaneEmmhcg7rT,
...
import {
  ...
  initConversationRouteRuntime as appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutC1u3yp5sFt,
  ...
  setTemporaryChatSearch as appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutC1u3yp5sY,
...
var chatgptTemporaryChatUiValue1,
  chatgptTemporaryChatUiValue2,
  chatgptTemporaryChatUiValue3 = rolldownRuntimeN(() => {
    appInitialAvatarOverlayCompositionSurfaceIndex9fQ9wihuIndexBFCcxPM5MapboxGlDVWlwqbKppdhleyDn();
    chatgptTemporaryChatUiValue1 =
      appInitialAvatarOverlayCompositionSurfaceIndex9fQ9wihuIndexBFCcxPM5MapboxGlDVWlwqbKppdhleyZt();
    chatgptTemporaryChatUiValue2 = (chatgptTemporaryChatUiParam1) => (
      <svg
        width={20}
        height={20}
        viewBox="0 0 20 20"
  ...
  chatgptTemporaryChatUiValue4,
  chatgptTemporaryChatUiValue5,
  chatgptTemporaryChatUiValue6 = rolldownRuntimeN(() => {
    appInitialAvatarOverlayCompositionSurfaceIndex9fQ9wihuIndexBFCcxPM5MapboxGlDVWlwqbKppdhleyDn();
    chatgptTemporaryChatUiValue4 =
      appInitialAvatarOverlayCompositionSurfaceIndex9fQ9wihuIndexBFCcxPM5MapboxGlDVWlwqbKppdhleyZt();
    chatgptTemporaryChatUiValue5 = (chatgptTemporaryChatUiParam2) => (
      <svg
        width={20}
        height={20}
        viewBox="0 0 20 20"
...
export function chatgptTemporaryChatUiN(chatgptTemporaryChatUiParam4) {
  let { isIndicator, isTemporaryChat } = chatgptTemporaryChatUiParam4,
    chatgptTemporaryChatUiValue25 =
    ...
    chatgptTemporaryChatUiValue26 =
      appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutC1u3yp5sMt();
  if (isTemporaryChat && isIndicator) {
    let chatgptTemporaryChatUiValue40 =
      chatgptTemporaryChatUiValue25.formatMessage(
        chatgptTemporaryChatUiValue11.temporaryChatTooltip,
      );
    let chatgptTemporaryChatUiValue41 = (
      <div className="flex items-center gap-1.5 text-sm select-none">
        {chatgptTemporaryChatUiValue9.jsx(chatgptTemporaryChatUiValue5, {
          className: "icon-sm",
        })}
        {chatgptTemporaryChatUiValue9.jsx(
          appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
          {
            ...chatgptTemporaryChatUiValue11.temporaryChat,
          },
        )}
      </div>
    );
    let chatgptTemporaryChatUiValue42;
    return chatgptTemporaryChatUiValue9.jsx(
      appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewKr7rxhqeT,
      {
        tooltipContent: chatgptTemporaryChatUiValue40,
        children: chatgptTemporaryChatUiValue41,
      },
    );
  }
  let chatgptTemporaryChatUiValue27 =
    chatgptTemporaryChatUiValue25.formatMessage(
      isTemporaryChat
        ? chatgptTemporaryChatUiValue11.turnOffTemporaryChat
        : chatgptTemporaryChatUiValue11.turnOnTemporaryChat,
    );
  let chatgptTemporaryChatUiValue28 = chatgptTemporaryChatUiValue27,
    chatgptTemporaryChatUiValue29 = isTemporaryChat
      ? chatgptTemporaryChatUiValue2
      : chatgptTemporaryChatUiValue5,
    chatgptTemporaryChatUiValue30 = () => {
      chatgptTemporaryChatUiValue26(
        {
          pathname,
          search:
            appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutC1u3yp5sY(
              search,
              !isTemporaryChat,
            ),
        },
  ...
  let chatgptTemporaryChatUiValue31 = chatgptTemporaryChatUiValue9.jsx(
    chatgptTemporaryChatUiValue29,
    {
      className: "icon-sm",
    },
  );
  let chatgptTemporaryChatUiValue32 = chatgptTemporaryChatUiValue9.jsx(
    appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewCc80cam6Underscore,
    {
      "aria-label": chatgptTemporaryChatUiValue28,
      color: "ghost",
      onClick: chatgptTemporaryChatUiValue30,
      size: "icon",
      children: chatgptTemporaryChatUiValue31,
    },
  );
  return chatgptTemporaryChatUiValue9.jsx(
    appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewKr7rxhqeT,
    {
      tooltipContent: chatgptTemporaryChatUiValue28,
      children: chatgptTemporaryChatUiValue32,
    },
  );
}
export function chatgptTemporaryChatUiT(chatgptTemporaryChatUiParam6) {
  let { isTemporaryChat } = chatgptTemporaryChatUiParam6,
    [chatgptTemporaryChatUiValue44, chatgptTemporaryChatUiValue45] =
      chatgptTemporaryChatUiValue8.useState(chatgptTemporaryChatUiHelper1);
  if (!isTemporaryChat || chatgptTemporaryChatUiValue44) return null;
  return chatgptTemporaryChatUiValue9.jsx(chatgptTemporaryChatUiHelper2, {
    onClose: () => {
      window.localStorage.setItem(chatgptTemporaryChatUiValue10, "true");
      chatgptTemporaryChatUiValue45(true);
    },
  });
}
function chatgptTemporaryChatUiHelper1() {
  return window.localStorage.getItem(chatgptTemporaryChatUiValue10) === "true";
}
function chatgptTemporaryChatUiHelper2(chatgptTemporaryChatUiParam3) {
  let { onClose } = chatgptTemporaryChatUiParam3,
    chatgptTemporaryChatUiValue13 = (event) => {
      event.preventDefault();
      onClose();
    };
  let chatgptTemporaryChatUiValue14 = chatgptTemporaryChatUiValue13,
    chatgptTemporaryChatUiValue15 = {
      onEscapeKeyDown: chatgptTemporaryChatUiHelper3,
    };
  let chatgptTemporaryChatUiValue16 = (chatgptTemporaryChatUiParam7) => {
    chatgptTemporaryChatUiParam7 || onClose();
  };
  let chatgptTemporaryChatUiValue17 = chatgptTemporaryChatUiValue9.jsx(
    appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutH49w84u1F,
    {
      children: chatgptTemporaryChatUiValue9.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...chatgptTemporaryChatUiValue11.onboardingTitle,
        },
      ),
    },
  );
  let chatgptTemporaryChatUiValue18 = chatgptTemporaryChatUiValue9.jsx(
    appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutH49w84u1I,
    {
      title: chatgptTemporaryChatUiValue17,
      subtitle: chatgptTemporaryChatUiValue9.jsx(
        appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutH49w84u1D,
        {
          children: chatgptTemporaryChatUiValue9.jsx(
            appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
            {
              ...chatgptTemporaryChatUiValue11.onboardingDescription,
            },
          ),
        },
      ),
  ...
  let chatgptTemporaryChatUiValue19 = chatgptTemporaryChatUiValue9.jsx(
    chatgptTemporaryChatUiHelper4,
    {
      description: chatgptTemporaryChatUiValue9.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...chatgptTemporaryChatUiValue11.notInHistoryDescription,
        },
      ),
      icon: chatgptTemporaryChatUiValue9.jsx(chatgptTemporaryChatUiValue5, {
        className: "h-full w-full",
      }),
      title: chatgptTemporaryChatUiValue9.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...chatgptTemporaryChatUiValue11.notInHistoryTitle,
        },
      ),
    },
  );
  let chatgptTemporaryChatUiValue20 = chatgptTemporaryChatUiValue9.jsxs(
    appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutH49w84u1A,
    {
      className: "gap-4",
      children: [
        chatgptTemporaryChatUiValue19,
        chatgptTemporaryChatUiValue9.jsx(chatgptTemporaryChatUiHelper4, {
          description: chatgptTemporaryChatUiValue9.jsx(
            appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
            {
              ...chatgptTemporaryChatUiValue11.memoryOffDescription,
            },
          ),
          icon: chatgptTemporaryChatUiValue9.jsx(
          ...
          title: chatgptTemporaryChatUiValue9.jsx(
            appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
            {
              ...chatgptTemporaryChatUiValue11.memoryOffTitle,
            },
          ),
        }),
      ],
  ...
  let chatgptTemporaryChatUiValue21 = chatgptTemporaryChatUiValue9.jsx(
    appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutH49w84u1A,
    {
      children: chatgptTemporaryChatUiValue9.jsx(
          ...
          children: chatgptTemporaryChatUiValue9.jsx(
            appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewCc80cam6Underscore,
            {
              ...
              children: chatgptTemporaryChatUiValue9.jsx(
                appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
                {
                  ...chatgptTemporaryChatUiValue11.continueButton,
                },
              ),
            },
          ),
  ...
  let chatgptTemporaryChatUiValue22 = chatgptTemporaryChatUiValue9.jsxs(
    appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutH49w84u1N,
    {
      as: "form",
      className: "gap-4",
      onSubmit: chatgptTemporaryChatUiValue14,
      children: [
        chatgptTemporaryChatUiValue18,
        chatgptTemporaryChatUiValue20,
        chatgptTemporaryChatUiValue21,
      ],
    },
  );
  return chatgptTemporaryChatUiValue9.jsx(
    ...
    {
      open: true,
      contentProps: chatgptTemporaryChatUiValue15,
      onOpenChange: chatgptTemporaryChatUiValue16,
      shouldIgnoreClickOutside: true,
      showDialogClose: false,
      size: "wide",
      children: chatgptTemporaryChatUiValue22,
    },
  );
}
function chatgptTemporaryChatUiHelper3(event) {
  event.preventDefault();
}
function chatgptTemporaryChatUiHelper4(chatgptTemporaryChatUiParam5) {
  let { description, icon, title } = chatgptTemporaryChatUiParam5,
    chatgptTemporaryChatUiValue35 = (
      <div className="icon-sm mt-0.5 shrink-0 text-token-foreground">
        {icon}
      </div>
    );
  let chatgptTemporaryChatUiValue36 = (
    <div className="font-semibold text-token-foreground">{title}</div>
  );
  let chatgptTemporaryChatUiValue37 = (
    <p className="text-token-description-foreground">{description}</p>
  );
  let chatgptTemporaryChatUiValue38 = (
    <div className="flex min-w-0 flex-col gap-1">
      {chatgptTemporaryChatUiValue36}
      {chatgptTemporaryChatUiValue37}
    </div>
  );
  return (
    <div className="flex items-start gap-3">
      {chatgptTemporaryChatUiValue35}
      {chatgptTemporaryChatUiValue38}
    </div>
  );
}
var chatgptTemporaryChatUiValue7,
  chatgptTemporaryChatUiValue8,
  chatgptTemporaryChatUiValue9,
  chatgptTemporaryChatUiValue10,
  chatgptTemporaryChatUiValue11;
export const chatgptTemporaryChatUiR = rolldownRuntimeN(() => {
  chatgptTemporaryChatUiValue7 =
    appInitialAvatarOverlayCompositionSurfaceIndex9fQ9wihuIndexBFCcxPM5MapboxGlDVWlwqbKppdhleyUn();
  chatgptTemporaryChatUiValue8 = rolldownRuntimeS(
    appInitialAvatarOverlayCompositionSurfaceIndex9fQ9wihuIndexBFCcxPM5MapboxGlDVWlwqbKppdhleyDn(),
    1,
  );
  ...
  chatgptTemporaryChatUiValue3();
  chatgptTemporaryChatUiValue6();
  ...
  chatgptTemporaryChatUiValue9 =
    appInitialAvatarOverlayCompositionSurfaceIndex9fQ9wihuIndexBFCcxPM5MapboxGlDVWlwqbKppdhleyZt();
  chatgptTemporaryChatUiValue10 = "oai/apps/hasSeenTemporaryChatOnboarding";
  chatgptTemporaryChatUiValue11 =
    appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4A(
      {
        ...
        temporaryChatTooltip: {
          ...
          description:
            "Tooltip for the ChatGPT temporary chat header indicator.",
        },
