// Restored from ref/webview/assets/pricing-plan-page-Dtv4fuPP.js
// Flat boundary vendored current-build implementation used by the semantic positional adapter.
// PricingPlanPage chunk restored from the Codex webview bundle.
import {
...
import {
  ...
  imagePickerSchemaCapabilities as appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutOxnpxkxcNh,
  businessCheckoutSharedMember0697 as appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutOxnpxkxcTh,
  businessCheckoutSharedMember0798 as appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutOxnpxkxcVg,
...
import {
  settingsCommandSharedRuntimeVariant16Member0009 as appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelEt,
  settingsCommandSharedRuntimeVariant16Member0010 as appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelG,
  settingsCommandSharedRuntimeVariant16Member0014 as appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelH,
  settingsCommandSharedRuntimeVariant16Member0020 as appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelL,
  settingsCommandSharedRuntimeVariant16Member0024 as appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelR,
  settingsCommandSharedRuntimeVariant16Member0026 as appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelU,
  settingsCommandSharedRuntimeVariant16Member0029 as appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelW,
  settingsCommandSharedRuntimeVariant16Member0040 as appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelZ,
} from "../current-ref-aliases/settings-command-shared-runtime-variant-16/index";
import {
  hotkeyWindowThreadPageHoRuntimeVariant2Member0001 as _appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayS,
  hotkeyWindowThreadPageHoRuntimeVariant2Member0002 as appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayC,
  ...
  hotkeyWindowThreadPageHoRuntimeVariant2Member0012 as appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayL,
  hotkeyWindowThreadPageHoRuntimeVariant2Member0013 as appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayM,
  hotkeyWindowThreadPageHoRuntimeVariant2Member0015 as appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayO,
  hotkeyWindowThreadPageHoRuntimeVariant2Member0017 as appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayR,
  hotkeyWindowThreadPageHoRuntimeVariant2Member0018 as appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayS,
...
} from "../current-ref-aliases/icons/trending-topics/index";
import {
...
} from "../current-ref-aliases/subscription-update-plan/index";
import {
  ...
  pricingPlanPageValue37 = rolldownRuntimeN(() => {
    ...
    pricingPlanPageValue36 = (pricingPlanPageParam35) => (
      ...
      >
        ...
        <circle cx={9.7} cy={14.7} r={0.7} fill="currentColor" />
      </svg>
    );
  }),
      ...
      return [
        {
          ...
          label: pricingPlanPageValue90.jsx(
...
function pricingPlanPageHelper3(pricingPlanPageParam67) {
  return pricingPlanPageParam67 ===
...
function pricingPlanPageHelper5(
  ...
  switch (pricingPlanPageParam58) {
    ...
    case appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainSettingsCommandKt7wj8foP.PROLITE:
    case appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainSettingsCommandKt7wj8foP.PRO:
      return appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelW(
        {
          currentPlan: pricingPlanPageParam57,
          targetPlan: pricingPlanPageParam58,
        },
      );
    case appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainSettingsCommandKt7wj8foP.SELF_SERVE_BUSINESS:
      return appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelL;
    case appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainSettingsCommandKt7wj8foP.SELF_SERVE_BUSINESS_USAGE_BASED:
      return appInitialAppMainSettingsCommandMenuSectionItemsFirstRunPluginDetailPageNewTMd593oelR;
  }
}
    ...
    pricingPlanPageValue92 = [
      {
        ...
        targetPlan:
          appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainSettingsCommandKt7wj8foP.SELF_SERVE_BUSINESS,
      },
      {
        highlighted: false,
        id: "business_codex",
        targetPlan:
          appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainSettingsCommandKt7wj8foP.SELF_SERVE_BUSINESS_USAGE_BASED,
      },
    ];
  });
export function pricingPlanPagePricingPlanPage() {
  let pricingPlanPageValue146 =
    ...
    [pricingPlanPageValue156, pricingPlanPageValue157] =
      pricingPlanPageValue95.useState(null),
    [pricingPlanPageValue158, pricingPlanPageValue159] =
      pricingPlanPageValue95.useState(null),
    [pricingPlanPageValue160, pricingPlanPageValue161] =
      pricingPlanPageValue95.useState(false),
    { data: _data } =
    ...
    { data: __data } =
      appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayM(
        {
  ...
  if (
    (pricingPlanPageValue95.useEffect(() => {
  ...
  let pricingPlanPageValue162 = (
    ...
    pricingPlanPageValue163 = async (
      ...
      if (
        ...
        appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutOxnpxkxcKf(
          pricingPlanPageValue146,
          appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainBusinessCheckoutOxnpxkxcTh,
          {
      ...
      try {
        let pricingPlanPageValue223 = await pricingPlanPageValue150.fetchQuery(
          appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayO(
            {
              accountId: data.id,
    ...
    pricingPlanPageValue165 = async () => {
      if (pricingPlanPageValue156 != null) {
        pricingPlanPageValue161(true);
        try {
          let pricingPlanPageValue220 =
            await _appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayS(
              {
                accountId: data.id,
          ...
          await appInitialAppMainNewThreadPanelPageAppgenLibraryPageHotkeyWindowThreadPageHoCrseajayR(
            {
              accountId: data.id,
            },
          );
...
function pricingPlanPagePricingPlanPageContent(pricingPlanPageParam3) {
  let {
      currentPlan,
      defaultTab = "personal",
    ...
    pricingPlanPageValue105 =
      appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4G(),
    [pricingPlanPageValue106, pricingPlanPageValue107] =
      pricingPlanPageValue95.useState(defaultTab),
    pricingPlanPageValue108 = pricingPlanPageHelper3(currentPlan);
  let [pricingPlanPageValue109, pricingPlanPageValue110] =
  ...
  let pricingPlanPageValue116 = $.jsxs(
  ...
  let pricingPlanPageValue119 = pricingPlanPageValue105.formatMessage({
  ...
  let pricingPlanPageValue122 = $.jsx(subscriptionUpdatePlanO, {
  ...
  let pricingPlanPageValue123 =
    pricingPlanPageValue106 === "personal" ? (
      ...
      >
        {pricingPlanPageHelper2(currentPlan, pricingPlanPageValue109).map(
          (item) =>
            $.jsx(
              _n,
              {
  ...
  return (
    <main className="flex h-full min-h-0 flex-col bg-token-main-surface-primary text-token-text-primary [--cursor-interaction:pointer] [--pricing-plan-highlight:#635ef4]">
      {pricingPlanPageValue117}
      {pricingPlanPageValue124}
    </main>
  );
}
function _n(pricingPlanPageParam4) {
  ...
  let pricingPlanPageValue129 = pricingPlanPageValue128,
    ...
    pricingPlanPageValue131 = $.jsx(pricingPlanPageHelper11, {
      cardId: card.id,
    });
  let pricingPlanPageValue132 = card.highlighted
    ? $.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...
          description:
            "Badge labeling the emphasized Plus offer on the plan selection page",
        },
      )
    : null;
  let pricingPlanPageValue133 =
    pricingPlanPageValue129 == null ? null : (
      <span className="flex h-full flex-col justify-end gap-0.5">
        {card.id === "pro" ? (
          <span className="text-[10px] leading-none text-token-text-secondary [@container_(min-width:44rem)]:text-[11px]">
            {$.jsx(
              appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
              {
        ...
        {$.jsx(pricingPlanPageHelper7, {
          ...
          cadence: $.jsx(
            appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
            {
              ...
              description:
                "Monthly cadence label shown after a localized personal plan price",
            },
          ),
        })}
      </span>
  ...
  pricingPlanPageValue134 = $.jsx(pricingPlanPageHelper12, {
    cardId: card.id,
  });
  pricingPlanPageValue135 = $.jsx(pricingPlanPageHelper13, {
    cardId: card.id,
  });
  let pricingPlanPageValue136 =
    showProPlanSelector && card.id === "pro"
      ? $.jsx(subscriptionUpdatePlanO, {
          ...
          options: [
            {
              id: appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainSettingsCommandKt7wj8foP.PROLITE,
              label: "5x",
            },
            {
              id: appInitialArtifactTabContentElectronNotebookPreviewPanelAppMainSettingsCommandKt7wj8foP.PRO,
              label: "20x",
            },
          ],
          selectedId: proPlan,
      ...
      : null;
  let pricingPlanPageValue137 = on(card.id);
  ...
  let pricingPlanPageValue140 =
    ...
    pricingPlanPageValue142 = (pricingPlanPageParam66) => {
      card.action !== "current" &&
        onCtaClick(card.action, card.targetPlan, pricingPlanPageParam66);
    };
  let pricingPlanPageValue143 = isLoading
    ? $.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...
          description:
            "Label shown in a pricing plan button while loading its confirmation dialog",
        },
      )
    : $.jsx(pricingPlanPageHelper17, {
        action: card.action,
        cardId: card.id,
      });
  let pricingPlanPageValue144 = $.jsx(
    appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewCc80cam6Underscore,
    {
  ...
  return $.jsx(pricingPlanPageHelper9, {
...
function pricingPlanPageHelper6(pricingPlanPageParam8) {
  let { card, onCtaClick, pricingInfo } = pricingPlanPageParam8,
  ...
  let pricingPlanPageValue169 = pricingPlanPageValue168,
    ...
    pricingPlanPageValue171 = $.jsx(pricingPlanPageHelper20, {
      cardId: card.id,
    });
  let pricingPlanPageValue172 =
    card.id === "business_codex" ? (
      <span className="translate-y-1 text-lg font-medium [@container_(min-width:44rem)]:text-[28px]">
        {$.jsx(
          appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
          {
    ...
    ) : pricingPlanPageValue169 == null ? null : (
      $.jsx(pricingPlanPageHelper7, {
        ...
        cadence: $.jsx(
          appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
          {
            ...
            description:
              "Monthly per-seat cadence label shown after a localized Business plan price",
          },
        ),
      })
    );
  let pricingPlanPageValue173, pricingPlanPageValue174, pricingPlanPageValue175;
  pricingPlanPageValue173 = $.jsx(pricingPlanPageHelper24, {
    cardId: card.id,
  });
  pricingPlanPageValue174 = $.jsx(pricingPlanPageHelper18, {
    cardId: card.id,
  });
  ...
  let pricingPlanPageValue176 =
    card.id === "business_chatgpt_codex"
      ? pricingPlanPageValue167.formatMessage({
          ...
          description:
            "Accessible label for purchasing the Business ChatGPT and Codex offer",
        })
      : pricingPlanPageValue167.formatMessage({
          id: "settings.usage.pricingPlanPage.business.codexCtaAriaLabel",
          defaultMessage: "Get started with Business Codex",
          description:
            "Accessible label for purchasing the usage-priced Codex Business offer",
        });
  ...
  let pricingPlanPageValue179 = (pricingPlanPageParam73) => {
    onCtaClick("upgrade", card.targetPlan, pricingPlanPageParam73);
  };
  let pricingPlanPageValue180 = $.jsx(
    appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
    {
      id: "settings.usage.pricingPlanPage.business.codexCta",
      defaultMessage: "Get started",
      description:
        "CTA for purchasing a Business offer from the pricing plan page",
    },
  );
  let pricingPlanPageValue181 = $.jsx(
    appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewCc80cam6Underscore,
    {
...
function pricingPlanPageHelper7(pricingPlanPageParam34) {
  let { cadence, price } = pricingPlanPageParam34,
    pricingPlanPageValue210 = (
      <span className="sr-only">{price.formatted}</span>
    );
  let pricingPlanPageValue211 = price.parts.map(pricingPlanPageHelper8);
  let pricingPlanPageValue212 = (
    <span aria-hidden="true" className="leading-none whitespace-nowrap">
      {pricingPlanPageValue211}
    </span>
  );
  let pricingPlanPageValue213 =
    price.currencyCodeLabel == null ? null : <>{price.currencyCodeLabel} </>;
  let pricingPlanPageValue214 = (
    <span className="mb-0.5 text-[10px] text-token-text-secondary [@container_(min-width:44rem)]:text-[11px]">
...
function pricingPlanPageHelper9(pricingPlanPageParam9) {
  let {
      badge,
      cta,
      description,
  ...
  let pricingPlanPageValue187 = reserveHeaderControlSpace
      ? "min-h-10"
      : "min-h-6",
  ...
  let pricingPlanPageValue189 =
    headerControl ??
    (badge == null ? null : (
      <span className="rounded-full bg-[color-mix(in_srgb,var(--pricing-plan-highlight)_15%,transparent)] px-1.5 py-0.5 text-[10px] font-semibold text-[var(--pricing-plan-highlight)]">
        {badge}
      </span>
    ));
  let pricingPlanPageValue190 = (
    <div className={pricingPlanPageValue188}>
      {title}
      {pricingPlanPageValue189}
    </div>
  );
  let pricingPlanPageValue191 = (
    <div className="mt-3 flex h-12 items-center">{price}</div>
  );
  let pricingPlanPageValue192 = (
    <div className="mt-1 min-h-8 text-xs text-token-text-secondary [@container_(min-width:44rem)]:mt-2 [@container_(min-width:44rem)]:text-base [@container_(min-width:44rem)]:font-medium [@container_(min-width:44rem)]:text-token-text-primary">
      {description}
    </div>
  );
  let pricingPlanPageValue193 = (
    <div className="[@container_(min-width:44rem)]:min-h-36">
  ...
  let pricingPlanPageValue194 = (
    <div className="mt-3 [@container_(min-width:44rem)]:mb-2 [@container_(min-width:44rem)]:[@media(min-height:72rem)]:mt-4 [@container_(min-width:44rem)]:[@media(min-height:72rem)]:mb-2.5">
      {cta}
    </div>
  );
  let pricingPlanPageValue195 = features.map(pricingPlanPageHelper10);
  let pricingPlanPageValue196 = (
    <div className="mt-4 flex flex-col gap-2 [@container_(min-width:44rem)]:gap-4 [@container_(min-width:44rem)]:[@media(min-height:72rem)]:gap-5">
      {pricingPlanPageValue195}
    </div>
  );
  let pricingPlanPageValue197 = (
    <div className="mt-auto min-h-4 pt-5 text-[10px] leading-4 text-token-text-tertiary [@container_(min-width:44rem)]:text-xs [@container_(min-width:44rem)]:[@media(min-height:72rem)]:pt-6">
      {footer}
    </div>
  );
  return (
    <article className={pricingPlanPageValue186}>
...
function pricingPlanPageHelper10(
  pricingPlanPageParam54,
  pricingPlanPageParam55,
) {
  return (
    <div
      key={pricingPlanPageParam55}
    ...
    >
      {pricingPlanPageValue95.createElement(pricingPlanPageParam54.icon, {
        className: "size-4 shrink-0 [@container_(min-width:44rem)]:size-5",
      })}
      <span>{pricingPlanPageParam54.label}</span>
    </div>
  );
}
function pricingPlanPageHelper11(pricingPlanPageParam33) {
  let { cardId } = pricingPlanPageParam33;
  switch (cardId) {
    case "free": {
...
function pricingPlanPageHelper12(pricingPlanPageParam26) {
  let { cardId } = pricingPlanPageParam26;
  switch (cardId) {
    case "free": {
...
function pricingPlanPageHelper13(pricingPlanPageParam31) {
  let { cardId } = pricingPlanPageParam31;
  switch (cardId) {
    case "free": {
      ...
      return $.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...
          description:
            "Footer link to billing help shown on the Free plan card",
          values: {
    ...
    case "pro": {
      ...
      return $.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...
          description:
            "Footer link to Pro usage guardrails shown on the Pro plan card",
          values: {
            link: pricingPlanPageHelper14,
          },
        },
      );
    }
...
function pricingPlanPageHelper14(pricingPlanPageParam69) {
  return $.jsx(pricingPlanPageHelper23, {
    href: pricingPlanPageValue101,
    children: pricingPlanPageParam69,
  });
}
function pricingPlanPageHelper15(pricingPlanPageParam70) {
  return $.jsx(pricingPlanPageHelper23, {
    href: pricingPlanPageValue98,
    children: pricingPlanPageParam70,
  });
}
function pricingPlanPageHelper16(pricingPlanPageParam71) {
  return $.jsx(pricingPlanPageHelper23, {
    href: pricingPlanPageValue99,
    children: pricingPlanPageParam71,
  });
}
function pricingPlanPageHelper17(pricingPlanPageParam38) {
  let { action, cardId } = pricingPlanPageParam38;
  if (action === "current") {
  ...
  return action === "upgrade"
    ? $.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...
          description:
            "Button label for selecting a more capable personal plan",
          values: {
            plan: $.jsx(pricingPlanPageHelper11, {
              cardId,
            }),
          },
        },
    ...
    : $.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...
          description:
            "Button label for selecting a less capable personal plan",
          values: {
            plan: $.jsx(pricingPlanPageHelper11, {
              cardId,
            }),
...
function pricingPlanPageHelper18(pricingPlanPageParam50) {
  let { cardId } = pricingPlanPageParam50;
  ...
  return $.jsx(
    appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
    {
      ...
      description:
        "Footer link to Business annual billing details shown on the ChatGPT and Codex Business plan card",
      values: {
        link: pricingPlanPageHelper19,
      },
    },
  );
}
function pricingPlanPageHelper19(pricingPlanPageParam72) {
  return $.jsx(pricingPlanPageHelper23, {
    href: pricingPlanPageValue100,
    children: pricingPlanPageParam72,
  });
}
function pricingPlanPageHelper20(pricingPlanPageParam45) {
  let { cardId } = pricingPlanPageParam45;
    ...
    <span>
      {$.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
          ...
          values: {
            product: pricingPlanPageHelper21,
          },
        },
      )}
    </span>
...
function pricingPlanPageHelper21(pricingPlanPageParam63) {
  return (
    <span className="text-token-text-secondary">{pricingPlanPageParam63}</span>
  );
}
function pricingPlanPageHelper22(pricingPlanPageParam62) {
  return (
    <span className="text-[var(--pricing-plan-highlight)]">
      {pricingPlanPageParam62}
    </span>
  );
}
function pricingPlanPageHelper23(pricingPlanPageParam49) {
  let { children, href } = pricingPlanPageParam49,
...
function pricingPlanPageHelper24(pricingPlanPageParam46) {
  let { cardId } = pricingPlanPageParam46;
  return cardId === "business_chatgpt_codex"
    ? $.jsx(
        appInitialAvatarOverlayCompositionSurfaceArtifactTabContentElectronNotebookPreviewDejrazf4D,
        {
...
rolldownRuntimeN(() => {
  ...
  $ =
    appInitialAvatarOverlayCompositionSurfaceIndex9fQ9wihuIndexBFCcxPM5MapboxGlDVWlwqbKppdhleyZt();
  pricingPlanPageValue96 =
    "!border-transparent !bg-[var(--pricing-plan-highlight)] !text-white enabled:hover:!bg-[color-mix(in_srgb,var(--pricing-plan-highlight)_90%,transparent)] data-[state=open]:!bg-[color-mix(in_srgb,var(--pricing-plan-highlight)_90%,transparent)]";
  pricingPlanPageValue97 =
    "w-full justify-center py-1 [@container_(min-width:44rem)]:min-h-11";
  pricingPlanPageValue98 = "https://help.openai.com/en/articles/20001047";
  pricingPlanPageValue99 =
    "https://help.openai.com/en/collections/3943089-billing";
  pricingPlanPageValue100 =
