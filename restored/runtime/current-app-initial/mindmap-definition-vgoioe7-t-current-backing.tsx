// Restored from ref/webview/assets/mindmap-definition-VGOIOE7T-DIbOvok1.js
...
import {
  ...
  lighten as distD,
  isDark as distP,
  initMermaidColorUtils as distT,
} from "../package-adapters/mermaid-color/index";
import {
  getUserDefinedConfig as _chunkABZYJK2DD,
  sanitizeTextWithConfig as chunkABZYJK2DB,
  getConfig as chunkABZYJK2DD,
  defaultConfig as chunkABZYJK2DK,
  initLegacyMermaidCommonRuntime as chunkABZYJK2DL,
} from "../package-adapters/mermaid-common-legacy/index";
import { initMermaidSvgUtilities as chunkS3R3BYOJU } from "../package-adapters/mermaid-svg-utils-current/index";
import { initMermaidTextAndIcons as chunkJA3XYJ7ZI } from "../package-adapters/mermaid-11-12/text-icons/index";
import { initChunkHN2XXSSU as chunkHN2XXSSUN } from "../../vendor/mermaid-relation-markers";
import { initChunkCVBHYZKI as chunkCVBHYZKIN } from "../../vendor/mermaid-subgraph-title-margins";
import {
  initMermaidDiagramElement as chunk55IACEB6N,
  getDiagramElement as chunk55IACEB6T,
} from "../package-adapters/mermaid-diagram-element-current/index";
import {
  chunkQN33PNHLT as chunkQN33PNHLN,
  chunkQN33PNHLN as chunkQN33PNHLT,
} from "../../vendor/chunk-qn33-pnhl";
import { initLegacyMermaidStyleUtils as chunkATLVNIR6N } from "../package-adapters/mermaid-common-legacy/style-utils";
import { initMermaidShapeRenderer as chunkJZLCHNYAI } from "../package-adapters/mermaid-11-12/shape-renderer/index";
import { initMermaidEdgeRenderer as chunkQXUST7PYN } from "../package-adapters/mermaid-11-12/edge-renderer/index";
import {
  render as chunkN4CR4FBYI,
  initMermaidLayoutRegistry as chunkN4CR4FBYN,
  getRegisteredLayoutAlgorithm as chunkN4CR4FBYT,
} from "../package-adapters/mermaid-11-12/layout-registry/index";
import {
...
var mindmapDefinitionVGOIOE7TValue1,
  mindmapDefinitionVGOIOE7TValue2,
  mindmapDefinitionVGOIOE7TValue3,
  mindmapDefinitionVGOIOE7TValue4,
  mindmapDefinitionVGOIOE7TValue5,
  mindmapDefinitionVGOIOE7TValue6,
...
rolldownRuntimeN(() => {
  ...
  distT();
  mindmapDefinitionVGOIOE7TValue1 = (function () {
    var mindmapDefinitionVGOIOE7TValue7 = chunkAGHRB4JFN(function (
      ...
      mindmapDefinitionVGOIOE7TValue24 = {
        ...
        parseError: chunkAGHRB4JFN(function (
          ...
          if (mindmapDefinitionVGOIOE7TParam41.recoverable)
            this.trace(mindmapDefinitionVGOIOE7TParam40);
          else {
            var mindmapDefinitionVGOIOE7TValue104 = Error(
              mindmapDefinitionVGOIOE7TParam40,
            );
            throw (
              (mindmapDefinitionVGOIOE7TValue104.hash =
                mindmapDefinitionVGOIOE7TParam41),
              mindmapDefinitionVGOIOE7TValue104
            );
          }
        }, "parseError"),
        parse: chunkAGHRB4JFN(function (mindmapDefinitionVGOIOE7TParam1) {
          ...
          function mindmapDefinitionVGOIOE7THelper3() {
            var mindmapDefinitionVGOIOE7TValue97 =
              mindmapDefinitionVGOIOE7TValue27.pop() ||
              mindmapDefinitionVGOIOE7TValue38.lex() ||
              1;
            return (
              typeof mindmapDefinitionVGOIOE7TValue97 != "number" &&
                (mindmapDefinitionVGOIOE7TValue97 instanceof Array &&
                  ((mindmapDefinitionVGOIOE7TValue27 =
                    mindmapDefinitionVGOIOE7TValue97),
                  (mindmapDefinitionVGOIOE7TValue97 =
                    mindmapDefinitionVGOIOE7TValue27.pop())),
                (mindmapDefinitionVGOIOE7TValue97 =
    ...
    mindmapDefinitionVGOIOE7TValue24.lexer = (function () {
      return {
        ...
        setInput: chunkAGHRB4JFN(function (
          ...
          mindmapDefinitionVGOIOE7TParam30,
        ) {
          return (
            (this.yy = mindmapDefinitionVGOIOE7TParam30 || this.yy || {}),
            (this._input = mindmapDefinitionVGOIOE7TParam29),
        ...
        unput: chunkAGHRB4JFN(function (mindmapDefinitionVGOIOE7TParam17) {
          var mindmapDefinitionVGOIOE7TValue69 =
              mindmapDefinitionVGOIOE7TParam17.length,
            mindmapDefinitionVGOIOE7TValue70 =
              mindmapDefinitionVGOIOE7TParam17.split(/(?:\r\n?|\n)/g);
          this._input = mindmapDefinitionVGOIOE7TParam17 + this._input;
          this.yytext = this.yytext.substr(
            0,
            this.yytext.length - mindmapDefinitionVGOIOE7TValue69,
          );
          this.offset -= mindmapDefinitionVGOIOE7TValue69;
          var mindmapDefinitionVGOIOE7TValue71 =
            this.match.split(/(?:\r\n?|\n)/g);
          this.match = this.match.substr(0, this.match.length - 1);
          this.matched = this.matched.substr(0, this.matched.length - 1);
          mindmapDefinitionVGOIOE7TValue70.length - 1 &&
            (this.yylineno -= mindmapDefinitionVGOIOE7TValue70.length - 1);
          var mindmapDefinitionVGOIOE7TValue72 = this.yylloc.range;
          return (
            (this.yylloc = {
              first_line: this.yylloc.first_line,
              last_line: this.yylineno + 1,
              first_column: this.yylloc.first_column,
              last_column: mindmapDefinitionVGOIOE7TValue70
                ? (mindmapDefinitionVGOIOE7TValue70.length ===
                  mindmapDefinitionVGOIOE7TValue71.length
                  ...
                  mindmapDefinitionVGOIOE7TValue70[0].length
                : this.yylloc.first_column - mindmapDefinitionVGOIOE7TValue69,
            }),
            this.options.ranges &&
              (this.yylloc.range = [
                mindmapDefinitionVGOIOE7TValue72[0],
                mindmapDefinitionVGOIOE7TValue72[0] +
                  this.yyleng -
                  mindmapDefinitionVGOIOE7TValue69,
              ]),
        ...
        pastInput: chunkAGHRB4JFN(function () {
          var mindmapDefinitionVGOIOE7TValue99 = this.matched.substr(
            0,
            this.matched.length - this.match.length,
          );
          return (
            (mindmapDefinitionVGOIOE7TValue99.length > 20 ? "..." : "") +
            mindmapDefinitionVGOIOE7TValue99.substr(-20).replace(/\n/g, "")
          );
        }, "pastInput"),
        upcomingInput: chunkAGHRB4JFN(function () {
          var mindmapDefinitionVGOIOE7TValue96 = this.match;
          return (
            mindmapDefinitionVGOIOE7TValue96.length < 20 &&
              (mindmapDefinitionVGOIOE7TValue96 += this._input.substr(
                0,
                20 - mindmapDefinitionVGOIOE7TValue96.length,
              )),
            (
              mindmapDefinitionVGOIOE7TValue96.substr(0, 20) +
              (mindmapDefinitionVGOIOE7TValue96.length > 20 ? "..." : "")
            ).replace(/\n/g, "")
          );
        }, "upcomingInput"),
        showPosition: chunkAGHRB4JFN(function () {
          var mindmapDefinitionVGOIOE7TValue100 = this.pastInput(),
            mindmapDefinitionVGOIOE7TValue101 = Array(
              mindmapDefinitionVGOIOE7TValue100.length + 1,
            ).join("-");
          return (
            mindmapDefinitionVGOIOE7TValue100 +
            this.upcomingInput() +
            "\n" +
        ...
        next: chunkAGHRB4JFN(function () {
          ...
          for (
            ...
            if (
              ...
              mindmapDefinitionVGOIOE7TValue65 &&
                (!mindmapDefinitionVGOIOE7TValue64 ||
                  mindmapDefinitionVGOIOE7TValue65[0].length >
                    mindmapDefinitionVGOIOE7TValue64[0].length))
            ) {
              if (
                ((mindmapDefinitionVGOIOE7TValue64 =
                  mindmapDefinitionVGOIOE7TValue65),
                ...
                if (
                  ((mindmapDefinitionVGOIOE7TValue63 = this.test_match(
                    mindmapDefinitionVGOIOE7TValue65,
                    mindmapDefinitionVGOIOE7TValue67[
                      mindmapDefinitionVGOIOE7TValue68
                    ],
                  )),
                  mindmapDefinitionVGOIOE7TValue63 !== false)
                )
                  return mindmapDefinitionVGOIOE7TValue63;
                if (this._backtrack) {
                  mindmapDefinitionVGOIOE7TValue64 = false;
                  continue;
                } else return false;
              } else if (!this.options.flex) break;
            }
          return mindmapDefinitionVGOIOE7TValue64
            ? ((mindmapDefinitionVGOIOE7TValue63 = this.test_match(
                mindmapDefinitionVGOIOE7TValue64,
                mindmapDefinitionVGOIOE7TValue67[
                  mindmapDefinitionVGOIOE7TValue66
        ...
        begin: chunkAGHRB4JFN(function (mindmapDefinitionVGOIOE7TParam51) {
          this.conditionStack.push(mindmapDefinitionVGOIOE7TParam51);
        }, "begin"),
        ...
        topState: chunkAGHRB4JFN(function (mindmapDefinitionVGOIOE7TParam39) {
          return (
            (mindmapDefinitionVGOIOE7TParam39 =
              this.conditionStack.length -
              1 -
              Math.abs(mindmapDefinitionVGOIOE7TParam39 || 0)),
            mindmapDefinitionVGOIOE7TParam39 >= 0
              ? this.conditionStack[mindmapDefinitionVGOIOE7TParam39]
              : "INITIAL"
          );
        }, "topState"),
  ...
  mindmapDefinitionVGOIOE7TValue2 = mindmapDefinitionVGOIOE7TValue1;
  mindmapDefinitionVGOIOE7TValue3 = {
    DEFAULT: 0,
    NO_BORDER: 0,
    ROUNDED_RECT: 1,
  ...
  mindmapDefinitionVGOIOE7TValue4 = class {
    ...
    getParent(mindmapDefinitionVGOIOE7TParam42) {
      for (
        let mindmapDefinitionVGOIOE7TValue108 = this.nodes.length - 1;
        mindmapDefinitionVGOIOE7TValue108 >= 0;
        mindmapDefinitionVGOIOE7TValue108--
      )
        if (
          this.nodes[mindmapDefinitionVGOIOE7TValue108].level <
          mindmapDefinitionVGOIOE7TParam42
        )
          return this.nodes[mindmapDefinitionVGOIOE7TValue108];
      return null;
    }
    getMindmap() {
    ...
    addNode(
      ...
      let mindmapDefinitionVGOIOE7TValue74 = false;
      this.nodes.length === 0
        ? ((this.baseLevel = mindmapDefinitionVGOIOE7TParam19),
          (mindmapDefinitionVGOIOE7TParam19 = 0),
          (mindmapDefinitionVGOIOE7TValue74 = true))
        : this.baseLevel !== undefined &&
          ((mindmapDefinitionVGOIOE7TParam19 -= this.baseLevel),
          (mindmapDefinitionVGOIOE7TValue74 = false));
      let mindmapDefinitionVGOIOE7TValue75 = chunkABZYJK2DB(),
        mindmapDefinitionVGOIOE7TValue76 =
          mindmapDefinitionVGOIOE7TValue75.mindmap?.padding ??
          _chunkABZYJK2DD.mindmap.padding;
      switch (mindmapDefinitionVGOIOE7TParam22) {
        case this.nodeType.ROUNDED_RECT:
        case this.nodeType.RECT:
        case this.nodeType.HEXAGON:
          mindmapDefinitionVGOIOE7TValue76 *= 2;
          break;
      }
      let mindmapDefinitionVGOIOE7TValue77 = {
          id: this.count++,
          ...
          children: [],
          width:
            mindmapDefinitionVGOIOE7TValue75.mindmap?.maxNodeWidth ??
            _chunkABZYJK2DD.mindmap.maxNodeWidth,
          padding: mindmapDefinitionVGOIOE7TValue76,
          isRoot: mindmapDefinitionVGOIOE7TValue74,
        },
        mindmapDefinitionVGOIOE7TValue78 = this.getParent(
          mindmapDefinitionVGOIOE7TParam19,
        );
      if (mindmapDefinitionVGOIOE7TValue78) {
        mindmapDefinitionVGOIOE7TValue78.children.push(
          mindmapDefinitionVGOIOE7TValue77,
        );
        this.nodes.push(mindmapDefinitionVGOIOE7TValue77);
      } else if (mindmapDefinitionVGOIOE7TValue74)
        this.nodes.push(mindmapDefinitionVGOIOE7TValue77);
      else
        throw Error(
          `There can be only one root. No parent could be found for ("${mindmapDefinitionVGOIOE7TValue77.descr}")`,
        );
    }
    getType(
      ...
      switch (
        ...
        case "(":
          return mindmapDefinitionVGOIOE7TParam35 === ")"
    ...
    setElementForId(
      mindmapDefinitionVGOIOE7TParam52,
      mindmapDefinitionVGOIOE7TParam53,
    ) {
      this.elements[mindmapDefinitionVGOIOE7TParam52] =
        mindmapDefinitionVGOIOE7TParam53;
    }
    getElementById(mindmapDefinitionVGOIOE7TParam54) {
      return this.elements[mindmapDefinitionVGOIOE7TParam54];
    }
    decorateNode(mindmapDefinitionVGOIOE7TParam38) {
      if (!mindmapDefinitionVGOIOE7TParam38) return;
      let mindmapDefinitionVGOIOE7TValue102 = chunkABZYJK2DB(),
        mindmapDefinitionVGOIOE7TValue103 = this.nodes[this.nodes.length - 1];
      mindmapDefinitionVGOIOE7TParam38.icon &&
        (mindmapDefinitionVGOIOE7TValue103.icon = chunkABZYJK2DL(
          mindmapDefinitionVGOIOE7TParam38.icon,
          mindmapDefinitionVGOIOE7TValue102,
        ));
      mindmapDefinitionVGOIOE7TParam38.class &&
        (mindmapDefinitionVGOIOE7TValue103.class = chunkABZYJK2DL(
          mindmapDefinitionVGOIOE7TParam38.class,
          mindmapDefinitionVGOIOE7TValue102,
        ));
    }
    type2Str(mindmapDefinitionVGOIOE7TParam33) {
      switch (mindmapDefinitionVGOIOE7TParam33) {
    ...
    flattenNodes(
      ...
      let mindmapDefinitionVGOIOE7TValue59 = ["mindmap-node"];
      mindmapDefinitionVGOIOE7TParam15.isRoot === true
        ? mindmapDefinitionVGOIOE7TValue59.push("section-root", "section--1")
        : mindmapDefinitionVGOIOE7TParam15.section !== undefined &&
          mindmapDefinitionVGOIOE7TValue59.push(
            `section-${mindmapDefinitionVGOIOE7TParam15.section}`,
          );
      mindmapDefinitionVGOIOE7TParam15.class &&
        mindmapDefinitionVGOIOE7TValue59.push(
          mindmapDefinitionVGOIOE7TParam15.class,
        );
      let mindmapDefinitionVGOIOE7TValue60 =
          mindmapDefinitionVGOIOE7TValue59.join(" "),
        mindmapDefinitionVGOIOE7TValue61 = chunkAGHRB4JFN(
          (mindmapDefinitionVGOIOE7TParam32) => {
            switch (mindmapDefinitionVGOIOE7TParam32) {
        ...
        mindmapDefinitionVGOIOE7TValue62 = {
          id: mindmapDefinitionVGOIOE7TParam15.id.toString(),
          domId: "node_" + mindmapDefinitionVGOIOE7TParam15.id.toString(),
          label: mindmapDefinitionVGOIOE7TParam15.descr,
          isGroup: false,
          shape: mindmapDefinitionVGOIOE7TValue61(
            mindmapDefinitionVGOIOE7TParam15.type,
          ),
          width: mindmapDefinitionVGOIOE7TParam15.width,
          height: mindmapDefinitionVGOIOE7TParam15.height ?? 0,
          padding: mindmapDefinitionVGOIOE7TParam15.padding,
          cssClasses: mindmapDefinitionVGOIOE7TValue60,
          cssStyles: [],
          look: "default",
          icon: mindmapDefinitionVGOIOE7TParam15.icon,
          x: mindmapDefinitionVGOIOE7TParam15.x,
          y: mindmapDefinitionVGOIOE7TParam15.y,
          level: mindmapDefinitionVGOIOE7TParam15.level,
          nodeId: mindmapDefinitionVGOIOE7TParam15.nodeId,
          type: mindmapDefinitionVGOIOE7TParam15.type,
          section: mindmapDefinitionVGOIOE7TParam15.section,
        };
      if (
        (mindmapDefinitionVGOIOE7TParam16.push(
          mindmapDefinitionVGOIOE7TValue62,
        ),
        mindmapDefinitionVGOIOE7TParam15.children)
      )
        for (let mindmapDefinitionVGOIOE7TValue110 of mindmapDefinitionVGOIOE7TParam15.children)
          this.flattenNodes(
    ...
    generateEdges(
      ...
      if (mindmapDefinitionVGOIOE7TParam27.children)
        for (let mindmapDefinitionVGOIOE7TValue91 of mindmapDefinitionVGOIOE7TParam27.children) {
          ...
          let mindmapDefinitionVGOIOE7TValue93 =
            mindmapDefinitionVGOIOE7TParam27.level + 1;
          mindmapDefinitionVGOIOE7TValue92 += ` edge-depth-${mindmapDefinitionVGOIOE7TValue93}`;
          let mindmapDefinitionVGOIOE7TValue94 = {
            id: `edge_${mindmapDefinitionVGOIOE7TParam27.id}_${mindmapDefinitionVGOIOE7TValue91.id}`,
            start: mindmapDefinitionVGOIOE7TParam27.id.toString(),
            ...
            depth: mindmapDefinitionVGOIOE7TParam27.level,
            section: mindmapDefinitionVGOIOE7TValue91.section,
          };
          mindmapDefinitionVGOIOE7TParam28.push(
    ...
    getData() {
      let mindmapDefinitionVGOIOE7TValue79 = this.getMindmap(),
        mindmapDefinitionVGOIOE7TValue80 = chunkABZYJK2DB(),
        mindmapDefinitionVGOIOE7TValue81 =
          chunkABZYJK2DD().layout !== undefined,
        mindmapDefinitionVGOIOE7TValue82 = mindmapDefinitionVGOIOE7TValue80;
      if (
        (mindmapDefinitionVGOIOE7TValue81 ||
          (mindmapDefinitionVGOIOE7TValue82.layout = "cose-bilkent"),
        !mindmapDefinitionVGOIOE7TValue79)
      )
        return {
          nodes: [],
          edges: [],
          config: mindmapDefinitionVGOIOE7TValue82,
        };
      chunkAGHRB4JFI.debug(
        "getData: mindmapRoot",
        mindmapDefinitionVGOIOE7TValue79,
      ...
      this.assignSections(mindmapDefinitionVGOIOE7TValue79);
      let mindmapDefinitionVGOIOE7TValue83 = [],
        mindmapDefinitionVGOIOE7TValue84 = [];
      this.flattenNodes(
        mindmapDefinitionVGOIOE7TValue79,
      ...
      chunkAGHRB4JFI.debug(
        `getData: processed ${mindmapDefinitionVGOIOE7TValue83.length} nodes and ${mindmapDefinitionVGOIOE7TValue84.length} edges`,
      );
      let mindmapDefinitionVGOIOE7TValue85 = new Map();
      for (let mindmapDefinitionVGOIOE7TValue105 of mindmapDefinitionVGOIOE7TValue83)
        mindmapDefinitionVGOIOE7TValue85.set(
          mindmapDefinitionVGOIOE7TValue105.id,
          {
            shape: mindmapDefinitionVGOIOE7TValue105.shape,
            width: mindmapDefinitionVGOIOE7TValue105.width,
            height: mindmapDefinitionVGOIOE7TValue105.height,
            padding: mindmapDefinitionVGOIOE7TValue105.padding,
          },
        );
      return {
        nodes: mindmapDefinitionVGOIOE7TValue83,
        edges: mindmapDefinitionVGOIOE7TValue84,
        config: mindmapDefinitionVGOIOE7TValue82,
        rootNode: mindmapDefinitionVGOIOE7TValue79,
        markers: ["point"],
        direction: "TB",
        nodeSpacing: 50,
        rankSpacing: 50,
        shapes: Object.fromEntries(mindmapDefinitionVGOIOE7TValue85),
        type: "mindmap",
        diagramId:
          "mindmap-" +
  ...
  mindmapDefinitionVGOIOE7TValue5 = {
    draw: chunkAGHRB4JFN(
      async (
        ...
        let mindmapDefinitionVGOIOE7TValue86 =
            mindmapDefinitionVGOIOE7TParam26.db,
          mindmapDefinitionVGOIOE7TValue87 =
            mindmapDefinitionVGOIOE7TValue86.getData(),
          mindmapDefinitionVGOIOE7TValue88 = chunk55IACEB6T(
            mindmapDefinitionVGOIOE7TParam24,
            mindmapDefinitionVGOIOE7TValue87.config.securityLevel,
          );
        mindmapDefinitionVGOIOE7TValue87.type =
          mindmapDefinitionVGOIOE7TParam26.type;
        mindmapDefinitionVGOIOE7TValue87.layoutAlgorithm = chunkN4CR4FBYT(
          mindmapDefinitionVGOIOE7TValue87.config.layout,
          {
            fallback: "cose-bilkent",
          },
        );
        mindmapDefinitionVGOIOE7TValue87.diagramId =
          mindmapDefinitionVGOIOE7TParam24;
        mindmapDefinitionVGOIOE7TValue86.getMindmap() &&
          (mindmapDefinitionVGOIOE7TValue87.nodes.forEach((item) => {
            item.shape === "rounded"
              ? ((item.radius = 15),
                (item.taper = 15),
                (item.stroke = "none"),
          ...
          await chunkN4CR4FBYI(
            mindmapDefinitionVGOIOE7TValue87,
            mindmapDefinitionVGOIOE7TValue88,
          ),
          chunkQN33PNHLN(
            mindmapDefinitionVGOIOE7TValue88,
            mindmapDefinitionVGOIOE7TValue87.config.mindmap?.padding ??
              _chunkABZYJK2DD.mindmap.padding,
            "mindmapDiagram",
            mindmapDefinitionVGOIOE7TValue87.config.mindmap?.useMaxWidth ??
  ...
  mindmapDefinitionVGOIOE7TValue6 = chunkAGHRB4JFN(
    (mindmapDefinitionVGOIOE7TParam18) => {
      let mindmapDefinitionVGOIOE7TValue73 = "";
      for (
        let mindmapDefinitionVGOIOE7TValue98 = 0;
        mindmapDefinitionVGOIOE7TValue98 <
        mindmapDefinitionVGOIOE7TParam18.THEME_COLOR_LIMIT;
        mindmapDefinitionVGOIOE7TValue98++
      ) {
        mindmapDefinitionVGOIOE7TParam18[
          "lineColor" + mindmapDefinitionVGOIOE7TValue98
        ] =
          mindmapDefinitionVGOIOE7TParam18[
            "lineColor" + mindmapDefinitionVGOIOE7TValue98
          ] ||
          mindmapDefinitionVGOIOE7TParam18[
            "cScaleInv" + mindmapDefinitionVGOIOE7TValue98
          ];
        distP(
          mindmapDefinitionVGOIOE7TParam18[
            "lineColor" + mindmapDefinitionVGOIOE7TValue98
      ...
      for (
        let mindmapDefinitionVGOIOE7TValue89 = 0;
        mindmapDefinitionVGOIOE7TValue89 <
        mindmapDefinitionVGOIOE7TParam18.THEME_COLOR_LIMIT;
        mindmapDefinitionVGOIOE7TValue89++
      ) {
        let mindmapDefinitionVGOIOE7TValue90 =
          "" + (17 - 3 * mindmapDefinitionVGOIOE7TValue89);
        mindmapDefinitionVGOIOE7TValue73 += `
    .section-${mindmapDefinitionVGOIOE7TValue89 - 1} rect, .section-${mindmapDefinitionVGOIOE7TValue89 - 1} path, .section-${mindmapDefinitionVGOIOE7TValue89 - 1} circle, .section-${mindmapDefinitionVGOIOE7TValue89 - 1} polygon, .section-${mindmapDefinitionVGOIOE7TValue89 - 1} path  {
      fill: ${mindmapDefinitionVGOIOE7TParam18["cScale" + mindmapDefinitionVGOIOE7TValue89]};
    }
    .section-${mindmapDefinitionVGOIOE7TValue89 - 1} text {
     fill: ${mindmapDefinitionVGOIOE7TParam18["cScaleLabel" + mindmapDefinitionVGOIOE7TValue89]};
    }
    .node-icon-${mindmapDefinitionVGOIOE7TValue89 - 1} {
      font-size: 40px;
      color: ${mindmapDefinitionVGOIOE7TParam18["cScaleLabel" + mindmapDefinitionVGOIOE7TValue89]};
    }
    .section-edge-${mindmapDefinitionVGOIOE7TValue89 - 1}{
      stroke: ${mindmapDefinitionVGOIOE7TParam18["cScale" + mindmapDefinitionVGOIOE7TValue89]};
    }
    .edge-depth-${mindmapDefinitionVGOIOE7TValue89 - 1}{
      stroke-width: ${mindmapDefinitionVGOIOE7TValue90};
    }
    .section-${mindmapDefinitionVGOIOE7TValue89 - 1} line {
      stroke: ${mindmapDefinitionVGOIOE7TParam18["cScaleInv" + mindmapDefinitionVGOIOE7TValue89]} ;
      stroke-width: 3;
    }
    ...
    `;
      ...
      return mindmapDefinitionVGOIOE7TValue73;
    },
    "genSections",
  );
  MindmapDefinitionVGOIOE7T = {
  ...
  ${mindmapDefinitionVGOIOE7TValue6(mindmapDefinitionVGOIOE7TParam31)}
  .section-root rect, .section-root path, .section-root circle, .section-root polygon  {
    fill: ${mindmapDefinitionVGOIOE7TParam31.git0};
  }
  .section-root text {
    fill: ${mindmapDefinitionVGOIOE7TParam31.gitBranchLabel0};
  }
  .section-root span {
    color: ${mindmapDefinitionVGOIOE7TParam31.gitBranchLabel0};
  }
  .section-2 span {
    color: ${mindmapDefinitionVGOIOE7TParam31.gitBranchLabel0};
  }
