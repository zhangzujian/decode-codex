...
} from "../../vendor/lodash-pull-request-helpers";
import {
...
} from "../../vendor/pull-request-new-thread-current-runtime/config-query-aliases";
var Mt,
  Nt,
  Pt,
  Ft,
...
function nn({ authMethod: e, hostId: t }) {
  return {
    ...
    queryFn: async () => {
      try {
        return await L(`get-config-requirements-for-host`, {
          hostId: t,
        });
      } catch (e) {
        return (
...
function dn(e, t, n) {
  ...
  return i
    ? {
        ...e,
        config: Object.assign(structuredClone(e.config), {
          [r]: i,
        }),
      }
    : e;
