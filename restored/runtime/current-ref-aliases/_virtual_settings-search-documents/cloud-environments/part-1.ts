...
export const cloudEnvironmentsSettingsSearchDocumentsPart1 = [
  {
  ...
  {
    defaultMessage:
      "Runs after branch checkout whenever ChatGPT reuses a cached container",
  ...
  {
    defaultMessage:
      "Speeds up chat startup by saving the container after setup",
