...
// Appshot attachment card and accessibility-aware preview lightbox.
...
import {
  computeComposerSnapshotHeight,
  SCREENSHOT_WIDTH,
  THREAD_SCREENSHOT_HEIGHT,
} from "./utils";
import type { AppshotAttachmentProps, AppshotPreviewItem } from "./types";
...
export default AppshotAttachment;
