...
function NewChatSuggestionCategories(homeAmbientOperand1) {
  let {
    ...
    homeAmbientBinding113 =
      appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dVy(),
    [homeAmbientBinding114, homeAmbientBinding115] = (0,
    homeAmbientBinding30.useState)(homeAmbientBinding111),
    [homeAmbientBinding116, homeAmbientBinding117] = (0,
    homeAmbientBinding30.useState)(null),
    homeAmbientBinding118,
    homeAmbientBinding119;
  ((homeAmbientBinding118 =
    categories.find((item) => item.id === homeAmbientBinding114) ?? null),
    (homeAmbientBinding119 =
      homeAmbientBinding118 != null &&
      isComposerPromptForCategory(
        composerPrompt,
        homeAmbientBinding118.starterPrompt,
      )));
  let homeAmbientBinding120 = homeAmbientBinding119,
    homeAmbientBinding121 =
      homeAmbientBinding118 != null &&
      homeAmbientBinding116?.id === homeAmbientBinding118.id &&
      homeAmbientBinding116.previousPrompt === composerPrompt;
  homeAmbientBinding118 != null &&
    (homeAmbientBinding120
      ? homeAmbientBinding116 != null && homeAmbientBinding117(null)
      : homeAmbientBinding121 ||
        (homeAmbientBinding115(null),
        homeAmbientBinding116 != null && homeAmbientBinding117(null)));
  let homeAmbientBinding122 =
      homeAmbientBinding118 != null &&
      (homeAmbientBinding120 || homeAmbientBinding121)
        ? homeAmbientBinding118
        : null,
  ...
  let homeAmbientBinding127 = (0, homeAmbientBinding30.useRef)(
      homeAmbientBinding126,
    ),
    homeAmbientBinding128,
    homeAmbientBinding129;
  ((homeAmbientBinding128 = () => {
    homeAmbientBinding125.current ||
      ((homeAmbientBinding125.current = !0),
    ...
    (homeAmbientBinding129 = [homeAmbientBinding112]),
    (0, homeAmbientBinding30.useEffect)(
      homeAmbientBinding128,
      homeAmbientBinding129,
    ));
  let homeAmbientBinding130, homeAmbientBinding131;
  ((homeAmbientBinding130 = () => {
    homeAmbientBinding122 == null ||
      homeAmbientBinding127.current.has(homeAmbientBinding122.id) ||
      (homeAmbientBinding127.current.add(homeAmbientBinding122.id),
      appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dBl(
        ...
        {
          promptIds: homeAmbientBinding122.suggestions
            .map(getNewChatSuggestionId)
            .join(`,`),
          promptTypes: homeAmbientBinding122.suggestions
            .map(getNewChatSuggestionAnalyticsType)
            .join(`,`),
    ...
    (homeAmbientBinding131 = [homeAmbientBinding112, homeAmbientBinding122]),
    (0, homeAmbientBinding30.useEffect)(
      homeAmbientBinding130,
      homeAmbientBinding131,
    ));
  ...
  let homeAmbientBinding133 = homeAmbientBinding132,
    homeAmbientBinding134 = (homeAmbientOperand27) => {
      (trackNewChatSuggestionAction(homeAmbientBinding112, {
        ...
        onSelectCategory(homeAmbientOperand27),
        homeAmbientBinding117({
  ...
  if (homeAmbientBinding122 != null) {
    ...
    let homeAmbientBinding182 = (homeAmbientOperand25) => {
      let homeAmbientBinding247 = homeAmbientBinding122.suggestions.findIndex(
        (item) => item.id === homeAmbientOperand25.id,
      );
      (trackNewChatSuggestionAction(homeAmbientBinding112, {
        action:
  ...
  let homeAmbientBinding136;
  {
    ...
    ((homeAmbientBinding239 = (homeAmbientOperand22) =>
      React.createElement(NewChatSuggestionCategoryRow, {
        disabled: homeAmbientBinding110,
  ...
  let homeAmbientBinding137 = React.createElement(
    `div`,
    {
  ...
  let homeAmbientBinding138 = React.createElement(
    NewChatSuggestionsDismissButton,
    {
      ariaLabel: homeAmbientBinding124,
      disabled: homeAmbientBinding110,
      onClick: homeAmbientBinding133,
  ...
  return React.createElement(
    ...
    homeAmbientBinding137,
    homeAmbientBinding138,
  );
}
...
function NewChatSuggestionCategoryRow(homeAmbientOperand11) {
  let {
    ...
    homeAmbientBinding194 = React.createElement(
      homeRowLayoutN,
      {
        "aria-hidden": `true`,
      },
  ...
  let homeAmbientBinding196 = React.createElement(
    homeRowLayoutT,
    null,
    homeAmbientBinding194,
    homeAmbientBinding195,
  );
  let homeAmbientBinding197 =
    trailingIcon == null
      ? null
      : React.createElement(
          `span`,
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      homeAmbientBinding196,
      homeAmbientBinding197,
    ),
  );
}
  ...
  let {
    ...
    homeAmbientBinding209 =
      appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwMh(
        ...
        homeAmbientBinding208,
      );
  let homeAmbientBinding210 = React.createElement(
...
function isComposerPromptForCategory(
  homeAmbientOperand38,
  homeAmbientOperand39,
) {
  return (
    homeAmbientOperand38 == null ||
    homeAmbientOperand38.startsWith(homeAmbientOperand39)
  );
}
...
function trackNewChatSuggestionAction(
  homeAmbientOperand46,
  homeAmbientOperand47,
) {
  appInitialAppMainRemoteConversationPageNewThreadPanelPageProjectsIndexPageAppIy8s9c2dBl(
    homeAmbientOperand46,
...
var homeAmbientBinding29,
  ...
  homeAmbientBinding32 = rolldownRuntimeN(() => {
    ((homeAmbientBinding29 =
      ...
      (homeAmbientBinding30 = rolldownRuntimeS(
      ...
      HomeAmbientRowsModule.homeAmbientBinding18(),
      (homeAmbientBinding31 =
