...
function AmbientSuggestionRows(homeAmbientOperand3) {
  ...
  {
    let homeAmbientBinding175 =
      apps == null ? void 0 : appInitialAppMainOnboardingPageFf(apps);
    ((homeAmbientBinding157 =
      trailingAction != null && (headline != null || suggestions.length > 0)),
      (homeAmbientBinding158 = `mx-auto -my-1.5 flex w-full min-w-0 flex-col divide-y divide-token-border/70 select-none`),
      (homeAmbientBinding159 =
        headline == null
          ? null
          : React.createElement(AmbientSuggestionRow, {
      ...
      (homeAmbientBinding160 = suggestions.map((item) => {
        ...
        for (let homeAmbientBinding245 of new Set(item.appIds)) {
          ...
          let homeAmbientBinding249 = homeAmbientBinding175?.get(
            homeAmbientBinding245,
          );
          if (
            homeAmbientBinding249?.logoUrl != null ||
            homeAmbientBinding249?.logoUrlDark != null
          ) {
            homeAmbientBinding201 = {
              appId: homeAmbientBinding245,
        ...
        return React.createElement(AmbientSuggestionRow, {
          dismissAction:
            homeAmbientBinding155 && onDismissSuggestion != null
              ? {
          ...
          tooltipContent:
            item.showTooltip === !1
              ? void 0
              : React.createElement(renderInlineCodeDescription, {
  ...
  let homeAmbientBinding161 = homeAmbientBinding157
    ? React.createElement(AmbientSuggestionRow, {
...
function AmbientSuggestionRow(homeAmbientOperand4) {
  let {
    ...
    homeAmbientBinding165 = React.createElement(
      homeRowLayoutN,
      {
        "aria-hidden": `true`,
      },
  ...
  let homeAmbientBinding166 = React.createElement(
    homeRowLayoutR,
    {
  ...
  let homeAmbientBinding167 = React.createElement(
    homeRowLayoutT,
    null,
    homeAmbientBinding165,
    homeAmbientBinding166,
  );
  let homeAmbientBinding168 = homeAmbientBinding167,
    homeAmbientBinding169 =
      onClick == null
        ? React.createElement(
            `div`,
            {
...
function AmbientSuggestionSourceIcon(homeAmbientOperand18) {
  return homeAmbientOperand18 == null
    ...
    : homeAmbientOperand18.Icon == null
      ? React.createElement(
      ...
      : React.createElement(homeAmbientOperand18.Icon, {
          className:
            appInitialAppMainWorktreeInitV2PageRemoteConversationPageNewThreadPanelPageOKo8xg8gwMh(
              `icon-xs shrink-0 object-contain`,
              homeAmbientBinding16.has(homeAmbientOperand18.appId) &&
                homeAmbientBinding17,
            ),
        });
}
function renderInlineCodeDescription({ description: description }) {
  let homeAmbientBinding241 = description.split(/(`[^`]+`)/g);
  return homeAmbientBinding241.length === 1
    ? description
    : homeAmbientBinding241.map((item, index) =>
...
var homeAmbientBinding13,
  ...
  homeAmbientBinding18 = rolldownRuntimeN(() => {
    ((homeAmbientBinding13 =
      ...
      (homeAmbientBinding15 = 750),
      (homeAmbientBinding16 = new Set([
        `figma`,
        `file-csv`,
        `file-pdf`,
        `file-presentation`,
      ...
      (homeAmbientBinding17 = `opacity-85`));
  });
