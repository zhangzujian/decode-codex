...
describe("quality-gate", () => {
  test("recognizes retained third-party package bodies by public vendor filename", () => {
    const fixtures: Array<[string, string[]]> = [
      ...
      [
        "chunk-atlvnir6.ts",
        ["mermaid/dist/chunks/mermaid.core/chunk-ATLVNIR6.mjs"],
      ],
      [
        "chunk-edxve4yy.ts",
      ...
      [
        "chunk-qn33-pnhl-dv-z-pb-bs-u.ts",
        ["mermaid/dist/chunks/mermaid.core/chunk-QN33PNHL.mjs"],
      ],
      [
        "chunk-tzmsle5b.ts",
        ["mermaid/dist/chunks/mermaid.core/chunk-TZMSLE5B.mjs"],
      ],
      [
        "chunk-u2hbqhqk.ts",
